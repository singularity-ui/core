...
const MaterialPlumbingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPlumbingTwoTone = (styled.default || styled)(MaterialPlumbingTwoToneSvg).attrs(p => ({
...
`;
MaterialPlumbingTwoTone.propTypes = {
