...
const MaterialHdrPlusOutlinedSvg = props => (
  <svg
...
const MaterialHdrPlusOutlined = props => <Icon as={MaterialHdrPlusOutlinedSvg} {...props} />

MaterialHdrPlusOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHdrPlusOutlined.propTypes = { ...Icon.propTypes }
