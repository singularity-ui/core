...
const MaterialBathroomOutlinedSvg = props => (
  <svg
...
const MaterialBathroomOutlined = props => <Icon as={MaterialBathroomOutlinedSvg} {...props} />

MaterialBathroomOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBathroomOutlined.propTypes = { ...Icon.propTypes }
