...
const MaterialForwardToInboxRoundedSvg = props => (
  <svg
...
const MaterialForwardToInboxRounded = props => <Icon as={MaterialForwardToInboxRoundedSvg} {...props} />

MaterialForwardToInboxRounded.defaultProps = { ...Icon.defaultProps }

MaterialForwardToInboxRounded.propTypes = { ...Icon.propTypes }
