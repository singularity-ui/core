...
const MaterialHistoryEduTwoToneSvg = props => (
  <svg
...
const MaterialHistoryEduTwoTone = props => <Icon as={MaterialHistoryEduTwoToneSvg} {...props} />

MaterialHistoryEduTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHistoryEduTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialHistoryEduTwoTone
