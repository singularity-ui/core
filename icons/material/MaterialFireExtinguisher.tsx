...
const MaterialFireExtinguisherSvg = props => (
  <svg
...
const MaterialFireExtinguisher = props => <Icon as={MaterialFireExtinguisherSvg} {...props} />

MaterialFireExtinguisher.defaultProps = { ...Icon.defaultProps }

MaterialFireExtinguisher.propTypes = { ...Icon.propTypes }

export default MaterialFireExtinguisher
