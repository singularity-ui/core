...
const MaterialBedroomParentSvg = props => (
  <svg
...
const MaterialBedroomParent = props => <Icon as={MaterialBedroomParentSvg} {...props} />

MaterialBedroomParent.defaultProps = { ...Icon.defaultProps }

MaterialBedroomParent.propTypes = { ...Icon.propTypes }
