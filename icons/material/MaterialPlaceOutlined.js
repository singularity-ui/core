...
const MaterialPlaceOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPlaceOutlined = (styled.default || styled)(MaterialPlaceOutlinedSvg).attrs(p => ({
...
`;
MaterialPlaceOutlined.propTypes = {
