...
const MaterialRestaurantMenuSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRestaurantMenu = (styled.default || styled)(MaterialRestaurantMenuSvg).attrs(p => ({
...
`;
MaterialRestaurantMenu.propTypes = {
