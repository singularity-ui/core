...
const MaterialLeakAddRoundedSvg = props => (
...
const MaterialLeakAddRounded = props => <Icon as={MaterialLeakAddRoundedSvg} {...props} />

MaterialLeakAddRounded.defaultProps = { ...Icon.defaultProps }

MaterialLeakAddRounded.propTypes = { ...Icon.propTypes }
