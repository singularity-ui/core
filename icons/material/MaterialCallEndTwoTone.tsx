...
const MaterialCallEndTwoToneSvg = props => (
...
const MaterialCallEndTwoTone = props => <Icon as={MaterialCallEndTwoToneSvg} {...props} />

MaterialCallEndTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCallEndTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialCallEndTwoTone
