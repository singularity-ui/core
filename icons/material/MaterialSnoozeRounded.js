...
const MaterialSnoozeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSnoozeRounded = (styled.default || styled)(MaterialSnoozeRoundedSvg).attrs(p => ({
...
`;
MaterialSnoozeRounded.propTypes = {
