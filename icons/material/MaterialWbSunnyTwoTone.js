...
const MaterialWbSunnyTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWbSunnyTwoTone = (styled.default || styled)(MaterialWbSunnyTwoToneSvg).attrs(p => ({
...
`;
MaterialWbSunnyTwoTone.propTypes = {
