...
const MaterialEmojiObjectsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEmojiObjects = (styled.default || styled)(MaterialEmojiObjectsSvg).attrs(p => ({
...
`;
MaterialEmojiObjects.propTypes = {
