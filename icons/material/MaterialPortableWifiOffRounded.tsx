...
const MaterialPortableWifiOffRoundedSvg = props => (
...
const MaterialPortableWifiOffRounded = props => <Icon as={MaterialPortableWifiOffRoundedSvg} {...props} />

MaterialPortableWifiOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialPortableWifiOffRounded.propTypes = { ...Icon.propTypes }
