...
const MaterialElderlyRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElderlyRounded = (styled.default || styled)(MaterialElderlyRoundedSvg).attrs(p => ({
...
`;
MaterialElderlyRounded.propTypes = {
