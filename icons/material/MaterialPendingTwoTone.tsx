...
const MaterialPendingTwoToneSvg = props => (
  <svg
...
const MaterialPendingTwoTone = props => <Icon as={MaterialPendingTwoToneSvg} {...props} />

MaterialPendingTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPendingTwoTone.propTypes = { ...Icon.propTypes }
