...
const MaterialSailingOutlinedSvg = props => (
  <svg
...
const MaterialSailingOutlined = props => <Icon as={MaterialSailingOutlinedSvg} {...props} />

MaterialSailingOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSailingOutlined.propTypes = { ...Icon.propTypes }
