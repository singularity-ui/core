...
const MaterialSellOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSellOutlined = (styled.default || styled)(MaterialSellOutlinedSvg).attrs(p => ({
...
`;
MaterialSellOutlined.propTypes = {
