...
const MaterialUnarchiveTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUnarchiveTwoTone = (styled.default || styled)(MaterialUnarchiveTwoToneSvg).attrs(p => ({
...
`;
MaterialUnarchiveTwoTone.propTypes = {
