...
const MaterialLayersRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLayersRounded = (styled.default || styled)(MaterialLayersRoundedSvg).attrs(p => ({
...
`;
MaterialLayersRounded.propTypes = {
