...
const MaterialForwardThirtyOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardThirtyOutlined = (styled.default || styled)(MaterialForwardThirtyOutlinedSvg).attrs(p => ({
...
`;
MaterialForwardThirtyOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialForwardThirtyOutlined;