...
const MaterialProductionQuantityLimitsSvg = props => (
  <svg
...
const MaterialProductionQuantityLimits = props => <Icon as={MaterialProductionQuantityLimitsSvg} {...props} />

MaterialProductionQuantityLimits.defaultProps = { ...Icon.defaultProps }

MaterialProductionQuantityLimits.propTypes = { ...Icon.propTypes }
