...
const MaterialTenKTwoToneSvg = props => (
  <svg
...
const MaterialTenKTwoTone = props => <Icon as={MaterialTenKTwoToneSvg} {...props} />

MaterialTenKTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialTenKTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialTenKTwoTone
