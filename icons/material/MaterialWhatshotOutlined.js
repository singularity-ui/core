...
const MaterialWhatshotOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWhatshotOutlined = (styled.default || styled)(MaterialWhatshotOutlinedSvg).attrs(p => ({
...
`;
MaterialWhatshotOutlined.propTypes = {
