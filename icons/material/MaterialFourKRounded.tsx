...
const MaterialFourKRoundedSvg = props => (
...
const MaterialFourKRounded = props => <Icon as={MaterialFourKRoundedSvg} {...props} />

MaterialFourKRounded.defaultProps = { ...Icon.defaultProps }

MaterialFourKRounded.propTypes = { ...Icon.propTypes }
