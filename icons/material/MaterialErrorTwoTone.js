...
const MaterialErrorTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialErrorTwoTone = (styled.default || styled)(MaterialErrorTwoToneSvg).attrs(p => ({
...
`;
MaterialErrorTwoTone.propTypes = {
