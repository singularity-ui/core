...
const MaterialPaymentsRoundedSvg = props => (
  <svg
...
const MaterialPaymentsRounded = props => <Icon as={MaterialPaymentsRoundedSvg} {...props} />

MaterialPaymentsRounded.defaultProps = { ...Icon.defaultProps }

MaterialPaymentsRounded.propTypes = { ...Icon.propTypes }

export default MaterialPaymentsRounded
