...
const MaterialDoNotDisturbOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoNotDisturbOff = (styled.default || styled)(MaterialDoNotDisturbOffSvg).attrs(p => ({
...
`;
MaterialDoNotDisturbOff.propTypes = {
