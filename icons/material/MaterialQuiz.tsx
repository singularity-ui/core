...
const MaterialQuiz = props => <Icon as={MaterialQuizSvg} {...props} />

MaterialQuiz.defaultProps = { ...Icon.defaultProps }

MaterialQuiz.propTypes = { ...Icon.propTypes }
