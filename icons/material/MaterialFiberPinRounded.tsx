...
const MaterialFiberPinRoundedSvg = props => (
...
const MaterialFiberPinRounded = props => <Icon as={MaterialFiberPinRoundedSvg} {...props} />

MaterialFiberPinRounded.defaultProps = { ...Icon.defaultProps }

MaterialFiberPinRounded.propTypes = { ...Icon.propTypes }
