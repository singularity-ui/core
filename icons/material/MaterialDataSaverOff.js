...
const MaterialDataSaverOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDataSaverOff = (styled.default || styled)(MaterialDataSaverOffSvg).attrs(p => ({
...
`;
MaterialDataSaverOff.propTypes = {
