...
const MaterialWavesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWaves = (styled.default || styled)(MaterialWavesSvg).attrs(p => ({
...
`;
MaterialWaves.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialWaves;