...
const MaterialFontDownloadOffSvg = props => (
  <svg
...
const MaterialFontDownloadOff = props => <Icon as={MaterialFontDownloadOffSvg} {...props} />

MaterialFontDownloadOff.defaultProps = { ...Icon.defaultProps }

MaterialFontDownloadOff.propTypes = { ...Icon.propTypes }
