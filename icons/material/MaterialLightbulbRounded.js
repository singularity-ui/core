...
const MaterialLightbulbRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLightbulbRounded = (styled.default || styled)(MaterialLightbulbRoundedSvg).attrs(p => ({
...
`;
MaterialLightbulbRounded.propTypes = {
