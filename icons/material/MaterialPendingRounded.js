...
const MaterialPendingRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPendingRounded = (styled.default || styled)(MaterialPendingRoundedSvg).attrs(p => ({
...
`;
MaterialPendingRounded.propTypes = {
