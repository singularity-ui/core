...
const MaterialDialpadSvg = props => (
...
const MaterialDialpad = props => <Icon as={MaterialDialpadSvg} {...props} />

MaterialDialpad.defaultProps = { ...Icon.defaultProps }

MaterialDialpad.propTypes = { ...Icon.propTypes }

export default MaterialDialpad
