...
const MaterialWifiLockSharpSvg = props => (
  <svg
...
const MaterialWifiLockSharp = props => <Icon as={MaterialWifiLockSharpSvg} {...props} />

MaterialWifiLockSharp.defaultProps = { ...Icon.defaultProps }

MaterialWifiLockSharp.propTypes = { ...Icon.propTypes }

export default MaterialWifiLockSharp
