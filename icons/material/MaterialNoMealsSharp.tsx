...
const MaterialNoMealsSharpSvg = props => (
  <svg
...
const MaterialNoMealsSharp = props => <Icon as={MaterialNoMealsSharpSvg} {...props} />

MaterialNoMealsSharp.defaultProps = { ...Icon.defaultProps }

MaterialNoMealsSharp.propTypes = { ...Icon.propTypes }

export default MaterialNoMealsSharp
