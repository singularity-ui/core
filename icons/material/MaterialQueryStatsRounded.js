...
const MaterialQueryStatsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialQueryStatsRounded = (styled.default || styled)(MaterialQueryStatsRoundedSvg).attrs(p => ({
...
`;
MaterialQueryStatsRounded.propTypes = {
