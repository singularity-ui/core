...
const MaterialCleanHandsSharpSvg = props => (
  <svg
...
const MaterialCleanHandsSharp = props => <Icon as={MaterialCleanHandsSharpSvg} {...props} />

MaterialCleanHandsSharp.defaultProps = { ...Icon.defaultProps }

MaterialCleanHandsSharp.propTypes = { ...Icon.propTypes }
