...
const MaterialMarkEmailUnreadSvg = props => (
  <svg
...
const MaterialMarkEmailUnread = props => <Icon as={MaterialMarkEmailUnreadSvg} {...props} />

MaterialMarkEmailUnread.defaultProps = { ...Icon.defaultProps }

MaterialMarkEmailUnread.propTypes = { ...Icon.propTypes }
