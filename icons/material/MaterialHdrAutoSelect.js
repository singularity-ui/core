...
const MaterialHdrAutoSelectSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrAutoSelect = (styled.default || styled)(MaterialHdrAutoSelectSvg).attrs(p => ({
...
`;
MaterialHdrAutoSelect.propTypes = {
