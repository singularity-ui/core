...
const MaterialHeadsetOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHeadsetOffRounded = (styled.default || styled)(MaterialHeadsetOffRoundedSvg).attrs(p => ({
...
`;
MaterialHeadsetOffRounded.propTypes = {
