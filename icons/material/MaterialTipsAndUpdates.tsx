...
const MaterialTipsAndUpdatesSvg = props => (
  <svg
...
const MaterialTipsAndUpdates = props => <Icon as={MaterialTipsAndUpdatesSvg} {...props} />

MaterialTipsAndUpdates.defaultProps = { ...Icon.defaultProps }

MaterialTipsAndUpdates.propTypes = { ...Icon.propTypes }

export default MaterialTipsAndUpdates
