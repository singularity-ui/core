...
const MaterialSettingsPhoneSvg = props => (
...
const MaterialSettingsPhone = props => <Icon as={MaterialSettingsPhoneSvg} {...props} />

MaterialSettingsPhone.defaultProps = { ...Icon.defaultProps }

MaterialSettingsPhone.propTypes = { ...Icon.propTypes }

export default MaterialSettingsPhone
