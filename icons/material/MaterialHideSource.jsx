...
const MaterialHideSourceSvg = props => (
  <svg
...
const MaterialHideSource = props => <Icon as={MaterialHideSourceSvg} {...props} />

MaterialHideSource.defaultProps = { ...Icon.defaultProps }

MaterialHideSource.propTypes = { ...Icon.propTypes }

export default MaterialHideSource
