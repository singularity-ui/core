...
const MaterialDoNotTouchTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoNotTouchTwoTone = (styled.default || styled)(MaterialDoNotTouchTwoToneSvg).attrs(p => ({
...
`;
MaterialDoNotTouchTwoTone.propTypes = {
