...
const MaterialPhotoCameraFrontTwoToneSvg = props => (
  <svg
...
const MaterialPhotoCameraFrontTwoTone = props => <Icon as={MaterialPhotoCameraFrontTwoToneSvg} {...props} />

MaterialPhotoCameraFrontTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPhotoCameraFrontTwoTone.propTypes = { ...Icon.propTypes }
