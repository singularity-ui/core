...
const MaterialReduceCapacityRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReduceCapacityRounded = (styled.default || styled)(MaterialReduceCapacityRoundedSvg).attrs(p => ({
...
`;
MaterialReduceCapacityRounded.propTypes = {
