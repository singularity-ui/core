...
const MaterialFlightLandRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlightLandRounded = (styled.default || styled)(MaterialFlightLandRoundedSvg).attrs(p => ({
...
`;
MaterialFlightLandRounded.propTypes = {
