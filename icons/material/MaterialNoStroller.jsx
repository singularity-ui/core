...
const MaterialNoStrollerSvg = props => (
  <svg
...
const MaterialNoStroller = props => <Icon as={MaterialNoStrollerSvg} {...props} />

MaterialNoStroller.defaultProps = { ...Icon.defaultProps }

MaterialNoStroller.propTypes = { ...Icon.propTypes }

export default MaterialNoStroller
