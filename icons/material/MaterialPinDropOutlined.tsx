...
const MaterialPinDropOutlinedSvg = props => (
...
const MaterialPinDropOutlined = props => <Icon as={MaterialPinDropOutlinedSvg} {...props} />

MaterialPinDropOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPinDropOutlined.propTypes = { ...Icon.propTypes }
