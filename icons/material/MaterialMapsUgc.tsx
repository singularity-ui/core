...
const MaterialMapsUgcSvg = props => (
  <svg
...
const MaterialMapsUgc = props => <Icon as={MaterialMapsUgcSvg} {...props} />

MaterialMapsUgc.defaultProps = { ...Icon.defaultProps }

MaterialMapsUgc.propTypes = { ...Icon.propTypes }
