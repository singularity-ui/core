...
const MaterialMultilineChartSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMultilineChart = (styled.default || styled)(MaterialMultilineChartSvg).attrs(p => ({
...
`;
MaterialMultilineChart.propTypes = {
