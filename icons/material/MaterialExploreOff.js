...
const MaterialExploreOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialExploreOff = (styled.default || styled)(MaterialExploreOffSvg).attrs(p => ({
...
`;
MaterialExploreOff.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialExploreOff;