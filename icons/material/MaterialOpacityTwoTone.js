...
const MaterialOpacityTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOpacityTwoTone = (styled.default || styled)(MaterialOpacityTwoToneSvg).attrs(p => ({
...
`;
MaterialOpacityTwoTone.propTypes = {
