...
const MaterialMicrowaveTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMicrowaveTwoTone = (styled.default || styled)(MaterialMicrowaveTwoToneSvg).attrs(p => ({
...
`;
MaterialMicrowaveTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialMicrowaveTwoTone;