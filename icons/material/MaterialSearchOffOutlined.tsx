...
const MaterialSearchOffOutlinedSvg = props => (
  <svg
...
const MaterialSearchOffOutlined = props => <Icon as={MaterialSearchOffOutlinedSvg} {...props} />

MaterialSearchOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSearchOffOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSearchOffOutlined
