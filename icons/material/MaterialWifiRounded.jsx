...
const MaterialWifiRoundedSvg = props => (
...
const MaterialWifiRounded = props => <Icon as={MaterialWifiRoundedSvg} {...props} />

MaterialWifiRounded.defaultProps = { ...Icon.defaultProps }

MaterialWifiRounded.propTypes = { ...Icon.propTypes }
