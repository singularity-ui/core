...
const MaterialTryTwoToneSvg = props => (
  <svg
...
const MaterialTryTwoTone = props => <Icon as={MaterialTryTwoToneSvg} {...props} />

MaterialTryTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialTryTwoTone.propTypes = { ...Icon.propTypes }
