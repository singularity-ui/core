...
const MaterialLocalCarWashSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalCarWashSharp = (styled.default || styled)(MaterialLocalCarWashSharpSvg).attrs(p => ({
...
`;
MaterialLocalCarWashSharp.propTypes = {
