...
const MaterialImportantDevicesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialImportantDevices = (styled.default || styled)(MaterialImportantDevicesSvg).attrs(p => ({
...
`;
MaterialImportantDevices.propTypes = {
