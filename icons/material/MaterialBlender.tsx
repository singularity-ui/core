...
const MaterialBlenderSvg = props => (
  <svg
...
const MaterialBlender = props => <Icon as={MaterialBlenderSvg} {...props} />

MaterialBlender.defaultProps = { ...Icon.defaultProps }

MaterialBlender.propTypes = { ...Icon.propTypes }
