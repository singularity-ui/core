...
const MaterialScreenLockLandscapeSvg = props => (
...
const MaterialScreenLockLandscape = props => <Icon as={MaterialScreenLockLandscapeSvg} {...props} />

MaterialScreenLockLandscape.defaultProps = { ...Icon.defaultProps }

MaterialScreenLockLandscape.propTypes = { ...Icon.propTypes }
