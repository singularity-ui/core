...
const MaterialPowerOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPowerOffRounded = (styled.default || styled)(MaterialPowerOffRoundedSvg).attrs(p => ({
...
`;
MaterialPowerOffRounded.propTypes = {
