...
const MaterialCancelRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCancelRounded = (styled.default || styled)(MaterialCancelRoundedSvg).attrs(p => ({
...
`;
MaterialCancelRounded.propTypes = {
