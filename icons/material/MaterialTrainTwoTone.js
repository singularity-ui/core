...
const MaterialTrainTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTrainTwoTone = (styled.default || styled)(MaterialTrainTwoToneSvg).attrs(p => ({
...
`;
MaterialTrainTwoTone.propTypes = {
