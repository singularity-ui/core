...
const MaterialBusAlertSvg = props => (
...
const MaterialBusAlert = props => <Icon as={MaterialBusAlertSvg} {...props} />

MaterialBusAlert.defaultProps = { ...Icon.defaultProps }

MaterialBusAlert.propTypes = { ...Icon.propTypes }
