...
const MaterialStarsOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStarsOutlined = (styled.default || styled)(MaterialStarsOutlinedSvg).attrs(p => ({
...
`;
MaterialStarsOutlined.propTypes = {
