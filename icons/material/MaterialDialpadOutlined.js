...
const MaterialDialpadOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDialpadOutlined = (styled.default || styled)(MaterialDialpadOutlinedSvg).attrs(p => ({
...
`;
MaterialDialpadOutlined.propTypes = {
