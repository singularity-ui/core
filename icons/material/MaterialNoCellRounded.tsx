...
const MaterialNoCellRoundedSvg = props => (
  <svg
...
const MaterialNoCellRounded = props => <Icon as={MaterialNoCellRoundedSvg} {...props} />

MaterialNoCellRounded.defaultProps = { ...Icon.defaultProps }

MaterialNoCellRounded.propTypes = { ...Icon.propTypes }
