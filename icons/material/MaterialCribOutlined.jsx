...
const MaterialCribOutlinedSvg = props => (
  <svg
...
const MaterialCribOutlined = props => <Icon as={MaterialCribOutlinedSvg} {...props} />

MaterialCribOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCribOutlined.propTypes = { ...Icon.propTypes }

export default MaterialCribOutlined
