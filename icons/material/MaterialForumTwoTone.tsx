...
const MaterialForumTwoToneSvg = props => (
...
const MaterialForumTwoTone = props => <Icon as={MaterialForumTwoToneSvg} {...props} />

MaterialForumTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialForumTwoTone.propTypes = { ...Icon.propTypes }
