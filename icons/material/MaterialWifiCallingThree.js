...
const MaterialWifiCallingThreeSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWifiCallingThree = (styled.default || styled)(MaterialWifiCallingThreeSvg).attrs(p => ({
...
`;
MaterialWifiCallingThree.propTypes = {
