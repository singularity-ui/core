...
const MaterialPersonAddAltSvg = props => (
  <svg
...
const MaterialPersonAddAlt = props => <Icon as={MaterialPersonAddAltSvg} {...props} />

MaterialPersonAddAlt.defaultProps = { ...Icon.defaultProps }

MaterialPersonAddAlt.propTypes = { ...Icon.propTypes }
