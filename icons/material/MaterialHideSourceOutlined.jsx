...
const MaterialHideSourceOutlinedSvg = props => (
  <svg
...
const MaterialHideSourceOutlined = props => <Icon as={MaterialHideSourceOutlinedSvg} {...props} />

MaterialHideSourceOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHideSourceOutlined.propTypes = { ...Icon.propTypes }

export default MaterialHideSourceOutlined
