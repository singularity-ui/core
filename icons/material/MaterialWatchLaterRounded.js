...
const MaterialWatchLaterRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWatchLaterRounded = (styled.default || styled)(MaterialWatchLaterRoundedSvg).attrs(p => ({
...
`;
MaterialWatchLaterRounded.propTypes = {
