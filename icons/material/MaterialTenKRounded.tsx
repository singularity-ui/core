...
const MaterialTenKRoundedSvg = props => (
  <svg
...
const MaterialTenKRounded = props => <Icon as={MaterialTenKRoundedSvg} {...props} />

MaterialTenKRounded.defaultProps = { ...Icon.defaultProps }

MaterialTenKRounded.propTypes = { ...Icon.propTypes }
