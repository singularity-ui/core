...
const MaterialZoomInRoundedSvg = props => (
...
const MaterialZoomInRounded = props => <Icon as={MaterialZoomInRoundedSvg} {...props} />

MaterialZoomInRounded.defaultProps = { ...Icon.defaultProps }

MaterialZoomInRounded.propTypes = { ...Icon.propTypes }

export default MaterialZoomInRounded
