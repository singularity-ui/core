...
const MaterialSportsBaseballSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsBaseball = (styled.default || styled)(MaterialSportsBaseballSvg).attrs(p => ({
...
`;
MaterialSportsBaseball.propTypes = {
