...
const MaterialWifiCallingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWifiCallingTwoTone = (styled.default || styled)(MaterialWifiCallingTwoToneSvg).attrs(p => ({
...
`;
MaterialWifiCallingTwoTone.propTypes = {
