...
const MaterialFenceSharpSvg = props => (
  <svg
...
const MaterialFenceSharp = props => <Icon as={MaterialFenceSharpSvg} {...props} />

MaterialFenceSharp.defaultProps = { ...Icon.defaultProps }

MaterialFenceSharp.propTypes = { ...Icon.propTypes }

export default MaterialFenceSharp
