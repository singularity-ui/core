...
const MaterialWbAutoOutlinedSvg = props => (
...
const MaterialWbAutoOutlined = props => <Icon as={MaterialWbAutoOutlinedSvg} {...props} />

MaterialWbAutoOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWbAutoOutlined.propTypes = { ...Icon.propTypes }
