...
const MaterialWhatshotOutlinedSvg = props => (
...
const MaterialWhatshotOutlined = props => <Icon as={MaterialWhatshotOutlinedSvg} {...props} />

MaterialWhatshotOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWhatshotOutlined.propTypes = { ...Icon.propTypes }

export default MaterialWhatshotOutlined
