...
const MaterialThreeKTwoToneSvg = props => (
  <svg
...
const MaterialThreeKTwoTone = props => <Icon as={MaterialThreeKTwoToneSvg} {...props} />

MaterialThreeKTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialThreeKTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialThreeKTwoTone
