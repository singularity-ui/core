...
const MaterialContactMailRoundedSvg = props => (
...
const MaterialContactMailRounded = props => <Icon as={MaterialContactMailRoundedSvg} {...props} />

MaterialContactMailRounded.defaultProps = { ...Icon.defaultProps }

MaterialContactMailRounded.propTypes = { ...Icon.propTypes }

export default MaterialContactMailRounded
