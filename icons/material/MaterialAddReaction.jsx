...
const MaterialAddReactionSvg = props => (
  <svg
...
const MaterialAddReaction = props => <Icon as={MaterialAddReactionSvg} {...props} />

MaterialAddReaction.defaultProps = { ...Icon.defaultProps }

MaterialAddReaction.propTypes = { ...Icon.propTypes }

export default MaterialAddReaction
