...
const MaterialEventSeatRoundedSvg = props => (
...
const MaterialEventSeatRounded = props => <Icon as={MaterialEventSeatRoundedSvg} {...props} />

MaterialEventSeatRounded.defaultProps = { ...Icon.defaultProps }

MaterialEventSeatRounded.propTypes = { ...Icon.propTypes }
