...
const MaterialMemoryTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMemoryTwoTone = (styled.default || styled)(MaterialMemoryTwoToneSvg).attrs(p => ({
...
`;
MaterialMemoryTwoTone.propTypes = {
