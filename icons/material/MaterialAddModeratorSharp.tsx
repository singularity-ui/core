...
const MaterialAddModeratorSharpSvg = props => (
  <svg
...
const MaterialAddModeratorSharp = props => <Icon as={MaterialAddModeratorSharpSvg} {...props} />

MaterialAddModeratorSharp.defaultProps = { ...Icon.defaultProps }

MaterialAddModeratorSharp.propTypes = { ...Icon.propTypes }

export default MaterialAddModeratorSharp
