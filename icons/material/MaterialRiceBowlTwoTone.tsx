...
const MaterialRiceBowlTwoToneSvg = props => (
  <svg
...
const MaterialRiceBowlTwoTone = props => <Icon as={MaterialRiceBowlTwoToneSvg} {...props} />

MaterialRiceBowlTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRiceBowlTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialRiceBowlTwoTone
