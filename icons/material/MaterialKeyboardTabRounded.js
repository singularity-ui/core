...
const MaterialKeyboardTabRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKeyboardTabRounded = (styled.default || styled)(MaterialKeyboardTabRoundedSvg).attrs(p => ({
...
`;
MaterialKeyboardTabRounded.propTypes = {
