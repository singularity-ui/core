...
const MaterialNightsStayRoundedSvg = props => (
  <svg
...
const MaterialNightsStayRounded = props => <Icon as={MaterialNightsStayRoundedSvg} {...props} />

MaterialNightsStayRounded.defaultProps = { ...Icon.defaultProps }

MaterialNightsStayRounded.propTypes = { ...Icon.propTypes }
