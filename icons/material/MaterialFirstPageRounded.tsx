...
const MaterialFirstPageRoundedSvg = props => (
...
const MaterialFirstPageRounded = props => <Icon as={MaterialFirstPageRoundedSvg} {...props} />

MaterialFirstPageRounded.defaultProps = { ...Icon.defaultProps }

MaterialFirstPageRounded.propTypes = { ...Icon.propTypes }
