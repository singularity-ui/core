...
const MaterialGestureRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGestureRounded = (styled.default || styled)(MaterialGestureRoundedSvg).attrs(p => ({
...
`;
MaterialGestureRounded.propTypes = {
