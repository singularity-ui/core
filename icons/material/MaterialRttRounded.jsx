...
const MaterialRttRoundedSvg = props => (
  <svg
...
const MaterialRttRounded = props => <Icon as={MaterialRttRoundedSvg} {...props} />

MaterialRttRounded.defaultProps = { ...Icon.defaultProps }

MaterialRttRounded.propTypes = { ...Icon.propTypes }

export default MaterialRttRounded
