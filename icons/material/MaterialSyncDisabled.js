...
const MaterialSyncDisabledSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSyncDisabled = (styled.default || styled)(MaterialSyncDisabledSvg).attrs(p => ({
...
`;
MaterialSyncDisabled.propTypes = {
