...
const MaterialCameraRearRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCameraRearRounded = (styled.default || styled)(MaterialCameraRearRoundedSvg).attrs(p => ({
...
`;
MaterialCameraRearRounded.propTypes = {
