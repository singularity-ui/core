...
const MaterialUnsubscribeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUnsubscribeTwoTone = (styled.default || styled)(MaterialUnsubscribeTwoToneSvg).attrs(p => ({
...
`;
MaterialUnsubscribeTwoTone.propTypes = {
