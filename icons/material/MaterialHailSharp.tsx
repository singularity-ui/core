...
const MaterialHailSharpSvg = props => (
  <svg
...
const MaterialHailSharp = props => <Icon as={MaterialHailSharpSvg} {...props} />

MaterialHailSharp.defaultProps = { ...Icon.defaultProps }

MaterialHailSharp.propTypes = { ...Icon.propTypes }

export default MaterialHailSharp
