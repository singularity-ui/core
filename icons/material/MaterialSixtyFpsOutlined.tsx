...
const MaterialSixtyFpsOutlinedSvg = props => (
  <svg
...
const MaterialSixtyFpsOutlined = props => <Icon as={MaterialSixtyFpsOutlinedSvg} {...props} />

MaterialSixtyFpsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSixtyFpsOutlined.propTypes = { ...Icon.propTypes }
