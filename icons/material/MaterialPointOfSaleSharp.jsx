...
const MaterialPointOfSaleSharpSvg = props => (
  <svg
...
const MaterialPointOfSaleSharp = props => <Icon as={MaterialPointOfSaleSharpSvg} {...props} />

MaterialPointOfSaleSharp.defaultProps = { ...Icon.defaultProps }

MaterialPointOfSaleSharp.propTypes = { ...Icon.propTypes }
