...
const MaterialNetworkLockedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNetworkLocked = (styled.default || styled)(MaterialNetworkLockedSvg).attrs(p => ({
...
`;
MaterialNetworkLocked.propTypes = {
