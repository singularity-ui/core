...
const MaterialEditRoadSharpSvg = props => (
  <svg
...
const MaterialEditRoadSharp = props => <Icon as={MaterialEditRoadSharpSvg} {...props} />

MaterialEditRoadSharp.defaultProps = { ...Icon.defaultProps }

MaterialEditRoadSharp.propTypes = { ...Icon.propTypes }

export default MaterialEditRoadSharp
