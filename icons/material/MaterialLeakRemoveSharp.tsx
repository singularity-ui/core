...
const MaterialLeakRemoveSharpSvg = props => (
...
const MaterialLeakRemoveSharp = props => <Icon as={MaterialLeakRemoveSharpSvg} {...props} />

MaterialLeakRemoveSharp.defaultProps = { ...Icon.defaultProps }

MaterialLeakRemoveSharp.propTypes = { ...Icon.propTypes }

export default MaterialLeakRemoveSharp
