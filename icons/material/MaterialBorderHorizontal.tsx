...
const MaterialBorderHorizontalSvg = props => (
...
const MaterialBorderHorizontal = props => <Icon as={MaterialBorderHorizontalSvg} {...props} />

MaterialBorderHorizontal.defaultProps = { ...Icon.defaultProps }

MaterialBorderHorizontal.propTypes = { ...Icon.propTypes }
