...
const MaterialRemoveDoneTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRemoveDoneTwoTone = (styled.default || styled)(MaterialRemoveDoneTwoToneSvg).attrs(p => ({
...
`;
MaterialRemoveDoneTwoTone.propTypes = {
