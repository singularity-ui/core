...
const MaterialIntegrationInstructionsSvg = props => (
  <svg
...
const MaterialIntegrationInstructions = props => <Icon as={MaterialIntegrationInstructionsSvg} {...props} />

MaterialIntegrationInstructions.defaultProps = { ...Icon.defaultProps }

MaterialIntegrationInstructions.propTypes = { ...Icon.propTypes }
