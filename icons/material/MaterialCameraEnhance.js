...
const MaterialCameraEnhanceSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCameraEnhance = (styled.default || styled)(MaterialCameraEnhanceSvg).attrs(p => ({
...
`;
MaterialCameraEnhance.propTypes = {
