...
const MaterialHotelTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHotelTwoTone = (styled.default || styled)(MaterialHotelTwoToneSvg).attrs(p => ({
...
`;
MaterialHotelTwoTone.propTypes = {
