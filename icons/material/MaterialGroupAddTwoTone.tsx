...
const MaterialGroupAddTwoToneSvg = props => (
...
const MaterialGroupAddTwoTone = props => <Icon as={MaterialGroupAddTwoToneSvg} {...props} />

MaterialGroupAddTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialGroupAddTwoTone.propTypes = { ...Icon.propTypes }
