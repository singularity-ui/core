...
const MaterialOutboundSvg = props => (
  <svg
...
const MaterialOutbound = props => <Icon as={MaterialOutboundSvg} {...props} />

MaterialOutbound.defaultProps = { ...Icon.defaultProps }

MaterialOutbound.propTypes = { ...Icon.propTypes }
