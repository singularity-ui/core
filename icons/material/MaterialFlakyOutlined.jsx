...
const MaterialFlakyOutlinedSvg = props => (
  <svg
...
const MaterialFlakyOutlined = props => <Icon as={MaterialFlakyOutlinedSvg} {...props} />

MaterialFlakyOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFlakyOutlined.propTypes = { ...Icon.propTypes }

export default MaterialFlakyOutlined
