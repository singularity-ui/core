...
const MaterialSeventeenMpRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSeventeenMpRounded = (styled.default || styled)(MaterialSeventeenMpRoundedSvg).attrs(p => ({
...
`;
MaterialSeventeenMpRounded.propTypes = {
