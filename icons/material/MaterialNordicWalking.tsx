...
const MaterialNordicWalkingSvg = props => (
  <svg
...
const MaterialNordicWalking = props => <Icon as={MaterialNordicWalkingSvg} {...props} />

MaterialNordicWalking.defaultProps = { ...Icon.defaultProps }

MaterialNordicWalking.propTypes = { ...Icon.propTypes }

export default MaterialNordicWalking
