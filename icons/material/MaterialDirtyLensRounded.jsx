...
const MaterialDirtyLensRoundedSvg = props => (
  <svg
...
const MaterialDirtyLensRounded = props => <Icon as={MaterialDirtyLensRoundedSvg} {...props} />

MaterialDirtyLensRounded.defaultProps = { ...Icon.defaultProps }

MaterialDirtyLensRounded.propTypes = { ...Icon.propTypes }

export default MaterialDirtyLensRounded
