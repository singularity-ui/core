...
const MaterialNightlightRoundSvg = props => (
...
const MaterialNightlightRound = props => <Icon as={MaterialNightlightRoundSvg} {...props} />

MaterialNightlightRound.defaultProps = { ...Icon.defaultProps }

MaterialNightlightRound.propTypes = { ...Icon.propTypes }
