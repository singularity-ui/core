...
const MaterialMonitorWeightSvg = props => (
  <svg
...
const MaterialMonitorWeight = props => <Icon as={MaterialMonitorWeightSvg} {...props} />

MaterialMonitorWeight.defaultProps = { ...Icon.defaultProps }

MaterialMonitorWeight.propTypes = { ...Icon.propTypes }
