...
const MaterialPhoneEnabledSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneEnabled = (styled.default || styled)(MaterialPhoneEnabledSvg).attrs(p => ({
...
`;
MaterialPhoneEnabled.propTypes = {
