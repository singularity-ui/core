...
const MaterialFlipCameraAndroidSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlipCameraAndroid = (styled.default || styled)(MaterialFlipCameraAndroidSvg).attrs(p => ({
...
`;
MaterialFlipCameraAndroid.propTypes = {
