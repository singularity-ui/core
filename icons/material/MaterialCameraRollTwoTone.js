...
const MaterialCameraRollTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCameraRollTwoTone = (styled.default || styled)(MaterialCameraRollTwoToneSvg).attrs(p => ({
...
`;
MaterialCameraRollTwoTone.propTypes = {
