...
const MaterialNaturePeopleSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNaturePeople = (styled.default || styled)(MaterialNaturePeopleSvg).attrs(p => ({
...
`;
MaterialNaturePeople.propTypes = {
