...
const MaterialThirtyFpsSelectRoundedSvg = props => (
  <svg
...
const MaterialThirtyFpsSelectRounded = props => <Icon as={MaterialThirtyFpsSelectRoundedSvg} {...props} />

MaterialThirtyFpsSelectRounded.defaultProps = { ...Icon.defaultProps }

MaterialThirtyFpsSelectRounded.propTypes = { ...Icon.propTypes }
