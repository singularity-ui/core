...
const MaterialFollowTheSignsRoundedSvg = props => (
  <svg
...
const MaterialFollowTheSignsRounded = props => <Icon as={MaterialFollowTheSignsRoundedSvg} {...props} />

MaterialFollowTheSignsRounded.defaultProps = { ...Icon.defaultProps }

MaterialFollowTheSignsRounded.propTypes = { ...Icon.propTypes }

export default MaterialFollowTheSignsRounded
