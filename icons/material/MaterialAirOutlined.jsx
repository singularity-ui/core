...
const MaterialAirOutlinedSvg = props => (
  <svg
...
const MaterialAirOutlined = props => <Icon as={MaterialAirOutlinedSvg} {...props} />

MaterialAirOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAirOutlined.propTypes = { ...Icon.propTypes }

export default MaterialAirOutlined
