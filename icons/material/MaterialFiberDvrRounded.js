...
const MaterialFiberDvrRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFiberDvrRounded = (styled.default || styled)(MaterialFiberDvrRoundedSvg).attrs(p => ({
...
`;
MaterialFiberDvrRounded.propTypes = {
