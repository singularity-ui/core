...
const MaterialPanoramaPhotosphereSvg = props => (
...
const MaterialPanoramaPhotosphere = props => <Icon as={MaterialPanoramaPhotosphereSvg} {...props} />

MaterialPanoramaPhotosphere.defaultProps = { ...Icon.defaultProps }

MaterialPanoramaPhotosphere.propTypes = { ...Icon.propTypes }

export default MaterialPanoramaPhotosphere
