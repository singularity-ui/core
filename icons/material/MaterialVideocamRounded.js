...
const MaterialVideocamRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVideocamRounded = (styled.default || styled)(MaterialVideocamRoundedSvg).attrs(p => ({
...
`;
MaterialVideocamRounded.propTypes = {
