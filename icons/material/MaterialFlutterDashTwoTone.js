...
const MaterialFlutterDashTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
  ...
  d: "M5,11c0,0.81,0.1,1.53,0.25,2.21c0.18-0.69,0.46-1.33,0.83-1.92c-0.21-0.47-0.34-0.99-0.34-1.54C5.75,7.68,7.43,6,9.5,6 c0.96,0,1.84,0.37,2.5,0.97C12.66,6.37,13.54,6,14.5,6c2.07,0,3.75,1.68,3.75,3.75c0,0.55-0.12,1.07-0.34,1.54 c0.37,0.59,0.66,1.24,0.84,1.94C18.9,12.55,19,11.82,19,11c0-3.86-3.14-7-7-7C8.14,4,5,7.14,5,11z"
...
const MaterialFlutterDashTwoTone = (styled.default || styled)(MaterialFlutterDashTwoToneSvg).attrs(p => ({
...
`;
MaterialFlutterDashTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFlutterDashTwoTone;