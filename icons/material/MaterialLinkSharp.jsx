...
const MaterialLinkSharpSvg = props => (
...
const MaterialLinkSharp = props => <Icon as={MaterialLinkSharpSvg} {...props} />

MaterialLinkSharp.defaultProps = { ...Icon.defaultProps }

MaterialLinkSharp.propTypes = { ...Icon.propTypes }

export default MaterialLinkSharp
