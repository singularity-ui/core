...
const MaterialThirtyFpsSvg = props => (
  <svg
...
const MaterialThirtyFps = props => <Icon as={MaterialThirtyFpsSvg} {...props} />

MaterialThirtyFps.defaultProps = { ...Icon.defaultProps }

MaterialThirtyFps.propTypes = { ...Icon.propTypes }
