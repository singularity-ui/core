...
const MaterialSchemaRoundedSvg = props => (
  <svg
...
const MaterialSchemaRounded = props => <Icon as={MaterialSchemaRoundedSvg} {...props} />

MaterialSchemaRounded.defaultProps = { ...Icon.defaultProps }

MaterialSchemaRounded.propTypes = { ...Icon.propTypes }

export default MaterialSchemaRounded
