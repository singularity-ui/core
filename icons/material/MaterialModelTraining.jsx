...
const MaterialModelTrainingSvg = props => (
  <svg
...
const MaterialModelTraining = props => <Icon as={MaterialModelTrainingSvg} {...props} />

MaterialModelTraining.defaultProps = { ...Icon.defaultProps }

MaterialModelTraining.propTypes = { ...Icon.propTypes }
