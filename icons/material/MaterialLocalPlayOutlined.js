...
const MaterialLocalPlayOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalPlayOutlined = (styled.default || styled)(MaterialLocalPlayOutlinedSvg).attrs(p => ({
...
`;
MaterialLocalPlayOutlined.propTypes = {
