...
const MaterialFmdGoodOutlinedSvg = props => (
  <svg
...
const MaterialFmdGoodOutlined = props => <Icon as={MaterialFmdGoodOutlinedSvg} {...props} />

MaterialFmdGoodOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFmdGoodOutlined.propTypes = { ...Icon.propTypes }
