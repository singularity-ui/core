...
const MaterialAddIcCallRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddIcCallRounded = (styled.default || styled)(MaterialAddIcCallRoundedSvg).attrs(p => ({
...
`;
MaterialAddIcCallRounded.propTypes = {
