...
const MaterialEditRoadSvg = props => (
  <svg
...
const MaterialEditRoad = props => <Icon as={MaterialEditRoadSvg} {...props} />

MaterialEditRoad.defaultProps = { ...Icon.defaultProps }

MaterialEditRoad.propTypes = { ...Icon.propTypes }
