...
const MaterialCampaignOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCampaignOutlined = (styled.default || styled)(MaterialCampaignOutlinedSvg).attrs(p => ({
...
`;
MaterialCampaignOutlined.propTypes = {
