...
const MaterialChildCareSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChildCareSharp = (styled.default || styled)(MaterialChildCareSharpSvg).attrs(p => ({
...
`;
MaterialChildCareSharp.propTypes = {
