...
const MaterialTransformRoundedSvg = props => (
...
const MaterialTransformRounded = props => <Icon as={MaterialTransformRoundedSvg} {...props} />

MaterialTransformRounded.defaultProps = { ...Icon.defaultProps }

MaterialTransformRounded.propTypes = { ...Icon.propTypes }
