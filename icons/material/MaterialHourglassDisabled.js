...
const MaterialHourglassDisabledSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHourglassDisabled = (styled.default || styled)(MaterialHourglassDisabledSvg).attrs(p => ({
...
`;
MaterialHourglassDisabled.propTypes = {
