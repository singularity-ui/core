...
const MaterialFenceOutlinedSvg = props => (
  <svg
...
const MaterialFenceOutlined = props => <Icon as={MaterialFenceOutlinedSvg} {...props} />

MaterialFenceOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFenceOutlined.propTypes = { ...Icon.propTypes }

export default MaterialFenceOutlined
