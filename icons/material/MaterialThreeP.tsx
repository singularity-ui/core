...
const MaterialThreeP = props => <Icon as={MaterialThreePSvg} {...props} />

MaterialThreeP.defaultProps = { ...Icon.defaultProps }

MaterialThreeP.propTypes = { ...Icon.propTypes }
