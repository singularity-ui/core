...
const MaterialSwipeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSwipeTwoTone = (styled.default || styled)(MaterialSwipeTwoToneSvg).attrs(p => ({
...
`;
MaterialSwipeTwoTone.propTypes = {
