...
const MaterialHistoryEduRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHistoryEduRounded = (styled.default || styled)(MaterialHistoryEduRoundedSvg).attrs(p => ({
...
`;
MaterialHistoryEduRounded.propTypes = {
