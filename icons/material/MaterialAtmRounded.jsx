...
const MaterialAtmRoundedSvg = props => (
...
const MaterialAtmRounded = props => <Icon as={MaterialAtmRoundedSvg} {...props} />

MaterialAtmRounded.defaultProps = { ...Icon.defaultProps }

MaterialAtmRounded.propTypes = { ...Icon.propTypes }
