...
const MaterialKayakingRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKayakingRounded = (styled.default || styled)(MaterialKayakingRoundedSvg).attrs(p => ({
...
`;
MaterialKayakingRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialKayakingRounded;