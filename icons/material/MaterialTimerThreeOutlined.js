...
const MaterialTimerThreeOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerThreeOutlined = (styled.default || styled)(MaterialTimerThreeOutlinedSvg).attrs(p => ({
...
`;
MaterialTimerThreeOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialTimerThreeOutlined;