...
const MaterialCarRentalTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCarRentalTwoTone = (styled.default || styled)(MaterialCarRentalTwoToneSvg).attrs(p => ({
...
`;
MaterialCarRentalTwoTone.propTypes = {
