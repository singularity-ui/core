...
const MaterialRawOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRawOffTwoTone = (styled.default || styled)(MaterialRawOffTwoToneSvg).attrs(p => ({
...
`;
MaterialRawOffTwoTone.propTypes = {
