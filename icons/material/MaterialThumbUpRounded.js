...
const MaterialThumbUpRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThumbUpRounded = (styled.default || styled)(MaterialThumbUpRoundedSvg).attrs(p => ({
...
`;
MaterialThumbUpRounded.propTypes = {
