...
const MaterialPermPhoneMsgSvg = props => (
...
const MaterialPermPhoneMsg = props => <Icon as={MaterialPermPhoneMsgSvg} {...props} />

MaterialPermPhoneMsg.defaultProps = { ...Icon.defaultProps }

MaterialPermPhoneMsg.propTypes = { ...Icon.propTypes }

export default MaterialPermPhoneMsg
