...
const MaterialWifiOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWifiOffSharp = (styled.default || styled)(MaterialWifiOffSharpSvg).attrs(p => ({
...
`;
MaterialWifiOffSharp.propTypes = {
