...
const MaterialPsychologySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPsychologySharp = (styled.default || styled)(MaterialPsychologySharpSvg).attrs(p => ({
...
`;
MaterialPsychologySharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialPsychologySharp;