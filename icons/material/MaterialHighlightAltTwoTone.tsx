...
const MaterialHighlightAltTwoToneSvg = props => (
  <svg
...
const MaterialHighlightAltTwoTone = props => <Icon as={MaterialHighlightAltTwoToneSvg} {...props} />

MaterialHighlightAltTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHighlightAltTwoTone.propTypes = { ...Icon.propTypes }
