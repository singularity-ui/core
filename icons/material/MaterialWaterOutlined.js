...
const MaterialWaterOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWaterOutlined = (styled.default || styled)(MaterialWaterOutlinedSvg).attrs(p => ({
...
`;
MaterialWaterOutlined.propTypes = {
