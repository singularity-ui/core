...
const MaterialBatteryUnknownSvg = props => (
...
const MaterialBatteryUnknown = props => <Icon as={MaterialBatteryUnknownSvg} {...props} />

MaterialBatteryUnknown.defaultProps = { ...Icon.defaultProps }

MaterialBatteryUnknown.propTypes = { ...Icon.propTypes }

export default MaterialBatteryUnknown
