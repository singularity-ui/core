...
const MaterialCenterFocusWeakSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCenterFocusWeak = (styled.default || styled)(MaterialCenterFocusWeakSvg).attrs(p => ({
...
`;
MaterialCenterFocusWeak.propTypes = {
