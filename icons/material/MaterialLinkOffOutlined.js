...
const MaterialLinkOffOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLinkOffOutlined = (styled.default || styled)(MaterialLinkOffOutlinedSvg).attrs(p => ({
...
`;
MaterialLinkOffOutlined.propTypes = {
