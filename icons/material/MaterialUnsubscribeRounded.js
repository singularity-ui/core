...
const MaterialUnsubscribeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUnsubscribeRounded = (styled.default || styled)(MaterialUnsubscribeRoundedSvg).attrs(p => ({
...
`;
MaterialUnsubscribeRounded.propTypes = {
