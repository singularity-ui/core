...
const MaterialCheckroomSharpSvg = props => (
  <svg
...
const MaterialCheckroomSharp = props => <Icon as={MaterialCheckroomSharpSvg} {...props} />

MaterialCheckroomSharp.defaultProps = { ...Icon.defaultProps }

MaterialCheckroomSharp.propTypes = { ...Icon.propTypes }

export default MaterialCheckroomSharp
