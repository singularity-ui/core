...
const MaterialMotionPhotosAutoOutlinedSvg = props => (
  <svg
...
const MaterialMotionPhotosAutoOutlined = props => <Icon as={MaterialMotionPhotosAutoOutlinedSvg} {...props} />

MaterialMotionPhotosAutoOutlined.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosAutoOutlined.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosAutoOutlined
