...
const MaterialLocalPhoneTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalPhoneTwoTone = (styled.default || styled)(MaterialLocalPhoneTwoToneSvg).attrs(p => ({
...
`;
MaterialLocalPhoneTwoTone.propTypes = {
