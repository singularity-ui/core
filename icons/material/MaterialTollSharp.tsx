...
const MaterialTollSharpSvg = props => (
...
const MaterialTollSharp = props => <Icon as={MaterialTollSharpSvg} {...props} />

MaterialTollSharp.defaultProps = { ...Icon.defaultProps }

MaterialTollSharp.propTypes = { ...Icon.propTypes }

export default MaterialTollSharp
