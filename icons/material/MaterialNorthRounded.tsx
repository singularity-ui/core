...
const MaterialNorthRoundedSvg = props => (
  <svg
...
const MaterialNorthRounded = props => <Icon as={MaterialNorthRoundedSvg} {...props} />

MaterialNorthRounded.defaultProps = { ...Icon.defaultProps }

MaterialNorthRounded.propTypes = { ...Icon.propTypes }
