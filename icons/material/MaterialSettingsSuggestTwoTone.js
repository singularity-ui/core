...
const MaterialSettingsSuggestTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialSettingsSuggestTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSettingsSuggestTwoTone;