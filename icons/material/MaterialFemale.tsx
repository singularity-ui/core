...
const MaterialFemale = props => <Icon as={MaterialFemaleSvg} {...props} />

MaterialFemale.defaultProps = { ...Icon.defaultProps }

MaterialFemale.propTypes = { ...Icon.propTypes }
