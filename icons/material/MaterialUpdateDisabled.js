...
const MaterialUpdateDisabledSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUpdateDisabled = (styled.default || styled)(MaterialUpdateDisabledSvg).attrs(p => ({
...
`;
MaterialUpdateDisabled.propTypes = {
