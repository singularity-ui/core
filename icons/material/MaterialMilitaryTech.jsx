...
const MaterialMilitaryTechSvg = props => (
  <svg
...
const MaterialMilitaryTech = props => <Icon as={MaterialMilitaryTechSvg} {...props} />

MaterialMilitaryTech.defaultProps = { ...Icon.defaultProps }

MaterialMilitaryTech.propTypes = { ...Icon.propTypes }

export default MaterialMilitaryTech
