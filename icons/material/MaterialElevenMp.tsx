...
const MaterialElevenMpSvg = props => (
...
const MaterialElevenMp = props => <Icon as={MaterialElevenMpSvg} {...props} />

MaterialElevenMp.defaultProps = { ...Icon.defaultProps }

MaterialElevenMp.propTypes = { ...Icon.propTypes }

export default MaterialElevenMp
