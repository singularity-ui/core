...
const MaterialFiberDvrRoundedSvg = props => (
...
const MaterialFiberDvrRounded = props => <Icon as={MaterialFiberDvrRoundedSvg} {...props} />

MaterialFiberDvrRounded.defaultProps = { ...Icon.defaultProps }

MaterialFiberDvrRounded.propTypes = { ...Icon.propTypes }

export default MaterialFiberDvrRounded
