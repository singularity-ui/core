...
const MaterialStorefrontRoundedSvg = props => (
  <svg
...
const MaterialStorefrontRounded = props => <Icon as={MaterialStorefrontRoundedSvg} {...props} />

MaterialStorefrontRounded.defaultProps = { ...Icon.defaultProps }

MaterialStorefrontRounded.propTypes = { ...Icon.propTypes }

export default MaterialStorefrontRounded
