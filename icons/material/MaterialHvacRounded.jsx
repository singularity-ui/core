...
const MaterialHvacRoundedSvg = props => (
  <svg
...
const MaterialHvacRounded = props => <Icon as={MaterialHvacRoundedSvg} {...props} />

MaterialHvacRounded.defaultProps = { ...Icon.defaultProps }

MaterialHvacRounded.propTypes = { ...Icon.propTypes }

export default MaterialHvacRounded
