...
const MaterialLockOpenTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLockOpenTwoTone = (styled.default || styled)(MaterialLockOpenTwoToneSvg).attrs(p => ({
...
`;
MaterialLockOpenTwoTone.propTypes = {
