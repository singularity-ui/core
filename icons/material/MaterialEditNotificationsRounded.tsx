...
const MaterialEditNotificationsRoundedSvg = props => (
  <svg
...
const MaterialEditNotificationsRounded = props => <Icon as={MaterialEditNotificationsRoundedSvg} {...props} />

MaterialEditNotificationsRounded.defaultProps = { ...Icon.defaultProps }

MaterialEditNotificationsRounded.propTypes = { ...Icon.propTypes }

export default MaterialEditNotificationsRounded
