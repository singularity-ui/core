...
const MaterialAltRouteSvg = props => (
  <svg
...
const MaterialAltRoute = props => <Icon as={MaterialAltRouteSvg} {...props} />

MaterialAltRoute.defaultProps = { ...Icon.defaultProps }

MaterialAltRoute.propTypes = { ...Icon.propTypes }

export default MaterialAltRoute
