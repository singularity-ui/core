...
const MaterialHearingDisabledOutlinedSvg = props => (
  <svg
...
const MaterialHearingDisabledOutlined = props => <Icon as={MaterialHearingDisabledOutlinedSvg} {...props} />

MaterialHearingDisabledOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHearingDisabledOutlined.propTypes = { ...Icon.propTypes }

export default MaterialHearingDisabledOutlined
