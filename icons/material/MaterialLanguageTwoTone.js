...
const MaterialLanguageTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLanguageTwoTone = (styled.default || styled)(MaterialLanguageTwoToneSvg).attrs(p => ({
...
`;
MaterialLanguageTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialLanguageTwoTone;