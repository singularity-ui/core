...
const MaterialPhonelinkLockRoundedSvg = props => (
  <svg
...
const MaterialPhonelinkLockRounded = props => <Icon as={MaterialPhonelinkLockRoundedSvg} {...props} />

MaterialPhonelinkLockRounded.defaultProps = { ...Icon.defaultProps }

MaterialPhonelinkLockRounded.propTypes = { ...Icon.propTypes }
