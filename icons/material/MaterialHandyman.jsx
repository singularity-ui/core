...
const MaterialHandymanSvg = props => (
  <svg
...
const MaterialHandyman = props => <Icon as={MaterialHandymanSvg} {...props} />

MaterialHandyman.defaultProps = { ...Icon.defaultProps }

MaterialHandyman.propTypes = { ...Icon.propTypes }

export default MaterialHandyman
