...
const MaterialSportsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsTwoTone = (styled.default || styled)(MaterialSportsTwoToneSvg).attrs(p => ({
...
`;
MaterialSportsTwoTone.propTypes = {
