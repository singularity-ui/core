...
const MaterialNoCell = props => <Icon as={MaterialNoCellSvg} {...props} />

MaterialNoCell.defaultProps = { ...Icon.defaultProps }

MaterialNoCell.propTypes = { ...Icon.propTypes }
