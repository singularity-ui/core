...
const MaterialMaleTwoToneSvg = props => (
  <svg
...
const MaterialMaleTwoTone = props => <Icon as={MaterialMaleTwoToneSvg} {...props} />

MaterialMaleTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMaleTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialMaleTwoTone
