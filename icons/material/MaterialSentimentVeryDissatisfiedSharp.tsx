...
const MaterialSentimentVeryDissatisfiedSharpSvg = props => (
...
const MaterialSentimentVeryDissatisfiedSharp = props => (
  <Icon as={MaterialSentimentVeryDissatisfiedSharpSvg} {...props} />
)

MaterialSentimentVeryDissatisfiedSharp.defaultProps = { ...Icon.defaultProps }

MaterialSentimentVeryDissatisfiedSharp.propTypes = { ...Icon.propTypes }

export default MaterialSentimentVeryDissatisfiedSharp
