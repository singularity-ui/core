...
const MaterialTrafficRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTrafficRounded = (styled.default || styled)(MaterialTrafficRoundedSvg).attrs(p => ({
...
`;
MaterialTrafficRounded.propTypes = {
