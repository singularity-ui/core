...
const MaterialTwoWheelerSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTwoWheelerSharp = (styled.default || styled)(MaterialTwoWheelerSharpSvg).attrs(p => ({
...
`;
MaterialTwoWheelerSharp.propTypes = {
