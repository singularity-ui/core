...
const MaterialMaleOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMaleOutlined = (styled.default || styled)(MaterialMaleOutlinedSvg).attrs(p => ({
...
`;
MaterialMaleOutlined.propTypes = {
