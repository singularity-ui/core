...
const MaterialBluetoothDriveSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBluetoothDrive = (styled.default || styled)(MaterialBluetoothDriveSvg).attrs(p => ({
...
`;
MaterialBluetoothDrive.propTypes = {
