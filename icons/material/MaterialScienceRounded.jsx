...
const MaterialScienceRoundedSvg = props => (
  <svg
...
const MaterialScienceRounded = props => <Icon as={MaterialScienceRoundedSvg} {...props} />

MaterialScienceRounded.defaultProps = { ...Icon.defaultProps }

MaterialScienceRounded.propTypes = { ...Icon.propTypes }
