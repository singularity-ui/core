...
const MaterialFilterHeightTwoToneSvg = props => (
...
const MaterialFilterHeightTwoTone = props => <Icon as={MaterialFilterHeightTwoToneSvg} {...props} />

MaterialFilterHeightTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialFilterHeightTwoTone.propTypes = { ...Icon.propTypes }
