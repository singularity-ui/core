...
const MaterialPianoOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPianoOutlined = (styled.default || styled)(MaterialPianoOutlinedSvg).attrs(p => ({
...
`;
MaterialPianoOutlined.propTypes = {
