...
const MaterialFitScreenOutlinedSvg = props => (
  <svg
...
const MaterialFitScreenOutlined = props => <Icon as={MaterialFitScreenOutlinedSvg} {...props} />

MaterialFitScreenOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFitScreenOutlined.propTypes = { ...Icon.propTypes }
