...
const MaterialSportsScoreTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsScoreTwoTone = (styled.default || styled)(MaterialSportsScoreTwoToneSvg).attrs(p => ({
...
`;
MaterialSportsScoreTwoTone.propTypes = {
