...
const MaterialDashboardCustomizeTwoToneSvg = props => (
  <svg
...
const MaterialDashboardCustomizeTwoTone = props => <Icon as={MaterialDashboardCustomizeTwoToneSvg} {...props} />

MaterialDashboardCustomizeTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDashboardCustomizeTwoTone.propTypes = { ...Icon.propTypes }
