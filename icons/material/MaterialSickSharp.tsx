...
const MaterialSickSharpSvg = props => (
  <svg
...
const MaterialSickSharp = props => <Icon as={MaterialSickSharpSvg} {...props} />

MaterialSickSharp.defaultProps = { ...Icon.defaultProps }

MaterialSickSharp.propTypes = { ...Icon.propTypes }

export default MaterialSickSharp
