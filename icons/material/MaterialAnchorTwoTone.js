...
const MaterialAnchorTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAnchorTwoTone = (styled.default || styled)(MaterialAnchorTwoToneSvg).attrs(p => ({
...
`;
MaterialAnchorTwoTone.propTypes = {
