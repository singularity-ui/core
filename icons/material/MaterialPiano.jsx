...
const MaterialPiano = props => <Icon as={MaterialPianoSvg} {...props} />

MaterialPiano.defaultProps = { ...Icon.defaultProps }

MaterialPiano.propTypes = { ...Icon.propTypes }

export default MaterialPiano
