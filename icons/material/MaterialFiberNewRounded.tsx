...
const MaterialFiberNewRoundedSvg = props => (
...
const MaterialFiberNewRounded = props => <Icon as={MaterialFiberNewRoundedSvg} {...props} />

MaterialFiberNewRounded.defaultProps = { ...Icon.defaultProps }

MaterialFiberNewRounded.propTypes = { ...Icon.propTypes }

export default MaterialFiberNewRounded
