...
const MaterialMotionPhotosAutoSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMotionPhotosAuto = (styled.default || styled)(MaterialMotionPhotosAutoSvg).attrs(p => ({
...
`;
MaterialMotionPhotosAuto.propTypes = {
