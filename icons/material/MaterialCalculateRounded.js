...
const MaterialCalculateRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCalculateRounded = (styled.default || styled)(MaterialCalculateRoundedSvg).attrs(p => ({
...
`;
MaterialCalculateRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialCalculateRounded;