...
const MaterialTaxiAlertSvg = props => (
...
const MaterialTaxiAlert = props => <Icon as={MaterialTaxiAlertSvg} {...props} />

MaterialTaxiAlert.defaultProps = { ...Icon.defaultProps }

MaterialTaxiAlert.propTypes = { ...Icon.propTypes }

export default MaterialTaxiAlert
