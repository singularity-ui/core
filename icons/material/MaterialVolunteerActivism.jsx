...
const MaterialVolunteerActivismSvg = props => (
  <svg
...
const MaterialVolunteerActivism = props => <Icon as={MaterialVolunteerActivismSvg} {...props} />

MaterialVolunteerActivism.defaultProps = { ...Icon.defaultProps }

MaterialVolunteerActivism.propTypes = { ...Icon.propTypes }

export default MaterialVolunteerActivism
