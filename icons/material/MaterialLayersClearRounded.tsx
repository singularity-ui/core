...
const MaterialLayersClearRoundedSvg = props => (
...
const MaterialLayersClearRounded = props => <Icon as={MaterialLayersClearRoundedSvg} {...props} />

MaterialLayersClearRounded.defaultProps = { ...Icon.defaultProps }

MaterialLayersClearRounded.propTypes = { ...Icon.propTypes }
