...
const MaterialHdrOff = props => <Icon as={MaterialHdrOffSvg} {...props} />

MaterialHdrOff.defaultProps = { ...Icon.defaultProps }

MaterialHdrOff.propTypes = { ...Icon.propTypes }

export default MaterialHdrOff
