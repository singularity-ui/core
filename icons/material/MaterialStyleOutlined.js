...
const MaterialStyleOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStyleOutlined = (styled.default || styled)(MaterialStyleOutlinedSvg).attrs(p => ({
...
`;
MaterialStyleOutlined.propTypes = {
