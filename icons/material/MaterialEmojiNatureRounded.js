...
const MaterialEmojiNatureRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEmojiNatureRounded = (styled.default || styled)(MaterialEmojiNatureRoundedSvg).attrs(p => ({
...
`;
MaterialEmojiNatureRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialEmojiNatureRounded;