...
const MaterialShieldTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialShieldTwoTone = (styled.default || styled)(MaterialShieldTwoToneSvg).attrs(p => ({
...
`;
MaterialShieldTwoTone.propTypes = {
