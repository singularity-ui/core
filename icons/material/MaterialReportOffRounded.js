...
const MaterialReportOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReportOffRounded = (styled.default || styled)(MaterialReportOffRoundedSvg).attrs(p => ({
...
`;
MaterialReportOffRounded.propTypes = {
