...
const MaterialTtyTwoToneSvg = props => (
  <svg
...
const MaterialTtyTwoTone = props => <Icon as={MaterialTtyTwoToneSvg} {...props} />

MaterialTtyTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialTtyTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialTtyTwoTone
