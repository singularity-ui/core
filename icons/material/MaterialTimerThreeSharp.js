...
const MaterialTimerThreeSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerThreeSharp = (styled.default || styled)(MaterialTimerThreeSharpSvg).attrs(p => ({
...
`;
MaterialTimerThreeSharp.propTypes = {
