...
const MaterialDrySharpSvg = props => (
  <svg
...
const MaterialDrySharp = props => <Icon as={MaterialDrySharpSvg} {...props} />

MaterialDrySharp.defaultProps = { ...Icon.defaultProps }

MaterialDrySharp.propTypes = { ...Icon.propTypes }
