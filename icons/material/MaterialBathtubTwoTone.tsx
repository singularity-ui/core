...
const MaterialBathtubTwoToneSvg = props => (
  <svg
...
const MaterialBathtubTwoTone = props => <Icon as={MaterialBathtubTwoToneSvg} {...props} />

MaterialBathtubTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBathtubTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialBathtubTwoTone
