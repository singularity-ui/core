...
const MaterialFlipCameraIosRoundedSvg = props => (
  <svg
...
const MaterialFlipCameraIosRounded = props => <Icon as={MaterialFlipCameraIosRoundedSvg} {...props} />

MaterialFlipCameraIosRounded.defaultProps = { ...Icon.defaultProps }

MaterialFlipCameraIosRounded.propTypes = { ...Icon.propTypes }
