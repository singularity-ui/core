...
const MaterialBedroomChildSvg = props => (
  <svg
...
const MaterialBedroomChild = props => <Icon as={MaterialBedroomChildSvg} {...props} />

MaterialBedroomChild.defaultProps = { ...Icon.defaultProps }

MaterialBedroomChild.propTypes = { ...Icon.propTypes }
