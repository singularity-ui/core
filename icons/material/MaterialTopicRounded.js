...
const MaterialTopicRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTopicRounded = (styled.default || styled)(MaterialTopicRoundedSvg).attrs(p => ({
...
`;
MaterialTopicRounded.propTypes = {
