...
const MaterialSupervisorAccountOutlinedSvg = props => (
...
const MaterialSupervisorAccountOutlined = props => <Icon as={MaterialSupervisorAccountOutlinedSvg} {...props} />

MaterialSupervisorAccountOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSupervisorAccountOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSupervisorAccountOutlined
