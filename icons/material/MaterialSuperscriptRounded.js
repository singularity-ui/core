...
const MaterialSuperscriptRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSuperscriptRounded = (styled.default || styled)(MaterialSuperscriptRoundedSvg).attrs(p => ({
...
`;
MaterialSuperscriptRounded.propTypes = {
