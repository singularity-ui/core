...
const MaterialHideSourceTwoToneSvg = props => (
  <svg
...
const MaterialHideSourceTwoTone = props => <Icon as={MaterialHideSourceTwoToneSvg} {...props} />

MaterialHideSourceTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHideSourceTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialHideSourceTwoTone
