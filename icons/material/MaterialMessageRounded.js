...
const MaterialMessageRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMessageRounded = (styled.default || styled)(MaterialMessageRoundedSvg).attrs(p => ({
...
`;
MaterialMessageRounded.propTypes = {
