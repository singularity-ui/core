...
const MaterialBeachAccessTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBeachAccessTwoTone = (styled.default || styled)(MaterialBeachAccessTwoToneSvg).attrs(p => ({
...
`;
MaterialBeachAccessTwoTone.propTypes = {
