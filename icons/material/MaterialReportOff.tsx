...
const MaterialReportOffSvg = props => (
...
const MaterialReportOff = props => <Icon as={MaterialReportOffSvg} {...props} />

MaterialReportOff.defaultProps = { ...Icon.defaultProps }

MaterialReportOff.propTypes = { ...Icon.propTypes }

export default MaterialReportOff
