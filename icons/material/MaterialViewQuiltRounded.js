...
const MaterialViewQuiltRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialViewQuiltRounded = (styled.default || styled)(MaterialViewQuiltRoundedSvg).attrs(p => ({
...
`;
MaterialViewQuiltRounded.propTypes = {
