...
const MaterialSixKOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixKOutlined = (styled.default || styled)(MaterialSixKOutlinedSvg).attrs(p => ({
...
`;
MaterialSixKOutlined.propTypes = {
