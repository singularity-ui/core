...
const MaterialTimerThreeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerThreeRounded = (styled.default || styled)(MaterialTimerThreeRoundedSvg).attrs(p => ({
...
`;
MaterialTimerThreeRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialTimerThreeRounded;