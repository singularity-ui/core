...
const MaterialMaleOutlinedSvg = props => (
  <svg
...
const MaterialMaleOutlined = props => <Icon as={MaterialMaleOutlinedSvg} {...props} />

MaterialMaleOutlined.defaultProps = { ...Icon.defaultProps }

MaterialMaleOutlined.propTypes = { ...Icon.propTypes }

export default MaterialMaleOutlined
