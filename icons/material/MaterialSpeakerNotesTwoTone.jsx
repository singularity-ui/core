...
const MaterialSpeakerNotesTwoToneSvg = props => (
...
const MaterialSpeakerNotesTwoTone = props => <Icon as={MaterialSpeakerNotesTwoToneSvg} {...props} />

MaterialSpeakerNotesTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSpeakerNotesTwoTone.propTypes = { ...Icon.propTypes }
