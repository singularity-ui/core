...
const MaterialDesignServicesSharpSvg = props => (
  <svg
...
const MaterialDesignServicesSharp = props => <Icon as={MaterialDesignServicesSharpSvg} {...props} />

MaterialDesignServicesSharp.defaultProps = { ...Icon.defaultProps }

MaterialDesignServicesSharp.propTypes = { ...Icon.propTypes }
