...
const MaterialMarginTwoToneSvg = props => (
  <svg
...
const MaterialMarginTwoTone = props => <Icon as={MaterialMarginTwoToneSvg} {...props} />

MaterialMarginTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMarginTwoTone.propTypes = { ...Icon.propTypes }
