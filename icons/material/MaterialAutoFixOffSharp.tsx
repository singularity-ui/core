...
const MaterialAutoFixOffSharpSvg = props => (
  <svg
...
const MaterialAutoFixOffSharp = props => <Icon as={MaterialAutoFixOffSharpSvg} {...props} />

MaterialAutoFixOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialAutoFixOffSharp.propTypes = { ...Icon.propTypes }
