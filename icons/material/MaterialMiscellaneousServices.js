...
const MaterialMiscellaneousServicesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMiscellaneousServices = (styled.default || styled)(MaterialMiscellaneousServicesSvg).attrs(p => ({
...
`;
MaterialMiscellaneousServices.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialMiscellaneousServices;