...
const MaterialWifiOffSvg = props => (
...
const MaterialWifiOff = props => <Icon as={MaterialWifiOffSvg} {...props} />

MaterialWifiOff.defaultProps = { ...Icon.defaultProps }

MaterialWifiOff.propTypes = { ...Icon.propTypes }

export default MaterialWifiOff
