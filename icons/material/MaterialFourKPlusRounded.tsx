...
const MaterialFourKPlusRoundedSvg = props => (
  <svg
...
const MaterialFourKPlusRounded = props => <Icon as={MaterialFourKPlusRoundedSvg} {...props} />

MaterialFourKPlusRounded.defaultProps = { ...Icon.defaultProps }

MaterialFourKPlusRounded.propTypes = { ...Icon.propTypes }
