...
const MaterialVisibilityTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVisibilityTwoTone = (styled.default || styled)(MaterialVisibilityTwoToneSvg).attrs(p => ({
...
`;
MaterialVisibilityTwoTone.propTypes = {
