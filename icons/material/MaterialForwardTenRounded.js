...
const MaterialForwardTenRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardTenRounded = (styled.default || styled)(MaterialForwardTenRoundedSvg).attrs(p => ({
...
`;
MaterialForwardTenRounded.propTypes = {
