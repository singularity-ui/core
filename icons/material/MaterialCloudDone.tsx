...
const MaterialCloudDoneSvg = props => (
...
const MaterialCloudDone = props => <Icon as={MaterialCloudDoneSvg} {...props} />

MaterialCloudDone.defaultProps = { ...Icon.defaultProps }

MaterialCloudDone.propTypes = { ...Icon.propTypes }
