...
const MaterialPsychologySvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPsychology = (styled.default || styled)(MaterialPsychologySvg).attrs(p => ({
...
`;
MaterialPsychology.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialPsychology;