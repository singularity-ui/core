...
const MaterialSupportAgentTwoToneSvg = props => (
  <svg
...
const MaterialSupportAgentTwoTone = props => <Icon as={MaterialSupportAgentTwoToneSvg} {...props} />

MaterialSupportAgentTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSupportAgentTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSupportAgentTwoTone
