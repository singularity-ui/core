...
const MaterialPreviewSvg = props => (
  <svg
...
const MaterialPreview = props => <Icon as={MaterialPreviewSvg} {...props} />

MaterialPreview.defaultProps = { ...Icon.defaultProps }

MaterialPreview.propTypes = { ...Icon.propTypes }
