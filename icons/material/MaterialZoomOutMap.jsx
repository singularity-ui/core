...
const MaterialZoomOutMapSvg = props => (
  <svg
...
const MaterialZoomOutMap = props => <Icon as={MaterialZoomOutMapSvg} {...props} />

MaterialZoomOutMap.defaultProps = { ...Icon.defaultProps }

MaterialZoomOutMap.propTypes = { ...Icon.propTypes }
