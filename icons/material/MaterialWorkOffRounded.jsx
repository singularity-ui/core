...
const MaterialWorkOffRoundedSvg = props => (
...
const MaterialWorkOffRounded = props => <Icon as={MaterialWorkOffRoundedSvg} {...props} />

MaterialWorkOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialWorkOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialWorkOffRounded
