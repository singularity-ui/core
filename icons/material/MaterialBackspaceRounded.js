...
const MaterialBackspaceRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBackspaceRounded = (styled.default || styled)(MaterialBackspaceRoundedSvg).attrs(p => ({
...
`;
MaterialBackspaceRounded.propTypes = {
