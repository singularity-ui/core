...
const MaterialHailTwoToneSvg = props => (
  <svg
...
const MaterialHailTwoTone = props => <Icon as={MaterialHailTwoToneSvg} {...props} />

MaterialHailTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHailTwoTone.propTypes = { ...Icon.propTypes }
