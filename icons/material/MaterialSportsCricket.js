...
const MaterialSportsCricketSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsCricket = (styled.default || styled)(MaterialSportsCricketSvg).attrs(p => ({
...
`;
MaterialSportsCricket.propTypes = {
