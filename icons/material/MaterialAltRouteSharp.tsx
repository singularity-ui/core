...
const MaterialAltRouteSharpSvg = props => (
  <svg
...
const MaterialAltRouteSharp = props => <Icon as={MaterialAltRouteSharpSvg} {...props} />

MaterialAltRouteSharp.defaultProps = { ...Icon.defaultProps }

MaterialAltRouteSharp.propTypes = { ...Icon.propTypes }
