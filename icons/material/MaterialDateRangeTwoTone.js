...
const MaterialDateRangeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDateRangeTwoTone = (styled.default || styled)(MaterialDateRangeTwoToneSvg).attrs(p => ({
...
`;
MaterialDateRangeTwoTone.propTypes = {
