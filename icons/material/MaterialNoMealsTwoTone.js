...
const MaterialNoMealsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoMealsTwoTone = (styled.default || styled)(MaterialNoMealsTwoToneSvg).attrs(p => ({
...
`;
MaterialNoMealsTwoTone.propTypes = {
