...
const MaterialSummarizeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSummarizeRounded = (styled.default || styled)(MaterialSummarizeRoundedSvg).attrs(p => ({
...
`;
MaterialSummarizeRounded.propTypes = {
