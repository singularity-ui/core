...
const MaterialCelebrationOutlinedSvg = props => (
  <svg
...
const MaterialCelebrationOutlined = props => <Icon as={MaterialCelebrationOutlinedSvg} {...props} />

MaterialCelebrationOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCelebrationOutlined.propTypes = { ...Icon.propTypes }

export default MaterialCelebrationOutlined
