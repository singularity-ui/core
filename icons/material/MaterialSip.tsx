...
const MaterialSip = props => <Icon as={MaterialSipSvg} {...props} />

MaterialSip.defaultProps = { ...Icon.defaultProps }

MaterialSip.propTypes = { ...Icon.propTypes }
