...
const MaterialContentCutRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialContentCutRounded = (styled.default || styled)(MaterialContentCutRoundedSvg).attrs(p => ({
...
`;
MaterialContentCutRounded.propTypes = {
