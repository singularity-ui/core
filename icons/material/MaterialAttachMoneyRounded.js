...
const MaterialAttachMoneyRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttachMoneyRounded = (styled.default || styled)(MaterialAttachMoneyRoundedSvg).attrs(p => ({
...
`;
MaterialAttachMoneyRounded.propTypes = {
