...
const MaterialSleddingSharpSvg = props => (
  <svg
...
const MaterialSleddingSharp = props => <Icon as={MaterialSleddingSharpSvg} {...props} />

MaterialSleddingSharp.defaultProps = { ...Icon.defaultProps }

MaterialSleddingSharp.propTypes = { ...Icon.propTypes }
