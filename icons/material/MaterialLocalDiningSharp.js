...
const MaterialLocalDiningSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalDiningSharp = (styled.default || styled)(MaterialLocalDiningSharpSvg).attrs(p => ({
...
`;
MaterialLocalDiningSharp.propTypes = {
