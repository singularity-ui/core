...
const MaterialFoodBankSvg = props => (
  <svg
...
const MaterialFoodBank = props => <Icon as={MaterialFoodBankSvg} {...props} />

MaterialFoodBank.defaultProps = { ...Icon.defaultProps }

MaterialFoodBank.propTypes = { ...Icon.propTypes }
