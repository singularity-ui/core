...
const MaterialCachedRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCachedRounded = (styled.default || styled)(MaterialCachedRoundedSvg).attrs(p => ({
...
`;
MaterialCachedRounded.propTypes = {
