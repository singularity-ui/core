...
const MaterialFastForwardRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFastForwardRounded = (styled.default || styled)(MaterialFastForwardRoundedSvg).attrs(p => ({
...
`;
MaterialFastForwardRounded.propTypes = {
