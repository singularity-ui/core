...
const MaterialTaxiAlertRoundedSvg = props => (
  <svg
...
const MaterialTaxiAlertRounded = props => <Icon as={MaterialTaxiAlertRoundedSvg} {...props} />

MaterialTaxiAlertRounded.defaultProps = { ...Icon.defaultProps }

MaterialTaxiAlertRounded.propTypes = { ...Icon.propTypes }
