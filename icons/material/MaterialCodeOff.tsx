...
const MaterialCodeOffSvg = props => (
  <svg
...
const MaterialCodeOff = props => <Icon as={MaterialCodeOffSvg} {...props} />

MaterialCodeOff.defaultProps = { ...Icon.defaultProps }

MaterialCodeOff.propTypes = { ...Icon.propTypes }
