...
const MaterialLoyaltyRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLoyaltyRounded = (styled.default || styled)(MaterialLoyaltyRoundedSvg).attrs(p => ({
...
`;
MaterialLoyaltyRounded.propTypes = {
