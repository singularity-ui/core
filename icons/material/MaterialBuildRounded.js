...
const MaterialBuildRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBuildRounded = (styled.default || styled)(MaterialBuildRoundedSvg).attrs(p => ({
...
`;
MaterialBuildRounded.propTypes = {
