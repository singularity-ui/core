...
const MaterialCampaignTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCampaignTwoTone = (styled.default || styled)(MaterialCampaignTwoToneSvg).attrs(p => ({
...
`;
MaterialCampaignTwoTone.propTypes = {
