...
const MaterialMarkAsUnreadSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMarkAsUnread = (styled.default || styled)(MaterialMarkAsUnreadSvg).attrs(p => ({
...
`;
MaterialMarkAsUnread.propTypes = {
