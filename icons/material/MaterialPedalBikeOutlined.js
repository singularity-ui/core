...
const MaterialPedalBikeOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPedalBikeOutlined = (styled.default || styled)(MaterialPedalBikeOutlinedSvg).attrs(p => ({
...
`;
MaterialPedalBikeOutlined.propTypes = {
