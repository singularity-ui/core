...
const MaterialTimerThreeSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerThree = (styled.default || styled)(MaterialTimerThreeSvg).attrs(p => ({
...
`;
MaterialTimerThree.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialTimerThree;