...
const MaterialSportsFootballOutlinedSvg = props => (
  <svg
...
const MaterialSportsFootballOutlined = props => <Icon as={MaterialSportsFootballOutlinedSvg} {...props} />

MaterialSportsFootballOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSportsFootballOutlined.propTypes = { ...Icon.propTypes }
