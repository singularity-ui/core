...
const MaterialUpdateDisabledSvg = props => (
  <svg
...
const MaterialUpdateDisabled = props => <Icon as={MaterialUpdateDisabledSvg} {...props} />

MaterialUpdateDisabled.defaultProps = { ...Icon.defaultProps }

MaterialUpdateDisabled.propTypes = { ...Icon.propTypes }

export default MaterialUpdateDisabled
