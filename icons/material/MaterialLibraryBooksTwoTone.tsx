...
const MaterialLibraryBooksTwoToneSvg = props => (
...
const MaterialLibraryBooksTwoTone = props => <Icon as={MaterialLibraryBooksTwoToneSvg} {...props} />

MaterialLibraryBooksTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialLibraryBooksTwoTone.propTypes = { ...Icon.propTypes }
