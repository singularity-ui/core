...
const MaterialCancelScheduleSendOutlinedSvg = props => (
  <svg
...
const MaterialCancelScheduleSendOutlined = props => <Icon as={MaterialCancelScheduleSendOutlinedSvg} {...props} />

MaterialCancelScheduleSendOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCancelScheduleSendOutlined.propTypes = { ...Icon.propTypes }

export default MaterialCancelScheduleSendOutlined
