...
const MaterialWavesTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWavesTwoTone = (styled.default || styled)(MaterialWavesTwoToneSvg).attrs(p => ({
...
`;
MaterialWavesTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialWavesTwoTone;