...
const MaterialBuildCircleSvg = props => (
  <svg
...
const MaterialBuildCircle = props => <Icon as={MaterialBuildCircleSvg} {...props} />

MaterialBuildCircle.defaultProps = { ...Icon.defaultProps }

MaterialBuildCircle.propTypes = { ...Icon.propTypes }
