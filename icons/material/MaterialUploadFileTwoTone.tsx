...
const MaterialUploadFileTwoToneSvg = props => (
  <svg
...
const MaterialUploadFileTwoTone = props => <Icon as={MaterialUploadFileTwoToneSvg} {...props} />

MaterialUploadFileTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialUploadFileTwoTone.propTypes = { ...Icon.propTypes }
