...
const MaterialFilterSixSvg = props => (
...
const MaterialFilterSix = props => <Icon as={MaterialFilterSixSvg} {...props} />

MaterialFilterSix.defaultProps = { ...Icon.defaultProps }

MaterialFilterSix.propTypes = { ...Icon.propTypes }

export default MaterialFilterSix
