...
const MaterialDeckOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDeckOutlined = (styled.default || styled)(MaterialDeckOutlinedSvg).attrs(p => ({
...
`;
MaterialDeckOutlined.propTypes = {
