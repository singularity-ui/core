...
const MaterialDeveloperModeSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDeveloperMode = (styled.default || styled)(MaterialDeveloperModeSvg).attrs(p => ({
...
`;
MaterialDeveloperMode.propTypes = {
