...
const MaterialFiveGRoundedSvg = props => (
  <svg
...
const MaterialFiveGRounded = props => <Icon as={MaterialFiveGRoundedSvg} {...props} />

MaterialFiveGRounded.defaultProps = { ...Icon.defaultProps }

MaterialFiveGRounded.propTypes = { ...Icon.propTypes }
