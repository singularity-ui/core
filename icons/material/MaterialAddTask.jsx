...
const MaterialAddTaskSvg = props => (
  <svg
...
const MaterialAddTask = props => <Icon as={MaterialAddTaskSvg} {...props} />

MaterialAddTask.defaultProps = { ...Icon.defaultProps }

MaterialAddTask.propTypes = { ...Icon.propTypes }
