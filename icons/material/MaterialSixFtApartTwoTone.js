...
const MaterialSixFtApartTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixFtApartTwoTone = (styled.default || styled)(MaterialSixFtApartTwoToneSvg).attrs(p => ({
...
`;
MaterialSixFtApartTwoTone.propTypes = {
