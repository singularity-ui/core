...
const MaterialSailingSharpSvg = props => (
  <svg
...
const MaterialSailingSharp = props => <Icon as={MaterialSailingSharpSvg} {...props} />

MaterialSailingSharp.defaultProps = { ...Icon.defaultProps }

MaterialSailingSharp.propTypes = { ...Icon.propTypes }

export default MaterialSailingSharp
