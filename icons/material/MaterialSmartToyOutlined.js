...
const MaterialSmartToyOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSmartToyOutlined = (styled.default || styled)(MaterialSmartToyOutlinedSvg).attrs(p => ({
...
`;
MaterialSmartToyOutlined.propTypes = {
