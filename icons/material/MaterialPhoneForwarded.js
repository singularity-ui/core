...
const MaterialPhoneForwardedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneForwarded = (styled.default || styled)(MaterialPhoneForwardedSvg).attrs(p => ({
...
`;
MaterialPhoneForwarded.propTypes = {
