...
const MaterialCabin = props => <Icon as={MaterialCabinSvg} {...props} />

MaterialCabin.defaultProps = { ...Icon.defaultProps }

MaterialCabin.propTypes = { ...Icon.propTypes }

export default MaterialCabin
