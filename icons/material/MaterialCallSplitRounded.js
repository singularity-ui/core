...
const MaterialCallSplitRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCallSplitRounded = (styled.default || styled)(MaterialCallSplitRoundedSvg).attrs(p => ({
...
`;
MaterialCallSplitRounded.propTypes = {
