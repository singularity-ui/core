...
const MaterialParaglidingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialParaglidingSharp = (styled.default || styled)(MaterialParaglidingSharpSvg).attrs(p => ({
...
`;
MaterialParaglidingSharp.propTypes = {
