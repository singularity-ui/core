...
const MaterialListAltTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialListAltTwoTone = (styled.default || styled)(MaterialListAltTwoToneSvg).attrs(p => ({
...
`;
MaterialListAltTwoTone.propTypes = {
