...
const MaterialSnowmobileRoundedSvg = props => (
  <svg
...
const MaterialSnowmobileRounded = props => <Icon as={MaterialSnowmobileRoundedSvg} {...props} />

MaterialSnowmobileRounded.defaultProps = { ...Icon.defaultProps }

MaterialSnowmobileRounded.propTypes = { ...Icon.propTypes }

export default MaterialSnowmobileRounded
