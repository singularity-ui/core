...
const MaterialTwoK = props => <Icon as={MaterialTwoKSvg} {...props} />

MaterialTwoK.defaultProps = { ...Icon.defaultProps }

MaterialTwoK.propTypes = { ...Icon.propTypes }

export default MaterialTwoK
