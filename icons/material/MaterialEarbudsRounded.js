...
const MaterialEarbudsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEarbudsRounded = (styled.default || styled)(MaterialEarbudsRoundedSvg).attrs(p => ({
...
`;
MaterialEarbudsRounded.propTypes = {
