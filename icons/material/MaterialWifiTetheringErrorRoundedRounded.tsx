...
const MaterialWifiTetheringErrorRoundedRoundedSvg = props => (
  <svg
...
const MaterialWifiTetheringErrorRoundedRounded = props => (
  <Icon as={MaterialWifiTetheringErrorRoundedRoundedSvg} {...props} />
)

MaterialWifiTetheringErrorRoundedRounded.defaultProps = { ...Icon.defaultProps }

MaterialWifiTetheringErrorRoundedRounded.propTypes = { ...Icon.propTypes }

export default MaterialWifiTetheringErrorRoundedRounded
