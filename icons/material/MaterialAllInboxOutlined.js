...
const MaterialAllInboxOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAllInboxOutlined = (styled.default || styled)(MaterialAllInboxOutlinedSvg).attrs(p => ({
...
`;
MaterialAllInboxOutlined.propTypes = {
