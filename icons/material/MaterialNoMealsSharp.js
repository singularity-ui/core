...
const MaterialNoMealsSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoMealsSharp = (styled.default || styled)(MaterialNoMealsSharpSvg).attrs(p => ({
...
`;
MaterialNoMealsSharp.propTypes = {
