...
const MaterialUmbrellaOutlinedSvg = props => (
  <svg
...
const MaterialUmbrellaOutlined = props => <Icon as={MaterialUmbrellaOutlinedSvg} {...props} />

MaterialUmbrellaOutlined.defaultProps = { ...Icon.defaultProps }

MaterialUmbrellaOutlined.propTypes = { ...Icon.propTypes }

export default MaterialUmbrellaOutlined
