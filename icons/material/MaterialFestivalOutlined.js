...
const MaterialFestivalOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFestivalOutlined = (styled.default || styled)(MaterialFestivalOutlinedSvg).attrs(p => ({
...
`;
MaterialFestivalOutlined.propTypes = {
