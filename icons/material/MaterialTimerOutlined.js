...
const MaterialTimerOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerOutlined = (styled.default || styled)(MaterialTimerOutlinedSvg).attrs(p => ({
...
`;
MaterialTimerOutlined.propTypes = {
