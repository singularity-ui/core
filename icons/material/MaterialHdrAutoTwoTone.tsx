...
const MaterialHdrAutoTwoToneSvg = props => (
  <svg
...
const MaterialHdrAutoTwoTone = props => <Icon as={MaterialHdrAutoTwoToneSvg} {...props} />

MaterialHdrAutoTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHdrAutoTwoTone.propTypes = { ...Icon.propTypes }
