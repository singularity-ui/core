...
const MaterialEditNotificationsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEditNotifications = (styled.default || styled)(MaterialEditNotificationsSvg).attrs(p => ({
...
`;
MaterialEditNotifications.propTypes = {
