...
const MaterialDeck = props => <Icon as={MaterialDeckSvg} {...props} />

MaterialDeck.defaultProps = { ...Icon.defaultProps }

MaterialDeck.propTypes = { ...Icon.propTypes }

export default MaterialDeck
