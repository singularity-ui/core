...
const MaterialViewWeekRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialViewWeekRounded = (styled.default || styled)(MaterialViewWeekRoundedSvg).attrs(p => ({
...
`;
MaterialViewWeekRounded.propTypes = {
