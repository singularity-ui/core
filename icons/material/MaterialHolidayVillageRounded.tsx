...
const MaterialHolidayVillageRoundedSvg = props => (
  <svg
...
const MaterialHolidayVillageRounded = props => <Icon as={MaterialHolidayVillageRoundedSvg} {...props} />

MaterialHolidayVillageRounded.defaultProps = { ...Icon.defaultProps }

MaterialHolidayVillageRounded.propTypes = { ...Icon.propTypes }

export default MaterialHolidayVillageRounded
