...
const MaterialNoFoodRoundedSvg = props => (
  <svg
...
const MaterialNoFoodRounded = props => <Icon as={MaterialNoFoodRoundedSvg} {...props} />

MaterialNoFoodRounded.defaultProps = { ...Icon.defaultProps }

MaterialNoFoodRounded.propTypes = { ...Icon.propTypes }

export default MaterialNoFoodRounded
