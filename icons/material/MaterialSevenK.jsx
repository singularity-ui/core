...
const MaterialSevenK = props => <Icon as={MaterialSevenKSvg} {...props} />

MaterialSevenK.defaultProps = { ...Icon.defaultProps }

MaterialSevenK.propTypes = { ...Icon.propTypes }
