...
const MaterialRowing = props => <Icon as={MaterialRowingSvg} {...props} />

MaterialRowing.defaultProps = { ...Icon.defaultProps }

MaterialRowing.propTypes = { ...Icon.propTypes }

export default MaterialRowing
