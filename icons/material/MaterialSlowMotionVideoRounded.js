...
const MaterialSlowMotionVideoRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSlowMotionVideoRounded = (styled.default || styled)(MaterialSlowMotionVideoRoundedSvg).attrs(p => ({
...
`;
MaterialSlowMotionVideoRounded.propTypes = {
