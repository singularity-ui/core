...
const MaterialSettingsBluetoothRoundedSvg = props => (
  <svg
...
const MaterialSettingsBluetoothRounded = props => <Icon as={MaterialSettingsBluetoothRoundedSvg} {...props} />

MaterialSettingsBluetoothRounded.defaultProps = { ...Icon.defaultProps }

MaterialSettingsBluetoothRounded.propTypes = { ...Icon.propTypes }

export default MaterialSettingsBluetoothRounded
