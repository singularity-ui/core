...
const MaterialConnectedTvRoundedSvg = props => (
  <svg
...
const MaterialConnectedTvRounded = props => <Icon as={MaterialConnectedTvRoundedSvg} {...props} />

MaterialConnectedTvRounded.defaultProps = { ...Icon.defaultProps }

MaterialConnectedTvRounded.propTypes = { ...Icon.propTypes }
