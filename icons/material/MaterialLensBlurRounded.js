...
const MaterialLensBlurRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLensBlurRounded = (styled.default || styled)(MaterialLensBlurRoundedSvg).attrs(p => ({
...
`;
MaterialLensBlurRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialLensBlurRounded;