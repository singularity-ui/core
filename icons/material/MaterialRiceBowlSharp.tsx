...
const MaterialRiceBowlSharpSvg = props => (
  <svg
...
const MaterialRiceBowlSharp = props => <Icon as={MaterialRiceBowlSharpSvg} {...props} />

MaterialRiceBowlSharp.defaultProps = { ...Icon.defaultProps }

MaterialRiceBowlSharp.propTypes = { ...Icon.propTypes }

export default MaterialRiceBowlSharp
