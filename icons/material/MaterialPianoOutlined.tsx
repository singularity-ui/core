...
const MaterialPianoOutlinedSvg = props => (
  <svg
...
const MaterialPianoOutlined = props => <Icon as={MaterialPianoOutlinedSvg} {...props} />

MaterialPianoOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPianoOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPianoOutlined
