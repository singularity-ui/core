...
const MaterialSettingsPowerSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSettingsPower = (styled.default || styled)(MaterialSettingsPowerSvg).attrs(p => ({
...
`;
MaterialSettingsPower.propTypes = {
