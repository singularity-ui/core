...
const MaterialRecentActorsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRecentActors = (styled.default || styled)(MaterialRecentActorsSvg).attrs(p => ({
...
`;
MaterialRecentActors.propTypes = {
