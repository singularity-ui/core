...
const MaterialViewArrayRoundedSvg = props => (
  <svg
...
const MaterialViewArrayRounded = props => <Icon as={MaterialViewArrayRoundedSvg} {...props} />

MaterialViewArrayRounded.defaultProps = { ...Icon.defaultProps }

MaterialViewArrayRounded.propTypes = { ...Icon.propTypes }
