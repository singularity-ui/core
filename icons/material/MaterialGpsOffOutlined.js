...
const MaterialGpsOffOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGpsOffOutlined = (styled.default || styled)(MaterialGpsOffOutlinedSvg).attrs(p => ({
...
`;
MaterialGpsOffOutlined.propTypes = {
