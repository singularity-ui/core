...
const MaterialStrollerTwoToneSvg = props => (
  <svg
...
const MaterialStrollerTwoTone = props => <Icon as={MaterialStrollerTwoToneSvg} {...props} />

MaterialStrollerTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialStrollerTwoTone.propTypes = { ...Icon.propTypes }
