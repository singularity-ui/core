...
const MaterialCellWifiSharpSvg = props => (
  <svg
...
const MaterialCellWifiSharp = props => <Icon as={MaterialCellWifiSharpSvg} {...props} />

MaterialCellWifiSharp.defaultProps = { ...Icon.defaultProps }

MaterialCellWifiSharp.propTypes = { ...Icon.propTypes }

export default MaterialCellWifiSharp
