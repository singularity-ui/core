...
const MaterialSnowboardingOutlinedSvg = props => (
  <svg
...
const MaterialSnowboardingOutlined = props => <Icon as={MaterialSnowboardingOutlinedSvg} {...props} />

MaterialSnowboardingOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSnowboardingOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSnowboardingOutlined
