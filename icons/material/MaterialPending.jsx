...
const MaterialPendingSvg = props => (
  <svg
...
const MaterialPending = props => <Icon as={MaterialPendingSvg} {...props} />

MaterialPending.defaultProps = { ...Icon.defaultProps }

MaterialPending.propTypes = { ...Icon.propTypes }
