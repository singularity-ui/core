...
const MaterialTimelapseSvg = props => (
...
const MaterialTimelapse = props => <Icon as={MaterialTimelapseSvg} {...props} />

MaterialTimelapse.defaultProps = { ...Icon.defaultProps }

MaterialTimelapse.propTypes = { ...Icon.propTypes }

export default MaterialTimelapse
