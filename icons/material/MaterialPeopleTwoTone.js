...
const MaterialPeopleTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPeopleTwoTone = (styled.default || styled)(MaterialPeopleTwoToneSvg).attrs(p => ({
...
`;
MaterialPeopleTwoTone.propTypes = {
