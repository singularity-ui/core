...
const MaterialSingleBedRoundedSvg = props => (
  <svg
...
const MaterialSingleBedRounded = props => <Icon as={MaterialSingleBedRoundedSvg} {...props} />

MaterialSingleBedRounded.defaultProps = { ...Icon.defaultProps }

MaterialSingleBedRounded.propTypes = { ...Icon.propTypes }
