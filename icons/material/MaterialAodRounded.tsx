...
const MaterialAodRoundedSvg = props => (
  <svg
...
const MaterialAodRounded = props => <Icon as={MaterialAodRoundedSvg} {...props} />

MaterialAodRounded.defaultProps = { ...Icon.defaultProps }

MaterialAodRounded.propTypes = { ...Icon.propTypes }
