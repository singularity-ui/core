...
const MaterialAnchorRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAnchorRounded = (styled.default || styled)(MaterialAnchorRoundedSvg).attrs(p => ({
...
`;
MaterialAnchorRounded.propTypes = {
