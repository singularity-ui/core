...
const MaterialSurfingOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSurfingOutlined = (styled.default || styled)(MaterialSurfingOutlinedSvg).attrs(p => ({
...
`;
MaterialSurfingOutlined.propTypes = {
