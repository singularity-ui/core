...
const MaterialGroupAddOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGroupAddOutlined = (styled.default || styled)(MaterialGroupAddOutlinedSvg).attrs(p => ({
...
`;
MaterialGroupAddOutlined.propTypes = {
