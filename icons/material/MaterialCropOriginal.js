...
const MaterialCropOriginalSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCropOriginal = (styled.default || styled)(MaterialCropOriginalSvg).attrs(p => ({
...
`;
MaterialCropOriginal.propTypes = {
