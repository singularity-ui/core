...
const MaterialDeveloperBoardOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDeveloperBoardOff = (styled.default || styled)(MaterialDeveloperBoardOffSvg).attrs(p => ({
...
`;
MaterialDeveloperBoardOff.propTypes = {
