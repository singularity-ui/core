...
const MaterialHttp = props => <Icon as={MaterialHttpSvg} {...props} />

MaterialHttp.defaultProps = { ...Icon.defaultProps }

MaterialHttp.propTypes = { ...Icon.propTypes }

export default MaterialHttp
