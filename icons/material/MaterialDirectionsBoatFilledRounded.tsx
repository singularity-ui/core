...
const MaterialDirectionsBoatFilledRoundedSvg = props => (
  <svg
...
const MaterialDirectionsBoatFilledRounded = props => <Icon as={MaterialDirectionsBoatFilledRoundedSvg} {...props} />

MaterialDirectionsBoatFilledRounded.defaultProps = { ...Icon.defaultProps }

MaterialDirectionsBoatFilledRounded.propTypes = { ...Icon.propTypes }
