...
const MaterialFileDownloadDoneRoundedSvg = props => (
  <svg
...
const MaterialFileDownloadDoneRounded = props => <Icon as={MaterialFileDownloadDoneRoundedSvg} {...props} />

MaterialFileDownloadDoneRounded.defaultProps = { ...Icon.defaultProps }

MaterialFileDownloadDoneRounded.propTypes = { ...Icon.propTypes }
