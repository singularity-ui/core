...
const MaterialSettingsVoiceSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSettingsVoice = (styled.default || styled)(MaterialSettingsVoiceSvg).attrs(p => ({
...
`;
MaterialSettingsVoice.propTypes = {
