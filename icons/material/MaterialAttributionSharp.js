...
const MaterialAttributionSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttributionSharp = (styled.default || styled)(MaterialAttributionSharpSvg).attrs(p => ({
...
`;
MaterialAttributionSharp.propTypes = {
