...
const MaterialFactCheckOutlinedSvg = props => (
  <svg
...
const MaterialFactCheckOutlined = props => <Icon as={MaterialFactCheckOutlinedSvg} {...props} />

MaterialFactCheckOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFactCheckOutlined.propTypes = { ...Icon.propTypes }
