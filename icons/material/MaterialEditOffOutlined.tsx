...
const MaterialEditOffOutlinedSvg = props => (
  <svg
...
const MaterialEditOffOutlined = props => <Icon as={MaterialEditOffOutlinedSvg} {...props} />

MaterialEditOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialEditOffOutlined.propTypes = { ...Icon.propTypes }
