...
const MaterialHdrPlusSvg = props => (
  <svg
...
const MaterialHdrPlus = props => <Icon as={MaterialHdrPlusSvg} {...props} />

MaterialHdrPlus.defaultProps = { ...Icon.defaultProps }

MaterialHdrPlus.propTypes = { ...Icon.propTypes }
