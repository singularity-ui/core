...
const MaterialSportsVolleyballOutlinedSvg = props => (
  <svg
...
const MaterialSportsVolleyballOutlined = props => <Icon as={MaterialSportsVolleyballOutlinedSvg} {...props} />

MaterialSportsVolleyballOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSportsVolleyballOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSportsVolleyballOutlined
