...
const MaterialSeventeenMpRoundedSvg = props => (
  <svg
...
const MaterialSeventeenMpRounded = props => <Icon as={MaterialSeventeenMpRoundedSvg} {...props} />

MaterialSeventeenMpRounded.defaultProps = { ...Icon.defaultProps }

MaterialSeventeenMpRounded.propTypes = { ...Icon.propTypes }

export default MaterialSeventeenMpRounded
