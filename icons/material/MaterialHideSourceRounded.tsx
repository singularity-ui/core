...
const MaterialHideSourceRoundedSvg = props => (
  <svg
...
const MaterialHideSourceRounded = props => <Icon as={MaterialHideSourceRoundedSvg} {...props} />

MaterialHideSourceRounded.defaultProps = { ...Icon.defaultProps }

MaterialHideSourceRounded.propTypes = { ...Icon.propTypes }

export default MaterialHideSourceRounded
