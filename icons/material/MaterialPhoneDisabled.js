...
const MaterialPhoneDisabledSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneDisabled = (styled.default || styled)(MaterialPhoneDisabledSvg).attrs(p => ({
...
`;
MaterialPhoneDisabled.propTypes = {
