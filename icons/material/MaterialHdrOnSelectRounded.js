...
const MaterialHdrOnSelectRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrOnSelectRounded = (styled.default || styled)(MaterialHdrOnSelectRoundedSvg).attrs(p => ({
...
`;
MaterialHdrOnSelectRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialHdrOnSelectRounded;