...
const MaterialFaceRetouchingOffOutlinedSvg = props => (
  <svg
...
const MaterialFaceRetouchingOffOutlined = props => <Icon as={MaterialFaceRetouchingOffOutlinedSvg} {...props} />

MaterialFaceRetouchingOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFaceRetouchingOffOutlined.propTypes = { ...Icon.propTypes }
