...
const MaterialWbTwilightOutlinedSvg = props => (
  <svg
...
const MaterialWbTwilightOutlined = props => <Icon as={MaterialWbTwilightOutlinedSvg} {...props} />

MaterialWbTwilightOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWbTwilightOutlined.propTypes = { ...Icon.propTypes }
