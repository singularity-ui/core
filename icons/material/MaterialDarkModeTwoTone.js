...
const MaterialDarkModeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDarkModeTwoTone = (styled.default || styled)(MaterialDarkModeTwoToneSvg).attrs(p => ({
...
`;
MaterialDarkModeTwoTone.propTypes = {
