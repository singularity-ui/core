...
const MaterialNfc = props => <Icon as={MaterialNfcSvg} {...props} />

MaterialNfc.defaultProps = { ...Icon.defaultProps }

MaterialNfc.propTypes = { ...Icon.propTypes }

export default MaterialNfc
