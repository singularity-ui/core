...
const MaterialPermCameraMicSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPermCameraMic = (styled.default || styled)(MaterialPermCameraMicSvg).attrs(p => ({
...
`;
MaterialPermCameraMic.propTypes = {
