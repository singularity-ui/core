...
const MaterialAutoDeleteTwoToneSvg = props => (
  <svg
...
const MaterialAutoDeleteTwoTone = props => <Icon as={MaterialAutoDeleteTwoToneSvg} {...props} />

MaterialAutoDeleteTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialAutoDeleteTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialAutoDeleteTwoTone
