...
const MaterialPetsOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPetsOutlined = (styled.default || styled)(MaterialPetsOutlinedSvg).attrs(p => ({
...
`;
MaterialPetsOutlined.propTypes = {
