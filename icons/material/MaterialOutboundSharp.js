...
const MaterialOutboundSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOutboundSharp = (styled.default || styled)(MaterialOutboundSharpSvg).attrs(p => ({
...
`;
MaterialOutboundSharp.propTypes = {
