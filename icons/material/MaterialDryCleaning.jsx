...
const MaterialDryCleaningSvg = props => (
  <svg
...
const MaterialDryCleaning = props => <Icon as={MaterialDryCleaningSvg} {...props} />

MaterialDryCleaning.defaultProps = { ...Icon.defaultProps }

MaterialDryCleaning.propTypes = { ...Icon.propTypes }

export default MaterialDryCleaning
