...
const MaterialEditOffTwoToneSvg = props => (
  <svg
...
const MaterialEditOffTwoTone = props => <Icon as={MaterialEditOffTwoToneSvg} {...props} />

MaterialEditOffTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialEditOffTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialEditOffTwoTone
