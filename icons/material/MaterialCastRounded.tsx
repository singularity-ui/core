...
const MaterialCastRoundedSvg = props => (
...
const MaterialCastRounded = props => <Icon as={MaterialCastRoundedSvg} {...props} />

MaterialCastRounded.defaultProps = { ...Icon.defaultProps }

MaterialCastRounded.propTypes = { ...Icon.propTypes }
