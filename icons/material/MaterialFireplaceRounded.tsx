...
const MaterialFireplaceRoundedSvg = props => (
  <svg
...
const MaterialFireplaceRounded = props => <Icon as={MaterialFireplaceRoundedSvg} {...props} />

MaterialFireplaceRounded.defaultProps = { ...Icon.defaultProps }

MaterialFireplaceRounded.propTypes = { ...Icon.propTypes }

export default MaterialFireplaceRounded
