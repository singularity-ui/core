...
const MaterialCallEndOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCallEndOutlined = (styled.default || styled)(MaterialCallEndOutlinedSvg).attrs(p => ({
...
`;
MaterialCallEndOutlined.propTypes = {
