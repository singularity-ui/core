...
const MaterialWorkspacesOutlinedSvg = props => (
  <svg
...
const MaterialWorkspacesOutlined = props => <Icon as={MaterialWorkspacesOutlinedSvg} {...props} />

MaterialWorkspacesOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWorkspacesOutlined.propTypes = { ...Icon.propTypes }
