...
const MaterialTwoKPlusSvg = props => (
...
const MaterialTwoKPlus = props => <Icon as={MaterialTwoKPlusSvg} {...props} />

MaterialTwoKPlus.defaultProps = { ...Icon.defaultProps }

MaterialTwoKPlus.propTypes = { ...Icon.propTypes }
