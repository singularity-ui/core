...
const MaterialEvStationRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEvStationRounded = (styled.default || styled)(MaterialEvStationRoundedSvg).attrs(p => ({
...
`;
MaterialEvStationRounded.propTypes = {
