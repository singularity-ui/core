...
const MaterialEmojiObjectsSvg = props => (
  <svg
...
const MaterialEmojiObjects = props => <Icon as={MaterialEmojiObjectsSvg} {...props} />

MaterialEmojiObjects.defaultProps = { ...Icon.defaultProps }

MaterialEmojiObjects.propTypes = { ...Icon.propTypes }

export default MaterialEmojiObjects
