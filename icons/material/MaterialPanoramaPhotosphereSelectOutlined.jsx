...
const MaterialPanoramaPhotosphereSelectOutlinedSvg = props => (
  <svg
...
const MaterialPanoramaPhotosphereSelectOutlined = props => (
  <Icon as={MaterialPanoramaPhotosphereSelectOutlinedSvg} {...props} />
)

MaterialPanoramaPhotosphereSelectOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPanoramaPhotosphereSelectOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPanoramaPhotosphereSelectOutlined
