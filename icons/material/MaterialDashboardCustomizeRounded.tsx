...
const MaterialDashboardCustomizeRoundedSvg = props => (
  <svg
...
const MaterialDashboardCustomizeRounded = props => <Icon as={MaterialDashboardCustomizeRoundedSvg} {...props} />

MaterialDashboardCustomizeRounded.defaultProps = { ...Icon.defaultProps }

MaterialDashboardCustomizeRounded.propTypes = { ...Icon.propTypes }
