...
const MaterialVrpanoRoundedSvg = props => (
  <svg
...
const MaterialVrpanoRounded = props => <Icon as={MaterialVrpanoRoundedSvg} {...props} />

MaterialVrpanoRounded.defaultProps = { ...Icon.defaultProps }

MaterialVrpanoRounded.propTypes = { ...Icon.propTypes }
