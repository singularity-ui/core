...
const MaterialRouterRoundedSvg = props => (
...
const MaterialRouterRounded = props => <Icon as={MaterialRouterRoundedSvg} {...props} />

MaterialRouterRounded.defaultProps = { ...Icon.defaultProps }

MaterialRouterRounded.propTypes = { ...Icon.propTypes }

export default MaterialRouterRounded
