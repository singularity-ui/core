...
const MaterialDialpadSharpSvg = props => (
...
const MaterialDialpadSharp = props => <Icon as={MaterialDialpadSharpSvg} {...props} />

MaterialDialpadSharp.defaultProps = { ...Icon.defaultProps }

MaterialDialpadSharp.propTypes = { ...Icon.propTypes }

export default MaterialDialpadSharp
