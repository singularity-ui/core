...
const MaterialSanitizerTwoToneSvg = props => (
  <svg
...
const MaterialSanitizerTwoTone = props => <Icon as={MaterialSanitizerTwoToneSvg} {...props} />

MaterialSanitizerTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSanitizerTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSanitizerTwoTone
