...
const MaterialWbAutoRoundedSvg = props => (
...
const MaterialWbAutoRounded = props => <Icon as={MaterialWbAutoRoundedSvg} {...props} />

MaterialWbAutoRounded.defaultProps = { ...Icon.defaultProps }

MaterialWbAutoRounded.propTypes = { ...Icon.propTypes }
