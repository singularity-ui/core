...
const MaterialSickOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSickOutlined = (styled.default || styled)(MaterialSickOutlinedSvg).attrs(p => ({
...
`;
MaterialSickOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSickOutlined;