...
const MaterialCreditScoreSvg = props => (
  <svg
...
const MaterialCreditScore = props => <Icon as={MaterialCreditScoreSvg} {...props} />

MaterialCreditScore.defaultProps = { ...Icon.defaultProps }

MaterialCreditScore.propTypes = { ...Icon.propTypes }
