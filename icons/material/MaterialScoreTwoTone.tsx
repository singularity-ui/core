...
const MaterialScoreTwoToneSvg = props => (
...
const MaterialScoreTwoTone = props => <Icon as={MaterialScoreTwoToneSvg} {...props} />

MaterialScoreTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialScoreTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialScoreTwoTone
