...
const MaterialStormOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStormOutlined = (styled.default || styled)(MaterialStormOutlinedSvg).attrs(p => ({
...
`;
MaterialStormOutlined.propTypes = {
