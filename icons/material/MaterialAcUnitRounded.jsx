...
const MaterialAcUnitRoundedSvg = props => (
...
const MaterialAcUnitRounded = props => <Icon as={MaterialAcUnitRoundedSvg} {...props} />

MaterialAcUnitRounded.defaultProps = { ...Icon.defaultProps }

MaterialAcUnitRounded.propTypes = { ...Icon.propTypes }
