...
const MaterialPersonOffOutlinedSvg = props => (
  <svg
...
const MaterialPersonOffOutlined = props => <Icon as={MaterialPersonOffOutlinedSvg} {...props} />

MaterialPersonOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPersonOffOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPersonOffOutlined
