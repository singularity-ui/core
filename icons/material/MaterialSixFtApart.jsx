...
const MaterialSixFtApartSvg = props => (
  <svg
...
const MaterialSixFtApart = props => <Icon as={MaterialSixFtApartSvg} {...props} />

MaterialSixFtApart.defaultProps = { ...Icon.defaultProps }

MaterialSixFtApart.propTypes = { ...Icon.propTypes }

export default MaterialSixFtApart
