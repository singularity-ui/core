...
const MaterialGavelRoundedSvg = props => (
...
const MaterialGavelRounded = props => <Icon as={MaterialGavelRoundedSvg} {...props} />

MaterialGavelRounded.defaultProps = { ...Icon.defaultProps }

MaterialGavelRounded.propTypes = { ...Icon.propTypes }
