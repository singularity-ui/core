...
const MaterialSanitizerSharpSvg = props => (
  <svg
...
const MaterialSanitizerSharp = props => <Icon as={MaterialSanitizerSharpSvg} {...props} />

MaterialSanitizerSharp.defaultProps = { ...Icon.defaultProps }

MaterialSanitizerSharp.propTypes = { ...Icon.propTypes }
