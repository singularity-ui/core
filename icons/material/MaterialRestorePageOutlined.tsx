...
const MaterialRestorePageOutlinedSvg = props => (
...
const MaterialRestorePageOutlined = props => <Icon as={MaterialRestorePageOutlinedSvg} {...props} />

MaterialRestorePageOutlined.defaultProps = { ...Icon.defaultProps }

MaterialRestorePageOutlined.propTypes = { ...Icon.propTypes }
