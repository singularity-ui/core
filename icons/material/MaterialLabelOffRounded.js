...
const MaterialLabelOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLabelOffRounded = (styled.default || styled)(MaterialLabelOffRoundedSvg).attrs(p => ({
...
`;
MaterialLabelOffRounded.propTypes = {
