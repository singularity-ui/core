...
const MaterialSixKPlusSvg = props => (
...
const MaterialSixKPlus = props => <Icon as={MaterialSixKPlusSvg} {...props} />

MaterialSixKPlus.defaultProps = { ...Icon.defaultProps }

MaterialSixKPlus.propTypes = { ...Icon.propTypes }

export default MaterialSixKPlus
