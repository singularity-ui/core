...
const MaterialLocalFireDepartmentSharpSvg = props => (
  <svg
...
const MaterialLocalFireDepartmentSharp = props => <Icon as={MaterialLocalFireDepartmentSharpSvg} {...props} />

MaterialLocalFireDepartmentSharp.defaultProps = { ...Icon.defaultProps }

MaterialLocalFireDepartmentSharp.propTypes = { ...Icon.propTypes }

export default MaterialLocalFireDepartmentSharp
