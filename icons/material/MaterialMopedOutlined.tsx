...
const MaterialMopedOutlinedSvg = props => (
  <svg
...
const MaterialMopedOutlined = props => <Icon as={MaterialMopedOutlinedSvg} {...props} />

MaterialMopedOutlined.defaultProps = { ...Icon.defaultProps }

MaterialMopedOutlined.propTypes = { ...Icon.propTypes }

export default MaterialMopedOutlined
