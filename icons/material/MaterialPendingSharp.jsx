...
const MaterialPendingSharpSvg = props => (
  <svg
...
const MaterialPendingSharp = props => <Icon as={MaterialPendingSharpSvg} {...props} />

MaterialPendingSharp.defaultProps = { ...Icon.defaultProps }

MaterialPendingSharp.propTypes = { ...Icon.propTypes }
