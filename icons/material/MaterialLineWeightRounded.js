...
const MaterialLineWeightRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLineWeightRounded = (styled.default || styled)(MaterialLineWeightRoundedSvg).attrs(p => ({
...
`;
MaterialLineWeightRounded.propTypes = {
