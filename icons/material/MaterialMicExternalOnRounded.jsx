...
const MaterialMicExternalOnRoundedSvg = props => (
  <svg
...
const MaterialMicExternalOnRounded = props => <Icon as={MaterialMicExternalOnRoundedSvg} {...props} />

MaterialMicExternalOnRounded.defaultProps = { ...Icon.defaultProps }

MaterialMicExternalOnRounded.propTypes = { ...Icon.propTypes }
