...
const MaterialBrokenImageTwoToneSvg = props => (
...
const MaterialBrokenImageTwoTone = props => <Icon as={MaterialBrokenImageTwoToneSvg} {...props} />

MaterialBrokenImageTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBrokenImageTwoTone.propTypes = { ...Icon.propTypes }
