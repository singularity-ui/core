...
const MaterialSd = props => <Icon as={MaterialSdSvg} {...props} />

MaterialSd.defaultProps = { ...Icon.defaultProps }

MaterialSd.propTypes = { ...Icon.propTypes }
