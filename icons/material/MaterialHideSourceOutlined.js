...
const MaterialHideSourceOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHideSourceOutlined = (styled.default || styled)(MaterialHideSourceOutlinedSvg).attrs(p => ({
...
`;
MaterialHideSourceOutlined.propTypes = {
