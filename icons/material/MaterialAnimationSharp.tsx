...
const MaterialAnimationSharpSvg = props => (
  <svg
...
const MaterialAnimationSharp = props => <Icon as={MaterialAnimationSharpSvg} {...props} />

MaterialAnimationSharp.defaultProps = { ...Icon.defaultProps }

MaterialAnimationSharp.propTypes = { ...Icon.propTypes }

export default MaterialAnimationSharp
