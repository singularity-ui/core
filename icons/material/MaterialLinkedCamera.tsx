...
const MaterialLinkedCameraSvg = props => (
...
const MaterialLinkedCamera = props => <Icon as={MaterialLinkedCameraSvg} {...props} />

MaterialLinkedCamera.defaultProps = { ...Icon.defaultProps }

MaterialLinkedCamera.propTypes = { ...Icon.propTypes }

export default MaterialLinkedCamera
