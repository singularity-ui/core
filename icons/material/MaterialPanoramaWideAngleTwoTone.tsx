...
const MaterialPanoramaWideAngleTwoToneSvg = props => (
...
const MaterialPanoramaWideAngleTwoTone = props => <Icon as={MaterialPanoramaWideAngleTwoToneSvg} {...props} />

MaterialPanoramaWideAngleTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPanoramaWideAngleTwoTone.propTypes = { ...Icon.propTypes }
