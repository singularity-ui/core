...
const MaterialLocalDrinkOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalDrinkOutlined = (styled.default || styled)(MaterialLocalDrinkOutlinedSvg).attrs(p => ({
...
`;
MaterialLocalDrinkOutlined.propTypes = {
