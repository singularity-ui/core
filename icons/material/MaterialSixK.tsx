...
const MaterialSixK = props => <Icon as={MaterialSixKSvg} {...props} />

MaterialSixK.defaultProps = { ...Icon.defaultProps }

MaterialSixK.propTypes = { ...Icon.propTypes }

export default MaterialSixK
