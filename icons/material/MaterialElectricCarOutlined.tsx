...
const MaterialElectricCarOutlinedSvg = props => (
  <svg
...
const MaterialElectricCarOutlined = props => <Icon as={MaterialElectricCarOutlinedSvg} {...props} />

MaterialElectricCarOutlined.defaultProps = { ...Icon.defaultProps }

MaterialElectricCarOutlined.propTypes = { ...Icon.propTypes }
