...
const MaterialLockClockOutlinedSvg = props => (
  <svg
...
const MaterialLockClockOutlined = props => <Icon as={MaterialLockClockOutlinedSvg} {...props} />

MaterialLockClockOutlined.defaultProps = { ...Icon.defaultProps }

MaterialLockClockOutlined.propTypes = { ...Icon.propTypes }

export default MaterialLockClockOutlined
