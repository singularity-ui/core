...
const MaterialLensBlurTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLensBlurTwoTone = (styled.default || styled)(MaterialLensBlurTwoToneSvg).attrs(p => ({
...
`;
MaterialLensBlurTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialLensBlurTwoTone;