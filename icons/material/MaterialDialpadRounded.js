...
const MaterialDialpadRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDialpadRounded = (styled.default || styled)(MaterialDialpadRoundedSvg).attrs(p => ({
...
`;
MaterialDialpadRounded.propTypes = {
