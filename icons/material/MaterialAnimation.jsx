...
const MaterialAnimationSvg = props => (
...
const MaterialAnimation = props => <Icon as={MaterialAnimationSvg} {...props} />

MaterialAnimation.defaultProps = { ...Icon.defaultProps }

MaterialAnimation.propTypes = { ...Icon.propTypes }
