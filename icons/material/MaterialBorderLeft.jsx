...
const MaterialBorderLeftSvg = props => (
...
const MaterialBorderLeft = props => <Icon as={MaterialBorderLeftSvg} {...props} />

MaterialBorderLeft.defaultProps = { ...Icon.defaultProps }

MaterialBorderLeft.propTypes = { ...Icon.propTypes }

export default MaterialBorderLeft
