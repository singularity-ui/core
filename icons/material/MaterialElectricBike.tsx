...
const MaterialElectricBikeSvg = props => (
  <svg
...
const MaterialElectricBike = props => <Icon as={MaterialElectricBikeSvg} {...props} />

MaterialElectricBike.defaultProps = { ...Icon.defaultProps }

MaterialElectricBike.propTypes = { ...Icon.propTypes }

export default MaterialElectricBike
