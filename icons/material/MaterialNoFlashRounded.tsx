...
const MaterialNoFlashRoundedSvg = props => (
  <svg
...
const MaterialNoFlashRounded = props => <Icon as={MaterialNoFlashRoundedSvg} {...props} />

MaterialNoFlashRounded.defaultProps = { ...Icon.defaultProps }

MaterialNoFlashRounded.propTypes = { ...Icon.propTypes }
