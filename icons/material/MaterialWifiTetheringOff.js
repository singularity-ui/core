...
const MaterialWifiTetheringOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWifiTetheringOff = (styled.default || styled)(MaterialWifiTetheringOffSvg).attrs(p => ({
...
`;
MaterialWifiTetheringOff.propTypes = {
