...
const MaterialSanitizerSvg = props => (
  <svg
...
const MaterialSanitizer = props => <Icon as={MaterialSanitizerSvg} {...props} />

MaterialSanitizer.defaultProps = { ...Icon.defaultProps }

MaterialSanitizer.propTypes = { ...Icon.propTypes }

export default MaterialSanitizer
