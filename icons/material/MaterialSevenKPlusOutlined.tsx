...
const MaterialSevenKPlusOutlinedSvg = props => (
  <svg
...
const MaterialSevenKPlusOutlined = props => <Icon as={MaterialSevenKPlusOutlinedSvg} {...props} />

MaterialSevenKPlusOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSevenKPlusOutlined.propTypes = { ...Icon.propTypes }
