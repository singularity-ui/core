...
const MaterialLooksThreeRoundedSvg = props => (
...
const MaterialLooksThreeRounded = props => <Icon as={MaterialLooksThreeRoundedSvg} {...props} />

MaterialLooksThreeRounded.defaultProps = { ...Icon.defaultProps }

MaterialLooksThreeRounded.propTypes = { ...Icon.propTypes }
