...
const MaterialSocialDistanceSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSocialDistance = (styled.default || styled)(MaterialSocialDistanceSvg).attrs(p => ({
...
`;
MaterialSocialDistance.propTypes = {
