...
const MaterialLocalAirportRoundedSvg = props => (
  <svg
...
const MaterialLocalAirportRounded = props => <Icon as={MaterialLocalAirportRoundedSvg} {...props} />

MaterialLocalAirportRounded.defaultProps = { ...Icon.defaultProps }

MaterialLocalAirportRounded.propTypes = { ...Icon.propTypes }
