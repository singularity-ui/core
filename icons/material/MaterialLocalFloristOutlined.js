...
const MaterialLocalFloristOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalFloristOutlined = (styled.default || styled)(MaterialLocalFloristOutlinedSvg).attrs(p => ({
...
`;
MaterialLocalFloristOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialLocalFloristOutlined;