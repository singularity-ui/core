...
const MaterialWheelchairPickupSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWheelchairPickup = (styled.default || styled)(MaterialWheelchairPickupSvg).attrs(p => ({
...
`;
MaterialWheelchairPickup.propTypes = {
