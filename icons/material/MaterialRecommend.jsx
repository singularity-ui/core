...
const MaterialRecommendSvg = props => (
...
const MaterialRecommend = props => <Icon as={MaterialRecommendSvg} {...props} />

MaterialRecommend.defaultProps = { ...Icon.defaultProps }

MaterialRecommend.propTypes = { ...Icon.propTypes }
