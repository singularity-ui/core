...
const MaterialEarbudsSvg = props => (
  <svg
...
const MaterialEarbuds = props => <Icon as={MaterialEarbudsSvg} {...props} />

MaterialEarbuds.defaultProps = { ...Icon.defaultProps }

MaterialEarbuds.propTypes = { ...Icon.propTypes }

export default MaterialEarbuds
