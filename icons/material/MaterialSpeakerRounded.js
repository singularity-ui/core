...
const MaterialSpeakerRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSpeakerRounded = (styled.default || styled)(MaterialSpeakerRoundedSvg).attrs(p => ({
...
`;
MaterialSpeakerRounded.propTypes = {
