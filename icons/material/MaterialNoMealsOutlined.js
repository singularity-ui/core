...
const MaterialNoMealsOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoMealsOutlined = (styled.default || styled)(MaterialNoMealsOutlinedSvg).attrs(p => ({
...
`;
MaterialNoMealsOutlined.propTypes = {
