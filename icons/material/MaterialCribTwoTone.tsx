...
const MaterialCribTwoToneSvg = props => (
  <svg
...
const MaterialCribTwoTone = props => <Icon as={MaterialCribTwoToneSvg} {...props} />

MaterialCribTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCribTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialCribTwoTone
