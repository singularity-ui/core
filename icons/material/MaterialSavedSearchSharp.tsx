...
const MaterialSavedSearchSharpSvg = props => (
  <svg
...
const MaterialSavedSearchSharp = props => <Icon as={MaterialSavedSearchSharpSvg} {...props} />

MaterialSavedSearchSharp.defaultProps = { ...Icon.defaultProps }

MaterialSavedSearchSharp.propTypes = { ...Icon.propTypes }

export default MaterialSavedSearchSharp
