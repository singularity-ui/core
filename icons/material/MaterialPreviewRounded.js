...
const MaterialPreviewRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPreviewRounded = (styled.default || styled)(MaterialPreviewRoundedSvg).attrs(p => ({
...
`;
MaterialPreviewRounded.propTypes = {
