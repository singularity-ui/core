...
const MaterialMyLocationTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMyLocationTwoTone = (styled.default || styled)(MaterialMyLocationTwoToneSvg).attrs(p => ({
...
`;
MaterialMyLocationTwoTone.propTypes = {
