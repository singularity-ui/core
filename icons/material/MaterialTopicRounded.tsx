...
const MaterialTopicRoundedSvg = props => (
  <svg
...
const MaterialTopicRounded = props => <Icon as={MaterialTopicRoundedSvg} {...props} />

MaterialTopicRounded.defaultProps = { ...Icon.defaultProps }

MaterialTopicRounded.propTypes = { ...Icon.propTypes }

export default MaterialTopicRounded
