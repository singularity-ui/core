...
const MaterialBookOnlineTwoToneSvg = props => (
  <svg
...
const MaterialBookOnlineTwoTone = props => <Icon as={MaterialBookOnlineTwoToneSvg} {...props} />

MaterialBookOnlineTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBookOnlineTwoTone.propTypes = { ...Icon.propTypes }
