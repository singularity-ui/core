...
const MaterialExpandRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialExpandRounded = (styled.default || styled)(MaterialExpandRoundedSvg).attrs(p => ({
...
`;
MaterialExpandRounded.propTypes = {
