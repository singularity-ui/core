...
const MaterialDryOutlinedSvg = props => (
  <svg
...
const MaterialDryOutlined = props => <Icon as={MaterialDryOutlinedSvg} {...props} />

MaterialDryOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDryOutlined.propTypes = { ...Icon.propTypes }

export default MaterialDryOutlined
