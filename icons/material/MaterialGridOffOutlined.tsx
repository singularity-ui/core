...
const MaterialGridOffOutlinedSvg = props => (
...
const MaterialGridOffOutlined = props => <Icon as={MaterialGridOffOutlinedSvg} {...props} />

MaterialGridOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialGridOffOutlined.propTypes = { ...Icon.propTypes }

export default MaterialGridOffOutlined
