...
const MaterialAddToPhotosRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddToPhotosRounded = (styled.default || styled)(MaterialAddToPhotosRoundedSvg).attrs(p => ({
...
`;
MaterialAddToPhotosRounded.propTypes = {
