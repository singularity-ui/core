...
const MaterialSmartToyRoundedSvg = props => (
  <svg
...
const MaterialSmartToyRounded = props => <Icon as={MaterialSmartToyRoundedSvg} {...props} />

MaterialSmartToyRounded.defaultProps = { ...Icon.defaultProps }

MaterialSmartToyRounded.propTypes = { ...Icon.propTypes }

export default MaterialSmartToyRounded
