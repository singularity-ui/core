...
const MaterialElectricBikeRoundedSvg = props => (
  <svg
...
const MaterialElectricBikeRounded = props => <Icon as={MaterialElectricBikeRoundedSvg} {...props} />

MaterialElectricBikeRounded.defaultProps = { ...Icon.defaultProps }

MaterialElectricBikeRounded.propTypes = { ...Icon.propTypes }
