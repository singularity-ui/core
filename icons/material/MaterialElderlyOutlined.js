...
const MaterialElderlyOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElderlyOutlined = (styled.default || styled)(MaterialElderlyOutlinedSvg).attrs(p => ({
...
`;
MaterialElderlyOutlined.propTypes = {
