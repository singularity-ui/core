...
const MaterialPedalBikeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPedalBikeTwoTone = (styled.default || styled)(MaterialPedalBikeTwoToneSvg).attrs(p => ({
...
`;
MaterialPedalBikeTwoTone.propTypes = {
