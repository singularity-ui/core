...
const MaterialDirectionsSubwaySvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDirectionsSubway = (styled.default || styled)(MaterialDirectionsSubwaySvg).attrs(p => ({
...
`;
MaterialDirectionsSubway.propTypes = {
