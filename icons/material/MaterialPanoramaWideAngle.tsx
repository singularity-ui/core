...
const MaterialPanoramaWideAngleSvg = props => (
...
const MaterialPanoramaWideAngle = props => <Icon as={MaterialPanoramaWideAngleSvg} {...props} />

MaterialPanoramaWideAngle.defaultProps = { ...Icon.defaultProps }

MaterialPanoramaWideAngle.propTypes = { ...Icon.propTypes }

export default MaterialPanoramaWideAngle
