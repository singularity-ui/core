...
const MaterialDiningOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDiningOutlined = (styled.default || styled)(MaterialDiningOutlinedSvg).attrs(p => ({
...
`;
MaterialDiningOutlined.propTypes = {
