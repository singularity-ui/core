...
const MaterialSdRoundedSvg = props => (
  <svg
...
const MaterialSdRounded = props => <Icon as={MaterialSdRoundedSvg} {...props} />

MaterialSdRounded.defaultProps = { ...Icon.defaultProps }

MaterialSdRounded.propTypes = { ...Icon.propTypes }
