...
const MaterialSpeedTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSpeedTwoTone = (styled.default || styled)(MaterialSpeedTwoToneSvg).attrs(p => ({
...
`;
MaterialSpeedTwoTone.propTypes = {
