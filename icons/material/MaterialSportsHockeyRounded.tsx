...
const MaterialSportsHockeyRoundedSvg = props => (
  <svg
...
const MaterialSportsHockeyRounded = props => <Icon as={MaterialSportsHockeyRoundedSvg} {...props} />

MaterialSportsHockeyRounded.defaultProps = { ...Icon.defaultProps }

MaterialSportsHockeyRounded.propTypes = { ...Icon.propTypes }

export default MaterialSportsHockeyRounded
