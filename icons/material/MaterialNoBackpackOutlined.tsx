...
const MaterialNoBackpackOutlinedSvg = props => (
  <svg
...
const MaterialNoBackpackOutlined = props => <Icon as={MaterialNoBackpackOutlinedSvg} {...props} />

MaterialNoBackpackOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNoBackpackOutlined.propTypes = { ...Icon.propTypes }

export default MaterialNoBackpackOutlined
