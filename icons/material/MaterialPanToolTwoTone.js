...
const MaterialPanToolTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPanToolTwoTone = (styled.default || styled)(MaterialPanToolTwoToneSvg).attrs(p => ({
...
`;
MaterialPanToolTwoTone.propTypes = {
