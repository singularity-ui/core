...
const MaterialWifiCallingTwoToneSvg = props => (
  <svg
...
const MaterialWifiCallingTwoTone = props => <Icon as={MaterialWifiCallingTwoToneSvg} {...props} />

MaterialWifiCallingTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialWifiCallingTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialWifiCallingTwoTone
