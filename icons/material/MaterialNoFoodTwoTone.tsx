...
const MaterialNoFoodTwoToneSvg = props => (
  <svg
...
const MaterialNoFoodTwoTone = props => <Icon as={MaterialNoFoodTwoToneSvg} {...props} />

MaterialNoFoodTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialNoFoodTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialNoFoodTwoTone
