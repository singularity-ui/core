...
const MaterialFilterTiltShiftRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFilterTiltShiftRounded = (styled.default || styled)(MaterialFilterTiltShiftRoundedSvg).attrs(p => ({
...
`;
MaterialFilterTiltShiftRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFilterTiltShiftRounded;