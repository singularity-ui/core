...
const MaterialDownloadingOutlinedSvg = props => (
  <svg
...
const MaterialDownloadingOutlined = props => <Icon as={MaterialDownloadingOutlinedSvg} {...props} />

MaterialDownloadingOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDownloadingOutlined.propTypes = { ...Icon.propTypes }

export default MaterialDownloadingOutlined
