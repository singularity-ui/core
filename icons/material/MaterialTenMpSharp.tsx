...
const MaterialTenMpSharpSvg = props => (
  <svg
...
const MaterialTenMpSharp = props => <Icon as={MaterialTenMpSharpSvg} {...props} />

MaterialTenMpSharp.defaultProps = { ...Icon.defaultProps }

MaterialTenMpSharp.propTypes = { ...Icon.propTypes }
