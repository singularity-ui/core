...
const MaterialSyncProblemRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSyncProblemRounded = (styled.default || styled)(MaterialSyncProblemRoundedSvg).attrs(p => ({
...
`;
MaterialSyncProblemRounded.propTypes = {
