...
const MaterialSpeakerPhoneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSpeakerPhone = (styled.default || styled)(MaterialSpeakerPhoneSvg).attrs(p => ({
...
`;
MaterialSpeakerPhone.propTypes = {
