...
const MaterialRoomPreferencesSharpSvg = props => (
  <svg
...
const MaterialRoomPreferencesSharp = props => <Icon as={MaterialRoomPreferencesSharpSvg} {...props} />

MaterialRoomPreferencesSharp.defaultProps = { ...Icon.defaultProps }

MaterialRoomPreferencesSharp.propTypes = { ...Icon.propTypes }
