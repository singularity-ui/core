...
const MaterialPhotoLibrarySvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhotoLibrary = (styled.default || styled)(MaterialPhotoLibrarySvg).attrs(p => ({
...
`;
MaterialPhotoLibrary.propTypes = {
