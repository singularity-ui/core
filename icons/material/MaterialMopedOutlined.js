...
const MaterialMopedOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMopedOutlined = (styled.default || styled)(MaterialMopedOutlinedSvg).attrs(p => ({
...
`;
MaterialMopedOutlined.propTypes = {
