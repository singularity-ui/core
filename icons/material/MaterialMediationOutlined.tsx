...
const MaterialMediationOutlinedSvg = props => (
  <svg
...
const MaterialMediationOutlined = props => <Icon as={MaterialMediationOutlinedSvg} {...props} />

MaterialMediationOutlined.defaultProps = { ...Icon.defaultProps }

MaterialMediationOutlined.propTypes = { ...Icon.propTypes }
