...
const MaterialAlarmTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmTwoTone = (styled.default || styled)(MaterialAlarmTwoToneSvg).attrs(p => ({
...
`;
MaterialAlarmTwoTone.propTypes = {
