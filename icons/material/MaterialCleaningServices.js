...
const MaterialCleaningServicesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCleaningServices = (styled.default || styled)(MaterialCleaningServicesSvg).attrs(p => ({
...
`;
MaterialCleaningServices.propTypes = {
