...
const MaterialDevicesOtherSvg = props => (
...
const MaterialDevicesOther = props => <Icon as={MaterialDevicesOtherSvg} {...props} />

MaterialDevicesOther.defaultProps = { ...Icon.defaultProps }

MaterialDevicesOther.propTypes = { ...Icon.propTypes }

export default MaterialDevicesOther
