...
const MaterialTram = props => <Icon as={MaterialTramSvg} {...props} />

MaterialTram.defaultProps = { ...Icon.defaultProps }

MaterialTram.propTypes = { ...Icon.propTypes }

export default MaterialTram
