...
const MaterialLeakRemoveSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLeakRemoveSharp = (styled.default || styled)(MaterialLeakRemoveSharpSvg).attrs(p => ({
...
`;
MaterialLeakRemoveSharp.propTypes = {
