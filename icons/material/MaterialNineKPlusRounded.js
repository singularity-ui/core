...
const MaterialNineKPlusRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialNineKPlusRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialNineKPlusRounded;