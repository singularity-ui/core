...
const MaterialLocalSeeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalSeeTwoTone = (styled.default || styled)(MaterialLocalSeeTwoToneSvg).attrs(p => ({
...
`;
MaterialLocalSeeTwoTone.propTypes = {
