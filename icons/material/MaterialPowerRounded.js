...
const MaterialPowerRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPowerRounded = (styled.default || styled)(MaterialPowerRoundedSvg).attrs(p => ({
...
`;
MaterialPowerRounded.propTypes = {
