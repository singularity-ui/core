...
const MaterialPatternOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPatternOutlined = (styled.default || styled)(MaterialPatternOutlinedSvg).attrs(p => ({
...
`;
MaterialPatternOutlined.propTypes = {
