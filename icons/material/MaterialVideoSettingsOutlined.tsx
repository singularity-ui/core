...
const MaterialVideoSettingsOutlinedSvg = props => (
  <svg
...
const MaterialVideoSettingsOutlined = props => <Icon as={MaterialVideoSettingsOutlinedSvg} {...props} />

MaterialVideoSettingsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialVideoSettingsOutlined.propTypes = { ...Icon.propTypes }

export default MaterialVideoSettingsOutlined
