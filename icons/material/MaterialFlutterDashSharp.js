...
const MaterialFlutterDashSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlutterDashSharp = (styled.default || styled)(MaterialFlutterDashSharpSvg).attrs(p => ({
...
`;
MaterialFlutterDashSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFlutterDashSharp;