...
const MaterialAltRouteOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAltRouteOutlined = (styled.default || styled)(MaterialAltRouteOutlinedSvg).attrs(p => ({
...
`;
MaterialAltRouteOutlined.propTypes = {
