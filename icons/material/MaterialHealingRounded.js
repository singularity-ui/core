...
const MaterialHealingRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHealingRounded = (styled.default || styled)(MaterialHealingRoundedSvg).attrs(p => ({
...
`;
MaterialHealingRounded.propTypes = {
