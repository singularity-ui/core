...
const MaterialFilterTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFilterTwoTone = (styled.default || styled)(MaterialFilterTwoToneSvg).attrs(p => ({
...
`;
MaterialFilterTwoTone.propTypes = {
