...
const MaterialFaceRoundedSvg = props => (
  <svg
...
const MaterialFaceRounded = props => <Icon as={MaterialFaceRoundedSvg} {...props} />

MaterialFaceRounded.defaultProps = { ...Icon.defaultProps }

MaterialFaceRounded.propTypes = { ...Icon.propTypes }
