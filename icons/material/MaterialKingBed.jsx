...
const MaterialKingBedSvg = props => (
  <svg
...
const MaterialKingBed = props => <Icon as={MaterialKingBedSvg} {...props} />

MaterialKingBed.defaultProps = { ...Icon.defaultProps }

MaterialKingBed.propTypes = { ...Icon.propTypes }
