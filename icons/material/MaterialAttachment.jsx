...
const MaterialAttachmentSvg = props => (
...
const MaterialAttachment = props => <Icon as={MaterialAttachmentSvg} {...props} />

MaterialAttachment.defaultProps = { ...Icon.defaultProps }

MaterialAttachment.propTypes = { ...Icon.propTypes }
