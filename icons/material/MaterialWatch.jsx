...
const MaterialWatch = props => <Icon as={MaterialWatchSvg} {...props} />

MaterialWatch.defaultProps = { ...Icon.defaultProps }

MaterialWatch.propTypes = { ...Icon.propTypes }

export default MaterialWatch
