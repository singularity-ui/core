...
const MaterialGpsOffSharpSvg = props => (
...
const MaterialGpsOffSharp = props => <Icon as={MaterialGpsOffSharpSvg} {...props} />

MaterialGpsOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialGpsOffSharp.propTypes = { ...Icon.propTypes }

export default MaterialGpsOffSharp
