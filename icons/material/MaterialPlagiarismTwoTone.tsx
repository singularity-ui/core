...
const MaterialPlagiarismTwoToneSvg = props => (
  <svg
...
const MaterialPlagiarismTwoTone = props => <Icon as={MaterialPlagiarismTwoToneSvg} {...props} />

MaterialPlagiarismTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPlagiarismTwoTone.propTypes = { ...Icon.propTypes }
