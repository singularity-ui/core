...
const MaterialSensorsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSensorsTwoTone = (styled.default || styled)(MaterialSensorsTwoToneSvg).attrs(p => ({
...
`;
MaterialSensorsTwoTone.propTypes = {
