...
const MaterialThreeMpSvg = props => (
...
const MaterialThreeMp = props => <Icon as={MaterialThreeMpSvg} {...props} />

MaterialThreeMp.defaultProps = { ...Icon.defaultProps }

MaterialThreeMp.propTypes = { ...Icon.propTypes }
