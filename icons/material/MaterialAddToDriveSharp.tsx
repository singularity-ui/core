...
const MaterialAddToDriveSharpSvg = props => (
  <svg
...
const MaterialAddToDriveSharp = props => <Icon as={MaterialAddToDriveSharpSvg} {...props} />

MaterialAddToDriveSharp.defaultProps = { ...Icon.defaultProps }

MaterialAddToDriveSharp.propTypes = { ...Icon.propTypes }

export default MaterialAddToDriveSharp
