...
const MaterialSleddingSvg = props => (
  <svg
...
const MaterialSledding = props => <Icon as={MaterialSleddingSvg} {...props} />

MaterialSledding.defaultProps = { ...Icon.defaultProps }

MaterialSledding.propTypes = { ...Icon.propTypes }

export default MaterialSledding
