...
const MaterialPartyModeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPartyModeTwoTone = (styled.default || styled)(MaterialPartyModeTwoToneSvg).attrs(p => ({
...
`;
MaterialPartyModeTwoTone.propTypes = {
