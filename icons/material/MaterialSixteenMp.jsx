...
const MaterialSixteenMpSvg = props => (
...
const MaterialSixteenMp = props => <Icon as={MaterialSixteenMpSvg} {...props} />

MaterialSixteenMp.defaultProps = { ...Icon.defaultProps }

MaterialSixteenMp.propTypes = { ...Icon.propTypes }

export default MaterialSixteenMp
