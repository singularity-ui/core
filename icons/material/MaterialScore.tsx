...
const MaterialScore = props => <Icon as={MaterialScoreSvg} {...props} />

MaterialScore.defaultProps = { ...Icon.defaultProps }

MaterialScore.propTypes = { ...Icon.propTypes }
