...
const MaterialRailwayAlertSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRailwayAlertSharp = (styled.default || styled)(MaterialRailwayAlertSharpSvg).attrs(p => ({
...
`;
MaterialRailwayAlertSharp.propTypes = {
