...
const MaterialNoStrollerOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoStrollerOutlined = (styled.default || styled)(MaterialNoStrollerOutlinedSvg).attrs(p => ({
...
`;
MaterialNoStrollerOutlined.propTypes = {
