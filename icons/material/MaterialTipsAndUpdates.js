...
const MaterialTipsAndUpdatesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTipsAndUpdates = (styled.default || styled)(MaterialTipsAndUpdatesSvg).attrs(p => ({
...
`;
MaterialTipsAndUpdates.propTypes = {
