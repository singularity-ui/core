...
const MaterialBikeScooterTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBikeScooterTwoTone = (styled.default || styled)(MaterialBikeScooterTwoToneSvg).attrs(p => ({
...
`;
MaterialBikeScooterTwoTone.propTypes = {
