...
const MaterialViewInArRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialViewInArRounded = (styled.default || styled)(MaterialViewInArRoundedSvg).attrs(p => ({
...
`;
MaterialViewInArRounded.propTypes = {
