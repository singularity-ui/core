...
const MaterialFamilyRestroomSvg = props => (
  <svg
...
const MaterialFamilyRestroom = props => <Icon as={MaterialFamilyRestroomSvg} {...props} />

MaterialFamilyRestroom.defaultProps = { ...Icon.defaultProps }

MaterialFamilyRestroom.propTypes = { ...Icon.propTypes }
