...
const MaterialFlareTwoToneSvg = props => (
...
const MaterialFlareTwoTone = props => <Icon as={MaterialFlareTwoToneSvg} {...props} />

MaterialFlareTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialFlareTwoTone.propTypes = { ...Icon.propTypes }
