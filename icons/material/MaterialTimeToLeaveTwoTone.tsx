...
const MaterialTimeToLeaveTwoToneSvg = props => (
...
const MaterialTimeToLeaveTwoTone = props => <Icon as={MaterialTimeToLeaveTwoToneSvg} {...props} />

MaterialTimeToLeaveTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialTimeToLeaveTwoTone.propTypes = { ...Icon.propTypes }
