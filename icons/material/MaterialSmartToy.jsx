...
const MaterialSmartToySvg = props => (
  <svg
...
const MaterialSmartToy = props => <Icon as={MaterialSmartToySvg} {...props} />

MaterialSmartToy.defaultProps = { ...Icon.defaultProps }

MaterialSmartToy.propTypes = { ...Icon.propTypes }
