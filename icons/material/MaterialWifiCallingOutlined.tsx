...
const MaterialWifiCallingOutlinedSvg = props => (
  <svg
...
const MaterialWifiCallingOutlined = props => <Icon as={MaterialWifiCallingOutlinedSvg} {...props} />

MaterialWifiCallingOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWifiCallingOutlined.propTypes = { ...Icon.propTypes }
