...
const MaterialPeopleAltOutlinedSvg = props => (
  <svg
...
const MaterialPeopleAltOutlined = props => <Icon as={MaterialPeopleAltOutlinedSvg} {...props} />

MaterialPeopleAltOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPeopleAltOutlined.propTypes = { ...Icon.propTypes }
