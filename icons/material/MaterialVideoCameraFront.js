...
const MaterialVideoCameraFrontSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVideoCameraFront = (styled.default || styled)(MaterialVideoCameraFrontSvg).attrs(p => ({
...
`;
MaterialVideoCameraFront.propTypes = {
