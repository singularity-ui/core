...
const MaterialSummarizeSvg = props => (
  <svg
...
const MaterialSummarize = props => <Icon as={MaterialSummarizeSvg} {...props} />

MaterialSummarize.defaultProps = { ...Icon.defaultProps }

MaterialSummarize.propTypes = { ...Icon.propTypes }
