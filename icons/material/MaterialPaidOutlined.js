...
const MaterialPaidOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPaidOutlined = (styled.default || styled)(MaterialPaidOutlinedSvg).attrs(p => ({
...
`;
MaterialPaidOutlined.propTypes = {
