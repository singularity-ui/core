...
const MaterialBed = props => <Icon as={MaterialBedSvg} {...props} />

MaterialBed.defaultProps = { ...Icon.defaultProps }

MaterialBed.propTypes = { ...Icon.propTypes }
