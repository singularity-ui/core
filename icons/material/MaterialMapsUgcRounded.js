...
const MaterialMapsUgcRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMapsUgcRounded = (styled.default || styled)(MaterialMapsUgcRoundedSvg).attrs(p => ({
...
`;
MaterialMapsUgcRounded.propTypes = {
