...
const MaterialShuffleOnTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialShuffleOnTwoTone = (styled.default || styled)(MaterialShuffleOnTwoToneSvg).attrs(p => ({
...
`;
MaterialShuffleOnTwoTone.propTypes = {
