...
const MaterialSyncTwoToneSvg = props => (
...
const MaterialSyncTwoTone = props => <Icon as={MaterialSyncTwoToneSvg} {...props} />

MaterialSyncTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSyncTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSyncTwoTone
