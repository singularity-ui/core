...
const MaterialOneKPlusRoundedSvg = props => (
  <svg
...
const MaterialOneKPlusRounded = props => <Icon as={MaterialOneKPlusRoundedSvg} {...props} />

MaterialOneKPlusRounded.defaultProps = { ...Icon.defaultProps }

MaterialOneKPlusRounded.propTypes = { ...Icon.propTypes }
