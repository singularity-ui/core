...
const MaterialFiveKPlusTwoToneSvg = props => (
  <svg
...
const MaterialFiveKPlusTwoTone = props => <Icon as={MaterialFiveKPlusTwoToneSvg} {...props} />

MaterialFiveKPlusTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialFiveKPlusTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialFiveKPlusTwoTone
