...
const MaterialMovingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMovingTwoTone = (styled.default || styled)(MaterialMovingTwoToneSvg).attrs(p => ({
...
`;
MaterialMovingTwoTone.propTypes = {
