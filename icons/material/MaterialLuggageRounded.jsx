...
const MaterialLuggageRoundedSvg = props => (
  <svg
...
const MaterialLuggageRounded = props => <Icon as={MaterialLuggageRoundedSvg} {...props} />

MaterialLuggageRounded.defaultProps = { ...Icon.defaultProps }

MaterialLuggageRounded.propTypes = { ...Icon.propTypes }
