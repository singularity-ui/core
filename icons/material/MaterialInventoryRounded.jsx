...
const MaterialInventoryRoundedSvg = props => (
  <svg
...
const MaterialInventoryRounded = props => <Icon as={MaterialInventoryRoundedSvg} {...props} />

MaterialInventoryRounded.defaultProps = { ...Icon.defaultProps }

MaterialInventoryRounded.propTypes = { ...Icon.propTypes }
