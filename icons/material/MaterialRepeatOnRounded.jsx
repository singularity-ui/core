...
const MaterialRepeatOnRoundedSvg = props => (
  <svg
...
const MaterialRepeatOnRounded = props => <Icon as={MaterialRepeatOnRoundedSvg} {...props} />

MaterialRepeatOnRounded.defaultProps = { ...Icon.defaultProps }

MaterialRepeatOnRounded.propTypes = { ...Icon.propTypes }
