...
const MaterialSportsSoccerOutlinedSvg = props => (
  <svg
...
const MaterialSportsSoccerOutlined = props => <Icon as={MaterialSportsSoccerOutlinedSvg} {...props} />

MaterialSportsSoccerOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSportsSoccerOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSportsSoccerOutlined
