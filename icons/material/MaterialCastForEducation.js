...
const MaterialCastForEducationSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCastForEducation = (styled.default || styled)(MaterialCastForEducationSvg).attrs(p => ({
...
`;
MaterialCastForEducation.propTypes = {
