...
const MaterialPages = props => <Icon as={MaterialPagesSvg} {...props} />

MaterialPages.defaultProps = { ...Icon.defaultProps }

MaterialPages.propTypes = { ...Icon.propTypes }
