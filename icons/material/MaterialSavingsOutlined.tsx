...
const MaterialSavingsOutlinedSvg = props => (
  <svg
...
const MaterialSavingsOutlined = props => <Icon as={MaterialSavingsOutlinedSvg} {...props} />

MaterialSavingsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSavingsOutlined.propTypes = { ...Icon.propTypes }
