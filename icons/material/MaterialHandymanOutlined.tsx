...
const MaterialHandymanOutlinedSvg = props => (
  <svg
...
const MaterialHandymanOutlined = props => <Icon as={MaterialHandymanOutlinedSvg} {...props} />

MaterialHandymanOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHandymanOutlined.propTypes = { ...Icon.propTypes }

export default MaterialHandymanOutlined
