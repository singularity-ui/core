...
const MaterialBusAlertRoundedSvg = props => (
  <svg
...
const MaterialBusAlertRounded = props => <Icon as={MaterialBusAlertRoundedSvg} {...props} />

MaterialBusAlertRounded.defaultProps = { ...Icon.defaultProps }

MaterialBusAlertRounded.propTypes = { ...Icon.propTypes }
