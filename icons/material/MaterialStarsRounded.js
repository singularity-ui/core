...
const MaterialStarsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStarsRounded = (styled.default || styled)(MaterialStarsRoundedSvg).attrs(p => ({
...
`;
MaterialStarsRounded.propTypes = {
