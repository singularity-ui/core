...
const MaterialSensorsSharpSvg = props => (
  <svg
...
const MaterialSensorsSharp = props => <Icon as={MaterialSensorsSharpSvg} {...props} />

MaterialSensorsSharp.defaultProps = { ...Icon.defaultProps }

MaterialSensorsSharp.propTypes = { ...Icon.propTypes }

export default MaterialSensorsSharp
