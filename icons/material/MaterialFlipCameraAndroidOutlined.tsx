...
const MaterialFlipCameraAndroidOutlinedSvg = props => (
  <svg
...
const MaterialFlipCameraAndroidOutlined = props => <Icon as={MaterialFlipCameraAndroidOutlinedSvg} {...props} />

MaterialFlipCameraAndroidOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFlipCameraAndroidOutlined.propTypes = { ...Icon.propTypes }

export default MaterialFlipCameraAndroidOutlined
