...
const MaterialAlarmOnSvg = props => (
...
const MaterialAlarmOn = props => <Icon as={MaterialAlarmOnSvg} {...props} />

MaterialAlarmOn.defaultProps = { ...Icon.defaultProps }

MaterialAlarmOn.propTypes = { ...Icon.propTypes }

export default MaterialAlarmOn
