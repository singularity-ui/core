...
const MaterialHistoryEduSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHistoryEduSharp = (styled.default || styled)(MaterialHistoryEduSharpSvg).attrs(p => ({
...
`;
MaterialHistoryEduSharp.propTypes = {
