...
const MaterialShoppingBagSvg = props => (
  <svg
...
const MaterialShoppingBag = props => <Icon as={MaterialShoppingBagSvg} {...props} />

MaterialShoppingBag.defaultProps = { ...Icon.defaultProps }

MaterialShoppingBag.propTypes = { ...Icon.propTypes }

export default MaterialShoppingBag
