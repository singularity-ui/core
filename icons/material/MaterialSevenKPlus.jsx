...
const MaterialSevenKPlusSvg = props => (
...
const MaterialSevenKPlus = props => <Icon as={MaterialSevenKPlusSvg} {...props} />

MaterialSevenKPlus.defaultProps = { ...Icon.defaultProps }

MaterialSevenKPlus.propTypes = { ...Icon.propTypes }

export default MaterialSevenKPlus
