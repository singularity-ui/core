...
const MaterialThirteenMpSvg = props => (
...
const MaterialThirteenMp = props => <Icon as={MaterialThirteenMpSvg} {...props} />

MaterialThirteenMp.defaultProps = { ...Icon.defaultProps }

MaterialThirteenMp.propTypes = { ...Icon.propTypes }

export default MaterialThirteenMp
