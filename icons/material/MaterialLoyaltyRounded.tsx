...
const MaterialLoyaltyRoundedSvg = props => (
...
const MaterialLoyaltyRounded = props => <Icon as={MaterialLoyaltyRoundedSvg} {...props} />

MaterialLoyaltyRounded.defaultProps = { ...Icon.defaultProps }

MaterialLoyaltyRounded.propTypes = { ...Icon.propTypes }

export default MaterialLoyaltyRounded
