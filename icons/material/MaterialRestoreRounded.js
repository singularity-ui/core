...
const MaterialRestoreRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRestoreRounded = (styled.default || styled)(MaterialRestoreRoundedSvg).attrs(p => ({
...
`;
MaterialRestoreRounded.propTypes = {
