...
const MaterialGroupTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGroupTwoTone = (styled.default || styled)(MaterialGroupTwoToneSvg).attrs(p => ({
...
`;
MaterialGroupTwoTone.propTypes = {
