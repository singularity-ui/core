...
const MaterialGridViewRoundedSvg = props => (
  <svg
...
const MaterialGridViewRounded = props => <Icon as={MaterialGridViewRoundedSvg} {...props} />

MaterialGridViewRounded.defaultProps = { ...Icon.defaultProps }

MaterialGridViewRounded.propTypes = { ...Icon.propTypes }

export default MaterialGridViewRounded
