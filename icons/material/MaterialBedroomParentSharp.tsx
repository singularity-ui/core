...
const MaterialBedroomParentSharpSvg = props => (
  <svg
...
const MaterialBedroomParentSharp = props => <Icon as={MaterialBedroomParentSharpSvg} {...props} />

MaterialBedroomParentSharp.defaultProps = { ...Icon.defaultProps }

MaterialBedroomParentSharp.propTypes = { ...Icon.propTypes }
