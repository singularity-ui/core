...
const MaterialMenuBookSharpSvg = props => (
  <svg
...
const MaterialMenuBookSharp = props => <Icon as={MaterialMenuBookSharpSvg} {...props} />

MaterialMenuBookSharp.defaultProps = { ...Icon.defaultProps }

MaterialMenuBookSharp.propTypes = { ...Icon.propTypes }

export default MaterialMenuBookSharp
