...
const MaterialLoupeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLoupeTwoTone = (styled.default || styled)(MaterialLoupeTwoToneSvg).attrs(p => ({
...
`;
MaterialLoupeTwoTone.propTypes = {
