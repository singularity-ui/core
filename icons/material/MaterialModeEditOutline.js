...
const MaterialModeEditOutlineSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialModeEditOutline = (styled.default || styled)(MaterialModeEditOutlineSvg).attrs(p => ({
...
`;
MaterialModeEditOutline.propTypes = {
