...
const MaterialBuildCircleSharpSvg = props => (
  <svg
...
const MaterialBuildCircleSharp = props => <Icon as={MaterialBuildCircleSharpSvg} {...props} />

MaterialBuildCircleSharp.defaultProps = { ...Icon.defaultProps }

MaterialBuildCircleSharp.propTypes = { ...Icon.propTypes }
