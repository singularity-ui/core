...
const MaterialSwitchLeftRoundedSvg = props => (
  <svg
...
const MaterialSwitchLeftRounded = props => <Icon as={MaterialSwitchLeftRoundedSvg} {...props} />

MaterialSwitchLeftRounded.defaultProps = { ...Icon.defaultProps }

MaterialSwitchLeftRounded.propTypes = { ...Icon.propTypes }
