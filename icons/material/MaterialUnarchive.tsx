...
const MaterialUnarchiveSvg = props => (
  <svg
...
const MaterialUnarchive = props => <Icon as={MaterialUnarchiveSvg} {...props} />

MaterialUnarchive.defaultProps = { ...Icon.defaultProps }

MaterialUnarchive.propTypes = { ...Icon.propTypes }
