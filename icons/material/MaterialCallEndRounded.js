...
const MaterialCallEndRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCallEndRounded = (styled.default || styled)(MaterialCallEndRoundedSvg).attrs(p => ({
...
`;
MaterialCallEndRounded.propTypes = {
