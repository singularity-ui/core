...
const MaterialHighlightAltSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHighlightAlt = (styled.default || styled)(MaterialHighlightAltSvg).attrs(p => ({
...
`;
MaterialHighlightAlt.propTypes = {
