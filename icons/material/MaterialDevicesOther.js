...
const MaterialDevicesOtherSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDevicesOther = (styled.default || styled)(MaterialDevicesOtherSvg).attrs(p => ({
...
`;
MaterialDevicesOther.propTypes = {
