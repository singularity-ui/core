...
const MaterialSensorsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSensorsRounded = (styled.default || styled)(MaterialSensorsRoundedSvg).attrs(p => ({
...
`;
MaterialSensorsRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSensorsRounded;