...
const MaterialThreeK = props => <Icon as={MaterialThreeKSvg} {...props} />

MaterialThreeK.defaultProps = { ...Icon.defaultProps }

MaterialThreeK.propTypes = { ...Icon.propTypes }

export default MaterialThreeK
