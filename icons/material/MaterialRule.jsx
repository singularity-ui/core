...
const MaterialRule = props => <Icon as={MaterialRuleSvg} {...props} />

MaterialRule.defaultProps = { ...Icon.defaultProps }

MaterialRule.propTypes = { ...Icon.propTypes }
