...
const MaterialSixFtApartOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixFtApartOutlined = (styled.default || styled)(MaterialSixFtApartOutlinedSvg).attrs(p => ({
...
`;
MaterialSixFtApartOutlined.propTypes = {
