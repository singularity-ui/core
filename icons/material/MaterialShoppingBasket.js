...
const MaterialShoppingBasketSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialShoppingBasket = (styled.default || styled)(MaterialShoppingBasketSvg).attrs(p => ({
...
`;
MaterialShoppingBasket.propTypes = {
