...
const MaterialLocalDrinkTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalDrinkTwoTone = (styled.default || styled)(MaterialLocalDrinkTwoToneSvg).attrs(p => ({
...
`;
MaterialLocalDrinkTwoTone.propTypes = {
