...
const MaterialViewInArOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialViewInArOutlined = (styled.default || styled)(MaterialViewInArOutlinedSvg).attrs(p => ({
...
`;
MaterialViewInArOutlined.propTypes = {
