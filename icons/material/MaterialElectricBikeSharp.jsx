...
const MaterialElectricBikeSharpSvg = props => (
  <svg
...
const MaterialElectricBikeSharp = props => <Icon as={MaterialElectricBikeSharpSvg} {...props} />

MaterialElectricBikeSharp.defaultProps = { ...Icon.defaultProps }

MaterialElectricBikeSharp.propTypes = { ...Icon.propTypes }

export default MaterialElectricBikeSharp
