...
const MaterialPhonePausedTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhonePausedTwoTone = (styled.default || styled)(MaterialPhonePausedTwoToneSvg).attrs(p => ({
...
`;
MaterialPhonePausedTwoTone.propTypes = {
