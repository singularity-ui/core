...
const MaterialRawOnRoundedSvg = props => (
  <svg
...
const MaterialRawOnRounded = props => <Icon as={MaterialRawOnRoundedSvg} {...props} />

MaterialRawOnRounded.defaultProps = { ...Icon.defaultProps }

MaterialRawOnRounded.propTypes = { ...Icon.propTypes }
