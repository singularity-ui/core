...
const MaterialTimerTenRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerTenRounded = (styled.default || styled)(MaterialTimerTenRoundedSvg).attrs(p => ({
...
`;
MaterialTimerTenRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialTimerTenRounded;