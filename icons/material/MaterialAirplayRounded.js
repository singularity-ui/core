...
const MaterialAirplayRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAirplayRounded = (styled.default || styled)(MaterialAirplayRoundedSvg).attrs(p => ({
...
`;
MaterialAirplayRounded.propTypes = {
