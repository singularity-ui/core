...
const MaterialKayakingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKayakingTwoTone = (styled.default || styled)(MaterialKayakingTwoToneSvg).attrs(p => ({
...
`;
MaterialKayakingTwoTone.propTypes = {
