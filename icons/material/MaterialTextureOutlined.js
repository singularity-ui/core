...
const MaterialTextureOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTextureOutlined = (styled.default || styled)(MaterialTextureOutlinedSvg).attrs(p => ({
...
`;
MaterialTextureOutlined.propTypes = {
