...
const MaterialPendingActionsSharpSvg = props => (
  <svg
...
const MaterialPendingActionsSharp = props => <Icon as={MaterialPendingActionsSharpSvg} {...props} />

MaterialPendingActionsSharp.defaultProps = { ...Icon.defaultProps }

MaterialPendingActionsSharp.propTypes = { ...Icon.propTypes }

export default MaterialPendingActionsSharp
