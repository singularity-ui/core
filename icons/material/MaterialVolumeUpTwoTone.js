...
const MaterialVolumeUpTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVolumeUpTwoTone = (styled.default || styled)(MaterialVolumeUpTwoToneSvg).attrs(p => ({
...
`;
MaterialVolumeUpTwoTone.propTypes = {
