...
const MaterialSevenKRoundedSvg = props => (
  <svg
...
const MaterialSevenKRounded = props => <Icon as={MaterialSevenKRoundedSvg} {...props} />

MaterialSevenKRounded.defaultProps = { ...Icon.defaultProps }

MaterialSevenKRounded.propTypes = { ...Icon.propTypes }

export default MaterialSevenKRounded
