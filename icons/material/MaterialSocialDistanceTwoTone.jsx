...
const MaterialSocialDistanceTwoToneSvg = props => (
  <svg
...
const MaterialSocialDistanceTwoTone = props => <Icon as={MaterialSocialDistanceTwoToneSvg} {...props} />

MaterialSocialDistanceTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSocialDistanceTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSocialDistanceTwoTone
