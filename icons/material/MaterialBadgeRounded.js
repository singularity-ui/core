...
const MaterialBadgeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBadgeRounded = (styled.default || styled)(MaterialBadgeRoundedSvg).attrs(p => ({
...
`;
MaterialBadgeRounded.propTypes = {
