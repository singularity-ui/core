...
const MaterialEditOffSvg = props => (
...
const MaterialEditOff = props => <Icon as={MaterialEditOffSvg} {...props} />

MaterialEditOff.defaultProps = { ...Icon.defaultProps }

MaterialEditOff.propTypes = { ...Icon.propTypes }
