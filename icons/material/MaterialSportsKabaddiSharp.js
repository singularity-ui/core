...
const MaterialSportsKabaddiSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsKabaddiSharp = (styled.default || styled)(MaterialSportsKabaddiSharpSvg).attrs(p => ({
...
`;
MaterialSportsKabaddiSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSportsKabaddiSharp;