...
const MaterialSpeakerSvg = props => (
...
const MaterialSpeaker = props => <Icon as={MaterialSpeakerSvg} {...props} />

MaterialSpeaker.defaultProps = { ...Icon.defaultProps }

MaterialSpeaker.propTypes = { ...Icon.propTypes }

export default MaterialSpeaker
