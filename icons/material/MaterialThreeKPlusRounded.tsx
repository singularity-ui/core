...
const MaterialThreeKPlusRoundedSvg = props => (
  <svg
...
const MaterialThreeKPlusRounded = props => <Icon as={MaterialThreeKPlusRoundedSvg} {...props} />

MaterialThreeKPlusRounded.defaultProps = { ...Icon.defaultProps }

MaterialThreeKPlusRounded.propTypes = { ...Icon.propTypes }

export default MaterialThreeKPlusRounded
