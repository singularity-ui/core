...
const MaterialOpenInNewOffSvg = props => (
  <svg
...
const MaterialOpenInNewOff = props => <Icon as={MaterialOpenInNewOffSvg} {...props} />

MaterialOpenInNewOff.defaultProps = { ...Icon.defaultProps }

MaterialOpenInNewOff.propTypes = { ...Icon.propTypes }

export default MaterialOpenInNewOff
