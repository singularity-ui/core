...
const MaterialWash = props => <Icon as={MaterialWashSvg} {...props} />

MaterialWash.defaultProps = { ...Icon.defaultProps }

MaterialWash.propTypes = { ...Icon.propTypes }

export default MaterialWash
