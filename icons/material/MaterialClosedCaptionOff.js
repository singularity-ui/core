...
const MaterialClosedCaptionOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialClosedCaptionOff = (styled.default || styled)(MaterialClosedCaptionOffSvg).attrs(p => ({
...
`;
MaterialClosedCaptionOff.propTypes = {
