...
const MaterialSmartScreenSvg = props => (
  <svg
...
const MaterialSmartScreen = props => <Icon as={MaterialSmartScreenSvg} {...props} />

MaterialSmartScreen.defaultProps = { ...Icon.defaultProps }

MaterialSmartScreen.propTypes = { ...Icon.propTypes }

export default MaterialSmartScreen
