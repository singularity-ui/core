...
const MaterialRotateRightRoundedSvg = props => (
...
const MaterialRotateRightRounded = props => <Icon as={MaterialRotateRightRoundedSvg} {...props} />

MaterialRotateRightRounded.defaultProps = { ...Icon.defaultProps }

MaterialRotateRightRounded.propTypes = { ...Icon.propTypes }
