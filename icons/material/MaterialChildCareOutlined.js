...
const MaterialChildCareOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChildCareOutlined = (styled.default || styled)(MaterialChildCareOutlinedSvg).attrs(p => ({
...
`;
MaterialChildCareOutlined.propTypes = {
