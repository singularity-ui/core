...
const MaterialFoundationRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFoundationRounded = (styled.default || styled)(MaterialFoundationRoundedSvg).attrs(p => ({
...
`;
MaterialFoundationRounded.propTypes = {
