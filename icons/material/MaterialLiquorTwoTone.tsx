...
const MaterialLiquorTwoToneSvg = props => (
  <svg
...
const MaterialLiquorTwoTone = props => <Icon as={MaterialLiquorTwoToneSvg} {...props} />

MaterialLiquorTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialLiquorTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialLiquorTwoTone
