...
const MaterialSnooze = props => <Icon as={MaterialSnoozeSvg} {...props} />

MaterialSnooze.defaultProps = { ...Icon.defaultProps }

MaterialSnooze.propTypes = { ...Icon.propTypes }

export default MaterialSnooze
