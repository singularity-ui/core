...
const MaterialSecurityRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSecurityRounded = (styled.default || styled)(MaterialSecurityRoundedSvg).attrs(p => ({
...
`;
MaterialSecurityRounded.propTypes = {
