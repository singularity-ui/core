...
const MaterialCottageTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCottageTwoTone = (styled.default || styled)(MaterialCottageTwoToneSvg).attrs(p => ({
...
`;
MaterialCottageTwoTone.propTypes = {
