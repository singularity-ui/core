...
const MaterialDepartureBoardSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDepartureBoard = (styled.default || styled)(MaterialDepartureBoardSvg).attrs(p => ({
...
`;
MaterialDepartureBoard.propTypes = {
