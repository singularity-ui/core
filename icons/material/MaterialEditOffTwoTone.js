...
const MaterialEditOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEditOffTwoTone = (styled.default || styled)(MaterialEditOffTwoToneSvg).attrs(p => ({
...
`;
MaterialEditOffTwoTone.propTypes = {
