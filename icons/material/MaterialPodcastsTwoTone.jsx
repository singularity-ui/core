...
const MaterialPodcastsTwoToneSvg = props => (
  <svg
...
const MaterialPodcastsTwoTone = props => <Icon as={MaterialPodcastsTwoToneSvg} {...props} />

MaterialPodcastsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPodcastsTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPodcastsTwoTone
