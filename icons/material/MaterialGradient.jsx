...
const MaterialGradientSvg = props => (
...
const MaterialGradient = props => <Icon as={MaterialGradientSvg} {...props} />

MaterialGradient.defaultProps = { ...Icon.defaultProps }

MaterialGradient.propTypes = { ...Icon.propTypes }
