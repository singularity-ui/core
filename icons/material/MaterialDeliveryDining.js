...
const MaterialDeliveryDiningSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDeliveryDining = (styled.default || styled)(MaterialDeliveryDiningSvg).attrs(p => ({
...
`;
MaterialDeliveryDining.propTypes = {
