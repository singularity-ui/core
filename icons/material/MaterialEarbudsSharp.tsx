...
const MaterialEarbudsSharpSvg = props => (
  <svg
...
const MaterialEarbudsSharp = props => <Icon as={MaterialEarbudsSharpSvg} {...props} />

MaterialEarbudsSharp.defaultProps = { ...Icon.defaultProps }

MaterialEarbudsSharp.propTypes = { ...Icon.propTypes }
