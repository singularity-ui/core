...
const MaterialCancelScheduleSendSharpSvg = props => (
  <svg
...
const MaterialCancelScheduleSendSharp = props => <Icon as={MaterialCancelScheduleSendSharpSvg} {...props} />

MaterialCancelScheduleSendSharp.defaultProps = { ...Icon.defaultProps }

MaterialCancelScheduleSendSharp.propTypes = { ...Icon.propTypes }

export default MaterialCancelScheduleSendSharp
