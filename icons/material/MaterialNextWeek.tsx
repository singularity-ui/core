...
const MaterialNextWeekSvg = props => (
  <svg
...
const MaterialNextWeek = props => <Icon as={MaterialNextWeekSvg} {...props} />

MaterialNextWeek.defaultProps = { ...Icon.defaultProps }

MaterialNextWeek.propTypes = { ...Icon.propTypes }

export default MaterialNextWeek
