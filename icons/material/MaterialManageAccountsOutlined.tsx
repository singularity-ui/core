...
const MaterialManageAccountsOutlinedSvg = props => (
  <svg
...
const MaterialManageAccountsOutlined = props => <Icon as={MaterialManageAccountsOutlinedSvg} {...props} />

MaterialManageAccountsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialManageAccountsOutlined.propTypes = { ...Icon.propTypes }

export default MaterialManageAccountsOutlined
