...
const MaterialRouter = props => <Icon as={MaterialRouterSvg} {...props} />

MaterialRouter.defaultProps = { ...Icon.defaultProps }

MaterialRouter.propTypes = { ...Icon.propTypes }
