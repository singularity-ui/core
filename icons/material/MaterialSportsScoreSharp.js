...
const MaterialSportsScoreSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsScoreSharp = (styled.default || styled)(MaterialSportsScoreSharpSvg).attrs(p => ({
...
`;
MaterialSportsScoreSharp.propTypes = {
