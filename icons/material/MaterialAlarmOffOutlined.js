...
const MaterialAlarmOffOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOffOutlined = (styled.default || styled)(MaterialAlarmOffOutlinedSvg).attrs(p => ({
...
`;
MaterialAlarmOffOutlined.propTypes = {
