...
const MaterialLeakAddSharpSvg = props => (
...
const MaterialLeakAddSharp = props => <Icon as={MaterialLeakAddSharpSvg} {...props} />

MaterialLeakAddSharp.defaultProps = { ...Icon.defaultProps }

MaterialLeakAddSharp.propTypes = { ...Icon.propTypes }

export default MaterialLeakAddSharp
