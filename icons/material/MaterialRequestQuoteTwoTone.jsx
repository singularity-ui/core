...
const MaterialRequestQuoteTwoToneSvg = props => (
  <svg
...
const MaterialRequestQuoteTwoTone = props => <Icon as={MaterialRequestQuoteTwoToneSvg} {...props} />

MaterialRequestQuoteTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRequestQuoteTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialRequestQuoteTwoTone
