...
const MaterialSendAndArchiveRoundedSvg = props => (
  <svg
...
const MaterialSendAndArchiveRounded = props => <Icon as={MaterialSendAndArchiveRoundedSvg} {...props} />

MaterialSendAndArchiveRounded.defaultProps = { ...Icon.defaultProps }

MaterialSendAndArchiveRounded.propTypes = { ...Icon.propTypes }
