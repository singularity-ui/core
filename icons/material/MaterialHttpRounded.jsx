...
const MaterialHttpRoundedSvg = props => (
...
const MaterialHttpRounded = props => <Icon as={MaterialHttpRoundedSvg} {...props} />

MaterialHttpRounded.defaultProps = { ...Icon.defaultProps }

MaterialHttpRounded.propTypes = { ...Icon.propTypes }
