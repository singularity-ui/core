...
const MaterialFireplaceRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFireplaceRounded = (styled.default || styled)(MaterialFireplaceRoundedSvg).attrs(p => ({
...
`;
MaterialFireplaceRounded.propTypes = {
