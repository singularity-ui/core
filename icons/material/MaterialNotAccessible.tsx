...
const MaterialNotAccessibleSvg = props => (
  <svg
...
const MaterialNotAccessible = props => <Icon as={MaterialNotAccessibleSvg} {...props} />

MaterialNotAccessible.defaultProps = { ...Icon.defaultProps }

MaterialNotAccessible.propTypes = { ...Icon.propTypes }
