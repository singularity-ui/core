...
const MaterialHardwareTwoToneSvg = props => (
  <svg
...
const MaterialHardwareTwoTone = props => <Icon as={MaterialHardwareTwoToneSvg} {...props} />

MaterialHardwareTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHardwareTwoTone.propTypes = { ...Icon.propTypes }
