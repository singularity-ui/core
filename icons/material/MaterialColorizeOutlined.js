...
const MaterialColorizeOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialColorizeOutlined = (styled.default || styled)(MaterialColorizeOutlinedSvg).attrs(p => ({
...
`;
MaterialColorizeOutlined.propTypes = {
