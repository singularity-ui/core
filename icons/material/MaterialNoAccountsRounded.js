...
const MaterialNoAccountsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoAccountsRounded = (styled.default || styled)(MaterialNoAccountsRoundedSvg).attrs(p => ({
...
`;
MaterialNoAccountsRounded.propTypes = {
