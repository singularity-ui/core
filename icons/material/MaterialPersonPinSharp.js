...
const MaterialPersonPinSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPersonPinSharp = (styled.default || styled)(MaterialPersonPinSharpSvg).attrs(p => ({
...
`;
MaterialPersonPinSharp.propTypes = {
