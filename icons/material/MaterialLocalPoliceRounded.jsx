...
const MaterialLocalPoliceRoundedSvg = props => (
  <svg
...
const MaterialLocalPoliceRounded = props => <Icon as={MaterialLocalPoliceRoundedSvg} {...props} />

MaterialLocalPoliceRounded.defaultProps = { ...Icon.defaultProps }

MaterialLocalPoliceRounded.propTypes = { ...Icon.propTypes }

export default MaterialLocalPoliceRounded
