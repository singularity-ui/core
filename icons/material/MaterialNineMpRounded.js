...
const MaterialNineMpRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNineMpRounded = (styled.default || styled)(MaterialNineMpRoundedSvg).attrs(p => ({
...
`;
MaterialNineMpRounded.propTypes = {
