...
const MaterialSpeakerOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSpeakerOutlined = (styled.default || styled)(MaterialSpeakerOutlinedSvg).attrs(p => ({
...
`;
MaterialSpeakerOutlined.propTypes = {
