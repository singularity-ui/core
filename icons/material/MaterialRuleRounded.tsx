...
const MaterialRuleRoundedSvg = props => (
  <svg
...
const MaterialRuleRounded = props => <Icon as={MaterialRuleRoundedSvg} {...props} />

MaterialRuleRounded.defaultProps = { ...Icon.defaultProps }

MaterialRuleRounded.propTypes = { ...Icon.propTypes }
