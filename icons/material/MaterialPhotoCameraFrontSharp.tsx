...
const MaterialPhotoCameraFrontSharpSvg = props => (
  <svg
...
const MaterialPhotoCameraFrontSharp = props => <Icon as={MaterialPhotoCameraFrontSharpSvg} {...props} />

MaterialPhotoCameraFrontSharp.defaultProps = { ...Icon.defaultProps }

MaterialPhotoCameraFrontSharp.propTypes = { ...Icon.propTypes }
