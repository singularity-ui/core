...
const MaterialWbAuto = props => <Icon as={MaterialWbAutoSvg} {...props} />

MaterialWbAuto.defaultProps = { ...Icon.defaultProps }

MaterialWbAuto.propTypes = { ...Icon.propTypes }

export default MaterialWbAuto
