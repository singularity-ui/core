...
const MaterialFileDownloadOffRoundedSvg = props => (
  <svg
...
const MaterialFileDownloadOffRounded = props => <Icon as={MaterialFileDownloadOffRoundedSvg} {...props} />

MaterialFileDownloadOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialFileDownloadOffRounded.propTypes = { ...Icon.propTypes }
