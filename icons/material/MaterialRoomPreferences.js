...
const MaterialRoomPreferencesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRoomPreferences = (styled.default || styled)(MaterialRoomPreferencesSvg).attrs(p => ({
...
`;
MaterialRoomPreferences.propTypes = {
