...
const MaterialHevc = props => <Icon as={MaterialHevcSvg} {...props} />

MaterialHevc.defaultProps = { ...Icon.defaultProps }

MaterialHevc.propTypes = { ...Icon.propTypes }
