...
const MaterialPhoneLockedTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneLockedTwoTone = (styled.default || styled)(MaterialPhoneLockedTwoToneSvg).attrs(p => ({
...
`;
MaterialPhoneLockedTwoTone.propTypes = {
