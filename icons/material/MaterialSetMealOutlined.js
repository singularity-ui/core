...
const MaterialSetMealOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSetMealOutlined = (styled.default || styled)(MaterialSetMealOutlinedSvg).attrs(p => ({
...
`;
MaterialSetMealOutlined.propTypes = {
