...
const MaterialHdrOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrOffTwoTone = (styled.default || styled)(MaterialHdrOffTwoToneSvg).attrs(p => ({
...
`;
MaterialHdrOffTwoTone.propTypes = {
