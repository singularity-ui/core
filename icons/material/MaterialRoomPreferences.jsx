...
const MaterialRoomPreferencesSvg = props => (
  <svg
...
const MaterialRoomPreferences = props => <Icon as={MaterialRoomPreferencesSvg} {...props} />

MaterialRoomPreferences.defaultProps = { ...Icon.defaultProps }

MaterialRoomPreferences.propTypes = { ...Icon.propTypes }

export default MaterialRoomPreferences
