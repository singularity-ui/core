...
const MaterialEscalatorWarningSvg = props => (
  <svg
...
const MaterialEscalatorWarning = props => <Icon as={MaterialEscalatorWarningSvg} {...props} />

MaterialEscalatorWarning.defaultProps = { ...Icon.defaultProps }

MaterialEscalatorWarning.propTypes = { ...Icon.propTypes }

export default MaterialEscalatorWarning
