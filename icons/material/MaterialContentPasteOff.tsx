...
const MaterialContentPasteOffSvg = props => (
  <svg
...
const MaterialContentPasteOff = props => <Icon as={MaterialContentPasteOffSvg} {...props} />

MaterialContentPasteOff.defaultProps = { ...Icon.defaultProps }

MaterialContentPasteOff.propTypes = { ...Icon.propTypes }

export default MaterialContentPasteOff
