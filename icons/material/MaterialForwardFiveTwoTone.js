...
const MaterialForwardFiveTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardFiveTwoTone = (styled.default || styled)(MaterialForwardFiveTwoToneSvg).attrs(p => ({
...
`;
MaterialForwardFiveTwoTone.propTypes = {
