...
const MaterialRateReviewOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRateReviewOutlined = (styled.default || styled)(MaterialRateReviewOutlinedSvg).attrs(p => ({
...
`;
MaterialRateReviewOutlined.propTypes = {
