...
const MaterialCallTwoToneSvg = props => (
...
const MaterialCallTwoTone = props => <Icon as={MaterialCallTwoToneSvg} {...props} />

MaterialCallTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCallTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialCallTwoTone
