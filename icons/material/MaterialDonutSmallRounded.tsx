...
const MaterialDonutSmallRoundedSvg = props => (
...
const MaterialDonutSmallRounded = props => <Icon as={MaterialDonutSmallRoundedSvg} {...props} />

MaterialDonutSmallRounded.defaultProps = { ...Icon.defaultProps }

MaterialDonutSmallRounded.propTypes = { ...Icon.propTypes }
