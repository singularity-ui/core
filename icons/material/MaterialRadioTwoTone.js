...
const MaterialRadioTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRadioTwoTone = (styled.default || styled)(MaterialRadioTwoToneSvg).attrs(p => ({
...
`;
MaterialRadioTwoTone.propTypes = {
