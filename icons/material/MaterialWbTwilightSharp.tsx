...
const MaterialWbTwilightSharpSvg = props => (
  <svg
...
const MaterialWbTwilightSharp = props => <Icon as={MaterialWbTwilightSharpSvg} {...props} />

MaterialWbTwilightSharp.defaultProps = { ...Icon.defaultProps }

MaterialWbTwilightSharp.propTypes = { ...Icon.propTypes }

export default MaterialWbTwilightSharp
