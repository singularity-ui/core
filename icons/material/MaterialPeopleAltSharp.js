...
const MaterialPeopleAltSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPeopleAltSharp = (styled.default || styled)(MaterialPeopleAltSharpSvg).attrs(p => ({
...
`;
MaterialPeopleAltSharp.propTypes = {
