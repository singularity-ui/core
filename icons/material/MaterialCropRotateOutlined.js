...
const MaterialCropRotateOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCropRotateOutlined = (styled.default || styled)(MaterialCropRotateOutlinedSvg).attrs(p => ({
...
`;
MaterialCropRotateOutlined.propTypes = {
