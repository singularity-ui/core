...
const MaterialBatchPredictionSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBatchPrediction = (styled.default || styled)(MaterialBatchPredictionSvg).attrs(p => ({
...
`;
MaterialBatchPrediction.propTypes = {
