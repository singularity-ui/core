...
const MaterialLocalTaxiSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalTaxiSharp = (styled.default || styled)(MaterialLocalTaxiSharpSvg).attrs(p => ({
...
`;
MaterialLocalTaxiSharp.propTypes = {
