...
const MaterialSevenKPlusRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSevenKPlusRounded = (styled.default || styled)(MaterialSevenKPlusRoundedSvg).attrs(p => ({
...
`;
MaterialSevenKPlusRounded.propTypes = {
