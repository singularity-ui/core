...
const MaterialFoodBankTwoToneSvg = props => (
  <svg
...
const MaterialFoodBankTwoTone = props => <Icon as={MaterialFoodBankTwoToneSvg} {...props} />

MaterialFoodBankTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialFoodBankTwoTone.propTypes = { ...Icon.propTypes }
