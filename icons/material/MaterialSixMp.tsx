...
const MaterialSixMp = props => <Icon as={MaterialSixMpSvg} {...props} />

MaterialSixMp.defaultProps = { ...Icon.defaultProps }

MaterialSixMp.propTypes = { ...Icon.propTypes }

export default MaterialSixMp
