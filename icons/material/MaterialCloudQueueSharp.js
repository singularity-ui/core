...
const MaterialCloudQueueSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCloudQueueSharp = (styled.default || styled)(MaterialCloudQueueSharpSvg).attrs(p => ({
...
`;
MaterialCloudQueueSharp.propTypes = {
