...
const MaterialRawOffOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRawOffOutlined = (styled.default || styled)(MaterialRawOffOutlinedSvg).attrs(p => ({
...
`;
MaterialRawOffOutlined.propTypes = {
