...
const MaterialContentPasteOffRoundedSvg = props => (
  <svg
...
const MaterialContentPasteOffRounded = props => <Icon as={MaterialContentPasteOffRoundedSvg} {...props} />

MaterialContentPasteOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialContentPasteOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialContentPasteOffRounded
