...
const MaterialFindInPageSvg = props => (
...
const MaterialFindInPage = props => <Icon as={MaterialFindInPageSvg} {...props} />

MaterialFindInPage.defaultProps = { ...Icon.defaultProps }

MaterialFindInPage.propTypes = { ...Icon.propTypes }
