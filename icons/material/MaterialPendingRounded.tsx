...
const MaterialPendingRoundedSvg = props => (
  <svg
...
const MaterialPendingRounded = props => <Icon as={MaterialPendingRoundedSvg} {...props} />

MaterialPendingRounded.defaultProps = { ...Icon.defaultProps }

MaterialPendingRounded.propTypes = { ...Icon.propTypes }

export default MaterialPendingRounded
