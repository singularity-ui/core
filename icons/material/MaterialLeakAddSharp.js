...
const MaterialLeakAddSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLeakAddSharp = (styled.default || styled)(MaterialLeakAddSharpSvg).attrs(p => ({
...
`;
MaterialLeakAddSharp.propTypes = {
