...
const MaterialConstructionRoundedSvg = props => (
  <svg
...
const MaterialConstructionRounded = props => <Icon as={MaterialConstructionRoundedSvg} {...props} />

MaterialConstructionRounded.defaultProps = { ...Icon.defaultProps }

MaterialConstructionRounded.propTypes = { ...Icon.propTypes }
