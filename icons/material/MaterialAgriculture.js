...
const MaterialAgricultureSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAgriculture = (styled.default || styled)(MaterialAgricultureSvg).attrs(p => ({
...
`;
MaterialAgriculture.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialAgriculture;