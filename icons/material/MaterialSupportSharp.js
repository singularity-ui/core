...
const MaterialSupportSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSupportSharp = (styled.default || styled)(MaterialSupportSharpSvg).attrs(p => ({
...
`;
MaterialSupportSharp.propTypes = {
