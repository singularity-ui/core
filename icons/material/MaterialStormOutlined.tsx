...
const MaterialStormOutlinedSvg = props => (
  <svg
...
const MaterialStormOutlined = props => <Icon as={MaterialStormOutlinedSvg} {...props} />

MaterialStormOutlined.defaultProps = { ...Icon.defaultProps }

MaterialStormOutlined.propTypes = { ...Icon.propTypes }

export default MaterialStormOutlined
