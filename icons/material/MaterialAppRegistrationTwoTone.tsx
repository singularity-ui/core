...
const MaterialAppRegistrationTwoToneSvg = props => (
  <svg
...
const MaterialAppRegistrationTwoTone = props => <Icon as={MaterialAppRegistrationTwoToneSvg} {...props} />

MaterialAppRegistrationTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialAppRegistrationTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialAppRegistrationTwoTone
