...
const MaterialContactPageSvg = props => (
  <svg
...
const MaterialContactPage = props => <Icon as={MaterialContactPageSvg} {...props} />

MaterialContactPage.defaultProps = { ...Icon.defaultProps }

MaterialContactPage.propTypes = { ...Icon.propTypes }

export default MaterialContactPage
