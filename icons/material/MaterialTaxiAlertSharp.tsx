...
const MaterialTaxiAlertSharpSvg = props => (
  <svg
...
const MaterialTaxiAlertSharp = props => <Icon as={MaterialTaxiAlertSharpSvg} {...props} />

MaterialTaxiAlertSharp.defaultProps = { ...Icon.defaultProps }

MaterialTaxiAlertSharp.propTypes = { ...Icon.propTypes }
