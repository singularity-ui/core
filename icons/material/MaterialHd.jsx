...
const MaterialHd = props => <Icon as={MaterialHdSvg} {...props} />

MaterialHd.defaultProps = { ...Icon.defaultProps }

MaterialHd.propTypes = { ...Icon.propTypes }

export default MaterialHd
