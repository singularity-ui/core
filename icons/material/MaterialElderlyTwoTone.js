...
const MaterialElderlyTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElderlyTwoTone = (styled.default || styled)(MaterialElderlyTwoToneSvg).attrs(p => ({
...
`;
MaterialElderlyTwoTone.propTypes = {
