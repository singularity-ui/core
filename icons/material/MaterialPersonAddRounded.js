...
const MaterialPersonAddRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPersonAddRounded = (styled.default || styled)(MaterialPersonAddRoundedSvg).attrs(p => ({
...
`;
MaterialPersonAddRounded.propTypes = {
