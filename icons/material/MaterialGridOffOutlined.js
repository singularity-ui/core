...
const MaterialGridOffOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGridOffOutlined = (styled.default || styled)(MaterialGridOffOutlinedSvg).attrs(p => ({
...
`;
MaterialGridOffOutlined.propTypes = {
