...
const MaterialFoodBankRoundedSvg = props => (
  <svg
...
const MaterialFoodBankRounded = props => <Icon as={MaterialFoodBankRoundedSvg} {...props} />

MaterialFoodBankRounded.defaultProps = { ...Icon.defaultProps }

MaterialFoodBankRounded.propTypes = { ...Icon.propTypes }
