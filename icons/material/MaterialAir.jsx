...
const MaterialAir = props => <Icon as={MaterialAirSvg} {...props} />

MaterialAir.defaultProps = { ...Icon.defaultProps }

MaterialAir.propTypes = { ...Icon.propTypes }

export default MaterialAir
