...
const MaterialPodcastsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPodcastsTwoTone = (styled.default || styled)(MaterialPodcastsTwoToneSvg).attrs(p => ({
...
`;
MaterialPodcastsTwoTone.propTypes = {
