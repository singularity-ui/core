...
const MaterialSyncProblemRoundedSvg = props => (
...
const MaterialSyncProblemRounded = props => <Icon as={MaterialSyncProblemRoundedSvg} {...props} />

MaterialSyncProblemRounded.defaultProps = { ...Icon.defaultProps }

MaterialSyncProblemRounded.propTypes = { ...Icon.propTypes }

export default MaterialSyncProblemRounded
