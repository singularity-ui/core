...
const MaterialRsvpRoundedSvg = props => (
  <svg
...
const MaterialRsvpRounded = props => <Icon as={MaterialRsvpRoundedSvg} {...props} />

MaterialRsvpRounded.defaultProps = { ...Icon.defaultProps }

MaterialRsvpRounded.propTypes = { ...Icon.propTypes }
