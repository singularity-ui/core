...
const MaterialWaterDamageRoundedSvg = props => (
  <svg
...
const MaterialWaterDamageRounded = props => <Icon as={MaterialWaterDamageRoundedSvg} {...props} />

MaterialWaterDamageRounded.defaultProps = { ...Icon.defaultProps }

MaterialWaterDamageRounded.propTypes = { ...Icon.propTypes }
