...
const MaterialAddToDriveTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddToDriveTwoTone = (styled.default || styled)(MaterialAddToDriveTwoToneSvg).attrs(p => ({
...
`;
MaterialAddToDriveTwoTone.propTypes = {
