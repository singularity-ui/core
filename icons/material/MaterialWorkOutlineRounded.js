...
const MaterialWorkOutlineRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWorkOutlineRounded = (styled.default || styled)(MaterialWorkOutlineRoundedSvg).attrs(p => ({
...
`;
MaterialWorkOutlineRounded.propTypes = {
