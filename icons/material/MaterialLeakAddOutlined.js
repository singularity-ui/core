...
const MaterialLeakAddOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLeakAddOutlined = (styled.default || styled)(MaterialLeakAddOutlinedSvg).attrs(p => ({
...
`;
MaterialLeakAddOutlined.propTypes = {
