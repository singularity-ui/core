...
const MaterialDoNotDisturbOffOutlinedSvg = props => (
  <svg
...
const MaterialDoNotDisturbOffOutlined = props => <Icon as={MaterialDoNotDisturbOffOutlinedSvg} {...props} />

MaterialDoNotDisturbOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDoNotDisturbOffOutlined.propTypes = { ...Icon.propTypes }
