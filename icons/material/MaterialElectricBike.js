...
const MaterialElectricBikeSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElectricBike = (styled.default || styled)(MaterialElectricBikeSvg).attrs(p => ({
...
`;
MaterialElectricBike.propTypes = {
