...
const MaterialSupportSvg = props => (
  <svg
...
const MaterialSupport = props => <Icon as={MaterialSupportSvg} {...props} />

MaterialSupport.defaultProps = { ...Icon.defaultProps }

MaterialSupport.propTypes = { ...Icon.propTypes }
