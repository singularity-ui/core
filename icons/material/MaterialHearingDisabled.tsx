...
const MaterialHearingDisabledSvg = props => (
  <svg
...
const MaterialHearingDisabled = props => <Icon as={MaterialHearingDisabledSvg} {...props} />

MaterialHearingDisabled.defaultProps = { ...Icon.defaultProps }

MaterialHearingDisabled.propTypes = { ...Icon.propTypes }

export default MaterialHearingDisabled
