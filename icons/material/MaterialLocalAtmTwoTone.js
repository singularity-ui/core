...
const MaterialLocalAtmTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalAtmTwoTone = (styled.default || styled)(MaterialLocalAtmTwoToneSvg).attrs(p => ({
...
`;
MaterialLocalAtmTwoTone.propTypes = {
