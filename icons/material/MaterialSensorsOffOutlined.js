...
const MaterialSensorsOffOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSensorsOffOutlined = (styled.default || styled)(MaterialSensorsOffOutlinedSvg).attrs(p => ({
...
`;
MaterialSensorsOffOutlined.propTypes = {
