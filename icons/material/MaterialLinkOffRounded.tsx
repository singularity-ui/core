...
const MaterialLinkOffRoundedSvg = props => (
  <svg
...
const MaterialLinkOffRounded = props => <Icon as={MaterialLinkOffRoundedSvg} {...props} />

MaterialLinkOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialLinkOffRounded.propTypes = { ...Icon.propTypes }
