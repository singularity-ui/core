...
const MaterialPedalBikeSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPedalBikeSharp = (styled.default || styled)(MaterialPedalBikeSharpSvg).attrs(p => ({
...
`;
MaterialPedalBikeSharp.propTypes = {
