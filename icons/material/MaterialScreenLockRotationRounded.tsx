...
const MaterialScreenLockRotationRoundedSvg = props => (
  <svg
...
const MaterialScreenLockRotationRounded = props => <Icon as={MaterialScreenLockRotationRoundedSvg} {...props} />

MaterialScreenLockRotationRounded.defaultProps = { ...Icon.defaultProps }

MaterialScreenLockRotationRounded.propTypes = { ...Icon.propTypes }
