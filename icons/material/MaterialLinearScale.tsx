...
const MaterialLinearScaleSvg = props => (
  <svg
...
const MaterialLinearScale = props => <Icon as={MaterialLinearScaleSvg} {...props} />

MaterialLinearScale.defaultProps = { ...Icon.defaultProps }

MaterialLinearScale.propTypes = { ...Icon.propTypes }

export default MaterialLinearScale
