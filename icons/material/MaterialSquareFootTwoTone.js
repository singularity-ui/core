...
const MaterialSquareFootTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSquareFootTwoTone = (styled.default || styled)(MaterialSquareFootTwoToneSvg).attrs(p => ({
...
`;
MaterialSquareFootTwoTone.propTypes = {
