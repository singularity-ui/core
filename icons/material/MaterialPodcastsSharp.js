...
const MaterialPodcastsSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPodcastsSharp = (styled.default || styled)(MaterialPodcastsSharpSvg).attrs(p => ({
...
`;
MaterialPodcastsSharp.propTypes = {
