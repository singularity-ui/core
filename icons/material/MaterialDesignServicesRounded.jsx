...
const MaterialDesignServicesRoundedSvg = props => (
  <svg
...
const MaterialDesignServicesRounded = props => <Icon as={MaterialDesignServicesRoundedSvg} {...props} />

MaterialDesignServicesRounded.defaultProps = { ...Icon.defaultProps }

MaterialDesignServicesRounded.propTypes = { ...Icon.propTypes }
