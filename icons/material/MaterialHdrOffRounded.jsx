...
const MaterialHdrOffRoundedSvg = props => (
...
const MaterialHdrOffRounded = props => <Icon as={MaterialHdrOffRoundedSvg} {...props} />

MaterialHdrOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialHdrOffRounded.propTypes = { ...Icon.propTypes }
