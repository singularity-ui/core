...
const MaterialPersonPinTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPersonPinTwoTone = (styled.default || styled)(MaterialPersonPinTwoToneSvg).attrs(p => ({
...
`;
MaterialPersonPinTwoTone.propTypes = {
