...
const MaterialPersonPinCircleRoundedSvg = props => (
  <svg
...
const MaterialPersonPinCircleRounded = props => <Icon as={MaterialPersonPinCircleRoundedSvg} {...props} />

MaterialPersonPinCircleRounded.defaultProps = { ...Icon.defaultProps }

MaterialPersonPinCircleRounded.propTypes = { ...Icon.propTypes }
