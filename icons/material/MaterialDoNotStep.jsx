...
const MaterialDoNotStepSvg = props => (
  <svg
...
const MaterialDoNotStep = props => <Icon as={MaterialDoNotStepSvg} {...props} />

MaterialDoNotStep.defaultProps = { ...Icon.defaultProps }

MaterialDoNotStep.propTypes = { ...Icon.propTypes }
