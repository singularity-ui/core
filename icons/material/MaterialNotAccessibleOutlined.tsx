...
const MaterialNotAccessibleOutlinedSvg = props => (
  <svg
...
const MaterialNotAccessibleOutlined = props => <Icon as={MaterialNotAccessibleOutlinedSvg} {...props} />

MaterialNotAccessibleOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNotAccessibleOutlined.propTypes = { ...Icon.propTypes }

export default MaterialNotAccessibleOutlined
