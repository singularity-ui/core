...
const MaterialSubjectRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSubjectRounded = (styled.default || styled)(MaterialSubjectRoundedSvg).attrs(p => ({
...
`;
MaterialSubjectRounded.propTypes = {
