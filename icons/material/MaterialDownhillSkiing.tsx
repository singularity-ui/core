...
const MaterialDownhillSkiingSvg = props => (
  <svg
...
const MaterialDownhillSkiing = props => <Icon as={MaterialDownhillSkiingSvg} {...props} />

MaterialDownhillSkiing.defaultProps = { ...Icon.defaultProps }

MaterialDownhillSkiing.propTypes = { ...Icon.propTypes }

export default MaterialDownhillSkiing
