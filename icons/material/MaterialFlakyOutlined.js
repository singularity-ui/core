...
const MaterialFlakyOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlakyOutlined = (styled.default || styled)(MaterialFlakyOutlinedSvg).attrs(p => ({
...
`;
MaterialFlakyOutlined.propTypes = {
