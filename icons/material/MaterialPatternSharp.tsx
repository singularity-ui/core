...
const MaterialPatternSharpSvg = props => (
  <svg
...
const MaterialPatternSharp = props => <Icon as={MaterialPatternSharpSvg} {...props} />

MaterialPatternSharp.defaultProps = { ...Icon.defaultProps }

MaterialPatternSharp.propTypes = { ...Icon.propTypes }

export default MaterialPatternSharp
