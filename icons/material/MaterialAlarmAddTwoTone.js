...
const MaterialAlarmAddTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmAddTwoTone = (styled.default || styled)(MaterialAlarmAddTwoToneSvg).attrs(p => ({
...
`;
MaterialAlarmAddTwoTone.propTypes = {
