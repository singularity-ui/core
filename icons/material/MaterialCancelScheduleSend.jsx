...
const MaterialCancelScheduleSendSvg = props => (
  <svg
...
const MaterialCancelScheduleSend = props => <Icon as={MaterialCancelScheduleSendSvg} {...props} />

MaterialCancelScheduleSend.defaultProps = { ...Icon.defaultProps }

MaterialCancelScheduleSend.propTypes = { ...Icon.propTypes }

export default MaterialCancelScheduleSend
