...
const MaterialManageSearchSvg = props => (
  <svg
...
const MaterialManageSearch = props => <Icon as={MaterialManageSearchSvg} {...props} />

MaterialManageSearch.defaultProps = { ...Icon.defaultProps }

MaterialManageSearch.propTypes = { ...Icon.propTypes }

export default MaterialManageSearch
