...
const MaterialKingBedRoundedSvg = props => (
  <svg
...
const MaterialKingBedRounded = props => <Icon as={MaterialKingBedRoundedSvg} {...props} />

MaterialKingBedRounded.defaultProps = { ...Icon.defaultProps }

MaterialKingBedRounded.propTypes = { ...Icon.propTypes }
