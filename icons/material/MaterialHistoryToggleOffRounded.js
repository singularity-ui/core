...
const MaterialHistoryToggleOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHistoryToggleOffRounded = (styled.default || styled)(MaterialHistoryToggleOffRoundedSvg).attrs(p => ({
...
`;
MaterialHistoryToggleOffRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialHistoryToggleOffRounded;