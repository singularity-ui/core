...
const MaterialMoreTimeSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMoreTimeSharp = (styled.default || styled)(MaterialMoreTimeSharpSvg).attrs(p => ({
...
`;
MaterialMoreTimeSharp.propTypes = {
