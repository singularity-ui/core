...
const MaterialSoapSharpSvg = props => (
  <svg
...
const MaterialSoapSharp = props => <Icon as={MaterialSoapSharpSvg} {...props} />

MaterialSoapSharp.defaultProps = { ...Icon.defaultProps }

MaterialSoapSharp.propTypes = { ...Icon.propTypes }
