...
const MaterialSportsScoreSvg = props => (
  <svg
...
const MaterialSportsScore = props => <Icon as={MaterialSportsScoreSvg} {...props} />

MaterialSportsScore.defaultProps = { ...Icon.defaultProps }

MaterialSportsScore.propTypes = { ...Icon.propTypes }
