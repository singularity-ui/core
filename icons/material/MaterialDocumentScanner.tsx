...
const MaterialDocumentScannerSvg = props => (
  <svg
...
const MaterialDocumentScanner = props => <Icon as={MaterialDocumentScannerSvg} {...props} />

MaterialDocumentScanner.defaultProps = { ...Icon.defaultProps }

MaterialDocumentScanner.propTypes = { ...Icon.propTypes }
