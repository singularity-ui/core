...
const MaterialUmbrellaRoundedSvg = props => (
  <svg
...
const MaterialUmbrellaRounded = props => <Icon as={MaterialUmbrellaRoundedSvg} {...props} />

MaterialUmbrellaRounded.defaultProps = { ...Icon.defaultProps }

MaterialUmbrellaRounded.propTypes = { ...Icon.propTypes }
