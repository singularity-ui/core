...
const MaterialHelpCenterSvg = props => (
  <svg
...
const MaterialHelpCenter = props => <Icon as={MaterialHelpCenterSvg} {...props} />

MaterialHelpCenter.defaultProps = { ...Icon.defaultProps }

MaterialHelpCenter.propTypes = { ...Icon.propTypes }

export default MaterialHelpCenter
