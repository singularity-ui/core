...
const MaterialMarkEmailReadSvg = props => (
  <svg
...
const MaterialMarkEmailRead = props => <Icon as={MaterialMarkEmailReadSvg} {...props} />

MaterialMarkEmailRead.defaultProps = { ...Icon.defaultProps }

MaterialMarkEmailRead.propTypes = { ...Icon.propTypes }
