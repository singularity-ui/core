...
const MaterialFiveMp = props => <Icon as={MaterialFiveMpSvg} {...props} />

MaterialFiveMp.defaultProps = { ...Icon.defaultProps }

MaterialFiveMp.propTypes = { ...Icon.propTypes }

export default MaterialFiveMp
