...
const MaterialEvStationRoundedSvg = props => (
...
const MaterialEvStationRounded = props => <Icon as={MaterialEvStationRoundedSvg} {...props} />

MaterialEvStationRounded.defaultProps = { ...Icon.defaultProps }

MaterialEvStationRounded.propTypes = { ...Icon.propTypes }

export default MaterialEvStationRounded
