...
const MaterialSubwayRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSubwayRounded = (styled.default || styled)(MaterialSubwayRoundedSvg).attrs(p => ({
...
`;
MaterialSubwayRounded.propTypes = {
