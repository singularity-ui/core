...
const MaterialFiveKPlusRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFiveKPlusRounded = (styled.default || styled)(MaterialFiveKPlusRoundedSvg).attrs(p => ({
...
`;
MaterialFiveKPlusRounded.propTypes = {
