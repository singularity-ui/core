...
const MaterialFingerprintRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFingerprintRounded = (styled.default || styled)(MaterialFingerprintRoundedSvg).attrs(p => ({
...
`;
MaterialFingerprintRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFingerprintRounded;