...
const MaterialSavingsSvg = props => (
  <svg
...
const MaterialSavings = props => <Icon as={MaterialSavingsSvg} {...props} />

MaterialSavings.defaultProps = { ...Icon.defaultProps }

MaterialSavings.propTypes = { ...Icon.propTypes }
