...
const MaterialNetworkCheckTwoToneSvg = props => (
...
const MaterialNetworkCheckTwoTone = props => <Icon as={MaterialNetworkCheckTwoToneSvg} {...props} />

MaterialNetworkCheckTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialNetworkCheckTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialNetworkCheckTwoTone
