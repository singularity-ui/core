...
const MaterialPestControlRodentSvg = props => (
  <svg
...
const MaterialPestControlRodent = props => <Icon as={MaterialPestControlRodentSvg} {...props} />

MaterialPestControlRodent.defaultProps = { ...Icon.defaultProps }

MaterialPestControlRodent.propTypes = { ...Icon.propTypes }
