...
const MaterialPlaceRoundedSvg = props => (
  <svg
...
const MaterialPlaceRounded = props => <Icon as={MaterialPlaceRoundedSvg} {...props} />

MaterialPlaceRounded.defaultProps = { ...Icon.defaultProps }

MaterialPlaceRounded.propTypes = { ...Icon.propTypes }
