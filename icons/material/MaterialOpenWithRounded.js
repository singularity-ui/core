...
const MaterialOpenWithRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOpenWithRounded = (styled.default || styled)(MaterialOpenWithRoundedSvg).attrs(p => ({
...
`;
MaterialOpenWithRounded.propTypes = {
