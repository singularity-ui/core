...
const MaterialPolicyOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPolicyOutlined = (styled.default || styled)(MaterialPolicyOutlinedSvg).attrs(p => ({
...
`;
MaterialPolicyOutlined.propTypes = {
