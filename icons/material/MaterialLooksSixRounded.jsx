...
const MaterialLooksSixRoundedSvg = props => (
...
const MaterialLooksSixRounded = props => <Icon as={MaterialLooksSixRoundedSvg} {...props} />

MaterialLooksSixRounded.defaultProps = { ...Icon.defaultProps }

MaterialLooksSixRounded.propTypes = { ...Icon.propTypes }
