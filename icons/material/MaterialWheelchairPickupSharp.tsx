...
const MaterialWheelchairPickupSharpSvg = props => (
  <svg
...
const MaterialWheelchairPickupSharp = props => <Icon as={MaterialWheelchairPickupSharpSvg} {...props} />

MaterialWheelchairPickupSharp.defaultProps = { ...Icon.defaultProps }

MaterialWheelchairPickupSharp.propTypes = { ...Icon.propTypes }
