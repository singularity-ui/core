...
const MaterialLocalMallTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalMallTwoTone = (styled.default || styled)(MaterialLocalMallTwoToneSvg).attrs(p => ({
...
`;
MaterialLocalMallTwoTone.propTypes = {
