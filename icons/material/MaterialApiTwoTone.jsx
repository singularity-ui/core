...
const MaterialApiTwoToneSvg = props => (
  <svg
...
const MaterialApiTwoTone = props => <Icon as={MaterialApiTwoToneSvg} {...props} />

MaterialApiTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialApiTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialApiTwoTone
