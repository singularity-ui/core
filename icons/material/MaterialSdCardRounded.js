...
const MaterialSdCardRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSdCardRounded = (styled.default || styled)(MaterialSdCardRoundedSvg).attrs(p => ({
...
`;
MaterialSdCardRounded.propTypes = {
