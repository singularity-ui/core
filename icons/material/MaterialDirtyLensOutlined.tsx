...
const MaterialDirtyLensOutlinedSvg = props => (
  <svg
...
const MaterialDirtyLensOutlined = props => <Icon as={MaterialDirtyLensOutlinedSvg} {...props} />

MaterialDirtyLensOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDirtyLensOutlined.propTypes = { ...Icon.propTypes }

export default MaterialDirtyLensOutlined
