...
const MaterialLiquor = props => <Icon as={MaterialLiquorSvg} {...props} />

MaterialLiquor.defaultProps = { ...Icon.defaultProps }

MaterialLiquor.propTypes = { ...Icon.propTypes }
