...
const MaterialTimerThreeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerThreeTwoTone = (styled.default || styled)(MaterialTimerThreeTwoToneSvg).attrs(p => ({
...
`;
MaterialTimerThreeTwoTone.propTypes = {
