...
const MaterialSignalWifiBadSvg = props => (
  <svg
...
const MaterialSignalWifiBad = props => <Icon as={MaterialSignalWifiBadSvg} {...props} />

MaterialSignalWifiBad.defaultProps = { ...Icon.defaultProps }

MaterialSignalWifiBad.propTypes = { ...Icon.propTypes }
