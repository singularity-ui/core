...
const MaterialHouseboatSvg = props => (
  <svg
...
const MaterialHouseboat = props => <Icon as={MaterialHouseboatSvg} {...props} />

MaterialHouseboat.defaultProps = { ...Icon.defaultProps }

MaterialHouseboat.propTypes = { ...Icon.propTypes }

export default MaterialHouseboat
