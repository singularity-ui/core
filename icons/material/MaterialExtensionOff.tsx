...
const MaterialExtensionOffSvg = props => (
  <svg
...
const MaterialExtensionOff = props => <Icon as={MaterialExtensionOffSvg} {...props} />

MaterialExtensionOff.defaultProps = { ...Icon.defaultProps }

MaterialExtensionOff.propTypes = { ...Icon.propTypes }

export default MaterialExtensionOff
