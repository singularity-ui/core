...
const MaterialPriceCheckRoundedSvg = props => (
  <svg
...
const MaterialPriceCheckRounded = props => <Icon as={MaterialPriceCheckRoundedSvg} {...props} />

MaterialPriceCheckRounded.defaultProps = { ...Icon.defaultProps }

MaterialPriceCheckRounded.propTypes = { ...Icon.propTypes }
