...
const MaterialHdrPlusRoundedSvg = props => (
  <svg
...
const MaterialHdrPlusRounded = props => <Icon as={MaterialHdrPlusRoundedSvg} {...props} />

MaterialHdrPlusRounded.defaultProps = { ...Icon.defaultProps }

MaterialHdrPlusRounded.propTypes = { ...Icon.propTypes }

export default MaterialHdrPlusRounded
