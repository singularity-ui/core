...
const MaterialTaskAltSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTaskAltSharp = (styled.default || styled)(MaterialTaskAltSharpSvg).attrs(p => ({
...
`;
MaterialTaskAltSharp.propTypes = {
