...
const MaterialBatchPredictionSvg = props => (
  <svg
...
const MaterialBatchPrediction = props => <Icon as={MaterialBatchPredictionSvg} {...props} />

MaterialBatchPrediction.defaultProps = { ...Icon.defaultProps }

MaterialBatchPrediction.propTypes = { ...Icon.propTypes }

export default MaterialBatchPrediction
