...
const MaterialHouseboatSharpSvg = props => (
  <svg
...
const MaterialHouseboatSharp = props => <Icon as={MaterialHouseboatSharpSvg} {...props} />

MaterialHouseboatSharp.defaultProps = { ...Icon.defaultProps }

MaterialHouseboatSharp.propTypes = { ...Icon.propTypes }
