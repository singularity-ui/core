...
const MaterialRestartAltOutlinedSvg = props => (
  <svg
...
const MaterialRestartAltOutlined = props => <Icon as={MaterialRestartAltOutlinedSvg} {...props} />

MaterialRestartAltOutlined.defaultProps = { ...Icon.defaultProps }

MaterialRestartAltOutlined.propTypes = { ...Icon.propTypes }

export default MaterialRestartAltOutlined
