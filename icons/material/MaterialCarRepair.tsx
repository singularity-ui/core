...
const MaterialCarRepairSvg = props => (
  <svg
...
const MaterialCarRepair = props => <Icon as={MaterialCarRepairSvg} {...props} />

MaterialCarRepair.defaultProps = { ...Icon.defaultProps }

MaterialCarRepair.propTypes = { ...Icon.propTypes }
