...
const MaterialHdrEnhancedSelectSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrEnhancedSelect = (styled.default || styled)(MaterialHdrEnhancedSelectSvg).attrs(p => ({
...
`;
MaterialHdrEnhancedSelect.propTypes = {
