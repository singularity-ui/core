...
const MaterialPhonelinkOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhonelinkOff = (styled.default || styled)(MaterialPhonelinkOffSvg).attrs(p => ({
...
`;
MaterialPhonelinkOff.propTypes = {
