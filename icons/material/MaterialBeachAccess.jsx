...
const MaterialBeachAccessSvg = props => (
...
const MaterialBeachAccess = props => <Icon as={MaterialBeachAccessSvg} {...props} />

MaterialBeachAccess.defaultProps = { ...Icon.defaultProps }

MaterialBeachAccess.propTypes = { ...Icon.propTypes }

export default MaterialBeachAccess
