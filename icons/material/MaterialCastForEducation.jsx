...
const MaterialCastForEducationSvg = props => (
  <svg
...
const MaterialCastForEducation = props => <Icon as={MaterialCastForEducationSvg} {...props} />

MaterialCastForEducation.defaultProps = { ...Icon.defaultProps }

MaterialCastForEducation.propTypes = { ...Icon.propTypes }

export default MaterialCastForEducation
