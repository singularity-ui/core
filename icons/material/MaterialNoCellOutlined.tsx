...
const MaterialNoCellOutlinedSvg = props => (
  <svg
...
const MaterialNoCellOutlined = props => <Icon as={MaterialNoCellOutlinedSvg} {...props} />

MaterialNoCellOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNoCellOutlined.propTypes = { ...Icon.propTypes }
