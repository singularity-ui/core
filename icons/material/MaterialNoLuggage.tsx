...
const MaterialNoLuggageSvg = props => (
  <svg
...
const MaterialNoLuggage = props => <Icon as={MaterialNoLuggageSvg} {...props} />

MaterialNoLuggage.defaultProps = { ...Icon.defaultProps }

MaterialNoLuggage.propTypes = { ...Icon.propTypes }
