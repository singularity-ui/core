...
const MaterialThirteenMpRoundedSvg = props => (
  <svg
...
const MaterialThirteenMpRounded = props => <Icon as={MaterialThirteenMpRoundedSvg} {...props} />

MaterialThirteenMpRounded.defaultProps = { ...Icon.defaultProps }

MaterialThirteenMpRounded.propTypes = { ...Icon.propTypes }
