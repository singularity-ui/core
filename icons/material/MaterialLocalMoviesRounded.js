...
const MaterialLocalMoviesRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalMoviesRounded = (styled.default || styled)(MaterialLocalMoviesRoundedSvg).attrs(p => ({
...
`;
MaterialLocalMoviesRounded.propTypes = {
