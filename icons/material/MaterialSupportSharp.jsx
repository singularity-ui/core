...
const MaterialSupportSharpSvg = props => (
  <svg
...
const MaterialSupportSharp = props => <Icon as={MaterialSupportSharpSvg} {...props} />

MaterialSupportSharp.defaultProps = { ...Icon.defaultProps }

MaterialSupportSharp.propTypes = { ...Icon.propTypes }

export default MaterialSupportSharp
