...
const MaterialAlarmOnOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOnOutlined = (styled.default || styled)(MaterialAlarmOnOutlinedSvg).attrs(p => ({
...
`;
MaterialAlarmOnOutlined.propTypes = {
