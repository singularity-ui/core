...
const MaterialPlumbingSvg = props => (
  <svg
...
const MaterialPlumbing = props => <Icon as={MaterialPlumbingSvg} {...props} />

MaterialPlumbing.defaultProps = { ...Icon.defaultProps }

MaterialPlumbing.propTypes = { ...Icon.propTypes }

export default MaterialPlumbing
