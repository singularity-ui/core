...
const MaterialMasksRoundedSvg = props => (
  <svg
...
const MaterialMasksRounded = props => <Icon as={MaterialMasksRoundedSvg} {...props} />

MaterialMasksRounded.defaultProps = { ...Icon.defaultProps }

MaterialMasksRounded.propTypes = { ...Icon.propTypes }

export default MaterialMasksRounded
