...
const MaterialCloudOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCloudOffRounded = (styled.default || styled)(MaterialCloudOffRoundedSvg).attrs(p => ({
...
`;
MaterialCloudOffRounded.propTypes = {
