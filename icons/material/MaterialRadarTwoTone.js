...
const MaterialRadarTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRadarTwoTone = (styled.default || styled)(MaterialRadarTwoToneSvg).attrs(p => ({
...
`;
MaterialRadarTwoTone.propTypes = {
