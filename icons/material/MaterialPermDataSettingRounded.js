...
const MaterialPermDataSettingRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPermDataSettingRounded = (styled.default || styled)(MaterialPermDataSettingRoundedSvg).attrs(p => ({
...
`;
MaterialPermDataSettingRounded.propTypes = {
