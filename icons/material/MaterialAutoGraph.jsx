...
const MaterialAutoGraphSvg = props => (
  <svg
...
const MaterialAutoGraph = props => <Icon as={MaterialAutoGraphSvg} {...props} />

MaterialAutoGraph.defaultProps = { ...Icon.defaultProps }

MaterialAutoGraph.propTypes = { ...Icon.propTypes }
