...
const MaterialCloudOffSharpSvg = props => (
...
const MaterialCloudOffSharp = props => <Icon as={MaterialCloudOffSharpSvg} {...props} />

MaterialCloudOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialCloudOffSharp.propTypes = { ...Icon.propTypes }

export default MaterialCloudOffSharp
