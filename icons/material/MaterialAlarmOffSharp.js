...
const MaterialAlarmOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOffSharp = (styled.default || styled)(MaterialAlarmOffSharpSvg).attrs(p => ({
...
`;
MaterialAlarmOffSharp.propTypes = {
