...
const MaterialPostAddSvg = props => (
  <svg
...
const MaterialPostAdd = props => <Icon as={MaterialPostAddSvg} {...props} />

MaterialPostAdd.defaultProps = { ...Icon.defaultProps }

MaterialPostAdd.propTypes = { ...Icon.propTypes }
