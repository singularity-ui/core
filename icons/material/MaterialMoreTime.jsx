...
const MaterialMoreTimeSvg = props => (
  <svg
...
const MaterialMoreTime = props => <Icon as={MaterialMoreTimeSvg} {...props} />

MaterialMoreTime.defaultProps = { ...Icon.defaultProps }

MaterialMoreTime.propTypes = { ...Icon.propTypes }
