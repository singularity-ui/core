...
const MaterialOpenInNewOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOpenInNewOff = (styled.default || styled)(MaterialOpenInNewOffSvg).attrs(p => ({
...
`;
MaterialOpenInNewOff.propTypes = {
