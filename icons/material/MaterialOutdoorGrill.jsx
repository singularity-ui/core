...
const MaterialOutdoorGrillSvg = props => (
  <svg
...
const MaterialOutdoorGrill = props => <Icon as={MaterialOutdoorGrillSvg} {...props} />

MaterialOutdoorGrill.defaultProps = { ...Icon.defaultProps }

MaterialOutdoorGrill.propTypes = { ...Icon.propTypes }

export default MaterialOutdoorGrill
