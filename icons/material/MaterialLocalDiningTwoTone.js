...
const MaterialLocalDiningTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalDiningTwoTone = (styled.default || styled)(MaterialLocalDiningTwoToneSvg).attrs(p => ({
...
`;
MaterialLocalDiningTwoTone.propTypes = {
