...
const MaterialCable = props => <Icon as={MaterialCableSvg} {...props} />

MaterialCable.defaultProps = { ...Icon.defaultProps }

MaterialCable.propTypes = { ...Icon.propTypes }

export default MaterialCable
