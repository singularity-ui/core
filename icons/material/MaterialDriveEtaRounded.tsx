...
const MaterialDriveEtaRoundedSvg = props => (
...
const MaterialDriveEtaRounded = props => <Icon as={MaterialDriveEtaRoundedSvg} {...props} />

MaterialDriveEtaRounded.defaultProps = { ...Icon.defaultProps }

MaterialDriveEtaRounded.propTypes = { ...Icon.propTypes }

export default MaterialDriveEtaRounded
