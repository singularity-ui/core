...
const MaterialEmojiSymbolsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEmojiSymbols = (styled.default || styled)(MaterialEmojiSymbolsSvg).attrs(p => ({
...
`;
MaterialEmojiSymbols.propTypes = {
