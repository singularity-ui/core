...
const MaterialFlashlightOffOutlinedSvg = props => (
  <svg
...
const MaterialFlashlightOffOutlined = props => <Icon as={MaterialFlashlightOffOutlinedSvg} {...props} />

MaterialFlashlightOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFlashlightOffOutlined.propTypes = { ...Icon.propTypes }
