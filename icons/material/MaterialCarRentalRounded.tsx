...
const MaterialCarRentalRoundedSvg = props => (
  <svg
...
const MaterialCarRentalRounded = props => <Icon as={MaterialCarRentalRoundedSvg} {...props} />

MaterialCarRentalRounded.defaultProps = { ...Icon.defaultProps }

MaterialCarRentalRounded.propTypes = { ...Icon.propTypes }
