...
const MaterialDehazeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDehazeRounded = (styled.default || styled)(MaterialDehazeRoundedSvg).attrs(p => ({
...
`;
MaterialDehazeRounded.propTypes = {
