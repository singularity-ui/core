...
const MaterialMotionPhotosPauseRoundedSvg = props => (
  <svg
...
const MaterialMotionPhotosPauseRounded = props => <Icon as={MaterialMotionPhotosPauseRoundedSvg} {...props} />

MaterialMotionPhotosPauseRounded.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosPauseRounded.propTypes = { ...Icon.propTypes }
