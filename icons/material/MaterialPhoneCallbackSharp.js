...
const MaterialPhoneCallbackSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneCallbackSharp = (styled.default || styled)(MaterialPhoneCallbackSharpSvg).attrs(p => ({
...
`;
MaterialPhoneCallbackSharp.propTypes = {
