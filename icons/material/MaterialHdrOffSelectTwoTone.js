...
const MaterialHdrOffSelectTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrOffSelectTwoTone = (styled.default || styled)(MaterialHdrOffSelectTwoToneSvg).attrs(p => ({
...
`;
MaterialHdrOffSelectTwoTone.propTypes = {
