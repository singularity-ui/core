...
const MaterialNoFood = props => <Icon as={MaterialNoFoodSvg} {...props} />

MaterialNoFood.defaultProps = { ...Icon.defaultProps }

MaterialNoFood.propTypes = { ...Icon.propTypes }
