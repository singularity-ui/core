...
const MaterialBathtubOutlinedSvg = props => (
  <svg
...
const MaterialBathtubOutlined = props => <Icon as={MaterialBathtubOutlinedSvg} {...props} />

MaterialBathtubOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBathtubOutlined.propTypes = { ...Icon.propTypes }

export default MaterialBathtubOutlined
