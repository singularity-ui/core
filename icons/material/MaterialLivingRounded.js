...
const MaterialLivingRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLivingRounded = (styled.default || styled)(MaterialLivingRoundedSvg).attrs(p => ({
...
`;
MaterialLivingRounded.propTypes = {
