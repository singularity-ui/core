...
const MaterialHealingOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHealingOutlined = (styled.default || styled)(MaterialHealingOutlinedSvg).attrs(p => ({
...
`;
MaterialHealingOutlined.propTypes = {
