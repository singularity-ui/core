...
const MaterialSettingsVoiceRoundedSvg = props => (
  <svg
...
const MaterialSettingsVoiceRounded = props => <Icon as={MaterialSettingsVoiceRoundedSvg} {...props} />

MaterialSettingsVoiceRounded.defaultProps = { ...Icon.defaultProps }

MaterialSettingsVoiceRounded.propTypes = { ...Icon.propTypes }
