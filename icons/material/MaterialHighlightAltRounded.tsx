...
const MaterialHighlightAltRoundedSvg = props => (
  <svg
...
const MaterialHighlightAltRounded = props => <Icon as={MaterialHighlightAltRoundedSvg} {...props} />

MaterialHighlightAltRounded.defaultProps = { ...Icon.defaultProps }

MaterialHighlightAltRounded.propTypes = { ...Icon.propTypes }

export default MaterialHighlightAltRounded
