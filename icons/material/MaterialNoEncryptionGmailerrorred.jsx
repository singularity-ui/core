...
const MaterialNoEncryptionGmailerrorredSvg = props => (
  <svg
...
const MaterialNoEncryptionGmailerrorred = props => <Icon as={MaterialNoEncryptionGmailerrorredSvg} {...props} />

MaterialNoEncryptionGmailerrorred.defaultProps = { ...Icon.defaultProps }

MaterialNoEncryptionGmailerrorred.propTypes = { ...Icon.propTypes }

export default MaterialNoEncryptionGmailerrorred
