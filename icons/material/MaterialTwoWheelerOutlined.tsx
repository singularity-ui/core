...
const MaterialTwoWheelerOutlinedSvg = props => (
  <svg
...
const MaterialTwoWheelerOutlined = props => <Icon as={MaterialTwoWheelerOutlinedSvg} {...props} />

MaterialTwoWheelerOutlined.defaultProps = { ...Icon.defaultProps }

MaterialTwoWheelerOutlined.propTypes = { ...Icon.propTypes }

export default MaterialTwoWheelerOutlined
