...
const MaterialVolunteerActivismSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVolunteerActivism = (styled.default || styled)(MaterialVolunteerActivismSvg).attrs(p => ({
...
`;
MaterialVolunteerActivism.propTypes = {
