...
const MaterialSellTwoToneSvg = props => (
  <svg
...
const MaterialSellTwoTone = props => <Icon as={MaterialSellTwoToneSvg} {...props} />

MaterialSellTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSellTwoTone.propTypes = { ...Icon.propTypes }
