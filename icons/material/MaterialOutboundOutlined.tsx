...
const MaterialOutboundOutlinedSvg = props => (
  <svg
...
const MaterialOutboundOutlined = props => <Icon as={MaterialOutboundOutlinedSvg} {...props} />

MaterialOutboundOutlined.defaultProps = { ...Icon.defaultProps }

MaterialOutboundOutlined.propTypes = { ...Icon.propTypes }
