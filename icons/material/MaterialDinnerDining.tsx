...
const MaterialDinnerDiningSvg = props => (
  <svg
...
const MaterialDinnerDining = props => <Icon as={MaterialDinnerDiningSvg} {...props} />

MaterialDinnerDining.defaultProps = { ...Icon.defaultProps }

MaterialDinnerDining.propTypes = { ...Icon.propTypes }
