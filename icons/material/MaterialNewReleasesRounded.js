...
const MaterialNewReleasesRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNewReleasesRounded = (styled.default || styled)(MaterialNewReleasesRoundedSvg).attrs(p => ({
...
`;
MaterialNewReleasesRounded.propTypes = {
