...
const MaterialAccessAlarmRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAccessAlarmRounded = (styled.default || styled)(MaterialAccessAlarmRoundedSvg).attrs(p => ({
...
`;
MaterialAccessAlarmRounded.propTypes = {
