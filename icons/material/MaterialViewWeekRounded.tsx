...
const MaterialViewWeekRoundedSvg = props => (
  <svg
...
const MaterialViewWeekRounded = props => <Icon as={MaterialViewWeekRoundedSvg} {...props} />

MaterialViewWeekRounded.defaultProps = { ...Icon.defaultProps }

MaterialViewWeekRounded.propTypes = { ...Icon.propTypes }

export default MaterialViewWeekRounded
