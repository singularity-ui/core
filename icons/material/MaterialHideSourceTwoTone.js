...
const MaterialHideSourceTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHideSourceTwoTone = (styled.default || styled)(MaterialHideSourceTwoToneSvg).attrs(p => ({
...
`;
MaterialHideSourceTwoTone.propTypes = {
