...
const MaterialAnimationSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAnimationSharp = (styled.default || styled)(MaterialAnimationSharpSvg).attrs(p => ({
...
`;
MaterialAnimationSharp.propTypes = {
