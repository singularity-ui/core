...
const MaterialVideoCameraBackSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVideoCameraBack = (styled.default || styled)(MaterialVideoCameraBackSvg).attrs(p => ({
...
`;
MaterialVideoCameraBack.propTypes = {
