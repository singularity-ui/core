...
const MaterialRateReviewTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRateReviewTwoTone = (styled.default || styled)(MaterialRateReviewTwoToneSvg).attrs(p => ({
...
`;
MaterialRateReviewTwoTone.propTypes = {
