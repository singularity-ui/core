...
const MaterialStormRoundedSvg = props => (
  <svg
...
const MaterialStormRounded = props => <Icon as={MaterialStormRoundedSvg} {...props} />

MaterialStormRounded.defaultProps = { ...Icon.defaultProps }

MaterialStormRounded.propTypes = { ...Icon.propTypes }
