...
const MaterialTenMp = props => <Icon as={MaterialTenMpSvg} {...props} />

MaterialTenMp.defaultProps = { ...Icon.defaultProps }

MaterialTenMp.propTypes = { ...Icon.propTypes }

export default MaterialTenMp
