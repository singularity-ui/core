...
const MaterialMovieFilterSharpSvg = props => (
...
const MaterialMovieFilterSharp = props => <Icon as={MaterialMovieFilterSharpSvg} {...props} />

MaterialMovieFilterSharp.defaultProps = { ...Icon.defaultProps }

MaterialMovieFilterSharp.propTypes = { ...Icon.propTypes }
