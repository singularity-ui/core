...
const MaterialApartmentSvg = props => (
  <svg
...
const MaterialApartment = props => <Icon as={MaterialApartmentSvg} {...props} />

MaterialApartment.defaultProps = { ...Icon.defaultProps }

MaterialApartment.propTypes = { ...Icon.propTypes }

export default MaterialApartment
