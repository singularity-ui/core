...
const MaterialVerifiedSvg = props => (
  <svg
...
const MaterialVerified = props => <Icon as={MaterialVerifiedSvg} {...props} />

MaterialVerified.defaultProps = { ...Icon.defaultProps }

MaterialVerified.propTypes = { ...Icon.propTypes }

export default MaterialVerified
