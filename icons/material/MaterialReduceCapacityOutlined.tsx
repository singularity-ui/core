...
const MaterialReduceCapacityOutlinedSvg = props => (
  <svg
...
const MaterialReduceCapacityOutlined = props => <Icon as={MaterialReduceCapacityOutlinedSvg} {...props} />

MaterialReduceCapacityOutlined.defaultProps = { ...Icon.defaultProps }

MaterialReduceCapacityOutlined.propTypes = { ...Icon.propTypes }

export default MaterialReduceCapacityOutlined
