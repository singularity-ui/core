...
const MaterialFourteenMpSharpSvg = props => (
  <svg
...
const MaterialFourteenMpSharp = props => <Icon as={MaterialFourteenMpSharpSvg} {...props} />

MaterialFourteenMpSharp.defaultProps = { ...Icon.defaultProps }

MaterialFourteenMpSharp.propTypes = { ...Icon.propTypes }
