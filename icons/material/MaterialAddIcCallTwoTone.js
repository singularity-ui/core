...
const MaterialAddIcCallTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddIcCallTwoTone = (styled.default || styled)(MaterialAddIcCallTwoToneSvg).attrs(p => ({
...
`;
MaterialAddIcCallTwoTone.propTypes = {
