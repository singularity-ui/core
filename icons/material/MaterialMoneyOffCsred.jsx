...
const MaterialMoneyOffCsredSvg = props => (
  <svg
...
const MaterialMoneyOffCsred = props => <Icon as={MaterialMoneyOffCsredSvg} {...props} />

MaterialMoneyOffCsred.defaultProps = { ...Icon.defaultProps }

MaterialMoneyOffCsred.propTypes = { ...Icon.propTypes }
