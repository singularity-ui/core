...
const MaterialPestControlSharpSvg = props => (
  <svg
...
const MaterialPestControlSharp = props => <Icon as={MaterialPestControlSharpSvg} {...props} />

MaterialPestControlSharp.defaultProps = { ...Icon.defaultProps }

MaterialPestControlSharp.propTypes = { ...Icon.propTypes }
