...
const MaterialVerifiedRoundedSvg = props => (
  <svg
...
const MaterialVerifiedRounded = props => <Icon as={MaterialVerifiedRoundedSvg} {...props} />

MaterialVerifiedRounded.defaultProps = { ...Icon.defaultProps }

MaterialVerifiedRounded.propTypes = { ...Icon.propTypes }

export default MaterialVerifiedRounded
