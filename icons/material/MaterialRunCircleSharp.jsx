...
const MaterialRunCircleSharpSvg = props => (
  <svg
...
const MaterialRunCircleSharp = props => <Icon as={MaterialRunCircleSharpSvg} {...props} />

MaterialRunCircleSharp.defaultProps = { ...Icon.defaultProps }

MaterialRunCircleSharp.propTypes = { ...Icon.propTypes }
