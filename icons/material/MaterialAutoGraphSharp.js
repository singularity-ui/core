...
const MaterialAutoGraphSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAutoGraphSharp = (styled.default || styled)(MaterialAutoGraphSharpSvg).attrs(p => ({
...
`;
MaterialAutoGraphSharp.propTypes = {
