...
const MaterialNextPlanOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNextPlanOutlined = (styled.default || styled)(MaterialNextPlanOutlinedSvg).attrs(p => ({
...
`;
MaterialNextPlanOutlined.propTypes = {
