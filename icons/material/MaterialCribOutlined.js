...
const MaterialCribOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCribOutlined = (styled.default || styled)(MaterialCribOutlinedSvg).attrs(p => ({
...
`;
MaterialCribOutlined.propTypes = {
