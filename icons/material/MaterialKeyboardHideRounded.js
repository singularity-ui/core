...
const MaterialKeyboardHideRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKeyboardHideRounded = (styled.default || styled)(MaterialKeyboardHideRoundedSvg).attrs(p => ({
...
`;
MaterialKeyboardHideRounded.propTypes = {
