...
const MaterialUmbrellaSharpSvg = props => (
  <svg
...
const MaterialUmbrellaSharp = props => <Icon as={MaterialUmbrellaSharpSvg} {...props} />

MaterialUmbrellaSharp.defaultProps = { ...Icon.defaultProps }

MaterialUmbrellaSharp.propTypes = { ...Icon.propTypes }

export default MaterialUmbrellaSharp
