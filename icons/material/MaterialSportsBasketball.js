...
const MaterialSportsBasketballSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsBasketball = (styled.default || styled)(MaterialSportsBasketballSvg).attrs(p => ({
...
`;
MaterialSportsBasketball.propTypes = {
