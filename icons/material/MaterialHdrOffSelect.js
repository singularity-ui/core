...
const MaterialHdrOffSelectSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrOffSelect = (styled.default || styled)(MaterialHdrOffSelectSvg).attrs(p => ({
...
`;
MaterialHdrOffSelect.propTypes = {
