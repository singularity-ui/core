...
const MaterialBathroomSvg = props => (
  <svg
...
const MaterialBathroom = props => <Icon as={MaterialBathroomSvg} {...props} />

MaterialBathroom.defaultProps = { ...Icon.defaultProps }

MaterialBathroom.propTypes = { ...Icon.propTypes }

export default MaterialBathroom
