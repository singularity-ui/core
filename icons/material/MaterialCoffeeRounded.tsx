...
const MaterialCoffeeRoundedSvg = props => (
  <svg
...
const MaterialCoffeeRounded = props => <Icon as={MaterialCoffeeRoundedSvg} {...props} />

MaterialCoffeeRounded.defaultProps = { ...Icon.defaultProps }

MaterialCoffeeRounded.propTypes = { ...Icon.propTypes }

export default MaterialCoffeeRounded
