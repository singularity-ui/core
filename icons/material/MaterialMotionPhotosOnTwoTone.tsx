...
const MaterialMotionPhotosOnTwoToneSvg = props => (
  <svg
...
const MaterialMotionPhotosOnTwoTone = props => <Icon as={MaterialMotionPhotosOnTwoToneSvg} {...props} />

MaterialMotionPhotosOnTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosOnTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosOnTwoTone
