...
const MaterialOutletRoundedSvg = props => (
  <svg
...
const MaterialOutletRounded = props => <Icon as={MaterialOutletRoundedSvg} {...props} />

MaterialOutletRounded.defaultProps = { ...Icon.defaultProps }

MaterialOutletRounded.propTypes = { ...Icon.propTypes }
