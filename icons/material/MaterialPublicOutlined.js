...
const MaterialPublicOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPublicOutlined = (styled.default || styled)(MaterialPublicOutlinedSvg).attrs(p => ({
...
`;
MaterialPublicOutlined.propTypes = {
