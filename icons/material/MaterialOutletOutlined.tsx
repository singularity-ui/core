...
const MaterialOutletOutlinedSvg = props => (
  <svg
...
const MaterialOutletOutlined = props => <Icon as={MaterialOutletOutlinedSvg} {...props} />

MaterialOutletOutlined.defaultProps = { ...Icon.defaultProps }

MaterialOutletOutlined.propTypes = { ...Icon.propTypes }
