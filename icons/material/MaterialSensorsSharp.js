...
const MaterialSensorsSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSensorsSharp = (styled.default || styled)(MaterialSensorsSharpSvg).attrs(p => ({
...
`;
MaterialSensorsSharp.propTypes = {
