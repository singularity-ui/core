...
const MaterialPlayCircleTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPlayCircleTwoTone = (styled.default || styled)(MaterialPlayCircleTwoToneSvg).attrs(p => ({
...
`;
MaterialPlayCircleTwoTone.propTypes = {
