...
const MaterialNetworkCheckRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNetworkCheckRounded = (styled.default || styled)(MaterialNetworkCheckRoundedSvg).attrs(p => ({
...
`;
MaterialNetworkCheckRounded.propTypes = {
