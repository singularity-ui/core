...
const MaterialSportsFootballSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsFootball = (styled.default || styled)(MaterialSportsFootballSvg).attrs(p => ({
...
`;
MaterialSportsFootball.propTypes = {
