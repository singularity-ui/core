...
const MaterialDriveEtaTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDriveEtaTwoTone = (styled.default || styled)(MaterialDriveEtaTwoToneSvg).attrs(p => ({
...
`;
MaterialDriveEtaTwoTone.propTypes = {
