...
const MaterialDoorbellRoundedSvg = props => (
  <svg
...
const MaterialDoorbellRounded = props => <Icon as={MaterialDoorbellRoundedSvg} {...props} />

MaterialDoorbellRounded.defaultProps = { ...Icon.defaultProps }

MaterialDoorbellRounded.propTypes = { ...Icon.propTypes }
