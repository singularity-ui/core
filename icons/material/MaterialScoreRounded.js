...
const MaterialScoreRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialScoreRounded = (styled.default || styled)(MaterialScoreRoundedSvg).attrs(p => ({
...
`;
MaterialScoreRounded.propTypes = {
