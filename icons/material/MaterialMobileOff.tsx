...
const MaterialMobileOffSvg = props => (
...
const MaterialMobileOff = props => <Icon as={MaterialMobileOffSvg} {...props} />

MaterialMobileOff.defaultProps = { ...Icon.defaultProps }

MaterialMobileOff.propTypes = { ...Icon.propTypes }
