...
const MaterialUpcomingSvg = props => (
  <svg
...
const MaterialUpcoming = props => <Icon as={MaterialUpcomingSvg} {...props} />

MaterialUpcoming.defaultProps = { ...Icon.defaultProps }

MaterialUpcoming.propTypes = { ...Icon.propTypes }
