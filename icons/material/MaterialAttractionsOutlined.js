...
const MaterialAttractionsOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttractionsOutlined = (styled.default || styled)(MaterialAttractionsOutlinedSvg).attrs(p => ({
...
`;
MaterialAttractionsOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialAttractionsOutlined;