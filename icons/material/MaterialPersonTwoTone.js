...
const MaterialPersonTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPersonTwoTone = (styled.default || styled)(MaterialPersonTwoToneSvg).attrs(p => ({
...
`;
MaterialPersonTwoTone.propTypes = {
