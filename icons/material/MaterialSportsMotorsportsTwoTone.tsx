...
const MaterialSportsMotorsportsTwoToneSvg = props => (
  <svg
...
const MaterialSportsMotorsportsTwoTone = props => <Icon as={MaterialSportsMotorsportsTwoToneSvg} {...props} />

MaterialSportsMotorsportsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSportsMotorsportsTwoTone.propTypes = { ...Icon.propTypes }
