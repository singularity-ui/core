...
const MaterialAddTaskTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddTaskTwoTone = (styled.default || styled)(MaterialAddTaskTwoToneSvg).attrs(p => ({
...
`;
MaterialAddTaskTwoTone.propTypes = {
