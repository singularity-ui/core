...
const MaterialRequestPageSvg = props => (
  <svg
...
const MaterialRequestPage = props => <Icon as={MaterialRequestPageSvg} {...props} />

MaterialRequestPage.defaultProps = { ...Icon.defaultProps }

MaterialRequestPage.propTypes = { ...Icon.propTypes }
