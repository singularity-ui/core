...
const MaterialEditNotificationsSvg = props => (
  <svg
...
const MaterialEditNotifications = props => <Icon as={MaterialEditNotificationsSvg} {...props} />

MaterialEditNotifications.defaultProps = { ...Icon.defaultProps }

MaterialEditNotifications.propTypes = { ...Icon.propTypes }

export default MaterialEditNotifications
