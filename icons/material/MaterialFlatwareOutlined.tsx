...
const MaterialFlatwareOutlinedSvg = props => (
  <svg
...
const MaterialFlatwareOutlined = props => <Icon as={MaterialFlatwareOutlinedSvg} {...props} />

MaterialFlatwareOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFlatwareOutlined.propTypes = { ...Icon.propTypes }
