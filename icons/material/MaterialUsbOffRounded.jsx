...
const MaterialUsbOffRoundedSvg = props => (
  <svg
...
const MaterialUsbOffRounded = props => <Icon as={MaterialUsbOffRoundedSvg} {...props} />

MaterialUsbOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialUsbOffRounded.propTypes = { ...Icon.propTypes }
