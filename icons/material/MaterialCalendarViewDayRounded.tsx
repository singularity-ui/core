...
const MaterialCalendarViewDayRoundedSvg = props => (
  <svg
...
const MaterialCalendarViewDayRounded = props => <Icon as={MaterialCalendarViewDayRoundedSvg} {...props} />

MaterialCalendarViewDayRounded.defaultProps = { ...Icon.defaultProps }

MaterialCalendarViewDayRounded.propTypes = { ...Icon.propTypes }
