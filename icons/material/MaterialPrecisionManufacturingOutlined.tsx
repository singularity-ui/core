...
const MaterialPrecisionManufacturingOutlinedSvg = props => (
  <svg
...
const MaterialPrecisionManufacturingOutlined = props => (
  <Icon as={MaterialPrecisionManufacturingOutlinedSvg} {...props} />
)

MaterialPrecisionManufacturingOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPrecisionManufacturingOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPrecisionManufacturingOutlined
