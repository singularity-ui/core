...
const MaterialRateReviewRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRateReviewRounded = (styled.default || styled)(MaterialRateReviewRoundedSvg).attrs(p => ({
...
`;
MaterialRateReviewRounded.propTypes = {
