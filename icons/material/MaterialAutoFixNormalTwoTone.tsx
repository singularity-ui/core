...
const MaterialAutoFixNormalTwoToneSvg = props => (
  <svg
...
const MaterialAutoFixNormalTwoTone = props => <Icon as={MaterialAutoFixNormalTwoToneSvg} {...props} />

MaterialAutoFixNormalTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialAutoFixNormalTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialAutoFixNormalTwoTone
