...
const MaterialReviewsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReviewsTwoTone = (styled.default || styled)(MaterialReviewsTwoToneSvg).attrs(p => ({
...
`;
MaterialReviewsTwoTone.propTypes = {
