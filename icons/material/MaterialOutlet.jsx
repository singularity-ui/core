...
const MaterialOutlet = props => <Icon as={MaterialOutletSvg} {...props} />

MaterialOutlet.defaultProps = { ...Icon.defaultProps }

MaterialOutlet.propTypes = { ...Icon.propTypes }
