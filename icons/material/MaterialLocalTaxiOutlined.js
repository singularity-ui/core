...
const MaterialLocalTaxiOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalTaxiOutlined = (styled.default || styled)(MaterialLocalTaxiOutlinedSvg).attrs(p => ({
...
`;
MaterialLocalTaxiOutlined.propTypes = {
