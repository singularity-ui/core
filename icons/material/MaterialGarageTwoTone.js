...
const MaterialGarageTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGarageTwoTone = (styled.default || styled)(MaterialGarageTwoToneSvg).attrs(p => ({
...
`;
MaterialGarageTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialGarageTwoTone;