...
const MaterialWeekendSvg = props => (
  <svg
...
const MaterialWeekend = props => <Icon as={MaterialWeekendSvg} {...props} />

MaterialWeekend.defaultProps = { ...Icon.defaultProps }

MaterialWeekend.propTypes = { ...Icon.propTypes }
