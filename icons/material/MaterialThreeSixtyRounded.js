...
const MaterialThreeSixtyRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThreeSixtyRounded = (styled.default || styled)(MaterialThreeSixtyRoundedSvg).attrs(p => ({
...
`;
MaterialThreeSixtyRounded.propTypes = {
