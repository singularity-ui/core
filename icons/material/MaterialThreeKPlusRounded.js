...
const MaterialThreeKPlusRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThreeKPlusRounded = (styled.default || styled)(MaterialThreeKPlusRoundedSvg).attrs(p => ({
...
`;
MaterialThreeKPlusRounded.propTypes = {
