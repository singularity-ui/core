...
const MaterialSurfingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSurfingTwoTone = (styled.default || styled)(MaterialSurfingTwoToneSvg).attrs(p => ({
...
`;
MaterialSurfingTwoTone.propTypes = {
