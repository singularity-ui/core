...
const MaterialWbAutoTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWbAutoTwoTone = (styled.default || styled)(MaterialWbAutoTwoToneSvg).attrs(p => ({
...
`;
MaterialWbAutoTwoTone.propTypes = {
