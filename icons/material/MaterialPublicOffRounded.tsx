...
const MaterialPublicOffRoundedSvg = props => (
  <svg
...
const MaterialPublicOffRounded = props => <Icon as={MaterialPublicOffRoundedSvg} {...props} />

MaterialPublicOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialPublicOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialPublicOffRounded
