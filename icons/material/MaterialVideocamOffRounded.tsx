...
const MaterialVideocamOffRoundedSvg = props => (
...
const MaterialVideocamOffRounded = props => <Icon as={MaterialVideocamOffRoundedSvg} {...props} />

MaterialVideocamOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialVideocamOffRounded.propTypes = { ...Icon.propTypes }
