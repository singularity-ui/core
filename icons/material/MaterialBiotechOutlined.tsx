...
const MaterialBiotechOutlinedSvg = props => (
  <svg
...
const MaterialBiotechOutlined = props => <Icon as={MaterialBiotechOutlinedSvg} {...props} />

MaterialBiotechOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBiotechOutlined.propTypes = { ...Icon.propTypes }

export default MaterialBiotechOutlined
