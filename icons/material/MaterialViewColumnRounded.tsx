...
const MaterialViewColumnRoundedSvg = props => (
  <svg
...
const MaterialViewColumnRounded = props => <Icon as={MaterialViewColumnRoundedSvg} {...props} />

MaterialViewColumnRounded.defaultProps = { ...Icon.defaultProps }

MaterialViewColumnRounded.propTypes = { ...Icon.propTypes }
