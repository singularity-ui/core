...
const MaterialDiscFullTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDiscFullTwoTone = (styled.default || styled)(MaterialDiscFullTwoToneSvg).attrs(p => ({
...
`;
MaterialDiscFullTwoTone.propTypes = {
