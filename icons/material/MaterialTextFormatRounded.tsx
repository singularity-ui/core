...
const MaterialTextFormatRoundedSvg = props => (
...
const MaterialTextFormatRounded = props => <Icon as={MaterialTextFormatRoundedSvg} {...props} />

MaterialTextFormatRounded.defaultProps = { ...Icon.defaultProps }

MaterialTextFormatRounded.propTypes = { ...Icon.propTypes }
