...
const MaterialGif = props => <Icon as={MaterialGifSvg} {...props} />

MaterialGif.defaultProps = { ...Icon.defaultProps }

MaterialGif.propTypes = { ...Icon.propTypes }

export default MaterialGif
