...
const MaterialPestControlSvg = props => (
  <svg
...
const MaterialPestControl = props => <Icon as={MaterialPestControlSvg} {...props} />

MaterialPestControl.defaultProps = { ...Icon.defaultProps }

MaterialPestControl.propTypes = { ...Icon.propTypes }

export default MaterialPestControl
