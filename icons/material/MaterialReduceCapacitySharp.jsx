...
const MaterialReduceCapacitySharpSvg = props => (
  <svg
...
const MaterialReduceCapacitySharp = props => <Icon as={MaterialReduceCapacitySharpSvg} {...props} />

MaterialReduceCapacitySharp.defaultProps = { ...Icon.defaultProps }

MaterialReduceCapacitySharp.propTypes = { ...Icon.propTypes }

export default MaterialReduceCapacitySharp
