...
const MaterialChaletOutlinedSvg = props => (
  <svg
...
const MaterialChaletOutlined = props => <Icon as={MaterialChaletOutlinedSvg} {...props} />

MaterialChaletOutlined.defaultProps = { ...Icon.defaultProps }

MaterialChaletOutlined.propTypes = { ...Icon.propTypes }

export default MaterialChaletOutlined
