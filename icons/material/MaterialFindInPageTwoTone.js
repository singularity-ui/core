...
const MaterialFindInPageTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFindInPageTwoTone = (styled.default || styled)(MaterialFindInPageTwoToneSvg).attrs(p => ({
...
`;
MaterialFindInPageTwoTone.propTypes = {
