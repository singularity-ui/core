...
const MaterialDraftsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDraftsRounded = (styled.default || styled)(MaterialDraftsRoundedSvg).attrs(p => ({
...
`;
MaterialDraftsRounded.propTypes = {
