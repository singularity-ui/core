...
const MaterialUmbrellaSvg = props => (
  <svg
...
const MaterialUmbrella = props => <Icon as={MaterialUmbrellaSvg} {...props} />

MaterialUmbrella.defaultProps = { ...Icon.defaultProps }

MaterialUmbrella.propTypes = { ...Icon.propTypes }
