...
const MaterialStreamTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStreamTwoTone = (styled.default || styled)(MaterialStreamTwoToneSvg).attrs(p => ({
...
`;
MaterialStreamTwoTone.propTypes = {
