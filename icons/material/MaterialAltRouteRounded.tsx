...
const MaterialAltRouteRoundedSvg = props => (
  <svg
...
const MaterialAltRouteRounded = props => <Icon as={MaterialAltRouteRoundedSvg} {...props} />

MaterialAltRouteRounded.defaultProps = { ...Icon.defaultProps }

MaterialAltRouteRounded.propTypes = { ...Icon.propTypes }
