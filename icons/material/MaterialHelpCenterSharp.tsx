...
const MaterialHelpCenterSharpSvg = props => (
  <svg
...
const MaterialHelpCenterSharp = props => <Icon as={MaterialHelpCenterSharpSvg} {...props} />

MaterialHelpCenterSharp.defaultProps = { ...Icon.defaultProps }

MaterialHelpCenterSharp.propTypes = { ...Icon.propTypes }
