...
const MaterialHouseRoundedSvg = props => (
  <svg
...
const MaterialHouseRounded = props => <Icon as={MaterialHouseRoundedSvg} {...props} />

MaterialHouseRounded.defaultProps = { ...Icon.defaultProps }

MaterialHouseRounded.propTypes = { ...Icon.propTypes }
