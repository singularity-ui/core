...
const MaterialHideSourceSharpSvg = props => (
  <svg
...
const MaterialHideSourceSharp = props => <Icon as={MaterialHideSourceSharpSvg} {...props} />

MaterialHideSourceSharp.defaultProps = { ...Icon.defaultProps }

MaterialHideSourceSharp.propTypes = { ...Icon.propTypes }

export default MaterialHideSourceSharp
