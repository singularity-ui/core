...
const MaterialSmokeFreeOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSmokeFreeOutlined = (styled.default || styled)(MaterialSmokeFreeOutlinedSvg).attrs(p => ({
...
`;
MaterialSmokeFreeOutlined.propTypes = {
