...
const MaterialMoped = props => <Icon as={MaterialMopedSvg} {...props} />

MaterialMoped.defaultProps = { ...Icon.defaultProps }

MaterialMoped.propTypes = { ...Icon.propTypes }

export default MaterialMoped
