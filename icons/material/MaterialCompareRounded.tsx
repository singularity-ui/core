...
const MaterialCompareRoundedSvg = props => (
...
const MaterialCompareRounded = props => <Icon as={MaterialCompareRoundedSvg} {...props} />

MaterialCompareRounded.defaultProps = { ...Icon.defaultProps }

MaterialCompareRounded.propTypes = { ...Icon.propTypes }
