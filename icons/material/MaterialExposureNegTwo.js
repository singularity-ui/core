...
const MaterialExposureNegTwoSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialExposureNegTwo = (styled.default || styled)(MaterialExposureNegTwoSvg).attrs(p => ({
...
`;
MaterialExposureNegTwo.propTypes = {
