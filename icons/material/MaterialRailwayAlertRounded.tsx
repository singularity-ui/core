...
const MaterialRailwayAlertRoundedSvg = props => (
  <svg
...
const MaterialRailwayAlertRounded = props => <Icon as={MaterialRailwayAlertRoundedSvg} {...props} />

MaterialRailwayAlertRounded.defaultProps = { ...Icon.defaultProps }

MaterialRailwayAlertRounded.propTypes = { ...Icon.propTypes }

export default MaterialRailwayAlertRounded
