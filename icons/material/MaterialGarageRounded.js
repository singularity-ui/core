...
const MaterialGarageRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGarageRounded = (styled.default || styled)(MaterialGarageRoundedSvg).attrs(p => ({
...
`;
MaterialGarageRounded.propTypes = {
