...
const MaterialFormatShapesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFormatShapes = (styled.default || styled)(MaterialFormatShapesSvg).attrs(p => ({
...
`;
MaterialFormatShapes.propTypes = {
