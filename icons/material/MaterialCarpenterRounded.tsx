...
const MaterialCarpenterRoundedSvg = props => (
  <svg
...
const MaterialCarpenterRounded = props => <Icon as={MaterialCarpenterRoundedSvg} {...props} />

MaterialCarpenterRounded.defaultProps = { ...Icon.defaultProps }

MaterialCarpenterRounded.propTypes = { ...Icon.propTypes }
