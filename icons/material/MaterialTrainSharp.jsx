...
const MaterialTrainSharpSvg = props => (
...
const MaterialTrainSharp = props => <Icon as={MaterialTrainSharpSvg} {...props} />

MaterialTrainSharp.defaultProps = { ...Icon.defaultProps }

MaterialTrainSharp.propTypes = { ...Icon.propTypes }

export default MaterialTrainSharp
