...
const MaterialAlarmRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmRounded = (styled.default || styled)(MaterialAlarmRoundedSvg).attrs(p => ({
...
`;
MaterialAlarmRounded.propTypes = {
