...
const MaterialAutoGraphOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAutoGraphOutlined = (styled.default || styled)(MaterialAutoGraphOutlinedSvg).attrs(p => ({
...
`;
MaterialAutoGraphOutlined.propTypes = {
