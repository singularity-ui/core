...
const MaterialElectricRickshawSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElectricRickshaw = (styled.default || styled)(MaterialElectricRickshawSvg).attrs(p => ({
...
`;
MaterialElectricRickshaw.propTypes = {
