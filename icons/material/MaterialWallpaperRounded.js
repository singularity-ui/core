...
const MaterialWallpaperRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWallpaperRounded = (styled.default || styled)(MaterialWallpaperRoundedSvg).attrs(p => ({
...
`;
MaterialWallpaperRounded.propTypes = {
