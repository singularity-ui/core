...
const MaterialPublicOffOutlinedSvg = props => (
  <svg
...
const MaterialPublicOffOutlined = props => <Icon as={MaterialPublicOffOutlinedSvg} {...props} />

MaterialPublicOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPublicOffOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPublicOffOutlined
