...
const MaterialBathtubSvg = props => (
  <svg
...
const MaterialBathtub = props => <Icon as={MaterialBathtubSvg} {...props} />

MaterialBathtub.defaultProps = { ...Icon.defaultProps }

MaterialBathtub.propTypes = { ...Icon.propTypes }

export default MaterialBathtub
