...
const MaterialUsb = props => <Icon as={MaterialUsbSvg} {...props} />

MaterialUsb.defaultProps = { ...Icon.defaultProps }

MaterialUsb.propTypes = { ...Icon.propTypes }

export default MaterialUsb
