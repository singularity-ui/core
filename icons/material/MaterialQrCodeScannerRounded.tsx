...
const MaterialQrCodeScannerRoundedSvg = props => (
  <svg
...
const MaterialQrCodeScannerRounded = props => <Icon as={MaterialQrCodeScannerRoundedSvg} {...props} />

MaterialQrCodeScannerRounded.defaultProps = { ...Icon.defaultProps }

MaterialQrCodeScannerRounded.propTypes = { ...Icon.propTypes }

export default MaterialQrCodeScannerRounded
