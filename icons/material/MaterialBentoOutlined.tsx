...
const MaterialBentoOutlinedSvg = props => (
  <svg
...
const MaterialBentoOutlined = props => <Icon as={MaterialBentoOutlinedSvg} {...props} />

MaterialBentoOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBentoOutlined.propTypes = { ...Icon.propTypes }
