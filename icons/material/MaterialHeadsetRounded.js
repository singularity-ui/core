...
const MaterialHeadsetRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHeadsetRounded = (styled.default || styled)(MaterialHeadsetRoundedSvg).attrs(p => ({
...
`;
MaterialHeadsetRounded.propTypes = {
