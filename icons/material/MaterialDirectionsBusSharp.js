...
const MaterialDirectionsBusSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDirectionsBusSharp = (styled.default || styled)(MaterialDirectionsBusSharpSvg).attrs(p => ({
...
`;
MaterialDirectionsBusSharp.propTypes = {
