...
const MaterialKayakingOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKayakingOutlined = (styled.default || styled)(MaterialKayakingOutlinedSvg).attrs(p => ({
...
`;
MaterialKayakingOutlined.propTypes = {
