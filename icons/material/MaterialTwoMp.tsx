...
const MaterialTwoMp = props => <Icon as={MaterialTwoMpSvg} {...props} />

MaterialTwoMp.defaultProps = { ...Icon.defaultProps }

MaterialTwoMp.propTypes = { ...Icon.propTypes }

export default MaterialTwoMp
