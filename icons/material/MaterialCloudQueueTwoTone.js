...
const MaterialCloudQueueTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCloudQueueTwoTone = (styled.default || styled)(MaterialCloudQueueTwoToneSvg).attrs(p => ({
...
`;
MaterialCloudQueueTwoTone.propTypes = {
