...
const MaterialHeightKPlusRoundedSvg = props => (
  <svg
...
const MaterialHeightKPlusRounded = props => <Icon as={MaterialHeightKPlusRoundedSvg} {...props} />

MaterialHeightKPlusRounded.defaultProps = { ...Icon.defaultProps }

MaterialHeightKPlusRounded.propTypes = { ...Icon.propTypes }
