...
const MaterialLinearScaleTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLinearScaleTwoTone = (styled.default || styled)(MaterialLinearScaleTwoToneSvg).attrs(p => ({
...
`;
MaterialLinearScaleTwoTone.propTypes = {
