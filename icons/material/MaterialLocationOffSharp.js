...
const MaterialLocationOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocationOffSharp = (styled.default || styled)(MaterialLocationOffSharpSvg).attrs(p => ({
...
`;
MaterialLocationOffSharp.propTypes = {
