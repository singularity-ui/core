...
const MaterialWbTwilightSvg = props => (
  <svg
...
const MaterialWbTwilight = props => <Icon as={MaterialWbTwilightSvg} {...props} />

MaterialWbTwilight.defaultProps = { ...Icon.defaultProps }

MaterialWbTwilight.propTypes = { ...Icon.propTypes }
