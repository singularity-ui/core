...
const MaterialThreeDRotationSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThreeDRotationSharp = (styled.default || styled)(MaterialThreeDRotationSharpSvg).attrs(p => ({
...
`;
MaterialThreeDRotationSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialThreeDRotationSharp;