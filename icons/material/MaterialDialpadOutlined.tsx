...
const MaterialDialpadOutlinedSvg = props => (
...
const MaterialDialpadOutlined = props => <Icon as={MaterialDialpadOutlinedSvg} {...props} />

MaterialDialpadOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDialpadOutlined.propTypes = { ...Icon.propTypes }

export default MaterialDialpadOutlined
