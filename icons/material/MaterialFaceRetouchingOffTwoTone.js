...
const MaterialFaceRetouchingOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialFaceRetouchingOffTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFaceRetouchingOffTwoTone;