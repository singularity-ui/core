...
const MaterialBlurOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBlurOffTwoTone = (styled.default || styled)(MaterialBlurOffTwoToneSvg).attrs(p => ({
...
`;
MaterialBlurOffTwoTone.propTypes = {
