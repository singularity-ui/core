...
const MaterialDonutLargeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDonutLargeTwoTone = (styled.default || styled)(MaterialDonutLargeTwoToneSvg).attrs(p => ({
...
`;
MaterialDonutLargeTwoTone.propTypes = {
