...
const MaterialTwoKPlusTwoToneSvg = props => (
  <svg
...
const MaterialTwoKPlusTwoTone = props => <Icon as={MaterialTwoKPlusTwoToneSvg} {...props} />

MaterialTwoKPlusTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialTwoKPlusTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialTwoKPlusTwoTone
