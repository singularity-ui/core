...
const MaterialSecurityUpdateGoodRoundedSvg = props => (
  <svg
...
const MaterialSecurityUpdateGoodRounded = props => <Icon as={MaterialSecurityUpdateGoodRoundedSvg} {...props} />

MaterialSecurityUpdateGoodRounded.defaultProps = { ...Icon.defaultProps }

MaterialSecurityUpdateGoodRounded.propTypes = { ...Icon.propTypes }

export default MaterialSecurityUpdateGoodRounded
