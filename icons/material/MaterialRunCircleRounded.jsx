...
const MaterialRunCircleRoundedSvg = props => (
  <svg
...
const MaterialRunCircleRounded = props => <Icon as={MaterialRunCircleRoundedSvg} {...props} />

MaterialRunCircleRounded.defaultProps = { ...Icon.defaultProps }

MaterialRunCircleRounded.propTypes = { ...Icon.propTypes }

export default MaterialRunCircleRounded
