...
const MaterialHdrPlusRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrPlusRounded = (styled.default || styled)(MaterialHdrPlusRoundedSvg).attrs(p => ({
...
`;
MaterialHdrPlusRounded.propTypes = {
