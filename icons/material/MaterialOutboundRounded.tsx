...
const MaterialOutboundRoundedSvg = props => (
  <svg
...
const MaterialOutboundRounded = props => <Icon as={MaterialOutboundRoundedSvg} {...props} />

MaterialOutboundRounded.defaultProps = { ...Icon.defaultProps }

MaterialOutboundRounded.propTypes = { ...Icon.propTypes }
