...
const MaterialSmartScreenRoundedSvg = props => (
  <svg
...
const MaterialSmartScreenRounded = props => <Icon as={MaterialSmartScreenRoundedSvg} {...props} />

MaterialSmartScreenRounded.defaultProps = { ...Icon.defaultProps }

MaterialSmartScreenRounded.propTypes = { ...Icon.propTypes }
