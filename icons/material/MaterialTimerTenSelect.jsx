...
const MaterialTimerTenSelectSvg = props => (
  <svg
...
const MaterialTimerTenSelect = props => <Icon as={MaterialTimerTenSelectSvg} {...props} />

MaterialTimerTenSelect.defaultProps = { ...Icon.defaultProps }

MaterialTimerTenSelect.propTypes = { ...Icon.propTypes }
