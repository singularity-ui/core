...
const MaterialChairRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChairRounded = (styled.default || styled)(MaterialChairRoundedSvg).attrs(p => ({
...
`;
MaterialChairRounded.propTypes = {
