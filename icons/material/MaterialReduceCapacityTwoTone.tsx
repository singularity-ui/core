...
const MaterialReduceCapacityTwoToneSvg = props => (
  <svg
...
const MaterialReduceCapacityTwoTone = props => <Icon as={MaterialReduceCapacityTwoToneSvg} {...props} />

MaterialReduceCapacityTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialReduceCapacityTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialReduceCapacityTwoTone
