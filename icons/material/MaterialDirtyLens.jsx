...
const MaterialDirtyLensSvg = props => (
...
const MaterialDirtyLens = props => <Icon as={MaterialDirtyLensSvg} {...props} />

MaterialDirtyLens.defaultProps = { ...Icon.defaultProps }

MaterialDirtyLens.propTypes = { ...Icon.propTypes }
