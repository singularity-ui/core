...
const MaterialSensorsOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSensorsOutlined = (styled.default || styled)(MaterialSensorsOutlinedSvg).attrs(p => ({
...
`;
MaterialSensorsOutlined.propTypes = {
