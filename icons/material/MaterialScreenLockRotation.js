...
const MaterialScreenLockRotationSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialScreenLockRotation = (styled.default || styled)(MaterialScreenLockRotationSvg).attrs(p => ({
...
`;
MaterialScreenLockRotation.propTypes = {
