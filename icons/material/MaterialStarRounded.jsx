...
const MaterialStarRoundedSvg = props => (
  <svg
...
const MaterialStarRounded = props => <Icon as={MaterialStarRoundedSvg} {...props} />

MaterialStarRounded.defaultProps = { ...Icon.defaultProps }

MaterialStarRounded.propTypes = { ...Icon.propTypes }
