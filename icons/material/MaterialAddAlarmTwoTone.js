...
const MaterialAddAlarmTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddAlarmTwoTone = (styled.default || styled)(MaterialAddAlarmTwoToneSvg).attrs(p => ({
...
`;
MaterialAddAlarmTwoTone.propTypes = {
