...
const MaterialRemoveDoneOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRemoveDoneOutlined = (styled.default || styled)(MaterialRemoveDoneOutlinedSvg).attrs(p => ({
...
`;
MaterialRemoveDoneOutlined.propTypes = {
