...
const MaterialTimerTenOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerTenOutlined = (styled.default || styled)(MaterialTimerTenOutlinedSvg).attrs(p => ({
...
`;
MaterialTimerTenOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialTimerTenOutlined;