...
const MaterialLightbulbTwoToneSvg = props => (
  <svg
...
const MaterialLightbulbTwoTone = props => <Icon as={MaterialLightbulbTwoToneSvg} {...props} />

MaterialLightbulbTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialLightbulbTwoTone.propTypes = { ...Icon.propTypes }
