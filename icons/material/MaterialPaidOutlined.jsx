...
const MaterialPaidOutlinedSvg = props => (
  <svg
...
const MaterialPaidOutlined = props => <Icon as={MaterialPaidOutlinedSvg} {...props} />

MaterialPaidOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPaidOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPaidOutlined
