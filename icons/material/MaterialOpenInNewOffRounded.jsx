...
const MaterialOpenInNewOffRoundedSvg = props => (
  <svg
...
const MaterialOpenInNewOffRounded = props => <Icon as={MaterialOpenInNewOffRoundedSvg} {...props} />

MaterialOpenInNewOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialOpenInNewOffRounded.propTypes = { ...Icon.propTypes }
