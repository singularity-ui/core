...
const MaterialLabelRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLabelRounded = (styled.default || styled)(MaterialLabelRoundedSvg).attrs(p => ({
...
`;
MaterialLabelRounded.propTypes = {
