...
const MaterialTvOff = props => <Icon as={MaterialTvOffSvg} {...props} />

MaterialTvOff.defaultProps = { ...Icon.defaultProps }

MaterialTvOff.propTypes = { ...Icon.propTypes }
