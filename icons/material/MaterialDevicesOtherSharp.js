...
const MaterialDevicesOtherSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDevicesOtherSharp = (styled.default || styled)(MaterialDevicesOtherSharpSvg).attrs(p => ({
...
`;
MaterialDevicesOtherSharp.propTypes = {
