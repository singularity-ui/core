...
const MaterialSportsTennisSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsTennis = (styled.default || styled)(MaterialSportsTennisSvg).attrs(p => ({
...
`;
MaterialSportsTennis.propTypes = {
