...
const MaterialUsbSharpSvg = props => (
...
const MaterialUsbSharp = props => <Icon as={MaterialUsbSharpSvg} {...props} />

MaterialUsbSharp.defaultProps = { ...Icon.defaultProps }

MaterialUsbSharp.propTypes = { ...Icon.propTypes }

export default MaterialUsbSharp
