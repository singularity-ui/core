...
const MaterialRuleFolderSharpSvg = props => (
  <svg
...
const MaterialRuleFolderSharp = props => <Icon as={MaterialRuleFolderSharpSvg} {...props} />

MaterialRuleFolderSharp.defaultProps = { ...Icon.defaultProps }

MaterialRuleFolderSharp.propTypes = { ...Icon.propTypes }
