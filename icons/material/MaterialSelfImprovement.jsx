...
const MaterialSelfImprovementSvg = props => (
  <svg
...
const MaterialSelfImprovement = props => <Icon as={MaterialSelfImprovementSvg} {...props} />

MaterialSelfImprovement.defaultProps = { ...Icon.defaultProps }

MaterialSelfImprovement.propTypes = { ...Icon.propTypes }

export default MaterialSelfImprovement
