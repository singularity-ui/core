...
const MaterialReviewsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReviewsRounded = (styled.default || styled)(MaterialReviewsRoundedSvg).attrs(p => ({
...
`;
MaterialReviewsRounded.propTypes = {
