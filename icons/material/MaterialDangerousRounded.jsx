...
const MaterialDangerousRoundedSvg = props => (
  <svg
...
const MaterialDangerousRounded = props => <Icon as={MaterialDangerousRoundedSvg} {...props} />

MaterialDangerousRounded.defaultProps = { ...Icon.defaultProps }

MaterialDangerousRounded.propTypes = { ...Icon.propTypes }
