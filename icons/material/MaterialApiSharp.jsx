...
const MaterialApiSharpSvg = props => (
  <svg
...
const MaterialApiSharp = props => <Icon as={MaterialApiSharpSvg} {...props} />

MaterialApiSharp.defaultProps = { ...Icon.defaultProps }

MaterialApiSharp.propTypes = { ...Icon.propTypes }
