...
const MaterialSafetyDividerSvg = props => (
  <svg
...
const MaterialSafetyDivider = props => <Icon as={MaterialSafetyDividerSvg} {...props} />

MaterialSafetyDivider.defaultProps = { ...Icon.defaultProps }

MaterialSafetyDivider.propTypes = { ...Icon.propTypes }
