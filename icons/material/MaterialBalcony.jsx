...
const MaterialBalconySvg = props => (
  <svg
...
const MaterialBalcony = props => <Icon as={MaterialBalconySvg} {...props} />

MaterialBalcony.defaultProps = { ...Icon.defaultProps }

MaterialBalcony.propTypes = { ...Icon.propTypes }
