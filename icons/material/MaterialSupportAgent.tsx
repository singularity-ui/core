...
const MaterialSupportAgentSvg = props => (
  <svg
...
const MaterialSupportAgent = props => <Icon as={MaterialSupportAgentSvg} {...props} />

MaterialSupportAgent.defaultProps = { ...Icon.defaultProps }

MaterialSupportAgent.propTypes = { ...Icon.propTypes }
