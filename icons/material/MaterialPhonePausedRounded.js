...
const MaterialPhonePausedRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhonePausedRounded = (styled.default || styled)(MaterialPhonePausedRoundedSvg).attrs(p => ({
...
`;
MaterialPhonePausedRounded.propTypes = {
