...
const MaterialVideoStableRoundedSvg = props => (
  <svg
...
const MaterialVideoStableRounded = props => <Icon as={MaterialVideoStableRoundedSvg} {...props} />

MaterialVideoStableRounded.defaultProps = { ...Icon.defaultProps }

MaterialVideoStableRounded.propTypes = { ...Icon.propTypes }
