...
const MaterialMarkChatUnreadOutlinedSvg = props => (
  <svg
...
const MaterialMarkChatUnreadOutlined = props => <Icon as={MaterialMarkChatUnreadOutlinedSvg} {...props} />

MaterialMarkChatUnreadOutlined.defaultProps = { ...Icon.defaultProps }

MaterialMarkChatUnreadOutlined.propTypes = { ...Icon.propTypes }
