...
const MaterialOneKPlusSvg = props => (
...
const MaterialOneKPlus = props => <Icon as={MaterialOneKPlusSvg} {...props} />

MaterialOneKPlus.defaultProps = { ...Icon.defaultProps }

MaterialOneKPlus.propTypes = { ...Icon.propTypes }
