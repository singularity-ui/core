...
const MaterialCancelPresentationSvg = props => (
...
const MaterialCancelPresentation = props => <Icon as={MaterialCancelPresentationSvg} {...props} />

MaterialCancelPresentation.defaultProps = { ...Icon.defaultProps }

MaterialCancelPresentation.propTypes = { ...Icon.propTypes }

export default MaterialCancelPresentation
