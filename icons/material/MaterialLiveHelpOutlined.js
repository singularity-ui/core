...
const MaterialLiveHelpOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLiveHelpOutlined = (styled.default || styled)(MaterialLiveHelpOutlinedSvg).attrs(p => ({
...
`;
MaterialLiveHelpOutlined.propTypes = {
