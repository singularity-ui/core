...
const MaterialVideoCameraBackRoundedSvg = props => (
  <svg
...
const MaterialVideoCameraBackRounded = props => <Icon as={MaterialVideoCameraBackRoundedSvg} {...props} />

MaterialVideoCameraBackRounded.defaultProps = { ...Icon.defaultProps }

MaterialVideoCameraBackRounded.propTypes = { ...Icon.propTypes }
