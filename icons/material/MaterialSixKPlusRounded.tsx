...
const MaterialSixKPlusRoundedSvg = props => (
  <svg
...
const MaterialSixKPlusRounded = props => <Icon as={MaterialSixKPlusRoundedSvg} {...props} />

MaterialSixKPlusRounded.defaultProps = { ...Icon.defaultProps }

MaterialSixKPlusRounded.propTypes = { ...Icon.propTypes }

export default MaterialSixKPlusRounded
