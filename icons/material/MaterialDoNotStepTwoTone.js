...
const MaterialDoNotStepTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoNotStepTwoTone = (styled.default || styled)(MaterialDoNotStepTwoToneSvg).attrs(p => ({
...
`;
MaterialDoNotStepTwoTone.propTypes = {
