...
const MaterialHeightKRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialHeightKRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialHeightKRounded;