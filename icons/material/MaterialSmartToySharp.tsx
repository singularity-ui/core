...
const MaterialSmartToySharpSvg = props => (
  <svg
...
const MaterialSmartToySharp = props => <Icon as={MaterialSmartToySharpSvg} {...props} />

MaterialSmartToySharp.defaultProps = { ...Icon.defaultProps }

MaterialSmartToySharp.propTypes = { ...Icon.propTypes }
