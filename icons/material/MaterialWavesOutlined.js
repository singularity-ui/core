...
const MaterialWavesOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWavesOutlined = (styled.default || styled)(MaterialWavesOutlinedSvg).attrs(p => ({
...
`;
MaterialWavesOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialWavesOutlined;