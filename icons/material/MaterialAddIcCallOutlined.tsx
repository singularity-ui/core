...
const MaterialAddIcCallOutlinedSvg = props => (
...
const MaterialAddIcCallOutlined = props => <Icon as={MaterialAddIcCallOutlinedSvg} {...props} />

MaterialAddIcCallOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAddIcCallOutlined.propTypes = { ...Icon.propTypes }
