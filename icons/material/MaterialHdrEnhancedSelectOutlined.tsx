...
const MaterialHdrEnhancedSelectOutlinedSvg = props => (
  <svg
...
const MaterialHdrEnhancedSelectOutlined = props => <Icon as={MaterialHdrEnhancedSelectOutlinedSvg} {...props} />

MaterialHdrEnhancedSelectOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHdrEnhancedSelectOutlined.propTypes = { ...Icon.propTypes }
