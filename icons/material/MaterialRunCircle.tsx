...
const MaterialRunCircleSvg = props => (
  <svg
...
const MaterialRunCircle = props => <Icon as={MaterialRunCircleSvg} {...props} />

MaterialRunCircle.defaultProps = { ...Icon.defaultProps }

MaterialRunCircle.propTypes = { ...Icon.propTypes }

export default MaterialRunCircle
