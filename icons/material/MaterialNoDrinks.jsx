...
const MaterialNoDrinksSvg = props => (
  <svg
...
const MaterialNoDrinks = props => <Icon as={MaterialNoDrinksSvg} {...props} />

MaterialNoDrinks.defaultProps = { ...Icon.defaultProps }

MaterialNoDrinks.propTypes = { ...Icon.propTypes }
