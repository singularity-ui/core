...
const MaterialVideoCameraFrontSvg = props => (
  <svg
...
const MaterialVideoCameraFront = props => <Icon as={MaterialVideoCameraFrontSvg} {...props} />

MaterialVideoCameraFront.defaultProps = { ...Icon.defaultProps }

MaterialVideoCameraFront.propTypes = { ...Icon.propTypes }

export default MaterialVideoCameraFront
