...
const MaterialBuildCircleOutlinedSvg = props => (
  <svg
...
const MaterialBuildCircleOutlined = props => <Icon as={MaterialBuildCircleOutlinedSvg} {...props} />

MaterialBuildCircleOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBuildCircleOutlined.propTypes = { ...Icon.propTypes }
