...
const MaterialBarChartRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBarChartRounded = (styled.default || styled)(MaterialBarChartRoundedSvg).attrs(p => ({
...
`;
MaterialBarChartRounded.propTypes = {
