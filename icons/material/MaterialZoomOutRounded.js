...
const MaterialZoomOutRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialZoomOutRounded = (styled.default || styled)(MaterialZoomOutRoundedSvg).attrs(p => ({
...
`;
MaterialZoomOutRounded.propTypes = {
