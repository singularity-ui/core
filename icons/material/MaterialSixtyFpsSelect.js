...
const MaterialSixtyFpsSelectSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixtyFpsSelect = (styled.default || styled)(MaterialSixtyFpsSelectSvg).attrs(p => ({
...
`;
MaterialSixtyFpsSelect.propTypes = {
