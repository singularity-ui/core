...
const MaterialBeenhereTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBeenhereTwoTone = (styled.default || styled)(MaterialBeenhereTwoToneSvg).attrs(p => ({
...
`;
MaterialBeenhereTwoTone.propTypes = {
