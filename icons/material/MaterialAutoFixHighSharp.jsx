...
const MaterialAutoFixHighSharpSvg = props => (
  <svg
...
const MaterialAutoFixHighSharp = props => <Icon as={MaterialAutoFixHighSharpSvg} {...props} />

MaterialAutoFixHighSharp.defaultProps = { ...Icon.defaultProps }

MaterialAutoFixHighSharp.propTypes = { ...Icon.propTypes }
