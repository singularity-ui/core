...
const MaterialThermostatAutoSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThermostatAuto = (styled.default || styled)(MaterialThermostatAutoSvg).attrs(p => ({
...
`;
MaterialThermostatAuto.propTypes = {
