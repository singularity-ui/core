...
const MaterialWorkspacesSvg = props => (
  <svg
...
const MaterialWorkspaces = props => <Icon as={MaterialWorkspacesSvg} {...props} />

MaterialWorkspaces.defaultProps = { ...Icon.defaultProps }

MaterialWorkspaces.propTypes = { ...Icon.propTypes }
