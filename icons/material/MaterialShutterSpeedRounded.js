...
const MaterialShutterSpeedRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialShutterSpeedRounded = (styled.default || styled)(MaterialShutterSpeedRoundedSvg).attrs(p => ({
...
`;
MaterialShutterSpeedRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialShutterSpeedRounded;