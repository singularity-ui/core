...
const MaterialStream = props => <Icon as={MaterialStreamSvg} {...props} />

MaterialStream.defaultProps = { ...Icon.defaultProps }

MaterialStream.propTypes = { ...Icon.propTypes }
