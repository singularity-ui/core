...
const MaterialPreviewSharpSvg = props => (
  <svg
...
const MaterialPreviewSharp = props => <Icon as={MaterialPreviewSharpSvg} {...props} />

MaterialPreviewSharp.defaultProps = { ...Icon.defaultProps }

MaterialPreviewSharp.propTypes = { ...Icon.propTypes }
