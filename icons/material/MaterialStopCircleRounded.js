...
const MaterialStopCircleRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStopCircleRounded = (styled.default || styled)(MaterialStopCircleRoundedSvg).attrs(p => ({
...
`;
MaterialStopCircleRounded.propTypes = {
