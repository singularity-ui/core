...
const MaterialRadarTwoToneSvg = props => (
  <svg
...
const MaterialRadarTwoTone = props => <Icon as={MaterialRadarTwoToneSvg} {...props} />

MaterialRadarTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRadarTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialRadarTwoTone
