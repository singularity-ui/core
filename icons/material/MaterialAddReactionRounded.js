...
const MaterialAddReactionRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddReactionRounded = (styled.default || styled)(MaterialAddReactionRoundedSvg).attrs(p => ({
...
`;
MaterialAddReactionRounded.propTypes = {
