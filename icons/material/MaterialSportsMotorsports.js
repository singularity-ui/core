...
const MaterialSportsMotorsportsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsMotorsports = (styled.default || styled)(MaterialSportsMotorsportsSvg).attrs(p => ({
...
`;
MaterialSportsMotorsports.propTypes = {
