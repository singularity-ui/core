...
const MaterialPolicySharpSvg = props => (
  <svg
...
const MaterialPolicySharp = props => <Icon as={MaterialPolicySharpSvg} {...props} />

MaterialPolicySharp.defaultProps = { ...Icon.defaultProps }

MaterialPolicySharp.propTypes = { ...Icon.propTypes }

export default MaterialPolicySharp
