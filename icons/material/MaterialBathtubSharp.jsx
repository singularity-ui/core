...
const MaterialBathtubSharpSvg = props => (
  <svg
...
const MaterialBathtubSharp = props => <Icon as={MaterialBathtubSharpSvg} {...props} />

MaterialBathtubSharp.defaultProps = { ...Icon.defaultProps }

MaterialBathtubSharp.propTypes = { ...Icon.propTypes }

export default MaterialBathtubSharp
