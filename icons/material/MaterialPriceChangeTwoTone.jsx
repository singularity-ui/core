...
const MaterialPriceChangeTwoToneSvg = props => (
  <svg
...
const MaterialPriceChangeTwoTone = props => <Icon as={MaterialPriceChangeTwoToneSvg} {...props} />

MaterialPriceChangeTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPriceChangeTwoTone.propTypes = { ...Icon.propTypes }
