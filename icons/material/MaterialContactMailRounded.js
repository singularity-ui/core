...
const MaterialContactMailRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialContactMailRounded = (styled.default || styled)(MaterialContactMailRoundedSvg).attrs(p => ({
...
`;
MaterialContactMailRounded.propTypes = {
