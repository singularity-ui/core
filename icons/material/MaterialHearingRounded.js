...
const MaterialHearingRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHearingRounded = (styled.default || styled)(MaterialHearingRoundedSvg).attrs(p => ({
...
`;
MaterialHearingRounded.propTypes = {
