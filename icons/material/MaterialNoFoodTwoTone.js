...
const MaterialNoFoodTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoFoodTwoTone = (styled.default || styled)(MaterialNoFoodTwoToneSvg).attrs(p => ({
...
`;
MaterialNoFoodTwoTone.propTypes = {
