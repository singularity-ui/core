...
const MaterialNextPlanTwoToneSvg = props => (
  <svg
...
const MaterialNextPlanTwoTone = props => <Icon as={MaterialNextPlanTwoToneSvg} {...props} />

MaterialNextPlanTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialNextPlanTwoTone.propTypes = { ...Icon.propTypes }
