...
const MaterialMedicalServicesTwoToneSvg = props => (
  <svg
...
const MaterialMedicalServicesTwoTone = props => <Icon as={MaterialMedicalServicesTwoToneSvg} {...props} />

MaterialMedicalServicesTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMedicalServicesTwoTone.propTypes = { ...Icon.propTypes }
