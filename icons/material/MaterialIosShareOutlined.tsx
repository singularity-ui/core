...
const MaterialIosShareOutlinedSvg = props => (
  <svg
...
const MaterialIosShareOutlined = props => <Icon as={MaterialIosShareOutlinedSvg} {...props} />

MaterialIosShareOutlined.defaultProps = { ...Icon.defaultProps }

MaterialIosShareOutlined.propTypes = { ...Icon.propTypes }
