...
const MaterialDialerSipRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDialerSipRounded = (styled.default || styled)(MaterialDialerSipRoundedSvg).attrs(p => ({
...
`;
MaterialDialerSipRounded.propTypes = {
