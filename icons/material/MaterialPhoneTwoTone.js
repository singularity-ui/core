...
const MaterialPhoneTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneTwoTone = (styled.default || styled)(MaterialPhoneTwoToneSvg).attrs(p => ({
...
`;
MaterialPhoneTwoTone.propTypes = {
