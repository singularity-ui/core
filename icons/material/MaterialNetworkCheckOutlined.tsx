...
const MaterialNetworkCheckOutlinedSvg = props => (
...
const MaterialNetworkCheckOutlined = props => <Icon as={MaterialNetworkCheckOutlinedSvg} {...props} />

MaterialNetworkCheckOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNetworkCheckOutlined.propTypes = { ...Icon.propTypes }
