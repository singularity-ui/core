...
const MaterialGroupsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGroupsRounded = (styled.default || styled)(MaterialGroupsRoundedSvg).attrs(p => ({
...
`;
MaterialGroupsRounded.propTypes = {
