...
const MaterialRestoreSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRestoreSharp = (styled.default || styled)(MaterialRestoreSharpSvg).attrs(p => ({
...
`;
MaterialRestoreSharp.propTypes = {
