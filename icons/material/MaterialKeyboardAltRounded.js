...
const MaterialKeyboardAltRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKeyboardAltRounded = (styled.default || styled)(MaterialKeyboardAltRoundedSvg).attrs(p => ({
...
`;
MaterialKeyboardAltRounded.propTypes = {
