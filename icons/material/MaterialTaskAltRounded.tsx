...
const MaterialTaskAltRoundedSvg = props => (
  <svg
...
const MaterialTaskAltRounded = props => <Icon as={MaterialTaskAltRoundedSvg} {...props} />

MaterialTaskAltRounded.defaultProps = { ...Icon.defaultProps }

MaterialTaskAltRounded.propTypes = { ...Icon.propTypes }

export default MaterialTaskAltRounded
