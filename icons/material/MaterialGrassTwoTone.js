...
const MaterialGrassTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGrassTwoTone = (styled.default || styled)(MaterialGrassTwoToneSvg).attrs(p => ({
...
`;
MaterialGrassTwoTone.propTypes = {
