...
const MaterialSlowMotionVideoRoundedSvg = props => (
...
const MaterialSlowMotionVideoRounded = props => <Icon as={MaterialSlowMotionVideoRoundedSvg} {...props} />

MaterialSlowMotionVideoRounded.defaultProps = { ...Icon.defaultProps }

MaterialSlowMotionVideoRounded.propTypes = { ...Icon.propTypes }

export default MaterialSlowMotionVideoRounded
