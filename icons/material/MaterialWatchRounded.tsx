...
const MaterialWatchRoundedSvg = props => (
...
const MaterialWatchRounded = props => <Icon as={MaterialWatchRoundedSvg} {...props} />

MaterialWatchRounded.defaultProps = { ...Icon.defaultProps }

MaterialWatchRounded.propTypes = { ...Icon.propTypes }
