...
const MaterialSettingsPowerSvg = props => (
...
const MaterialSettingsPower = props => <Icon as={MaterialSettingsPowerSvg} {...props} />

MaterialSettingsPower.defaultProps = { ...Icon.defaultProps }

MaterialSettingsPower.propTypes = { ...Icon.propTypes }

export default MaterialSettingsPower
