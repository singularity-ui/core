...
const MaterialFestivalSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFestivalSharp = (styled.default || styled)(MaterialFestivalSharpSvg).attrs(p => ({
...
`;
MaterialFestivalSharp.propTypes = {
