...
const MaterialPageviewSvg = props => (
...
const MaterialPageview = props => <Icon as={MaterialPageviewSvg} {...props} />

MaterialPageview.defaultProps = { ...Icon.defaultProps }

MaterialPageview.propTypes = { ...Icon.propTypes }
