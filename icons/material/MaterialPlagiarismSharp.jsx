...
const MaterialPlagiarismSharpSvg = props => (
  <svg
...
const MaterialPlagiarismSharp = props => <Icon as={MaterialPlagiarismSharpSvg} {...props} />

MaterialPlagiarismSharp.defaultProps = { ...Icon.defaultProps }

MaterialPlagiarismSharp.propTypes = { ...Icon.propTypes }
