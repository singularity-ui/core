...
const MaterialNineK = props => <Icon as={MaterialNineKSvg} {...props} />

MaterialNineK.defaultProps = { ...Icon.defaultProps }

MaterialNineK.propTypes = { ...Icon.propTypes }

export default MaterialNineK
