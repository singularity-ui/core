...
const MaterialWrapTextRoundedSvg = props => (
...
const MaterialWrapTextRounded = props => <Icon as={MaterialWrapTextRoundedSvg} {...props} />

MaterialWrapTextRounded.defaultProps = { ...Icon.defaultProps }

MaterialWrapTextRounded.propTypes = { ...Icon.propTypes }
