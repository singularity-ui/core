...
const MaterialPermDataSettingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPermDataSettingSharp = (styled.default || styled)(MaterialPermDataSettingSharpSvg).attrs(p => ({
...
`;
MaterialPermDataSettingSharp.propTypes = {
