...
const MaterialMediationSharpSvg = props => (
  <svg
...
const MaterialMediationSharp = props => <Icon as={MaterialMediationSharpSvg} {...props} />

MaterialMediationSharp.defaultProps = { ...Icon.defaultProps }

MaterialMediationSharp.propTypes = { ...Icon.propTypes }
