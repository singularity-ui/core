...
const MaterialLocationCitySvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocationCity = (styled.default || styled)(MaterialLocationCitySvg).attrs(p => ({
...
`;
MaterialLocationCity.propTypes = {
