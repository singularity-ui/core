...
const MaterialFourMpRoundedSvg = props => (
  <svg
...
const MaterialFourMpRounded = props => <Icon as={MaterialFourMpRoundedSvg} {...props} />

MaterialFourMpRounded.defaultProps = { ...Icon.defaultProps }

MaterialFourMpRounded.propTypes = { ...Icon.propTypes }

export default MaterialFourMpRounded
