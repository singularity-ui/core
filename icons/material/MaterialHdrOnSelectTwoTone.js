...
const MaterialHdrOnSelectTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrOnSelectTwoTone = (styled.default || styled)(MaterialHdrOnSelectTwoToneSvg).attrs(p => ({
...
`;
MaterialHdrOnSelectTwoTone.propTypes = {
