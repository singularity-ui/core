...
const MaterialReplayTenTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayTenTwoTone = (styled.default || styled)(MaterialReplayTenTwoToneSvg).attrs(p => ({
...
`;
MaterialReplayTenTwoTone.propTypes = {
