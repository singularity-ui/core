...
const MaterialCottageSvg = props => (
  <svg
...
const MaterialCottage = props => <Icon as={MaterialCottageSvg} {...props} />

MaterialCottage.defaultProps = { ...Icon.defaultProps }

MaterialCottage.propTypes = { ...Icon.propTypes }
