...
const MaterialTaskAltOutlinedSvg = props => (
  <svg
...
const MaterialTaskAltOutlined = props => <Icon as={MaterialTaskAltOutlinedSvg} {...props} />

MaterialTaskAltOutlined.defaultProps = { ...Icon.defaultProps }

MaterialTaskAltOutlined.propTypes = { ...Icon.propTypes }

export default MaterialTaskAltOutlined
