...
const MaterialStreamSharpSvg = props => (
  <svg
...
const MaterialStreamSharp = props => <Icon as={MaterialStreamSharpSvg} {...props} />

MaterialStreamSharp.defaultProps = { ...Icon.defaultProps }

MaterialStreamSharp.propTypes = { ...Icon.propTypes }
