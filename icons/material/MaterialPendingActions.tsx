...
const MaterialPendingActionsSvg = props => (
  <svg
...
const MaterialPendingActions = props => <Icon as={MaterialPendingActionsSvg} {...props} />

MaterialPendingActions.defaultProps = { ...Icon.defaultProps }

MaterialPendingActions.propTypes = { ...Icon.propTypes }
