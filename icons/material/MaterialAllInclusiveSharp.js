...
const MaterialAllInclusiveSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAllInclusiveSharp = (styled.default || styled)(MaterialAllInclusiveSharpSvg).attrs(p => ({
...
`;
MaterialAllInclusiveSharp.propTypes = {
