...
const MaterialLivingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLivingTwoTone = (styled.default || styled)(MaterialLivingTwoToneSvg).attrs(p => ({
...
`;
MaterialLivingTwoTone.propTypes = {
