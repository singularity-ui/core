...
const MaterialEscalatorWarningSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEscalatorWarning = (styled.default || styled)(MaterialEscalatorWarningSvg).attrs(p => ({
...
`;
MaterialEscalatorWarning.propTypes = {
