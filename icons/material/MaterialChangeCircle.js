...
const MaterialChangeCircleSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChangeCircle = (styled.default || styled)(MaterialChangeCircleSvg).attrs(p => ({
...
`;
MaterialChangeCircle.propTypes = {
