...
const MaterialFlutterDashRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlutterDashRounded = (styled.default || styled)(MaterialFlutterDashRoundedSvg).attrs(p => ({
...
`;
MaterialFlutterDashRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFlutterDashRounded;