...
const MaterialHelpCenterRoundedSvg = props => (
  <svg
...
const MaterialHelpCenterRounded = props => <Icon as={MaterialHelpCenterRoundedSvg} {...props} />

MaterialHelpCenterRounded.defaultProps = { ...Icon.defaultProps }

MaterialHelpCenterRounded.propTypes = { ...Icon.propTypes }

export default MaterialHelpCenterRounded
