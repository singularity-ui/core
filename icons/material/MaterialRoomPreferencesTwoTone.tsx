...
const MaterialRoomPreferencesTwoToneSvg = props => (
  <svg
...
const MaterialRoomPreferencesTwoTone = props => <Icon as={MaterialRoomPreferencesTwoToneSvg} {...props} />

MaterialRoomPreferencesTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRoomPreferencesTwoTone.propTypes = { ...Icon.propTypes }
