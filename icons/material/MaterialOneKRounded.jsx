...
const MaterialOneKRoundedSvg = props => (
  <svg
...
const MaterialOneKRounded = props => <Icon as={MaterialOneKRoundedSvg} {...props} />

MaterialOneKRounded.defaultProps = { ...Icon.defaultProps }

MaterialOneKRounded.propTypes = { ...Icon.propTypes }

export default MaterialOneKRounded
