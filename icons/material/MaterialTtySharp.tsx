...
const MaterialTtySharpSvg = props => (
  <svg
...
const MaterialTtySharp = props => <Icon as={MaterialTtySharpSvg} {...props} />

MaterialTtySharp.defaultProps = { ...Icon.defaultProps }

MaterialTtySharp.propTypes = { ...Icon.propTypes }
