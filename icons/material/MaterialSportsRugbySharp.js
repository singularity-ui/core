...
const MaterialSportsRugbySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsRugbySharp = (styled.default || styled)(MaterialSportsRugbySharpSvg).attrs(p => ({
...
`;
MaterialSportsRugbySharp.propTypes = {
