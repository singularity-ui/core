...
const MaterialSupportOutlinedSvg = props => (
  <svg
...
const MaterialSupportOutlined = props => <Icon as={MaterialSupportOutlinedSvg} {...props} />

MaterialSupportOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSupportOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSupportOutlined
