...
const MaterialAlarmOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOffTwoTone = (styled.default || styled)(MaterialAlarmOffTwoToneSvg).attrs(p => ({
...
`;
MaterialAlarmOffTwoTone.propTypes = {
