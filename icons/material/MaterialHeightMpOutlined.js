...
const MaterialHeightMpOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHeightMpOutlined = (styled.default || styled)(MaterialHeightMpOutlinedSvg).attrs(p => ({
...
`;
MaterialHeightMpOutlined.propTypes = {
