...
const MaterialRotateRightTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRotateRightTwoTone = (styled.default || styled)(MaterialRotateRightTwoToneSvg).attrs(p => ({
...
`;
MaterialRotateRightTwoTone.propTypes = {
