...
const MaterialCasinoRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCasinoRounded = (styled.default || styled)(MaterialCasinoRoundedSvg).attrs(p => ({
...
`;
MaterialCasinoRounded.propTypes = {
