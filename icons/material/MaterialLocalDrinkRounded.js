...
const MaterialLocalDrinkRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalDrinkRounded = (styled.default || styled)(MaterialLocalDrinkRoundedSvg).attrs(p => ({
...
`;
MaterialLocalDrinkRounded.propTypes = {
