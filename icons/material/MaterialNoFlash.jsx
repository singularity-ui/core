...
const MaterialNoFlashSvg = props => (
  <svg
...
const MaterialNoFlash = props => <Icon as={MaterialNoFlashSvg} {...props} />

MaterialNoFlash.defaultProps = { ...Icon.defaultProps }

MaterialNoFlash.propTypes = { ...Icon.propTypes }
