...
const MaterialPianoOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPianoOffRounded = (styled.default || styled)(MaterialPianoOffRoundedSvg).attrs(p => ({
...
`;
MaterialPianoOffRounded.propTypes = {
