...
const MaterialExtensionOffRoundedSvg = props => (
  <svg
...
const MaterialExtensionOffRounded = props => <Icon as={MaterialExtensionOffRoundedSvg} {...props} />

MaterialExtensionOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialExtensionOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialExtensionOffRounded
