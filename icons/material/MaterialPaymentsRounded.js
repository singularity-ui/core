...
const MaterialPaymentsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPaymentsRounded = (styled.default || styled)(MaterialPaymentsRoundedSvg).attrs(p => ({
...
`;
MaterialPaymentsRounded.propTypes = {
