...
const MaterialMicOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMicOffRounded = (styled.default || styled)(MaterialMicOffRoundedSvg).attrs(p => ({
...
`;
MaterialMicOffRounded.propTypes = {
