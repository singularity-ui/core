...
const MaterialNoTransferTwoToneSvg = props => (
  <svg
...
const MaterialNoTransferTwoTone = props => <Icon as={MaterialNoTransferTwoToneSvg} {...props} />

MaterialNoTransferTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialNoTransferTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialNoTransferTwoTone
