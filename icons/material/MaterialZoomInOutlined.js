...
const MaterialZoomInOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialZoomInOutlined = (styled.default || styled)(MaterialZoomInOutlinedSvg).attrs(p => ({
...
`;
MaterialZoomInOutlined.propTypes = {
