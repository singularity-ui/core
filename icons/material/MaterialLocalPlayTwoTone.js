...
const MaterialLocalPlayTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalPlayTwoTone = (styled.default || styled)(MaterialLocalPlayTwoToneSvg).attrs(p => ({
...
`;
MaterialLocalPlayTwoTone.propTypes = {
