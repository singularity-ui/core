...
const MaterialLaptopMacRoundedSvg = props => (
...
const MaterialLaptopMacRounded = props => <Icon as={MaterialLaptopMacRoundedSvg} {...props} />

MaterialLaptopMacRounded.defaultProps = { ...Icon.defaultProps }

MaterialLaptopMacRounded.propTypes = { ...Icon.propTypes }
