...
const MaterialDiningRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDiningRounded = (styled.default || styled)(MaterialDiningRoundedSvg).attrs(p => ({
...
`;
MaterialDiningRounded.propTypes = {
