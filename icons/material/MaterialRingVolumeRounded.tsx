...
const MaterialRingVolumeRoundedSvg = props => (
...
const MaterialRingVolumeRounded = props => <Icon as={MaterialRingVolumeRoundedSvg} {...props} />

MaterialRingVolumeRounded.defaultProps = { ...Icon.defaultProps }

MaterialRingVolumeRounded.propTypes = { ...Icon.propTypes }
