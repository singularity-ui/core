...
const MaterialWaterSharpSvg = props => (
  <svg
...
const MaterialWaterSharp = props => <Icon as={MaterialWaterSharpSvg} {...props} />

MaterialWaterSharp.defaultProps = { ...Icon.defaultProps }

MaterialWaterSharp.propTypes = { ...Icon.propTypes }

export default MaterialWaterSharp
