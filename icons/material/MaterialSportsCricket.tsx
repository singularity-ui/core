...
const MaterialSportsCricketSvg = props => (
  <svg
...
const MaterialSportsCricket = props => <Icon as={MaterialSportsCricketSvg} {...props} />

MaterialSportsCricket.defaultProps = { ...Icon.defaultProps }

MaterialSportsCricket.propTypes = { ...Icon.propTypes }

export default MaterialSportsCricket
