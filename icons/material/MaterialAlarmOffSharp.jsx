...
const MaterialAlarmOffSharpSvg = props => (
...
const MaterialAlarmOffSharp = props => <Icon as={MaterialAlarmOffSharpSvg} {...props} />

MaterialAlarmOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialAlarmOffSharp.propTypes = { ...Icon.propTypes }

export default MaterialAlarmOffSharp
