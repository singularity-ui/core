...
const MaterialScreenSearchDesktopSvg = props => (
  <svg
...
const MaterialScreenSearchDesktop = props => <Icon as={MaterialScreenSearchDesktopSvg} {...props} />

MaterialScreenSearchDesktop.defaultProps = { ...Icon.defaultProps }

MaterialScreenSearchDesktop.propTypes = { ...Icon.propTypes }
