...
const MaterialRingVolumeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRingVolumeTwoTone = (styled.default || styled)(MaterialRingVolumeTwoToneSvg).attrs(p => ({
...
`;
MaterialRingVolumeTwoTone.propTypes = {
