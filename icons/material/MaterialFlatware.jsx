...
const MaterialFlatwareSvg = props => (
  <svg
...
const MaterialFlatware = props => <Icon as={MaterialFlatwareSvg} {...props} />

MaterialFlatware.defaultProps = { ...Icon.defaultProps }

MaterialFlatware.propTypes = { ...Icon.propTypes }

export default MaterialFlatware
