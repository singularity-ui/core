...
const MaterialBrunchDiningSvg = props => (
  <svg
...
const MaterialBrunchDining = props => <Icon as={MaterialBrunchDiningSvg} {...props} />

MaterialBrunchDining.defaultProps = { ...Icon.defaultProps }

MaterialBrunchDining.propTypes = { ...Icon.propTypes }
