...
const MaterialEvStationOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEvStationOutlined = (styled.default || styled)(MaterialEvStationOutlinedSvg).attrs(p => ({
...
`;
MaterialEvStationOutlined.propTypes = {
