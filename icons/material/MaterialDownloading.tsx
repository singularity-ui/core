...
const MaterialDownloadingSvg = props => (
  <svg
...
const MaterialDownloading = props => <Icon as={MaterialDownloadingSvg} {...props} />

MaterialDownloading.defaultProps = { ...Icon.defaultProps }

MaterialDownloading.propTypes = { ...Icon.propTypes }
