...
const MaterialHdrOffSelectRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialHdrOffSelectRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialHdrOffSelectRounded;