...
const MaterialCameraRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCameraRounded = (styled.default || styled)(MaterialCameraRoundedSvg).attrs(p => ({
...
`;
MaterialCameraRounded.propTypes = {
