...
const MaterialNextPlanSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNextPlanSharp = (styled.default || styled)(MaterialNextPlanSharpSvg).attrs(p => ({
...
`;
MaterialNextPlanSharp.propTypes = {
