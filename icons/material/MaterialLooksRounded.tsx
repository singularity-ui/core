...
const MaterialLooksRoundedSvg = props => (
...
const MaterialLooksRounded = props => <Icon as={MaterialLooksRoundedSvg} {...props} />

MaterialLooksRounded.defaultProps = { ...Icon.defaultProps }

MaterialLooksRounded.propTypes = { ...Icon.propTypes }
