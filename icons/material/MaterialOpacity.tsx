...
const MaterialOpacitySvg = props => (
...
const MaterialOpacity = props => <Icon as={MaterialOpacitySvg} {...props} />

MaterialOpacity.defaultProps = { ...Icon.defaultProps }

MaterialOpacity.propTypes = { ...Icon.propTypes }

export default MaterialOpacity
