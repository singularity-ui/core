...
const MaterialCalculateOutlinedSvg = props => (
  <svg
...
const MaterialCalculateOutlined = props => <Icon as={MaterialCalculateOutlinedSvg} {...props} />

MaterialCalculateOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCalculateOutlined.propTypes = { ...Icon.propTypes }
