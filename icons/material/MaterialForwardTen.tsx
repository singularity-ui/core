...
const MaterialForwardTenSvg = props => (
  <svg
...
const MaterialForwardTen = props => <Icon as={MaterialForwardTenSvg} {...props} />

MaterialForwardTen.defaultProps = { ...Icon.defaultProps }

MaterialForwardTen.propTypes = { ...Icon.propTypes }
