...
const MaterialContentCutTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialContentCutTwoTone = (styled.default || styled)(MaterialContentCutTwoToneSvg).attrs(p => ({
...
`;
MaterialContentCutTwoTone.propTypes = {
