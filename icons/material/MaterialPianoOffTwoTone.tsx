...
const MaterialPianoOffTwoToneSvg = props => (
  <svg
...
const MaterialPianoOffTwoTone = props => <Icon as={MaterialPianoOffTwoToneSvg} {...props} />

MaterialPianoOffTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPianoOffTwoTone.propTypes = { ...Icon.propTypes }
