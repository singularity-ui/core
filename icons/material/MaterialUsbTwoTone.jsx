...
const MaterialUsbTwoToneSvg = props => (
...
const MaterialUsbTwoTone = props => <Icon as={MaterialUsbTwoToneSvg} {...props} />

MaterialUsbTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialUsbTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialUsbTwoTone
