...
const MaterialWifiCallingSvg = props => (
  <svg
...
const MaterialWifiCalling = props => <Icon as={MaterialWifiCallingSvg} {...props} />

MaterialWifiCalling.defaultProps = { ...Icon.defaultProps }

MaterialWifiCalling.propTypes = { ...Icon.propTypes }

export default MaterialWifiCalling
