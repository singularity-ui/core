...
const MaterialRailwayAlertSvg = props => (
...
const MaterialRailwayAlert = props => <Icon as={MaterialRailwayAlertSvg} {...props} />

MaterialRailwayAlert.defaultProps = { ...Icon.defaultProps }

MaterialRailwayAlert.propTypes = { ...Icon.propTypes }
