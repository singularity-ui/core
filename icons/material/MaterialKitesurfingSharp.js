...
const MaterialKitesurfingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKitesurfingSharp = (styled.default || styled)(MaterialKitesurfingSharpSvg).attrs(p => ({
...
`;
MaterialKitesurfingSharp.propTypes = {
