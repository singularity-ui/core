...
const MaterialKitesurfingSvg = props => (
  <svg
...
const MaterialKitesurfing = props => <Icon as={MaterialKitesurfingSvg} {...props} />

MaterialKitesurfing.defaultProps = { ...Icon.defaultProps }

MaterialKitesurfing.propTypes = { ...Icon.propTypes }

export default MaterialKitesurfing
