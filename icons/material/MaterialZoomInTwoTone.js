...
const MaterialZoomInTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialZoomInTwoTone = (styled.default || styled)(MaterialZoomInTwoToneSvg).attrs(p => ({
...
`;
MaterialZoomInTwoTone.propTypes = {
