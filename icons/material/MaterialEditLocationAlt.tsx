...
const MaterialEditLocationAltSvg = props => (
  <svg
...
const MaterialEditLocationAlt = props => <Icon as={MaterialEditLocationAltSvg} {...props} />

MaterialEditLocationAlt.defaultProps = { ...Icon.defaultProps }

MaterialEditLocationAlt.propTypes = { ...Icon.propTypes }
