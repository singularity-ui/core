...
const MaterialDoNotStepRoundedSvg = props => (
  <svg
...
const MaterialDoNotStepRounded = props => <Icon as={MaterialDoNotStepRoundedSvg} {...props} />

MaterialDoNotStepRounded.defaultProps = { ...Icon.defaultProps }

MaterialDoNotStepRounded.propTypes = { ...Icon.propTypes }

export default MaterialDoNotStepRounded
