...
const MaterialQrCodeOutlinedSvg = props => (
  <svg
...
const MaterialQrCodeOutlined = props => <Icon as={MaterialQrCodeOutlinedSvg} {...props} />

MaterialQrCodeOutlined.defaultProps = { ...Icon.defaultProps }

MaterialQrCodeOutlined.propTypes = { ...Icon.propTypes }

export default MaterialQrCodeOutlined
