...
const MaterialNordicWalkingSharpSvg = props => (
  <svg
...
const MaterialNordicWalkingSharp = props => <Icon as={MaterialNordicWalkingSharpSvg} {...props} />

MaterialNordicWalkingSharp.defaultProps = { ...Icon.defaultProps }

MaterialNordicWalkingSharp.propTypes = { ...Icon.propTypes }

export default MaterialNordicWalkingSharp
