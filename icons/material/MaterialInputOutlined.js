...
const MaterialInputOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialInputOutlined = (styled.default || styled)(MaterialInputOutlinedSvg).attrs(p => ({
...
`;
MaterialInputOutlined.propTypes = {
