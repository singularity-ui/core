...
const MaterialSupportOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSupportOutlined = (styled.default || styled)(MaterialSupportOutlinedSvg).attrs(p => ({
...
`;
MaterialSupportOutlined.propTypes = {
