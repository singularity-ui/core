...
const MaterialDownloadForOfflineTwoToneSvg = props => (
  <svg
...
const MaterialDownloadForOfflineTwoTone = props => <Icon as={MaterialDownloadForOfflineTwoToneSvg} {...props} />

MaterialDownloadForOfflineTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDownloadForOfflineTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialDownloadForOfflineTwoTone
