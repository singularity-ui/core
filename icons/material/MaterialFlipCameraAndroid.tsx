...
const MaterialFlipCameraAndroidSvg = props => (
  <svg
...
const MaterialFlipCameraAndroid = props => <Icon as={MaterialFlipCameraAndroidSvg} {...props} />

MaterialFlipCameraAndroid.defaultProps = { ...Icon.defaultProps }

MaterialFlipCameraAndroid.propTypes = { ...Icon.propTypes }

export default MaterialFlipCameraAndroid
