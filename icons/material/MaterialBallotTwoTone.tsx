...
const MaterialBallotTwoToneSvg = props => (
...
const MaterialBallotTwoTone = props => <Icon as={MaterialBallotTwoToneSvg} {...props} />

MaterialBallotTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBallotTwoTone.propTypes = { ...Icon.propTypes }
