...
const MaterialFlightTakeoffSvg = props => (
  <svg
...
const MaterialFlightTakeoff = props => <Icon as={MaterialFlightTakeoffSvg} {...props} />

MaterialFlightTakeoff.defaultProps = { ...Icon.defaultProps }

MaterialFlightTakeoff.propTypes = { ...Icon.propTypes }
