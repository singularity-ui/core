...
const MaterialWebAssetOffSvg = props => (
  <svg
...
const MaterialWebAssetOff = props => <Icon as={MaterialWebAssetOffSvg} {...props} />

MaterialWebAssetOff.defaultProps = { ...Icon.defaultProps }

MaterialWebAssetOff.propTypes = { ...Icon.propTypes }
