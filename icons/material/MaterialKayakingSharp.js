...
const MaterialKayakingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKayakingSharp = (styled.default || styled)(MaterialKayakingSharpSvg).attrs(p => ({
...
`;
MaterialKayakingSharp.propTypes = {
