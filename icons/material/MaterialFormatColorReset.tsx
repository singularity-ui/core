...
const MaterialFormatColorResetSvg = props => (
...
const MaterialFormatColorReset = props => <Icon as={MaterialFormatColorResetSvg} {...props} />

MaterialFormatColorReset.defaultProps = { ...Icon.defaultProps }

MaterialFormatColorReset.propTypes = { ...Icon.propTypes }

export default MaterialFormatColorReset
