...
const MaterialPermMediaRoundedSvg = props => (
  <svg
...
const MaterialPermMediaRounded = props => <Icon as={MaterialPermMediaRoundedSvg} {...props} />

MaterialPermMediaRounded.defaultProps = { ...Icon.defaultProps }

MaterialPermMediaRounded.propTypes = { ...Icon.propTypes }
