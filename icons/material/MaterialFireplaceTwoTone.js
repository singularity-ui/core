...
const MaterialFireplaceTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFireplaceTwoTone = (styled.default || styled)(MaterialFireplaceTwoToneSvg).attrs(p => ({
...
`;
MaterialFireplaceTwoTone.propTypes = {
