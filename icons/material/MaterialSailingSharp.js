...
const MaterialSailingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSailingSharp = (styled.default || styled)(MaterialSailingSharpSvg).attrs(p => ({
...
`;
MaterialSailingSharp.propTypes = {
