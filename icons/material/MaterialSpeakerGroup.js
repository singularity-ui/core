...
const MaterialSpeakerGroupSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSpeakerGroup = (styled.default || styled)(MaterialSpeakerGroupSvg).attrs(p => ({
...
`;
MaterialSpeakerGroup.propTypes = {
