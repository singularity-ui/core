...
const MaterialSixMpRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixMpRounded = (styled.default || styled)(MaterialSixMpRoundedSvg).attrs(p => ({
...
`;
MaterialSixMpRounded.propTypes = {
