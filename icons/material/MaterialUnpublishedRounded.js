...
const MaterialUnpublishedRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUnpublishedRounded = (styled.default || styled)(MaterialUnpublishedRoundedSvg).attrs(p => ({
...
`;
MaterialUnpublishedRounded.propTypes = {
