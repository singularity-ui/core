...
const MaterialSentimentDissatisfiedSvg = props => (
...
const MaterialSentimentDissatisfied = props => <Icon as={MaterialSentimentDissatisfiedSvg} {...props} />

MaterialSentimentDissatisfied.defaultProps = { ...Icon.defaultProps }

MaterialSentimentDissatisfied.propTypes = { ...Icon.propTypes }

export default MaterialSentimentDissatisfied
