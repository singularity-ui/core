...
const MaterialMoreTimeTwoToneSvg = props => (
  <svg
...
const MaterialMoreTimeTwoTone = props => <Icon as={MaterialMoreTimeTwoToneSvg} {...props} />

MaterialMoreTimeTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMoreTimeTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialMoreTimeTwoTone
