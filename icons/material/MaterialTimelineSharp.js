...
const MaterialTimelineSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimelineSharp = (styled.default || styled)(MaterialTimelineSharpSvg).attrs(p => ({
...
`;
MaterialTimelineSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialTimelineSharp;