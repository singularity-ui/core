...
const MaterialUnfoldLessRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUnfoldLessRounded = (styled.default || styled)(MaterialUnfoldLessRoundedSvg).attrs(p => ({
...
`;
MaterialUnfoldLessRounded.propTypes = {
