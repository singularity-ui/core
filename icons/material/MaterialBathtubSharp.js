...
const MaterialBathtubSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBathtubSharp = (styled.default || styled)(MaterialBathtubSharpSvg).attrs(p => ({
...
`;
MaterialBathtubSharp.propTypes = {
