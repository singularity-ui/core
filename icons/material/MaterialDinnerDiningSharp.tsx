...
const MaterialDinnerDiningSharpSvg = props => (
  <svg
...
const MaterialDinnerDiningSharp = props => <Icon as={MaterialDinnerDiningSharpSvg} {...props} />

MaterialDinnerDiningSharp.defaultProps = { ...Icon.defaultProps }

MaterialDinnerDiningSharp.propTypes = { ...Icon.propTypes }
