...
const MaterialMicExternalOnSvg = props => (
...
const MaterialMicExternalOn = props => <Icon as={MaterialMicExternalOnSvg} {...props} />

MaterialMicExternalOn.defaultProps = { ...Icon.defaultProps }

MaterialMicExternalOn.propTypes = { ...Icon.propTypes }
