...
const MaterialTaskAltTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTaskAltTwoTone = (styled.default || styled)(MaterialTaskAltTwoToneSvg).attrs(p => ({
...
`;
MaterialTaskAltTwoTone.propTypes = {
