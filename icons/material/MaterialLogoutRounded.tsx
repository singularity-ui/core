...
const MaterialLogoutRoundedSvg = props => (
  <svg
...
const MaterialLogoutRounded = props => <Icon as={MaterialLogoutRoundedSvg} {...props} />

MaterialLogoutRounded.defaultProps = { ...Icon.defaultProps }

MaterialLogoutRounded.propTypes = { ...Icon.propTypes }
