...
const MaterialTouchAppSvg = props => (
  <svg
...
const MaterialTouchApp = props => <Icon as={MaterialTouchAppSvg} {...props} />

MaterialTouchApp.defaultProps = { ...Icon.defaultProps }

MaterialTouchApp.propTypes = { ...Icon.propTypes }

export default MaterialTouchApp
