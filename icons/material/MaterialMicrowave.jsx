...
const MaterialMicrowaveSvg = props => (
  <svg
...
const MaterialMicrowave = props => <Icon as={MaterialMicrowaveSvg} {...props} />

MaterialMicrowave.defaultProps = { ...Icon.defaultProps }

MaterialMicrowave.propTypes = { ...Icon.propTypes }

export default MaterialMicrowave
