...
const MaterialForwardTenOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardTenOutlined = (styled.default || styled)(MaterialForwardTenOutlinedSvg).attrs(p => ({
...
`;
MaterialForwardTenOutlined.propTypes = {
