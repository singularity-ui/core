...
const MaterialWcOutlinedSvg = props => (
...
const MaterialWcOutlined = props => <Icon as={MaterialWcOutlinedSvg} {...props} />

MaterialWcOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWcOutlined.propTypes = { ...Icon.propTypes }

export default MaterialWcOutlined
