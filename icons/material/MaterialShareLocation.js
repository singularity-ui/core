...
const MaterialShareLocationSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialShareLocation = (styled.default || styled)(MaterialShareLocationSvg).attrs(p => ({
...
`;
MaterialShareLocation.propTypes = {
