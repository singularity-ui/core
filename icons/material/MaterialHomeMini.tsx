...
const MaterialHomeMiniSvg = props => (
  <svg
...
const MaterialHomeMini = props => <Icon as={MaterialHomeMiniSvg} {...props} />

MaterialHomeMini.defaultProps = { ...Icon.defaultProps }

MaterialHomeMini.propTypes = { ...Icon.propTypes }

export default MaterialHomeMini
