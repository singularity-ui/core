...
const MaterialWhereToVoteRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWhereToVoteRounded = (styled.default || styled)(MaterialWhereToVoteRoundedSvg).attrs(p => ({
...
`;
MaterialWhereToVoteRounded.propTypes = {
