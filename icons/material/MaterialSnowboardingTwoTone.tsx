...
const MaterialSnowboardingTwoToneSvg = props => (
  <svg
...
const MaterialSnowboardingTwoTone = props => <Icon as={MaterialSnowboardingTwoToneSvg} {...props} />

MaterialSnowboardingTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSnowboardingTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSnowboardingTwoTone
