...
const MaterialInsightsSvg = props => (
  <svg
...
const MaterialInsights = props => <Icon as={MaterialInsightsSvg} {...props} />

MaterialInsights.defaultProps = { ...Icon.defaultProps }

MaterialInsights.propTypes = { ...Icon.propTypes }
