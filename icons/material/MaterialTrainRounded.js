...
const MaterialTrainRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTrainRounded = (styled.default || styled)(MaterialTrainRoundedSvg).attrs(p => ({
...
`;
MaterialTrainRounded.propTypes = {
