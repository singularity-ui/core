...
const MaterialDeviceHubRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDeviceHubRounded = (styled.default || styled)(MaterialDeviceHubRoundedSvg).attrs(p => ({
...
`;
MaterialDeviceHubRounded.propTypes = {
