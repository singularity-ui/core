...
const MaterialHistoryToggleOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHistoryToggleOff = (styled.default || styled)(MaterialHistoryToggleOffSvg).attrs(p => ({
...
`;
MaterialHistoryToggleOff.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialHistoryToggleOff;