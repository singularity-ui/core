...
const MaterialCameraEnhanceTwoToneSvg = props => (
...
const MaterialCameraEnhanceTwoTone = props => <Icon as={MaterialCameraEnhanceTwoToneSvg} {...props} />

MaterialCameraEnhanceTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCameraEnhanceTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialCameraEnhanceTwoTone
