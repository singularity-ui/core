...
const MaterialFormatQuoteRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFormatQuoteRounded = (styled.default || styled)(MaterialFormatQuoteRoundedSvg).attrs(p => ({
...
`;
MaterialFormatQuoteRounded.propTypes = {
