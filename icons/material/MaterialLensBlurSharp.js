...
const MaterialLensBlurSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLensBlurSharp = (styled.default || styled)(MaterialLensBlurSharpSvg).attrs(p => ({
...
`;
MaterialLensBlurSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialLensBlurSharp;