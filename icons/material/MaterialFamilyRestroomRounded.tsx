...
const MaterialFamilyRestroomRoundedSvg = props => (
  <svg
...
const MaterialFamilyRestroomRounded = props => <Icon as={MaterialFamilyRestroomRoundedSvg} {...props} />

MaterialFamilyRestroomRounded.defaultProps = { ...Icon.defaultProps }

MaterialFamilyRestroomRounded.propTypes = { ...Icon.propTypes }

export default MaterialFamilyRestroomRounded
