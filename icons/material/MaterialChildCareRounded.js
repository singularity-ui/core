...
const MaterialChildCareRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChildCareRounded = (styled.default || styled)(MaterialChildCareRoundedSvg).attrs(p => ({
...
`;
MaterialChildCareRounded.propTypes = {
