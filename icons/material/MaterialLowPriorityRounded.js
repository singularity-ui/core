...
const MaterialLowPriorityRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLowPriorityRounded = (styled.default || styled)(MaterialLowPriorityRoundedSvg).attrs(p => ({
...
`;
MaterialLowPriorityRounded.propTypes = {
