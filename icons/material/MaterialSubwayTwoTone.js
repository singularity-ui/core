...
const MaterialSubwayTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSubwayTwoTone = (styled.default || styled)(MaterialSubwayTwoToneSvg).attrs(p => ({
...
`;
MaterialSubwayTwoTone.propTypes = {
