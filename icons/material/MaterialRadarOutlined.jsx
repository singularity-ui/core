...
const MaterialRadarOutlinedSvg = props => (
  <svg
...
const MaterialRadarOutlined = props => <Icon as={MaterialRadarOutlinedSvg} {...props} />

MaterialRadarOutlined.defaultProps = { ...Icon.defaultProps }

MaterialRadarOutlined.propTypes = { ...Icon.propTypes }

export default MaterialRadarOutlined
