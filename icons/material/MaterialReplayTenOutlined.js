...
const MaterialReplayTenOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayTenOutlined = (styled.default || styled)(MaterialReplayTenOutlinedSvg).attrs(p => ({
...
`;
MaterialReplayTenOutlined.propTypes = {
