...
const MaterialAddTaskOutlinedSvg = props => (
  <svg
...
const MaterialAddTaskOutlined = props => <Icon as={MaterialAddTaskOutlinedSvg} {...props} />

MaterialAddTaskOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAddTaskOutlined.propTypes = { ...Icon.propTypes }
