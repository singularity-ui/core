...
const MaterialCloudOffOutlinedSvg = props => (
...
const MaterialCloudOffOutlined = props => <Icon as={MaterialCloudOffOutlinedSvg} {...props} />

MaterialCloudOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCloudOffOutlined.propTypes = { ...Icon.propTypes }

export default MaterialCloudOffOutlined
