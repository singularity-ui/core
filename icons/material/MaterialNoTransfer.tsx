...
const MaterialNoTransferSvg = props => (
  <svg
...
const MaterialNoTransfer = props => <Icon as={MaterialNoTransferSvg} {...props} />

MaterialNoTransfer.defaultProps = { ...Icon.defaultProps }

MaterialNoTransfer.propTypes = { ...Icon.propTypes }
