...
const MaterialLockClockOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLockClockOutlined = (styled.default || styled)(MaterialLockClockOutlinedSvg).attrs(p => ({
...
`;
MaterialLockClockOutlined.propTypes = {
