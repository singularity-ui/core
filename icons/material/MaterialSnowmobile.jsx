...
const MaterialSnowmobileSvg = props => (
  <svg
...
const MaterialSnowmobile = props => <Icon as={MaterialSnowmobileSvg} {...props} />

MaterialSnowmobile.defaultProps = { ...Icon.defaultProps }

MaterialSnowmobile.propTypes = { ...Icon.propTypes }
