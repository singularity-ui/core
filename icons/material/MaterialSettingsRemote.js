...
const MaterialSettingsRemoteSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSettingsRemote = (styled.default || styled)(MaterialSettingsRemoteSvg).attrs(p => ({
...
`;
MaterialSettingsRemote.propTypes = {
