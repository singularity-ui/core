...
const MaterialThreePTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThreePTwoTone = (styled.default || styled)(MaterialThreePTwoToneSvg).attrs(p => ({
...
`;
MaterialThreePTwoTone.propTypes = {
