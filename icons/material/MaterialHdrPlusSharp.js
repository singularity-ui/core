...
const MaterialHdrPlusSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrPlusSharp = (styled.default || styled)(MaterialHdrPlusSharpSvg).attrs(p => ({
...
`;
MaterialHdrPlusSharp.propTypes = {
