...
const MaterialFilter = props => <Icon as={MaterialFilterSvg} {...props} />

MaterialFilter.defaultProps = { ...Icon.defaultProps }

MaterialFilter.propTypes = { ...Icon.propTypes }
