...
const MaterialVoiceOverOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVoiceOverOffRounded = (styled.default || styled)(MaterialVoiceOverOffRoundedSvg).attrs(p => ({
...
`;
MaterialVoiceOverOffRounded.propTypes = {
