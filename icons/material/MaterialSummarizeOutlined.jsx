...
const MaterialSummarizeOutlinedSvg = props => (
  <svg
...
const MaterialSummarizeOutlined = props => <Icon as={MaterialSummarizeOutlinedSvg} {...props} />

MaterialSummarizeOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSummarizeOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSummarizeOutlined
