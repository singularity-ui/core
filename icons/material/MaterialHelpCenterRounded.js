...
const MaterialHelpCenterRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHelpCenterRounded = (styled.default || styled)(MaterialHelpCenterRoundedSvg).attrs(p => ({
...
`;
MaterialHelpCenterRounded.propTypes = {
