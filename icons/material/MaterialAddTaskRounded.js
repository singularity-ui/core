...
const MaterialAddTaskRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddTaskRounded = (styled.default || styled)(MaterialAddTaskRoundedSvg).attrs(p => ({
...
`;
MaterialAddTaskRounded.propTypes = {
