...
const MaterialFormatSizeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFormatSizeRounded = (styled.default || styled)(MaterialFormatSizeRoundedSvg).attrs(p => ({
...
`;
MaterialFormatSizeRounded.propTypes = {
