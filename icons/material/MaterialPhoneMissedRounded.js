...
const MaterialPhoneMissedRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneMissedRounded = (styled.default || styled)(MaterialPhoneMissedRoundedSvg).attrs(p => ({
...
`;
MaterialPhoneMissedRounded.propTypes = {
