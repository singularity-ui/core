...
const MaterialStarRateTwoToneSvg = props => (
  <svg
...
const MaterialStarRateTwoTone = props => <Icon as={MaterialStarRateTwoToneSvg} {...props} />

MaterialStarRateTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialStarRateTwoTone.propTypes = { ...Icon.propTypes }
