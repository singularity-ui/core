...
const MaterialPushPinRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPushPinRounded = (styled.default || styled)(MaterialPushPinRoundedSvg).attrs(p => ({
...
`;
MaterialPushPinRounded.propTypes = {
