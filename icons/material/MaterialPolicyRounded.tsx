...
const MaterialPolicyRoundedSvg = props => (
  <svg
...
const MaterialPolicyRounded = props => <Icon as={MaterialPolicyRoundedSvg} {...props} />

MaterialPolicyRounded.defaultProps = { ...Icon.defaultProps }

MaterialPolicyRounded.propTypes = { ...Icon.propTypes }

export default MaterialPolicyRounded
