...
const MaterialExposureNegTwoSharpSvg = props => (
...
const MaterialExposureNegTwoSharp = props => <Icon as={MaterialExposureNegTwoSharpSvg} {...props} />

MaterialExposureNegTwoSharp.defaultProps = { ...Icon.defaultProps }

MaterialExposureNegTwoSharp.propTypes = { ...Icon.propTypes }
