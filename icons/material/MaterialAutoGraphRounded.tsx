...
const MaterialAutoGraphRoundedSvg = props => (
  <svg
...
const MaterialAutoGraphRounded = props => <Icon as={MaterialAutoGraphRoundedSvg} {...props} />

MaterialAutoGraphRounded.defaultProps = { ...Icon.defaultProps }

MaterialAutoGraphRounded.propTypes = { ...Icon.propTypes }

export default MaterialAutoGraphRounded
