...
const MaterialRecommendRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRecommendRounded = (styled.default || styled)(MaterialRecommendRoundedSvg).attrs(p => ({
...
`;
MaterialRecommendRounded.propTypes = {
