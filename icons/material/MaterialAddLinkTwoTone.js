...
const MaterialAddLinkTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddLinkTwoTone = (styled.default || styled)(MaterialAddLinkTwoToneSvg).attrs(p => ({
...
`;
MaterialAddLinkTwoTone.propTypes = {
