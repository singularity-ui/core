...
const MaterialPowerInputRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPowerInputRounded = (styled.default || styled)(MaterialPowerInputRoundedSvg).attrs(p => ({
...
`;
MaterialPowerInputRounded.propTypes = {
