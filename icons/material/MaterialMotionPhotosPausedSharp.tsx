...
const MaterialMotionPhotosPausedSharpSvg = props => (
  <svg
...
const MaterialMotionPhotosPausedSharp = props => <Icon as={MaterialMotionPhotosPausedSharpSvg} {...props} />

MaterialMotionPhotosPausedSharp.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosPausedSharp.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosPausedSharp
