...
const MaterialIcecreamSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialIcecreamSharp = (styled.default || styled)(MaterialIcecreamSharpSvg).attrs(p => ({
...
`;
MaterialIcecreamSharp.propTypes = {
