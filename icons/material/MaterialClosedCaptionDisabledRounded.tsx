...
const MaterialClosedCaptionDisabledRoundedSvg = props => (
  <svg
...
const MaterialClosedCaptionDisabledRounded = props => <Icon as={MaterialClosedCaptionDisabledRoundedSvg} {...props} />

MaterialClosedCaptionDisabledRounded.defaultProps = { ...Icon.defaultProps }

MaterialClosedCaptionDisabledRounded.propTypes = { ...Icon.propTypes }

export default MaterialClosedCaptionDisabledRounded
