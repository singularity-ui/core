...
const MaterialBackupTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBackupTwoTone = (styled.default || styled)(MaterialBackupTwoToneSvg).attrs(p => ({
...
`;
MaterialBackupTwoTone.propTypes = {
