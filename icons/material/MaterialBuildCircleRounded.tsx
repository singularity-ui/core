...
const MaterialBuildCircleRoundedSvg = props => (
  <svg
...
const MaterialBuildCircleRounded = props => <Icon as={MaterialBuildCircleRoundedSvg} {...props} />

MaterialBuildCircleRounded.defaultProps = { ...Icon.defaultProps }

MaterialBuildCircleRounded.propTypes = { ...Icon.propTypes }

export default MaterialBuildCircleRounded
