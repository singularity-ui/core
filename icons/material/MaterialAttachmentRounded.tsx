...
const MaterialAttachmentRoundedSvg = props => (
...
const MaterialAttachmentRounded = props => <Icon as={MaterialAttachmentRoundedSvg} {...props} />

MaterialAttachmentRounded.defaultProps = { ...Icon.defaultProps }

MaterialAttachmentRounded.propTypes = { ...Icon.propTypes }
