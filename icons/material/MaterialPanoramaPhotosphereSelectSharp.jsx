...
const MaterialPanoramaPhotosphereSelectSharpSvg = props => (
  <svg
...
const MaterialPanoramaPhotosphereSelectSharp = props => (
  <Icon as={MaterialPanoramaPhotosphereSelectSharpSvg} {...props} />
)

MaterialPanoramaPhotosphereSelectSharp.defaultProps = { ...Icon.defaultProps }

MaterialPanoramaPhotosphereSelectSharp.propTypes = { ...Icon.propTypes }

export default MaterialPanoramaPhotosphereSelectSharp
