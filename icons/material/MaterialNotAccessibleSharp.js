...
const MaterialNotAccessibleSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNotAccessibleSharp = (styled.default || styled)(MaterialNotAccessibleSharpSvg).attrs(p => ({
...
`;
MaterialNotAccessibleSharp.propTypes = {
