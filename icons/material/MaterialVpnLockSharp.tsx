...
const MaterialVpnLockSharpSvg = props => (
...
const MaterialVpnLockSharp = props => <Icon as={MaterialVpnLockSharpSvg} {...props} />

MaterialVpnLockSharp.defaultProps = { ...Icon.defaultProps }

MaterialVpnLockSharp.propTypes = { ...Icon.propTypes }
