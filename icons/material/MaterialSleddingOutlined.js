...
const MaterialSleddingOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSleddingOutlined = (styled.default || styled)(MaterialSleddingOutlinedSvg).attrs(p => ({
...
`;
MaterialSleddingOutlined.propTypes = {
