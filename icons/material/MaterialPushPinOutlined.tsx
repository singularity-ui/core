...
const MaterialPushPinOutlinedSvg = props => (
  <svg
...
const MaterialPushPinOutlined = props => <Icon as={MaterialPushPinOutlinedSvg} {...props} />

MaterialPushPinOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPushPinOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPushPinOutlined
