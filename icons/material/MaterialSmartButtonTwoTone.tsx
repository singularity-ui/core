...
const MaterialSmartButtonTwoToneSvg = props => (
  <svg
...
const MaterialSmartButtonTwoTone = props => <Icon as={MaterialSmartButtonTwoToneSvg} {...props} />

MaterialSmartButtonTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSmartButtonTwoTone.propTypes = { ...Icon.propTypes }
