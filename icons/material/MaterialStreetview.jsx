...
const MaterialStreetviewSvg = props => (
...
const MaterialStreetview = props => <Icon as={MaterialStreetviewSvg} {...props} />

MaterialStreetview.defaultProps = { ...Icon.defaultProps }

MaterialStreetview.propTypes = { ...Icon.propTypes }
