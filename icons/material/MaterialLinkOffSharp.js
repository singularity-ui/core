...
const MaterialLinkOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLinkOffSharp = (styled.default || styled)(MaterialLinkOffSharpSvg).attrs(p => ({
...
`;
MaterialLinkOffSharp.propTypes = {
