...
const MaterialCreditCardOffRoundedSvg = props => (
  <svg
...
const MaterialCreditCardOffRounded = props => <Icon as={MaterialCreditCardOffRoundedSvg} {...props} />

MaterialCreditCardOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialCreditCardOffRounded.propTypes = { ...Icon.propTypes }
