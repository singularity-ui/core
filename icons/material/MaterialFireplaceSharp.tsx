...
const MaterialFireplaceSharpSvg = props => (
  <svg
...
const MaterialFireplaceSharp = props => <Icon as={MaterialFireplaceSharpSvg} {...props} />

MaterialFireplaceSharp.defaultProps = { ...Icon.defaultProps }

MaterialFireplaceSharp.propTypes = { ...Icon.propTypes }
