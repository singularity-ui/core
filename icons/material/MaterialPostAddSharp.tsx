...
const MaterialPostAddSharpSvg = props => (
  <svg
...
const MaterialPostAddSharp = props => <Icon as={MaterialPostAddSharpSvg} {...props} />

MaterialPostAddSharp.defaultProps = { ...Icon.defaultProps }

MaterialPostAddSharp.propTypes = { ...Icon.propTypes }
