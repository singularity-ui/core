...
const MaterialSensorsOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSensorsOffSharp = (styled.default || styled)(MaterialSensorsOffSharpSvg).attrs(p => ({
...
`;
MaterialSensorsOffSharp.propTypes = {
