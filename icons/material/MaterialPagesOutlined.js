...
const MaterialPagesOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPagesOutlined = (styled.default || styled)(MaterialPagesOutlinedSvg).attrs(p => ({
...
`;
MaterialPagesOutlined.propTypes = {
