...
const MaterialGroupAddRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGroupAddRounded = (styled.default || styled)(MaterialGroupAddRoundedSvg).attrs(p => ({
...
`;
MaterialGroupAddRounded.propTypes = {
