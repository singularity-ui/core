...
const MaterialStrollerSvg = props => (
  <svg
...
const MaterialStroller = props => <Icon as={MaterialStrollerSvg} {...props} />

MaterialStroller.defaultProps = { ...Icon.defaultProps }

MaterialStroller.propTypes = { ...Icon.propTypes }
