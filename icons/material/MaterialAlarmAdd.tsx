...
const MaterialAlarmAddSvg = props => (
...
const MaterialAlarmAdd = props => <Icon as={MaterialAlarmAddSvg} {...props} />

MaterialAlarmAdd.defaultProps = { ...Icon.defaultProps }

MaterialAlarmAdd.propTypes = { ...Icon.propTypes }

export default MaterialAlarmAdd
