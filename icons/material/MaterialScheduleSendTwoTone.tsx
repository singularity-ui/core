...
const MaterialScheduleSendTwoToneSvg = props => (
  <svg
...
const MaterialScheduleSendTwoTone = props => <Icon as={MaterialScheduleSendTwoToneSvg} {...props} />

MaterialScheduleSendTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialScheduleSendTwoTone.propTypes = { ...Icon.propTypes }
