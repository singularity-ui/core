...
const MaterialNoteAltOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoteAltOutlined = (styled.default || styled)(MaterialNoteAltOutlinedSvg).attrs(p => ({
...
`;
MaterialNoteAltOutlined.propTypes = {
