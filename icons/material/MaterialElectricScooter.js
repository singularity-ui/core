...
const MaterialElectricScooterSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElectricScooter = (styled.default || styled)(MaterialElectricScooterSvg).attrs(p => ({
...
`;
MaterialElectricScooter.propTypes = {
