...
const MaterialRawOffRoundedSvg = props => (
  <svg
...
const MaterialRawOffRounded = props => <Icon as={MaterialRawOffRoundedSvg} {...props} />

MaterialRawOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialRawOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialRawOffRounded
