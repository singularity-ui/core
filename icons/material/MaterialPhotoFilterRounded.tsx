...
const MaterialPhotoFilterRoundedSvg = props => (
...
const MaterialPhotoFilterRounded = props => <Icon as={MaterialPhotoFilterRoundedSvg} {...props} />

MaterialPhotoFilterRounded.defaultProps = { ...Icon.defaultProps }

MaterialPhotoFilterRounded.propTypes = { ...Icon.propTypes }
