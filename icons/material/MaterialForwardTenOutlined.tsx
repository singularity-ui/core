...
const MaterialForwardTenOutlinedSvg = props => (
  <svg
...
const MaterialForwardTenOutlined = props => <Icon as={MaterialForwardTenOutlinedSvg} {...props} />

MaterialForwardTenOutlined.defaultProps = { ...Icon.defaultProps }

MaterialForwardTenOutlined.propTypes = { ...Icon.propTypes }

export default MaterialForwardTenOutlined
