...
const MaterialAddAPhotoTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddAPhotoTwoTone = (styled.default || styled)(MaterialAddAPhotoTwoToneSvg).attrs(p => ({
...
`;
MaterialAddAPhotoTwoTone.propTypes = {
