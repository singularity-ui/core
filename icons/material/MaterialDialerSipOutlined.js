...
const MaterialDialerSipOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDialerSipOutlined = (styled.default || styled)(MaterialDialerSipOutlinedSvg).attrs(p => ({
...
`;
MaterialDialerSipOutlined.propTypes = {
