...
const MaterialStairsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStairsRounded = (styled.default || styled)(MaterialStairsRoundedSvg).attrs(p => ({
...
`;
MaterialStairsRounded.propTypes = {
