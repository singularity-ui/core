...
const MaterialEditRoadOutlinedSvg = props => (
  <svg
...
const MaterialEditRoadOutlined = props => <Icon as={MaterialEditRoadOutlinedSvg} {...props} />

MaterialEditRoadOutlined.defaultProps = { ...Icon.defaultProps }

MaterialEditRoadOutlined.propTypes = { ...Icon.propTypes }
