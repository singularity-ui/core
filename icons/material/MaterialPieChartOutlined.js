...
const MaterialPieChartOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPieChartOutlined = (styled.default || styled)(MaterialPieChartOutlinedSvg).attrs(p => ({
...
`;
MaterialPieChartOutlined.propTypes = {
