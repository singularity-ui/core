...
const MaterialTryOutlinedSvg = props => (
  <svg
...
const MaterialTryOutlined = props => <Icon as={MaterialTryOutlinedSvg} {...props} />

MaterialTryOutlined.defaultProps = { ...Icon.defaultProps }

MaterialTryOutlined.propTypes = { ...Icon.propTypes }

export default MaterialTryOutlined
