...
const MaterialHdrOn = props => <Icon as={MaterialHdrOnSvg} {...props} />

MaterialHdrOn.defaultProps = { ...Icon.defaultProps }

MaterialHdrOn.propTypes = { ...Icon.propTypes }

export default MaterialHdrOn
