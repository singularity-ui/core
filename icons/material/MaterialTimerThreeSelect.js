...
const MaterialTimerThreeSelectSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerThreeSelect = (styled.default || styled)(MaterialTimerThreeSelectSvg).attrs(p => ({
...
`;
MaterialTimerThreeSelect.propTypes = {
