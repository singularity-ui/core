...
const MaterialHomeMiniSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHomeMiniSharp = (styled.default || styled)(MaterialHomeMiniSharpSvg).attrs(p => ({
...
`;
MaterialHomeMiniSharp.propTypes = {
