...
const MaterialPedalBikeSvg = props => (
  <svg
...
const MaterialPedalBike = props => <Icon as={MaterialPedalBikeSvg} {...props} />

MaterialPedalBike.defaultProps = { ...Icon.defaultProps }

MaterialPedalBike.propTypes = { ...Icon.propTypes }

export default MaterialPedalBike
