...
const MaterialSyncProblemSvg = props => (
...
const MaterialSyncProblem = props => <Icon as={MaterialSyncProblemSvg} {...props} />

MaterialSyncProblem.defaultProps = { ...Icon.defaultProps }

MaterialSyncProblem.propTypes = { ...Icon.propTypes }

export default MaterialSyncProblem
