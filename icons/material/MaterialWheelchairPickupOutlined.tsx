...
const MaterialWheelchairPickupOutlinedSvg = props => (
  <svg
...
const MaterialWheelchairPickupOutlined = props => <Icon as={MaterialWheelchairPickupOutlinedSvg} {...props} />

MaterialWheelchairPickupOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWheelchairPickupOutlined.propTypes = { ...Icon.propTypes }

export default MaterialWheelchairPickupOutlined
