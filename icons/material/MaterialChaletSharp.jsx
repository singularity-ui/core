...
const MaterialChaletSharpSvg = props => (
  <svg
...
const MaterialChaletSharp = props => <Icon as={MaterialChaletSharpSvg} {...props} />

MaterialChaletSharp.defaultProps = { ...Icon.defaultProps }

MaterialChaletSharp.propTypes = { ...Icon.propTypes }
