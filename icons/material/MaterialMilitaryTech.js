...
const MaterialMilitaryTechSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMilitaryTech = (styled.default || styled)(MaterialMilitaryTechSvg).attrs(p => ({
...
`;
MaterialMilitaryTech.propTypes = {
