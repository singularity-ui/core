...
const MaterialMotionPhotosPauseTwoToneSvg = props => (
  <svg
...
const MaterialMotionPhotosPauseTwoTone = props => <Icon as={MaterialMotionPhotosPauseTwoToneSvg} {...props} />

MaterialMotionPhotosPauseTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosPauseTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosPauseTwoTone
