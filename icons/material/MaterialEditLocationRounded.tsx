...
const MaterialEditLocationRoundedSvg = props => (
  <svg
...
const MaterialEditLocationRounded = props => <Icon as={MaterialEditLocationRoundedSvg} {...props} />

MaterialEditLocationRounded.defaultProps = { ...Icon.defaultProps }

MaterialEditLocationRounded.propTypes = { ...Icon.propTypes }
