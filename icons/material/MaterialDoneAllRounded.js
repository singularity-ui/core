...
const MaterialDoneAllRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoneAllRounded = (styled.default || styled)(MaterialDoneAllRoundedSvg).attrs(p => ({
...
`;
MaterialDoneAllRounded.propTypes = {
