...
const MaterialCameraswitchSvg = props => (
  <svg
...
const MaterialCameraswitch = props => <Icon as={MaterialCameraswitchSvg} {...props} />

MaterialCameraswitch.defaultProps = { ...Icon.defaultProps }

MaterialCameraswitch.propTypes = { ...Icon.propTypes }
