...
const MaterialBloodtypeTwoToneSvg = props => (
  <svg
...
const MaterialBloodtypeTwoTone = props => <Icon as={MaterialBloodtypeTwoToneSvg} {...props} />

MaterialBloodtypeTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBloodtypeTwoTone.propTypes = { ...Icon.propTypes }
