...
const MaterialRadioOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRadioOutlined = (styled.default || styled)(MaterialRadioOutlinedSvg).attrs(p => ({
...
`;
MaterialRadioOutlined.propTypes = {
