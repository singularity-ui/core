...
const MaterialSettingsSuggestSharpSvg = props => (
  <svg
...
const MaterialSettingsSuggestSharp = props => <Icon as={MaterialSettingsSuggestSharpSvg} {...props} />

MaterialSettingsSuggestSharp.defaultProps = { ...Icon.defaultProps }

MaterialSettingsSuggestSharp.propTypes = { ...Icon.propTypes }
