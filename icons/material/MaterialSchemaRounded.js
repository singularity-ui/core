...
const MaterialSchemaRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSchemaRounded = (styled.default || styled)(MaterialSchemaRoundedSvg).attrs(p => ({
...
`;
MaterialSchemaRounded.propTypes = {
