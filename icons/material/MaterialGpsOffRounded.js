...
const MaterialGpsOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGpsOffRounded = (styled.default || styled)(MaterialGpsOffRoundedSvg).attrs(p => ({
...
`;
MaterialGpsOffRounded.propTypes = {
