...
const MaterialSentimentSatisfiedAltTwoToneSvg = props => (
...
const MaterialSentimentSatisfiedAltTwoTone = props => <Icon as={MaterialSentimentSatisfiedAltTwoToneSvg} {...props} />

MaterialSentimentSatisfiedAltTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSentimentSatisfiedAltTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSentimentSatisfiedAltTwoTone
