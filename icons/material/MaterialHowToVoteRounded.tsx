...
const MaterialHowToVoteRoundedSvg = props => (
  <svg
...
const MaterialHowToVoteRounded = props => <Icon as={MaterialHowToVoteRoundedSvg} {...props} />

MaterialHowToVoteRounded.defaultProps = { ...Icon.defaultProps }

MaterialHowToVoteRounded.propTypes = { ...Icon.propTypes }
