...
const MaterialHeightKPlusSharpSvg = props => (
  <svg
...
const MaterialHeightKPlusSharp = props => <Icon as={MaterialHeightKPlusSharpSvg} {...props} />

MaterialHeightKPlusSharp.defaultProps = { ...Icon.defaultProps }

MaterialHeightKPlusSharp.propTypes = { ...Icon.propTypes }
