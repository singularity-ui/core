...
const MaterialToysOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialToysOutlined = (styled.default || styled)(MaterialToysOutlinedSvg).attrs(p => ({
...
`;
MaterialToysOutlined.propTypes = {
