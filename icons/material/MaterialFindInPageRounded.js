...
const MaterialFindInPageRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFindInPageRounded = (styled.default || styled)(MaterialFindInPageRoundedSvg).attrs(p => ({
...
`;
MaterialFindInPageRounded.propTypes = {
