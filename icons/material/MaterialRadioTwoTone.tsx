...
const MaterialRadioTwoToneSvg = props => (
...
const MaterialRadioTwoTone = props => <Icon as={MaterialRadioTwoToneSvg} {...props} />

MaterialRadioTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRadioTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialRadioTwoTone
