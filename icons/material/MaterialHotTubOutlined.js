...
const MaterialHotTubOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHotTubOutlined = (styled.default || styled)(MaterialHotTubOutlinedSvg).attrs(p => ({
...
`;
MaterialHotTubOutlined.propTypes = {
