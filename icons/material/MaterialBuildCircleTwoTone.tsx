...
const MaterialBuildCircleTwoToneSvg = props => (
  <svg
...
const MaterialBuildCircleTwoTone = props => <Icon as={MaterialBuildCircleTwoToneSvg} {...props} />

MaterialBuildCircleTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBuildCircleTwoTone.propTypes = { ...Icon.propTypes }
