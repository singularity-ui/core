...
const MaterialPatternRoundedSvg = props => (
  <svg
...
const MaterialPatternRounded = props => <Icon as={MaterialPatternRoundedSvg} {...props} />

MaterialPatternRounded.defaultProps = { ...Icon.defaultProps }

MaterialPatternRounded.propTypes = { ...Icon.propTypes }

export default MaterialPatternRounded
