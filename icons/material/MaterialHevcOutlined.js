...
const MaterialHevcOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHevcOutlined = (styled.default || styled)(MaterialHevcOutlinedSvg).attrs(p => ({
...
`;
MaterialHevcOutlined.propTypes = {
