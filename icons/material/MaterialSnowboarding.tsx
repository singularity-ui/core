...
const MaterialSnowboardingSvg = props => (
  <svg
...
const MaterialSnowboarding = props => <Icon as={MaterialSnowboardingSvg} {...props} />

MaterialSnowboarding.defaultProps = { ...Icon.defaultProps }

MaterialSnowboarding.propTypes = { ...Icon.propTypes }

export default MaterialSnowboarding
