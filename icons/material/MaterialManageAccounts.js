...
const MaterialManageAccountsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialManageAccounts = (styled.default || styled)(MaterialManageAccountsSvg).attrs(p => ({
...
`;
MaterialManageAccounts.propTypes = {
