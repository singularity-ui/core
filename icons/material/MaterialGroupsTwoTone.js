...
const MaterialGroupsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGroupsTwoTone = (styled.default || styled)(MaterialGroupsTwoToneSvg).attrs(p => ({
...
`;
MaterialGroupsTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialGroupsTwoTone;