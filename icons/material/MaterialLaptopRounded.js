...
const MaterialLaptopRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLaptopRounded = (styled.default || styled)(MaterialLaptopRoundedSvg).attrs(p => ({
...
`;
MaterialLaptopRounded.propTypes = {
