...
const MaterialPlagiarismRoundedSvg = props => (
  <svg
...
const MaterialPlagiarismRounded = props => <Icon as={MaterialPlagiarismRoundedSvg} {...props} />

MaterialPlagiarismRounded.defaultProps = { ...Icon.defaultProps }

MaterialPlagiarismRounded.propTypes = { ...Icon.propTypes }
