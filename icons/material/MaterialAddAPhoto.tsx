...
const MaterialAddAPhotoSvg = props => (
  <svg
...
const MaterialAddAPhoto = props => <Icon as={MaterialAddAPhotoSvg} {...props} />

MaterialAddAPhoto.defaultProps = { ...Icon.defaultProps }

MaterialAddAPhoto.propTypes = { ...Icon.propTypes }

export default MaterialAddAPhoto
