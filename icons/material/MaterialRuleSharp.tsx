...
const MaterialRuleSharpSvg = props => (
  <svg
...
const MaterialRuleSharp = props => <Icon as={MaterialRuleSharpSvg} {...props} />

MaterialRuleSharp.defaultProps = { ...Icon.defaultProps }

MaterialRuleSharp.propTypes = { ...Icon.propTypes }

export default MaterialRuleSharp
