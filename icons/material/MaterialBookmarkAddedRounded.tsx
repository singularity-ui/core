...
const MaterialBookmarkAddedRoundedSvg = props => (
  <svg
...
const MaterialBookmarkAddedRounded = props => <Icon as={MaterialBookmarkAddedRoundedSvg} {...props} />

MaterialBookmarkAddedRounded.defaultProps = { ...Icon.defaultProps }

MaterialBookmarkAddedRounded.propTypes = { ...Icon.propTypes }
