...
const MaterialWidgetsTwoToneSvg = props => (
...
const MaterialWidgetsTwoTone = props => <Icon as={MaterialWidgetsTwoToneSvg} {...props} />

MaterialWidgetsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialWidgetsTwoTone.propTypes = { ...Icon.propTypes }
