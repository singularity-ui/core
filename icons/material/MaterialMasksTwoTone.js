...
const MaterialMasksTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMasksTwoTone = (styled.default || styled)(MaterialMasksTwoToneSvg).attrs(p => ({
...
`;
MaterialMasksTwoTone.propTypes = {
