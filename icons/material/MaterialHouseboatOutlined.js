...
const MaterialHouseboatOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHouseboatOutlined = (styled.default || styled)(MaterialHouseboatOutlinedSvg).attrs(p => ({
...
`;
MaterialHouseboatOutlined.propTypes = {
