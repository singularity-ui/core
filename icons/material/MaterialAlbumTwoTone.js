...
const MaterialAlbumTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlbumTwoTone = (styled.default || styled)(MaterialAlbumTwoToneSvg).attrs(p => ({
...
`;
MaterialAlbumTwoTone.propTypes = {
