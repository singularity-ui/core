...
const MaterialPatternSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPatternSharp = (styled.default || styled)(MaterialPatternSharpSvg).attrs(p => ({
...
`;
MaterialPatternSharp.propTypes = {
