...
const MaterialAttachmentSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttachmentSharp = (styled.default || styled)(MaterialAttachmentSharpSvg).attrs(p => ({
...
`;
MaterialAttachmentSharp.propTypes = {
