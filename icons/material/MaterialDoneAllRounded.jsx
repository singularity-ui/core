...
const MaterialDoneAllRoundedSvg = props => (
...
const MaterialDoneAllRounded = props => <Icon as={MaterialDoneAllRoundedSvg} {...props} />

MaterialDoneAllRounded.defaultProps = { ...Icon.defaultProps }

MaterialDoneAllRounded.propTypes = { ...Icon.propTypes }

export default MaterialDoneAllRounded
