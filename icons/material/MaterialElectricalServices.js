...
const MaterialElectricalServicesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElectricalServices = (styled.default || styled)(MaterialElectricalServicesSvg).attrs(p => ({
...
`;
MaterialElectricalServices.propTypes = {
