...
const MaterialPinDropRoundedSvg = props => (
  <svg
...
const MaterialPinDropRounded = props => <Icon as={MaterialPinDropRoundedSvg} {...props} />

MaterialPinDropRounded.defaultProps = { ...Icon.defaultProps }

MaterialPinDropRounded.propTypes = { ...Icon.propTypes }
