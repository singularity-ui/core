...
const MaterialBedOutlinedSvg = props => (
  <svg
...
const MaterialBedOutlined = props => <Icon as={MaterialBedOutlinedSvg} {...props} />

MaterialBedOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBedOutlined.propTypes = { ...Icon.propTypes }

export default MaterialBedOutlined
