...
const MaterialDonutLargeSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDonutLargeSharp = (styled.default || styled)(MaterialDonutLargeSharpSvg).attrs(p => ({
...
`;
MaterialDonutLargeSharp.propTypes = {
