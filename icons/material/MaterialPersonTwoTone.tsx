...
const MaterialPersonTwoToneSvg = props => (
...
const MaterialPersonTwoTone = props => <Icon as={MaterialPersonTwoToneSvg} {...props} />

MaterialPersonTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPersonTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPersonTwoTone
