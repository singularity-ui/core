...
const MaterialFilterVintageTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFilterVintageTwoTone = (styled.default || styled)(MaterialFilterVintageTwoToneSvg).attrs(p => ({
...
`;
MaterialFilterVintageTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFilterVintageTwoTone;