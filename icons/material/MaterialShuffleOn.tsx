...
const MaterialShuffleOnSvg = props => (
...
const MaterialShuffleOn = props => <Icon as={MaterialShuffleOnSvg} {...props} />

MaterialShuffleOn.defaultProps = { ...Icon.defaultProps }

MaterialShuffleOn.propTypes = { ...Icon.propTypes }

export default MaterialShuffleOn
