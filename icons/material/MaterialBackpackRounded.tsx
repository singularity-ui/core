...
const MaterialBackpackRoundedSvg = props => (
  <svg
...
const MaterialBackpackRounded = props => <Icon as={MaterialBackpackRoundedSvg} {...props} />

MaterialBackpackRounded.defaultProps = { ...Icon.defaultProps }

MaterialBackpackRounded.propTypes = { ...Icon.propTypes }
