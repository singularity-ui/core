...
const MaterialDomainDisabledSvg = props => (
...
const MaterialDomainDisabled = props => <Icon as={MaterialDomainDisabledSvg} {...props} />

MaterialDomainDisabled.defaultProps = { ...Icon.defaultProps }

MaterialDomainDisabled.propTypes = { ...Icon.propTypes }
