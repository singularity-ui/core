...
const MaterialArchiveRoundedSvg = props => (
...
const MaterialArchiveRounded = props => <Icon as={MaterialArchiveRoundedSvg} {...props} />

MaterialArchiveRounded.defaultProps = { ...Icon.defaultProps }

MaterialArchiveRounded.propTypes = { ...Icon.propTypes }

export default MaterialArchiveRounded
