...
const MaterialMoneyOutlinedSvg = props => (
...
const MaterialMoneyOutlined = props => <Icon as={MaterialMoneyOutlinedSvg} {...props} />

MaterialMoneyOutlined.defaultProps = { ...Icon.defaultProps }

MaterialMoneyOutlined.propTypes = { ...Icon.propTypes }
