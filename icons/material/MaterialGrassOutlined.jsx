...
const MaterialGrassOutlinedSvg = props => (
  <svg
...
const MaterialGrassOutlined = props => <Icon as={MaterialGrassOutlinedSvg} {...props} />

MaterialGrassOutlined.defaultProps = { ...Icon.defaultProps }

MaterialGrassOutlined.propTypes = { ...Icon.propTypes }
