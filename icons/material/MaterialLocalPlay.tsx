...
const MaterialLocalPlaySvg = props => (
...
const MaterialLocalPlay = props => <Icon as={MaterialLocalPlaySvg} {...props} />

MaterialLocalPlay.defaultProps = { ...Icon.defaultProps }

MaterialLocalPlay.propTypes = { ...Icon.propTypes }

export default MaterialLocalPlay
