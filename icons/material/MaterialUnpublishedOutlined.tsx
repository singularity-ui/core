...
const MaterialUnpublishedOutlinedSvg = props => (
  <svg
...
const MaterialUnpublishedOutlined = props => <Icon as={MaterialUnpublishedOutlinedSvg} {...props} />

MaterialUnpublishedOutlined.defaultProps = { ...Icon.defaultProps }

MaterialUnpublishedOutlined.propTypes = { ...Icon.propTypes }
