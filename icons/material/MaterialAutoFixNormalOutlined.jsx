...
const MaterialAutoFixNormalOutlinedSvg = props => (
  <svg
...
const MaterialAutoFixNormalOutlined = props => <Icon as={MaterialAutoFixNormalOutlinedSvg} {...props} />

MaterialAutoFixNormalOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAutoFixNormalOutlined.propTypes = { ...Icon.propTypes }

export default MaterialAutoFixNormalOutlined
