...
const MaterialLunchDiningRoundedSvg = props => (
  <svg
...
const MaterialLunchDiningRounded = props => <Icon as={MaterialLunchDiningRoundedSvg} {...props} />

MaterialLunchDiningRounded.defaultProps = { ...Icon.defaultProps }

MaterialLunchDiningRounded.propTypes = { ...Icon.propTypes }
