...
const MaterialIcecreamOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialIcecreamOutlined = (styled.default || styled)(MaterialIcecreamOutlinedSvg).attrs(p => ({
...
`;
MaterialIcecreamOutlined.propTypes = {
