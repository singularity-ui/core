...
const MaterialCameraOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCameraOutlined = (styled.default || styled)(MaterialCameraOutlinedSvg).attrs(p => ({
...
`;
MaterialCameraOutlined.propTypes = {
