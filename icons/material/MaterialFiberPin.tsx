...
const MaterialFiberPinSvg = props => (
...
const MaterialFiberPin = props => <Icon as={MaterialFiberPinSvg} {...props} />

MaterialFiberPin.defaultProps = { ...Icon.defaultProps }

MaterialFiberPin.propTypes = { ...Icon.propTypes }

export default MaterialFiberPin
