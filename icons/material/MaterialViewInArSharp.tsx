...
const MaterialViewInArSharpSvg = props => (
  <svg
...
const MaterialViewInArSharp = props => <Icon as={MaterialViewInArSharpSvg} {...props} />

MaterialViewInArSharp.defaultProps = { ...Icon.defaultProps }

MaterialViewInArSharp.propTypes = { ...Icon.propTypes }
