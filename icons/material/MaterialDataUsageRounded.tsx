...
const MaterialDataUsageRoundedSvg = props => (
...
const MaterialDataUsageRounded = props => <Icon as={MaterialDataUsageRoundedSvg} {...props} />

MaterialDataUsageRounded.defaultProps = { ...Icon.defaultProps }

MaterialDataUsageRounded.propTypes = { ...Icon.propTypes }
