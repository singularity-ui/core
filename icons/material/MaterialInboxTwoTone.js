...
const MaterialInboxTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialInboxTwoTone = (styled.default || styled)(MaterialInboxTwoToneSvg).attrs(p => ({
...
`;
MaterialInboxTwoTone.propTypes = {
