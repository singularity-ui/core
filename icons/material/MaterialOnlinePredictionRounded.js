...
const MaterialOnlinePredictionRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOnlinePredictionRounded = (styled.default || styled)(MaterialOnlinePredictionRoundedSvg).attrs(p => ({
...
`;
MaterialOnlinePredictionRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialOnlinePredictionRounded;