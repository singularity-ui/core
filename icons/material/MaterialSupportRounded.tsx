...
const MaterialSupportRoundedSvg = props => (
  <svg
...
const MaterialSupportRounded = props => <Icon as={MaterialSupportRoundedSvg} {...props} />

MaterialSupportRounded.defaultProps = { ...Icon.defaultProps }

MaterialSupportRounded.propTypes = { ...Icon.propTypes }

export default MaterialSupportRounded
