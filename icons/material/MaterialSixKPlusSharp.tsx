...
const MaterialSixKPlusSharpSvg = props => (
  <svg
...
const MaterialSixKPlusSharp = props => <Icon as={MaterialSixKPlusSharpSvg} {...props} />

MaterialSixKPlusSharp.defaultProps = { ...Icon.defaultProps }

MaterialSixKPlusSharp.propTypes = { ...Icon.propTypes }
