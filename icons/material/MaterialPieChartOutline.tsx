...
const MaterialPieChartOutlineSvg = props => (
  <svg
...
const MaterialPieChartOutline = props => <Icon as={MaterialPieChartOutlineSvg} {...props} />

MaterialPieChartOutline.defaultProps = { ...Icon.defaultProps }

MaterialPieChartOutline.propTypes = { ...Icon.propTypes }
