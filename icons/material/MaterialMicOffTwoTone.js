...
const MaterialMicOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMicOffTwoTone = (styled.default || styled)(MaterialMicOffTwoToneSvg).attrs(p => ({
...
`;
MaterialMicOffTwoTone.propTypes = {
