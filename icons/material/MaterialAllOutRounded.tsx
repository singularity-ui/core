...
const MaterialAllOutRoundedSvg = props => (
...
const MaterialAllOutRounded = props => <Icon as={MaterialAllOutRoundedSvg} {...props} />

MaterialAllOutRounded.defaultProps = { ...Icon.defaultProps }

MaterialAllOutRounded.propTypes = { ...Icon.propTypes }
