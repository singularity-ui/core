...
const MaterialBorderTopSvg = props => (
...
const MaterialBorderTop = props => <Icon as={MaterialBorderTopSvg} {...props} />

MaterialBorderTop.defaultProps = { ...Icon.defaultProps }

MaterialBorderTop.propTypes = { ...Icon.propTypes }

export default MaterialBorderTop
