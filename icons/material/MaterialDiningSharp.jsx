...
const MaterialDiningSharpSvg = props => (
  <svg
...
const MaterialDiningSharp = props => <Icon as={MaterialDiningSharpSvg} {...props} />

MaterialDiningSharp.defaultProps = { ...Icon.defaultProps }

MaterialDiningSharp.propTypes = { ...Icon.propTypes }
