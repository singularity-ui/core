...
const MaterialOpacityOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOpacityOutlined = (styled.default || styled)(MaterialOpacityOutlinedSvg).attrs(p => ({
...
`;
MaterialOpacityOutlined.propTypes = {
