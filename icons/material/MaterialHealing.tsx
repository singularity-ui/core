...
const MaterialHealingSvg = props => (
...
const MaterialHealing = props => <Icon as={MaterialHealingSvg} {...props} />

MaterialHealing.defaultProps = { ...Icon.defaultProps }

MaterialHealing.propTypes = { ...Icon.propTypes }

export default MaterialHealing
