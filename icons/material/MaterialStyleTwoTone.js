...
const MaterialStyleTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStyleTwoTone = (styled.default || styled)(MaterialStyleTwoToneSvg).attrs(p => ({
...
`;
MaterialStyleTwoTone.propTypes = {
