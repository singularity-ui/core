...
const MaterialSkateboardingSvg = props => (
  <svg
...
const MaterialSkateboarding = props => <Icon as={MaterialSkateboardingSvg} {...props} />

MaterialSkateboarding.defaultProps = { ...Icon.defaultProps }

MaterialSkateboarding.propTypes = { ...Icon.propTypes }

export default MaterialSkateboarding
