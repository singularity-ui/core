...
const MaterialCallEndTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCallEndTwoTone = (styled.default || styled)(MaterialCallEndTwoToneSvg).attrs(p => ({
...
`;
MaterialCallEndTwoTone.propTypes = {
