...
const MaterialSixKRoundedSvg = props => (
  <svg
...
const MaterialSixKRounded = props => <Icon as={MaterialSixKRoundedSvg} {...props} />

MaterialSixKRounded.defaultProps = { ...Icon.defaultProps }

MaterialSixKRounded.propTypes = { ...Icon.propTypes }
