...
const MaterialFlipTwoToneSvg = props => (
...
const MaterialFlipTwoTone = props => <Icon as={MaterialFlipTwoToneSvg} {...props} />

MaterialFlipTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialFlipTwoTone.propTypes = { ...Icon.propTypes }
