...
const MaterialPanoramaPhotosphereSelectTwoToneSvg = props => (
  <svg
...
const MaterialPanoramaPhotosphereSelectTwoTone = props => (
  <Icon as={MaterialPanoramaPhotosphereSelectTwoToneSvg} {...props} />
)

MaterialPanoramaPhotosphereSelectTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPanoramaPhotosphereSelectTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPanoramaPhotosphereSelectTwoTone
