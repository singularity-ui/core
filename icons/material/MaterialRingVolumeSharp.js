...
const MaterialRingVolumeSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRingVolumeSharp = (styled.default || styled)(MaterialRingVolumeSharpSvg).attrs(p => ({
...
`;
MaterialRingVolumeSharp.propTypes = {
