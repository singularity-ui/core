...
const MaterialAlarmAddRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmAddRounded = (styled.default || styled)(MaterialAlarmAddRoundedSvg).attrs(p => ({
...
`;
MaterialAlarmAddRounded.propTypes = {
