...
const MaterialAnalyticsSharpSvg = props => (
  <svg
...
const MaterialAnalyticsSharp = props => <Icon as={MaterialAnalyticsSharpSvg} {...props} />

MaterialAnalyticsSharp.defaultProps = { ...Icon.defaultProps }

MaterialAnalyticsSharp.propTypes = { ...Icon.propTypes }
