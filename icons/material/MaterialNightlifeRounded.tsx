...
const MaterialNightlifeRoundedSvg = props => (
  <svg
...
const MaterialNightlifeRounded = props => <Icon as={MaterialNightlifeRoundedSvg} {...props} />

MaterialNightlifeRounded.defaultProps = { ...Icon.defaultProps }

MaterialNightlifeRounded.propTypes = { ...Icon.propTypes }
