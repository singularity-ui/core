...
const MaterialLinearScaleSharpSvg = props => (
...
const MaterialLinearScaleSharp = props => <Icon as={MaterialLinearScaleSharpSvg} {...props} />

MaterialLinearScaleSharp.defaultProps = { ...Icon.defaultProps }

MaterialLinearScaleSharp.propTypes = { ...Icon.propTypes }

export default MaterialLinearScaleSharp
