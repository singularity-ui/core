...
const MaterialAirlineSeatReclineNormalRoundedSvg = props => (
...
const MaterialAirlineSeatReclineNormalRounded = props => (
  <Icon as={MaterialAirlineSeatReclineNormalRoundedSvg} {...props} />
)

MaterialAirlineSeatReclineNormalRounded.defaultProps = { ...Icon.defaultProps }

MaterialAirlineSeatReclineNormalRounded.propTypes = { ...Icon.propTypes }

export default MaterialAirlineSeatReclineNormalRounded
