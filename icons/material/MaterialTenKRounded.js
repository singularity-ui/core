...
const MaterialTenKRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialTenKRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialTenKRounded;