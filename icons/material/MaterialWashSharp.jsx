...
const MaterialWashSharpSvg = props => (
  <svg
...
const MaterialWashSharp = props => <Icon as={MaterialWashSharpSvg} {...props} />

MaterialWashSharp.defaultProps = { ...Icon.defaultProps }

MaterialWashSharp.propTypes = { ...Icon.propTypes }
