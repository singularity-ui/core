...
const MaterialMovingRoundedSvg = props => (
  <svg
...
const MaterialMovingRounded = props => <Icon as={MaterialMovingRoundedSvg} {...props} />

MaterialMovingRounded.defaultProps = { ...Icon.defaultProps }

MaterialMovingRounded.propTypes = { ...Icon.propTypes }
