...
const MaterialHideSourceRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHideSourceRounded = (styled.default || styled)(MaterialHideSourceRoundedSvg).attrs(p => ({
...
`;
MaterialHideSourceRounded.propTypes = {
