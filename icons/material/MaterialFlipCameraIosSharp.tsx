...
const MaterialFlipCameraIosSharpSvg = props => (
  <svg
...
const MaterialFlipCameraIosSharp = props => <Icon as={MaterialFlipCameraIosSharpSvg} {...props} />

MaterialFlipCameraIosSharp.defaultProps = { ...Icon.defaultProps }

MaterialFlipCameraIosSharp.propTypes = { ...Icon.propTypes }
