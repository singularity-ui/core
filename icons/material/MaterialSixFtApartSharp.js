...
const MaterialSixFtApartSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixFtApartSharp = (styled.default || styled)(MaterialSixFtApartSharpSvg).attrs(p => ({
...
`;
MaterialSixFtApartSharp.propTypes = {
