...
const MaterialAccessAlarmsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAccessAlarms = (styled.default || styled)(MaterialAccessAlarmsSvg).attrs(p => ({
...
`;
MaterialAccessAlarms.propTypes = {
