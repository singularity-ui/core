...
const MaterialSearchOffTwoToneSvg = props => (
  <svg
...
const MaterialSearchOffTwoTone = props => <Icon as={MaterialSearchOffTwoToneSvg} {...props} />

MaterialSearchOffTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSearchOffTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSearchOffTwoTone
