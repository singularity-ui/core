...
const MaterialAlarmOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOutlined = (styled.default || styled)(MaterialAlarmOutlinedSvg).attrs(p => ({
...
`;
MaterialAlarmOutlined.propTypes = {
