...
const MaterialFingerprintTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFingerprintTwoTone = (styled.default || styled)(MaterialFingerprintTwoToneSvg).attrs(p => ({
...
`;
MaterialFingerprintTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFingerprintTwoTone;