...
const MaterialHowToRegOutlinedSvg = props => (
...
const MaterialHowToRegOutlined = props => <Icon as={MaterialHowToRegOutlinedSvg} {...props} />

MaterialHowToRegOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHowToRegOutlined.propTypes = { ...Icon.propTypes }
