...
const MaterialAddRoadSvg = props => (
  <svg
...
const MaterialAddRoad = props => <Icon as={MaterialAddRoadSvg} {...props} />

MaterialAddRoad.defaultProps = { ...Icon.defaultProps }

MaterialAddRoad.propTypes = { ...Icon.propTypes }
