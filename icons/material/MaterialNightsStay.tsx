...
const MaterialNightsStaySvg = props => (
  <svg
...
const MaterialNightsStay = props => <Icon as={MaterialNightsStaySvg} {...props} />

MaterialNightsStay.defaultProps = { ...Icon.defaultProps }

MaterialNightsStay.propTypes = { ...Icon.propTypes }

export default MaterialNightsStay
