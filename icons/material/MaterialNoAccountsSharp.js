...
const MaterialNoAccountsSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoAccountsSharp = (styled.default || styled)(MaterialNoAccountsSharpSvg).attrs(p => ({
...
`;
MaterialNoAccountsSharp.propTypes = {
