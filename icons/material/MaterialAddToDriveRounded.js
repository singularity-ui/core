...
const MaterialAddToDriveRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddToDriveRounded = (styled.default || styled)(MaterialAddToDriveRoundedSvg).attrs(p => ({
...
`;
MaterialAddToDriveRounded.propTypes = {
