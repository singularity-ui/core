...
const MaterialCarRentalSvg = props => (
  <svg
...
const MaterialCarRental = props => <Icon as={MaterialCarRentalSvg} {...props} />

MaterialCarRental.defaultProps = { ...Icon.defaultProps }

MaterialCarRental.propTypes = { ...Icon.propTypes }
