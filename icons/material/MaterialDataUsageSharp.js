...
const MaterialDataUsageSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDataUsageSharp = (styled.default || styled)(MaterialDataUsageSharpSvg).attrs(p => ({
...
`;
MaterialDataUsageSharp.propTypes = {
