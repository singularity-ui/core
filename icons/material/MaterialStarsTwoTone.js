...
const MaterialStarsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStarsTwoTone = (styled.default || styled)(MaterialStarsTwoToneSvg).attrs(p => ({
...
`;
MaterialStarsTwoTone.propTypes = {
