...
const MaterialSixKPlusTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixKPlusTwoTone = (styled.default || styled)(MaterialSixKPlusTwoToneSvg).attrs(p => ({
...
`;
MaterialSixKPlusTwoTone.propTypes = {
