...
const MaterialDoNotTouchSvg = props => (
  <svg
...
const MaterialDoNotTouch = props => <Icon as={MaterialDoNotTouchSvg} {...props} />

MaterialDoNotTouch.defaultProps = { ...Icon.defaultProps }

MaterialDoNotTouch.propTypes = { ...Icon.propTypes }
