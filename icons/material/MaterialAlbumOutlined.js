...
const MaterialAlbumOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlbumOutlined = (styled.default || styled)(MaterialAlbumOutlinedSvg).attrs(p => ({
...
`;
MaterialAlbumOutlined.propTypes = {
