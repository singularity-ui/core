...
const MaterialAddModeratorRoundedSvg = props => (
  <svg
...
const MaterialAddModeratorRounded = props => <Icon as={MaterialAddModeratorRoundedSvg} {...props} />

MaterialAddModeratorRounded.defaultProps = { ...Icon.defaultProps }

MaterialAddModeratorRounded.propTypes = { ...Icon.propTypes }
