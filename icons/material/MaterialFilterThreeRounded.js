...
const MaterialFilterThreeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFilterThreeRounded = (styled.default || styled)(MaterialFilterThreeRoundedSvg).attrs(p => ({
...
`;
MaterialFilterThreeRounded.propTypes = {
