...
const MaterialSetMealSharpSvg = props => (
  <svg
...
const MaterialSetMealSharp = props => <Icon as={MaterialSetMealSharpSvg} {...props} />

MaterialSetMealSharp.defaultProps = { ...Icon.defaultProps }

MaterialSetMealSharp.propTypes = { ...Icon.propTypes }

export default MaterialSetMealSharp
