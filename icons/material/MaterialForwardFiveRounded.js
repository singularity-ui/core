...
const MaterialForwardFiveRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardFiveRounded = (styled.default || styled)(MaterialForwardFiveRoundedSvg).attrs(p => ({
...
`;
MaterialForwardFiveRounded.propTypes = {
