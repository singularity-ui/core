...
const MaterialHandymanRoundedSvg = props => (
  <svg
...
const MaterialHandymanRounded = props => <Icon as={MaterialHandymanRoundedSvg} {...props} />

MaterialHandymanRounded.defaultProps = { ...Icon.defaultProps }

MaterialHandymanRounded.propTypes = { ...Icon.propTypes }
