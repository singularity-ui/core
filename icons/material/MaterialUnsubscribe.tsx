...
const MaterialUnsubscribeSvg = props => (
...
const MaterialUnsubscribe = props => <Icon as={MaterialUnsubscribeSvg} {...props} />

MaterialUnsubscribe.defaultProps = { ...Icon.defaultProps }

MaterialUnsubscribe.propTypes = { ...Icon.propTypes }
