...
const MaterialCreditCardOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCreditCardOff = (styled.default || styled)(MaterialCreditCardOffSvg).attrs(p => ({
...
`;
MaterialCreditCardOff.propTypes = {
