...
const MaterialAutoFixHighOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAutoFixHighOutlined = (styled.default || styled)(MaterialAutoFixHighOutlinedSvg).attrs(p => ({
...
`;
MaterialAutoFixHighOutlined.propTypes = {
