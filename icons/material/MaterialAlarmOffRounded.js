...
const MaterialAlarmOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOffRounded = (styled.default || styled)(MaterialAlarmOffRoundedSvg).attrs(p => ({
...
`;
MaterialAlarmOffRounded.propTypes = {
