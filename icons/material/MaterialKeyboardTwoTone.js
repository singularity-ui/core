...
const MaterialKeyboardTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKeyboardTwoTone = (styled.default || styled)(MaterialKeyboardTwoToneSvg).attrs(p => ({
...
`;
MaterialKeyboardTwoTone.propTypes = {
