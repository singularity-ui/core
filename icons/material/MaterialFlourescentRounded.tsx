...
const MaterialFlourescentRoundedSvg = props => (
  <svg
...
const MaterialFlourescentRounded = props => <Icon as={MaterialFlourescentRoundedSvg} {...props} />

MaterialFlourescentRounded.defaultProps = { ...Icon.defaultProps }

MaterialFlourescentRounded.propTypes = { ...Icon.propTypes }
