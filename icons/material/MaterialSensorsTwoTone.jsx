...
const MaterialSensorsTwoToneSvg = props => (
  <svg
...
const MaterialSensorsTwoTone = props => <Icon as={MaterialSensorsTwoToneSvg} {...props} />

MaterialSensorsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSensorsTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSensorsTwoTone
