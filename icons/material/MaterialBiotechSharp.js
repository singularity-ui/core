...
const MaterialBiotechSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBiotechSharp = (styled.default || styled)(MaterialBiotechSharpSvg).attrs(p => ({
...
`;
MaterialBiotechSharp.propTypes = {
