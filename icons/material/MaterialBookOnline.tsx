...
const MaterialBookOnlineSvg = props => (
  <svg
...
const MaterialBookOnline = props => <Icon as={MaterialBookOnlineSvg} {...props} />

MaterialBookOnline.defaultProps = { ...Icon.defaultProps }

MaterialBookOnline.propTypes = { ...Icon.propTypes }

export default MaterialBookOnline
