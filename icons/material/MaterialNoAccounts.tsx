...
const MaterialNoAccountsSvg = props => (
  <svg
...
const MaterialNoAccounts = props => <Icon as={MaterialNoAccountsSvg} {...props} />

MaterialNoAccounts.defaultProps = { ...Icon.defaultProps }

MaterialNoAccounts.propTypes = { ...Icon.propTypes }

export default MaterialNoAccounts
