...
const MaterialNoTransferTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoTransferTwoTone = (styled.default || styled)(MaterialNoTransferTwoToneSvg).attrs(p => ({
...
`;
MaterialNoTransferTwoTone.propTypes = {
