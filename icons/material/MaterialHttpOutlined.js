...
const MaterialHttpOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHttpOutlined = (styled.default || styled)(MaterialHttpOutlinedSvg).attrs(p => ({
...
`;
MaterialHttpOutlined.propTypes = {
