...
const MaterialThirtyFpsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThirtyFpsTwoTone = (styled.default || styled)(MaterialThirtyFpsTwoToneSvg).attrs(p => ({
...
`;
MaterialThirtyFpsTwoTone.propTypes = {
