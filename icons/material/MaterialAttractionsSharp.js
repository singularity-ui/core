...
const MaterialAttractionsSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttractionsSharp = (styled.default || styled)(MaterialAttractionsSharpSvg).attrs(p => ({
...
`;
MaterialAttractionsSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialAttractionsSharp;