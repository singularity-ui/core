...
const MaterialBuildCircleRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBuildCircleRounded = (styled.default || styled)(MaterialBuildCircleRoundedSvg).attrs(p => ({
...
`;
MaterialBuildCircleRounded.propTypes = {
