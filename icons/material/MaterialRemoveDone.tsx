...
const MaterialRemoveDoneSvg = props => (
...
const MaterialRemoveDone = props => <Icon as={MaterialRemoveDoneSvg} {...props} />

MaterialRemoveDone.defaultProps = { ...Icon.defaultProps }

MaterialRemoveDone.propTypes = { ...Icon.propTypes }
