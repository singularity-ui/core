...
const MaterialFeedRoundedSvg = props => (
  <svg
...
const MaterialFeedRounded = props => <Icon as={MaterialFeedRoundedSvg} {...props} />

MaterialFeedRounded.defaultProps = { ...Icon.defaultProps }

MaterialFeedRounded.propTypes = { ...Icon.propTypes }

export default MaterialFeedRounded
