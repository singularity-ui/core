...
const MaterialMoneyRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMoneyRounded = (styled.default || styled)(MaterialMoneyRoundedSvg).attrs(p => ({
...
`;
MaterialMoneyRounded.propTypes = {
