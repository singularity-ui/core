...
const MaterialReplayTenSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayTenSharp = (styled.default || styled)(MaterialReplayTenSharpSvg).attrs(p => ({
...
`;
MaterialReplayTenSharp.propTypes = {
