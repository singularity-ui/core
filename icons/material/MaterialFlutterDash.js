...
const MaterialFlutterDashSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlutterDash = (styled.default || styled)(MaterialFlutterDashSvg).attrs(p => ({
...
`;
MaterialFlutterDash.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFlutterDash;