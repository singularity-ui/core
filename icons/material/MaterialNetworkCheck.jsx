...
const MaterialNetworkCheckSvg = props => (
...
const MaterialNetworkCheck = props => <Icon as={MaterialNetworkCheckSvg} {...props} />

MaterialNetworkCheck.defaultProps = { ...Icon.defaultProps }

MaterialNetworkCheck.propTypes = { ...Icon.propTypes }

export default MaterialNetworkCheck
