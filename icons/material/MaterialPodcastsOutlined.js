...
const MaterialPodcastsOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPodcastsOutlined = (styled.default || styled)(MaterialPodcastsOutlinedSvg).attrs(p => ({
...
`;
MaterialPodcastsOutlined.propTypes = {
