...
const MaterialNetworkCheckRoundedSvg = props => (
...
const MaterialNetworkCheckRounded = props => <Icon as={MaterialNetworkCheckRoundedSvg} {...props} />

MaterialNetworkCheckRounded.defaultProps = { ...Icon.defaultProps }

MaterialNetworkCheckRounded.propTypes = { ...Icon.propTypes }

export default MaterialNetworkCheckRounded
