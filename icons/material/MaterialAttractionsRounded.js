...
const MaterialAttractionsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttractionsRounded = (styled.default || styled)(MaterialAttractionsRoundedSvg).attrs(p => ({
...
`;
MaterialAttractionsRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialAttractionsRounded;