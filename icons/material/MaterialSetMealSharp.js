...
const MaterialSetMealSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSetMealSharp = (styled.default || styled)(MaterialSetMealSharpSvg).attrs(p => ({
...
`;
MaterialSetMealSharp.propTypes = {
