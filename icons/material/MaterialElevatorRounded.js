...
const MaterialElevatorRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElevatorRounded = (styled.default || styled)(MaterialElevatorRoundedSvg).attrs(p => ({
...
`;
MaterialElevatorRounded.propTypes = {
