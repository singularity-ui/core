...
const MaterialCheckroomSvg = props => (
  <svg
...
const MaterialCheckroom = props => <Icon as={MaterialCheckroomSvg} {...props} />

MaterialCheckroom.defaultProps = { ...Icon.defaultProps }

MaterialCheckroom.propTypes = { ...Icon.propTypes }

export default MaterialCheckroom
