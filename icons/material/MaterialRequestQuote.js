...
const MaterialRequestQuoteSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRequestQuote = (styled.default || styled)(MaterialRequestQuoteSvg).attrs(p => ({
...
`;
MaterialRequestQuote.propTypes = {
