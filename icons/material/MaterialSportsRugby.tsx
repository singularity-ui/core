...
const MaterialSportsRugbySvg = props => (
  <svg
...
const MaterialSportsRugby = props => <Icon as={MaterialSportsRugbySvg} {...props} />

MaterialSportsRugby.defaultProps = { ...Icon.defaultProps }

MaterialSportsRugby.propTypes = { ...Icon.propTypes }

export default MaterialSportsRugby
