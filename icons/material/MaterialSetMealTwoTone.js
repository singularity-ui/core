...
const MaterialSetMealTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSetMealTwoTone = (styled.default || styled)(MaterialSetMealTwoToneSvg).attrs(p => ({
...
`;
MaterialSetMealTwoTone.propTypes = {
