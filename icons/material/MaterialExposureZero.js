...
const MaterialExposureZeroSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialExposureZero = (styled.default || styled)(MaterialExposureZeroSvg).attrs(p => ({
...
`;
MaterialExposureZero.propTypes = {
