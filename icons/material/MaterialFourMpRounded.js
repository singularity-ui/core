...
const MaterialFourMpRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFourMpRounded = (styled.default || styled)(MaterialFourMpRoundedSvg).attrs(p => ({
...
`;
MaterialFourMpRounded.propTypes = {
