...
const MaterialAlarmOnRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOnRounded = (styled.default || styled)(MaterialAlarmOnRoundedSvg).attrs(p => ({
...
`;
MaterialAlarmOnRounded.propTypes = {
