...
const MaterialSendToMobileTwoToneSvg = props => (
  <svg
...
const MaterialSendToMobileTwoTone = props => <Icon as={MaterialSendToMobileTwoToneSvg} {...props} />

MaterialSendToMobileTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSendToMobileTwoTone.propTypes = { ...Icon.propTypes }
