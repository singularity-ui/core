...
const MaterialSmartButtonSvg = props => (
  <svg
...
const MaterialSmartButton = props => <Icon as={MaterialSmartButtonSvg} {...props} />

MaterialSmartButton.defaultProps = { ...Icon.defaultProps }

MaterialSmartButton.propTypes = { ...Icon.propTypes }

export default MaterialSmartButton
