...
const MaterialSixKRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialSixKRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSixKRounded;