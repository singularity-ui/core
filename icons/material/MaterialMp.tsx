...
const MaterialMp = props => <Icon as={MaterialMpSvg} {...props} />

MaterialMp.defaultProps = { ...Icon.defaultProps }

MaterialMp.propTypes = { ...Icon.propTypes }

export default MaterialMp
