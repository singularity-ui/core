...
const MaterialParaglidingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialParaglidingTwoTone = (styled.default || styled)(MaterialParaglidingTwoToneSvg).attrs(p => ({
...
`;
MaterialParaglidingTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialParaglidingTwoTone;