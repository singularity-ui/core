...
const MaterialWorkOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWorkOffTwoTone = (styled.default || styled)(MaterialWorkOffTwoToneSvg).attrs(p => ({
...
`;
MaterialWorkOffTwoTone.propTypes = {
