...
const MaterialSoapOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSoapOutlined = (styled.default || styled)(MaterialSoapOutlinedSvg).attrs(p => ({
...
`;
MaterialSoapOutlined.propTypes = {
