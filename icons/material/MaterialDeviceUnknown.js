...
const MaterialDeviceUnknownSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDeviceUnknown = (styled.default || styled)(MaterialDeviceUnknownSvg).attrs(p => ({
...
`;
MaterialDeviceUnknown.propTypes = {
