...
const MaterialSupportAgentRoundedSvg = props => (
  <svg
...
const MaterialSupportAgentRounded = props => <Icon as={MaterialSupportAgentRoundedSvg} {...props} />

MaterialSupportAgentRounded.defaultProps = { ...Icon.defaultProps }

MaterialSupportAgentRounded.propTypes = { ...Icon.propTypes }
