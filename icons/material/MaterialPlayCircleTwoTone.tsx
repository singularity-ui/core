...
const MaterialPlayCircleTwoToneSvg = props => (
  <svg
...
const MaterialPlayCircleTwoTone = props => <Icon as={MaterialPlayCircleTwoToneSvg} {...props} />

MaterialPlayCircleTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPlayCircleTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPlayCircleTwoTone
