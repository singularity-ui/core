...
const MaterialLiquorTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLiquorTwoTone = (styled.default || styled)(MaterialLiquorTwoToneSvg).attrs(p => ({
...
`;
MaterialLiquorTwoTone.propTypes = {
