...
const MaterialUnpublishedRoundedSvg = props => (
  <svg
...
const MaterialUnpublishedRounded = props => <Icon as={MaterialUnpublishedRoundedSvg} {...props} />

MaterialUnpublishedRounded.defaultProps = { ...Icon.defaultProps }

MaterialUnpublishedRounded.propTypes = { ...Icon.propTypes }

export default MaterialUnpublishedRounded
