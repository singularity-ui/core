...
const MaterialSportsGolfSvg = props => (
  <svg
...
const MaterialSportsGolf = props => <Icon as={MaterialSportsGolfSvg} {...props} />

MaterialSportsGolf.defaultProps = { ...Icon.defaultProps }

MaterialSportsGolf.propTypes = { ...Icon.propTypes }
