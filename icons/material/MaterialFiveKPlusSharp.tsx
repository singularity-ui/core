...
const MaterialFiveKPlusSharpSvg = props => (
  <svg
...
const MaterialFiveKPlusSharp = props => <Icon as={MaterialFiveKPlusSharpSvg} {...props} />

MaterialFiveKPlusSharp.defaultProps = { ...Icon.defaultProps }

MaterialFiveKPlusSharp.propTypes = { ...Icon.propTypes }
