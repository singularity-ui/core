...
const MaterialIronRoundedSvg = props => (
  <svg
...
const MaterialIronRounded = props => <Icon as={MaterialIronRoundedSvg} {...props} />

MaterialIronRounded.defaultProps = { ...Icon.defaultProps }

MaterialIronRounded.propTypes = { ...Icon.propTypes }
