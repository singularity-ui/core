...
const MaterialAlarmAddSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmAddSharp = (styled.default || styled)(MaterialAlarmAddSharpSvg).attrs(p => ({
...
`;
MaterialAlarmAddSharp.propTypes = {
