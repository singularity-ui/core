...
const MaterialTvOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTvOffRounded = (styled.default || styled)(MaterialTvOffRoundedSvg).attrs(p => ({
...
`;
MaterialTvOffRounded.propTypes = {
