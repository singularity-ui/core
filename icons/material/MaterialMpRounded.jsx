...
const MaterialMpRoundedSvg = props => (
  <svg
...
const MaterialMpRounded = props => <Icon as={MaterialMpRoundedSvg} {...props} />

MaterialMpRounded.defaultProps = { ...Icon.defaultProps }

MaterialMpRounded.propTypes = { ...Icon.propTypes }
