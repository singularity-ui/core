...
const MaterialAlarmRoundedSvg = props => (
...
const MaterialAlarmRounded = props => <Icon as={MaterialAlarmRoundedSvg} {...props} />

MaterialAlarmRounded.defaultProps = { ...Icon.defaultProps }

MaterialAlarmRounded.propTypes = { ...Icon.propTypes }

export default MaterialAlarmRounded
