...
const MaterialChaletTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChaletTwoTone = (styled.default || styled)(MaterialChaletTwoToneSvg).attrs(p => ({
...
`;
MaterialChaletTwoTone.propTypes = {
