...
const MaterialShowerOutlinedSvg = props => (
  <svg
...
const MaterialShowerOutlined = props => <Icon as={MaterialShowerOutlinedSvg} {...props} />

MaterialShowerOutlined.defaultProps = { ...Icon.defaultProps }

MaterialShowerOutlined.propTypes = { ...Icon.propTypes }
