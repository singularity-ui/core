...
const MaterialQrCodeTwoRoundedSvg = props => (
  <svg
...
const MaterialQrCodeTwoRounded = props => <Icon as={MaterialQrCodeTwoRoundedSvg} {...props} />

MaterialQrCodeTwoRounded.defaultProps = { ...Icon.defaultProps }

MaterialQrCodeTwoRounded.propTypes = { ...Icon.propTypes }
