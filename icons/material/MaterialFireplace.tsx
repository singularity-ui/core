...
const MaterialFireplaceSvg = props => (
  <svg
...
const MaterialFireplace = props => <Icon as={MaterialFireplaceSvg} {...props} />

MaterialFireplace.defaultProps = { ...Icon.defaultProps }

MaterialFireplace.propTypes = { ...Icon.propTypes }
