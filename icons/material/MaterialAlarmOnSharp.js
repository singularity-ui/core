...
const MaterialAlarmOnSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOnSharp = (styled.default || styled)(MaterialAlarmOnSharpSvg).attrs(p => ({
...
`;
MaterialAlarmOnSharp.propTypes = {
