...
const MaterialMediaBluetoothOnSvg = props => (
  <svg
...
const MaterialMediaBluetoothOn = props => <Icon as={MaterialMediaBluetoothOnSvg} {...props} />

MaterialMediaBluetoothOn.defaultProps = { ...Icon.defaultProps }

MaterialMediaBluetoothOn.propTypes = { ...Icon.propTypes }
