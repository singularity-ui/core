...
const MaterialLiquorRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLiquorRounded = (styled.default || styled)(MaterialLiquorRoundedSvg).attrs(p => ({
...
`;
MaterialLiquorRounded.propTypes = {
