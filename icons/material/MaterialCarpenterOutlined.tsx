...
const MaterialCarpenterOutlinedSvg = props => (
  <svg
...
const MaterialCarpenterOutlined = props => <Icon as={MaterialCarpenterOutlinedSvg} {...props} />

MaterialCarpenterOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCarpenterOutlined.propTypes = { ...Icon.propTypes }

export default MaterialCarpenterOutlined
