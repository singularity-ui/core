...
const MaterialCreditScoreRoundedSvg = props => (
  <svg
...
const MaterialCreditScoreRounded = props => <Icon as={MaterialCreditScoreRoundedSvg} {...props} />

MaterialCreditScoreRounded.defaultProps = { ...Icon.defaultProps }

MaterialCreditScoreRounded.propTypes = { ...Icon.propTypes }
