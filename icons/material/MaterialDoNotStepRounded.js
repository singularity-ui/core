...
const MaterialDoNotStepRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoNotStepRounded = (styled.default || styled)(MaterialDoNotStepRoundedSvg).attrs(p => ({
...
`;
MaterialDoNotStepRounded.propTypes = {
