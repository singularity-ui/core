...
const MaterialWorkOffSvg = props => (
...
const MaterialWorkOff = props => <Icon as={MaterialWorkOffSvg} {...props} />

MaterialWorkOff.defaultProps = { ...Icon.defaultProps }

MaterialWorkOff.propTypes = { ...Icon.propTypes }

export default MaterialWorkOff
