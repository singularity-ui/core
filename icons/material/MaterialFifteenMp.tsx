...
const MaterialFifteenMpSvg = props => (
...
const MaterialFifteenMp = props => <Icon as={MaterialFifteenMpSvg} {...props} />

MaterialFifteenMp.defaultProps = { ...Icon.defaultProps }

MaterialFifteenMp.propTypes = { ...Icon.propTypes }

export default MaterialFifteenMp
