...
const MaterialAutoGraphTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAutoGraphTwoTone = (styled.default || styled)(MaterialAutoGraphTwoToneSvg).attrs(p => ({
...
`;
MaterialAutoGraphTwoTone.propTypes = {
