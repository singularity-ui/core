...
const MaterialStrollerOutlinedSvg = props => (
  <svg
...
const MaterialStrollerOutlined = props => <Icon as={MaterialStrollerOutlinedSvg} {...props} />

MaterialStrollerOutlined.defaultProps = { ...Icon.defaultProps }

MaterialStrollerOutlined.propTypes = { ...Icon.propTypes }
