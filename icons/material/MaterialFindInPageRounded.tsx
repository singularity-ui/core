...
const MaterialFindInPageRoundedSvg = props => (
...
const MaterialFindInPageRounded = props => <Icon as={MaterialFindInPageRoundedSvg} {...props} />

MaterialFindInPageRounded.defaultProps = { ...Icon.defaultProps }

MaterialFindInPageRounded.propTypes = { ...Icon.propTypes }

export default MaterialFindInPageRounded
