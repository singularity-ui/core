...
const MaterialPermPhoneMsgSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPermPhoneMsg = (styled.default || styled)(MaterialPermPhoneMsgSvg).attrs(p => ({
...
`;
MaterialPermPhoneMsg.propTypes = {
