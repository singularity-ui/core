...
const MaterialStormSharpSvg = props => (
  <svg
...
const MaterialStormSharp = props => <Icon as={MaterialStormSharpSvg} {...props} />

MaterialStormSharp.defaultProps = { ...Icon.defaultProps }

MaterialStormSharp.propTypes = { ...Icon.propTypes }
