...
const MaterialScoreTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialScoreTwoTone = (styled.default || styled)(MaterialScoreTwoToneSvg).attrs(p => ({
...
`;
MaterialScoreTwoTone.propTypes = {
