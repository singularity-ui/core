...
const MaterialMotionPhotosOffSvg = props => (
...
const MaterialMotionPhotosOff = props => <Icon as={MaterialMotionPhotosOffSvg} {...props} />

MaterialMotionPhotosOff.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosOff.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosOff
