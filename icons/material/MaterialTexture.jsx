...
const MaterialTextureSvg = props => (
...
const MaterialTexture = props => <Icon as={MaterialTextureSvg} {...props} />

MaterialTexture.defaultProps = { ...Icon.defaultProps }

MaterialTexture.propTypes = { ...Icon.propTypes }
