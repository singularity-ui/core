...
const MaterialRecentActorsSvg = props => (
...
const MaterialRecentActors = props => <Icon as={MaterialRecentActorsSvg} {...props} />

MaterialRecentActors.defaultProps = { ...Icon.defaultProps }

MaterialRecentActors.propTypes = { ...Icon.propTypes }

export default MaterialRecentActors
