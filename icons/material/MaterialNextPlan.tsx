...
const MaterialNextPlanSvg = props => (
  <svg
...
const MaterialNextPlan = props => <Icon as={MaterialNextPlanSvg} {...props} />

MaterialNextPlan.defaultProps = { ...Icon.defaultProps }

MaterialNextPlan.propTypes = { ...Icon.propTypes }

export default MaterialNextPlan
