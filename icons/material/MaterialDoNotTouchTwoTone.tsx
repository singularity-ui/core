...
const MaterialDoNotTouchTwoToneSvg = props => (
  <svg
...
const MaterialDoNotTouchTwoTone = props => <Icon as={MaterialDoNotTouchTwoToneSvg} {...props} />

MaterialDoNotTouchTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDoNotTouchTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialDoNotTouchTwoTone
