...
const MaterialPodcastsOutlinedSvg = props => (
  <svg
...
const MaterialPodcastsOutlined = props => <Icon as={MaterialPodcastsOutlinedSvg} {...props} />

MaterialPodcastsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPodcastsOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPodcastsOutlined
