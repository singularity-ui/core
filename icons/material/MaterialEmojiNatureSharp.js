...
const MaterialEmojiNatureSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEmojiNatureSharp = (styled.default || styled)(MaterialEmojiNatureSharpSvg).attrs(p => ({
...
`;
MaterialEmojiNatureSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialEmojiNatureSharp;