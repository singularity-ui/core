...
const MaterialHdrOffSelectSvg = props => (
  <svg
...
const MaterialHdrOffSelect = props => <Icon as={MaterialHdrOffSelectSvg} {...props} />

MaterialHdrOffSelect.defaultProps = { ...Icon.defaultProps }

MaterialHdrOffSelect.propTypes = { ...Icon.propTypes }

export default MaterialHdrOffSelect
