...
const MaterialPartyModeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPartyModeRounded = (styled.default || styled)(MaterialPartyModeRoundedSvg).attrs(p => ({
...
`;
MaterialPartyModeRounded.propTypes = {
