...
const MaterialSportsRugbyRoundedSvg = props => (
  <svg
...
const MaterialSportsRugbyRounded = props => <Icon as={MaterialSportsRugbyRoundedSvg} {...props} />

MaterialSportsRugbyRounded.defaultProps = { ...Icon.defaultProps }

MaterialSportsRugbyRounded.propTypes = { ...Icon.propTypes }
