...
const MaterialLocalDiningRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalDiningRounded = (styled.default || styled)(MaterialLocalDiningRoundedSvg).attrs(p => ({
...
`;
MaterialLocalDiningRounded.propTypes = {
