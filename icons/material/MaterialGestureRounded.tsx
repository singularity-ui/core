...
const MaterialGestureRoundedSvg = props => (
...
const MaterialGestureRounded = props => <Icon as={MaterialGestureRoundedSvg} {...props} />

MaterialGestureRounded.defaultProps = { ...Icon.defaultProps }

MaterialGestureRounded.propTypes = { ...Icon.propTypes }

export default MaterialGestureRounded
