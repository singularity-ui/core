...
const MaterialArchiveRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialArchiveRounded = (styled.default || styled)(MaterialArchiveRoundedSvg).attrs(p => ({
...
`;
MaterialArchiveRounded.propTypes = {
