...
const MaterialTaskRoundedSvg = props => (
  <svg
...
const MaterialTaskRounded = props => <Icon as={MaterialTaskRoundedSvg} {...props} />

MaterialTaskRounded.defaultProps = { ...Icon.defaultProps }

MaterialTaskRounded.propTypes = { ...Icon.propTypes }

export default MaterialTaskRounded
