...
const MaterialMotionPhotosAutoSvg = props => (
  <svg
...
const MaterialMotionPhotosAuto = props => <Icon as={MaterialMotionPhotosAutoSvg} {...props} />

MaterialMotionPhotosAuto.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosAuto.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosAuto
