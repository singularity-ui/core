...
const MaterialUsbOff = props => <Icon as={MaterialUsbOffSvg} {...props} />

MaterialUsbOff.defaultProps = { ...Icon.defaultProps }

MaterialUsbOff.propTypes = { ...Icon.propTypes }

export default MaterialUsbOff
