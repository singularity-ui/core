...
const MaterialUploadFile = props => <Icon as={MaterialUploadFileSvg} {...props} />

MaterialUploadFile.defaultProps = { ...Icon.defaultProps }

MaterialUploadFile.propTypes = { ...Icon.propTypes }
