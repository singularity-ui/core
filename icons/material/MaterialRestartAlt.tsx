...
const MaterialRestartAltSvg = props => (
  <svg
...
const MaterialRestartAlt = props => <Icon as={MaterialRestartAltSvg} {...props} />

MaterialRestartAlt.defaultProps = { ...Icon.defaultProps }

MaterialRestartAlt.propTypes = { ...Icon.propTypes }

export default MaterialRestartAlt
