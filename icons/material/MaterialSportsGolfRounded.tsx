...
const MaterialSportsGolfRoundedSvg = props => (
  <svg
...
const MaterialSportsGolfRounded = props => <Icon as={MaterialSportsGolfRoundedSvg} {...props} />

MaterialSportsGolfRounded.defaultProps = { ...Icon.defaultProps }

MaterialSportsGolfRounded.propTypes = { ...Icon.propTypes }
