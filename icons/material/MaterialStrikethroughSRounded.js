...
const MaterialStrikethroughSRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStrikethroughSRounded = (styled.default || styled)(MaterialStrikethroughSRoundedSvg).attrs(p => ({
...
`;
MaterialStrikethroughSRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialStrikethroughSRounded;