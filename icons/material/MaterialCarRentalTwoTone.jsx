...
const MaterialCarRentalTwoToneSvg = props => (
  <svg
...
const MaterialCarRentalTwoTone = props => <Icon as={MaterialCarRentalTwoToneSvg} {...props} />

MaterialCarRentalTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCarRentalTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialCarRentalTwoTone
