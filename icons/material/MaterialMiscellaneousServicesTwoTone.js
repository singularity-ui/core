...
const MaterialMiscellaneousServicesTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMiscellaneousServicesTwoTone = (styled.default || styled)(MaterialMiscellaneousServicesTwoToneSvg).attrs(p => ({
...
`;
MaterialMiscellaneousServicesTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialMiscellaneousServicesTwoTone;