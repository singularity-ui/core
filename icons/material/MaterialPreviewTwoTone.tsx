...
const MaterialPreviewTwoToneSvg = props => (
  <svg
...
const MaterialPreviewTwoTone = props => <Icon as={MaterialPreviewTwoToneSvg} {...props} />

MaterialPreviewTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPreviewTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPreviewTwoTone
