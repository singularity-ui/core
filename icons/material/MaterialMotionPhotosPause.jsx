...
const MaterialMotionPhotosPauseSvg = props => (
  <svg
...
const MaterialMotionPhotosPause = props => <Icon as={MaterialMotionPhotosPauseSvg} {...props} />

MaterialMotionPhotosPause.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosPause.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosPause
