...
const MaterialRestartAltRoundedSvg = props => (
  <svg
...
const MaterialRestartAltRounded = props => <Icon as={MaterialRestartAltRoundedSvg} {...props} />

MaterialRestartAltRounded.defaultProps = { ...Icon.defaultProps }

MaterialRestartAltRounded.propTypes = { ...Icon.propTypes }
