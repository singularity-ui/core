...
const MaterialPointOfSaleSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPointOfSale = (styled.default || styled)(MaterialPointOfSaleSvg).attrs(p => ({
...
`;
MaterialPointOfSale.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialPointOfSale;