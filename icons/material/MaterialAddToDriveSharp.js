...
const MaterialAddToDriveSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddToDriveSharp = (styled.default || styled)(MaterialAddToDriveSharpSvg).attrs(p => ({
...
`;
MaterialAddToDriveSharp.propTypes = {
