...
const MaterialTimerOffSharpSvg = props => (
...
const MaterialTimerOffSharp = props => <Icon as={MaterialTimerOffSharpSvg} {...props} />

MaterialTimerOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialTimerOffSharp.propTypes = { ...Icon.propTypes }

export default MaterialTimerOffSharp
