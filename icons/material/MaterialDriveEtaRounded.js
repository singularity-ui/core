...
const MaterialDriveEtaRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDriveEtaRounded = (styled.default || styled)(MaterialDriveEtaRoundedSvg).attrs(p => ({
...
`;
MaterialDriveEtaRounded.propTypes = {
