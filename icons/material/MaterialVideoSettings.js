...
const MaterialVideoSettingsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVideoSettings = (styled.default || styled)(MaterialVideoSettingsSvg).attrs(p => ({
...
`;
MaterialVideoSettings.propTypes = {
