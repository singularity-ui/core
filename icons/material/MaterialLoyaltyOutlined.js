...
const MaterialLoyaltyOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLoyaltyOutlined = (styled.default || styled)(MaterialLoyaltyOutlinedSvg).attrs(p => ({
...
`;
MaterialLoyaltyOutlined.propTypes = {
