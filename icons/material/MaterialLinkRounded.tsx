...
const MaterialLinkRoundedSvg = props => (
  <svg
...
const MaterialLinkRounded = props => <Icon as={MaterialLinkRoundedSvg} {...props} />

MaterialLinkRounded.defaultProps = { ...Icon.defaultProps }

MaterialLinkRounded.propTypes = { ...Icon.propTypes }
