...
const MaterialThermostatAutoRoundedSvg = props => (
  <svg
...
const MaterialThermostatAutoRounded = props => <Icon as={MaterialThermostatAutoRoundedSvg} {...props} />

MaterialThermostatAutoRounded.defaultProps = { ...Icon.defaultProps }

MaterialThermostatAutoRounded.propTypes = { ...Icon.propTypes }

export default MaterialThermostatAutoRounded
