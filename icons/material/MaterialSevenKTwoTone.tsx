...
const MaterialSevenKTwoToneSvg = props => (
  <svg
...
const MaterialSevenKTwoTone = props => <Icon as={MaterialSevenKTwoToneSvg} {...props} />

MaterialSevenKTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSevenKTwoTone.propTypes = { ...Icon.propTypes }
