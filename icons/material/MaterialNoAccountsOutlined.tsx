...
const MaterialNoAccountsOutlinedSvg = props => (
  <svg
...
const MaterialNoAccountsOutlined = props => <Icon as={MaterialNoAccountsOutlinedSvg} {...props} />

MaterialNoAccountsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNoAccountsOutlined.propTypes = { ...Icon.propTypes }

export default MaterialNoAccountsOutlined
