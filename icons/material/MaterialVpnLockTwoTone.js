...
const MaterialVpnLockTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVpnLockTwoTone = (styled.default || styled)(MaterialVpnLockTwoToneSvg).attrs(p => ({
...
`;
MaterialVpnLockTwoTone.propTypes = {
