...
const MaterialHearingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHearingTwoTone = (styled.default || styled)(MaterialHearingTwoToneSvg).attrs(p => ({
...
`;
MaterialHearingTwoTone.propTypes = {
