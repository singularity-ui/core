...
const MaterialTwoMpSharpSvg = props => (
  <svg
...
const MaterialTwoMpSharp = props => <Icon as={MaterialTwoMpSharpSvg} {...props} />

MaterialTwoMpSharp.defaultProps = { ...Icon.defaultProps }

MaterialTwoMpSharp.propTypes = { ...Icon.propTypes }
