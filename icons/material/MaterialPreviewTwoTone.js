...
const MaterialPreviewTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPreviewTwoTone = (styled.default || styled)(MaterialPreviewTwoToneSvg).attrs(p => ({
...
`;
MaterialPreviewTwoTone.propTypes = {
