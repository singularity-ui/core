...
const MaterialLocalTaxiTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalTaxiTwoTone = (styled.default || styled)(MaterialLocalTaxiTwoToneSvg).attrs(p => ({
...
`;
MaterialLocalTaxiTwoTone.propTypes = {
