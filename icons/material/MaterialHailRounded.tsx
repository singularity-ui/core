...
const MaterialHailRoundedSvg = props => (
  <svg
...
const MaterialHailRounded = props => <Icon as={MaterialHailRoundedSvg} {...props} />

MaterialHailRounded.defaultProps = { ...Icon.defaultProps }

MaterialHailRounded.propTypes = { ...Icon.propTypes }
