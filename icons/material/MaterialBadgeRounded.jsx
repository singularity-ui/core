...
const MaterialBadgeRoundedSvg = props => (
  <svg
...
const MaterialBadgeRounded = props => <Icon as={MaterialBadgeRoundedSvg} {...props} />

MaterialBadgeRounded.defaultProps = { ...Icon.defaultProps }

MaterialBadgeRounded.propTypes = { ...Icon.propTypes }

export default MaterialBadgeRounded
