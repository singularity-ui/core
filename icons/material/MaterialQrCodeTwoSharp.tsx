...
const MaterialQrCodeTwoSharpSvg = props => (
  <svg
...
const MaterialQrCodeTwoSharp = props => <Icon as={MaterialQrCodeTwoSharpSvg} {...props} />

MaterialQrCodeTwoSharp.defaultProps = { ...Icon.defaultProps }

MaterialQrCodeTwoSharp.propTypes = { ...Icon.propTypes }
