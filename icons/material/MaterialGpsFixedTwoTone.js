...
const MaterialGpsFixedTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGpsFixedTwoTone = (styled.default || styled)(MaterialGpsFixedTwoToneSvg).attrs(p => ({
...
`;
MaterialGpsFixedTwoTone.propTypes = {
