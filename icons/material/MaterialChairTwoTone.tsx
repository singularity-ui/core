...
const MaterialChairTwoToneSvg = props => (
  <svg
...
const MaterialChairTwoTone = props => <Icon as={MaterialChairTwoToneSvg} {...props} />

MaterialChairTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialChairTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialChairTwoTone
