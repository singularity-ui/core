...
const MaterialAnimationRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAnimationRounded = (styled.default || styled)(MaterialAnimationRoundedSvg).attrs(p => ({
...
`;
MaterialAnimationRounded.propTypes = {
