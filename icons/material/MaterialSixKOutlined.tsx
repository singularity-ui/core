...
const MaterialSixKOutlinedSvg = props => (
  <svg
...
const MaterialSixKOutlined = props => <Icon as={MaterialSixKOutlinedSvg} {...props} />

MaterialSixKOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSixKOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSixKOutlined
