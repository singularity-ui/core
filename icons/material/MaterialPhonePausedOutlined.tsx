...
const MaterialPhonePausedOutlinedSvg = props => (
...
const MaterialPhonePausedOutlined = props => <Icon as={MaterialPhonePausedOutlinedSvg} {...props} />

MaterialPhonePausedOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPhonePausedOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPhonePausedOutlined
