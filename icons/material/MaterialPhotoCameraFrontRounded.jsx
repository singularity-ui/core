...
const MaterialPhotoCameraFrontRoundedSvg = props => (
  <svg
...
const MaterialPhotoCameraFrontRounded = props => <Icon as={MaterialPhotoCameraFrontRoundedSvg} {...props} />

MaterialPhotoCameraFrontRounded.defaultProps = { ...Icon.defaultProps }

MaterialPhotoCameraFrontRounded.propTypes = { ...Icon.propTypes }

export default MaterialPhotoCameraFrontRounded
