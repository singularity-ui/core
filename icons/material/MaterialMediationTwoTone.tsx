...
const MaterialMediationTwoToneSvg = props => (
  <svg
...
const MaterialMediationTwoTone = props => <Icon as={MaterialMediationTwoToneSvg} {...props} />

MaterialMediationTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMediationTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialMediationTwoTone
