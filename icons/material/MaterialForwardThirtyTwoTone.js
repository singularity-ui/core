...
const MaterialForwardThirtyTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardThirtyTwoTone = (styled.default || styled)(MaterialForwardThirtyTwoToneSvg).attrs(p => ({
...
`;
MaterialForwardThirtyTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialForwardThirtyTwoTone;