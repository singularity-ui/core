...
const MaterialRunCircleOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRunCircleOutlined = (styled.default || styled)(MaterialRunCircleOutlinedSvg).attrs(p => ({
...
`;
MaterialRunCircleOutlined.propTypes = {
