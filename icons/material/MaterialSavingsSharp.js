...
const MaterialSavingsSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSavingsSharp = (styled.default || styled)(MaterialSavingsSharpSvg).attrs(p => ({
...
`;
MaterialSavingsSharp.propTypes = {
