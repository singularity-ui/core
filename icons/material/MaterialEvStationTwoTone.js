...
const MaterialEvStationTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEvStationTwoTone = (styled.default || styled)(MaterialEvStationTwoToneSvg).attrs(p => ({
...
`;
MaterialEvStationTwoTone.propTypes = {
