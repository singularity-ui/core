...
const MaterialSevenKRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSevenKRounded = (styled.default || styled)(MaterialSevenKRoundedSvg).attrs(p => ({
...
`;
MaterialSevenKRounded.propTypes = {
