...
const MaterialHearingDisabledRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialHearingDisabledRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialHearingDisabledRounded;