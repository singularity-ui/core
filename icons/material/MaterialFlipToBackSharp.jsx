...
const MaterialFlipToBackSharpSvg = props => (
...
const MaterialFlipToBackSharp = props => <Icon as={MaterialFlipToBackSharpSvg} {...props} />

MaterialFlipToBackSharp.defaultProps = { ...Icon.defaultProps }

MaterialFlipToBackSharp.propTypes = { ...Icon.propTypes }
