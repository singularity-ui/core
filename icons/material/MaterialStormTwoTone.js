...
const MaterialStormTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
  ...
  d: "M12,8c-2.21,0-4,1.79-4,4s1.79,4,4,4s4-1.79,4-4S14.21,8,12,8z M12,14c-1.1,0-2-0.9-2-2s0.9-2,2-2s2,0.9,2,2 S13.1,14,12,14z"
}), /*#__PURE__*/React.createElement("path", {
...
const MaterialStormTwoTone = (styled.default || styled)(MaterialStormTwoToneSvg).attrs(p => ({
...
`;
MaterialStormTwoTone.propTypes = {
