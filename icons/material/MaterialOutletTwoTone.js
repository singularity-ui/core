...
const MaterialOutletTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOutletTwoTone = (styled.default || styled)(MaterialOutletTwoToneSvg).attrs(p => ({
...
`;
MaterialOutletTwoTone.propTypes = {
