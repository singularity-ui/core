...
const MaterialElderlySharpSvg = props => (
  <svg
...
const MaterialElderlySharp = props => <Icon as={MaterialElderlySharpSvg} {...props} />

MaterialElderlySharp.defaultProps = { ...Icon.defaultProps }

MaterialElderlySharp.propTypes = { ...Icon.propTypes }

export default MaterialElderlySharp
