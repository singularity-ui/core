...
const MaterialSettingsSuggestSvg = props => (
  <svg
...
const MaterialSettingsSuggest = props => <Icon as={MaterialSettingsSuggestSvg} {...props} />

MaterialSettingsSuggest.defaultProps = { ...Icon.defaultProps }

MaterialSettingsSuggest.propTypes = { ...Icon.propTypes }

export default MaterialSettingsSuggest
