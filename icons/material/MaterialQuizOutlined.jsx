...
const MaterialQuizOutlinedSvg = props => (
  <svg
...
const MaterialQuizOutlined = props => <Icon as={MaterialQuizOutlinedSvg} {...props} />

MaterialQuizOutlined.defaultProps = { ...Icon.defaultProps }

MaterialQuizOutlined.propTypes = { ...Icon.propTypes }

export default MaterialQuizOutlined
