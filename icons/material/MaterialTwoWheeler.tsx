...
const MaterialTwoWheelerSvg = props => (
  <svg
...
const MaterialTwoWheeler = props => <Icon as={MaterialTwoWheelerSvg} {...props} />

MaterialTwoWheeler.defaultProps = { ...Icon.defaultProps }

MaterialTwoWheeler.propTypes = { ...Icon.propTypes }

export default MaterialTwoWheeler
