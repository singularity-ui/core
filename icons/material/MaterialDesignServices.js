...
const MaterialDesignServicesSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDesignServices = (styled.default || styled)(MaterialDesignServicesSvg).attrs(p => ({
...
`;
MaterialDesignServices.propTypes = {
