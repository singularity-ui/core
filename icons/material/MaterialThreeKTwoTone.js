...
const MaterialThreeKTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThreeKTwoTone = (styled.default || styled)(MaterialThreeKTwoToneSvg).attrs(p => ({
...
`;
MaterialThreeKTwoTone.propTypes = {
