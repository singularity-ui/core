...
const MaterialHeightKSvg = props => (
...
const MaterialHeightK = props => <Icon as={MaterialHeightKSvg} {...props} />

MaterialHeightK.defaultProps = { ...Icon.defaultProps }

MaterialHeightK.propTypes = { ...Icon.propTypes }
