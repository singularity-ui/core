...
const MaterialSurroundSoundSvg = props => (
...
const MaterialSurroundSound = props => <Icon as={MaterialSurroundSoundSvg} {...props} />

MaterialSurroundSound.defaultProps = { ...Icon.defaultProps }

MaterialSurroundSound.propTypes = { ...Icon.propTypes }

export default MaterialSurroundSound
