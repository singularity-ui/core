...
const MaterialThumbDownAltSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThumbDownAlt = (styled.default || styled)(MaterialThumbDownAltSvg).attrs(p => ({
...
`;
MaterialThumbDownAlt.propTypes = {
