...
const MaterialHevcTwoToneSvg = props => (
  <svg
...
const MaterialHevcTwoTone = props => <Icon as={MaterialHevcTwoToneSvg} {...props} />

MaterialHevcTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHevcTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialHevcTwoTone
