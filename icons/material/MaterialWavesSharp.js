...
const MaterialWavesSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWavesSharp = (styled.default || styled)(MaterialWavesSharpSvg).attrs(p => ({
...
`;
MaterialWavesSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialWavesSharp;