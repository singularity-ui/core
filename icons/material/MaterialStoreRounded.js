...
const MaterialStoreRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStoreRounded = (styled.default || styled)(MaterialStoreRoundedSvg).attrs(p => ({
...
`;
MaterialStoreRounded.propTypes = {
