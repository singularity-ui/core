...
const MaterialSupportRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSupportRounded = (styled.default || styled)(MaterialSupportRoundedSvg).attrs(p => ({
...
`;
MaterialSupportRounded.propTypes = {
