...
const MaterialLocalPoliceRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalPoliceRounded = (styled.default || styled)(MaterialLocalPoliceRoundedSvg).attrs(p => ({
...
`;
MaterialLocalPoliceRounded.propTypes = {
