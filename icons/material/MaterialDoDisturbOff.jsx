...
const MaterialDoDisturbOffSvg = props => (
  <svg
...
const MaterialDoDisturbOff = props => <Icon as={MaterialDoDisturbOffSvg} {...props} />

MaterialDoDisturbOff.defaultProps = { ...Icon.defaultProps }

MaterialDoDisturbOff.propTypes = { ...Icon.propTypes }

export default MaterialDoDisturbOff
