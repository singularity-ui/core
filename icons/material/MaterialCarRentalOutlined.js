...
const MaterialCarRentalOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCarRentalOutlined = (styled.default || styled)(MaterialCarRentalOutlinedSvg).attrs(p => ({
...
`;
MaterialCarRentalOutlined.propTypes = {
