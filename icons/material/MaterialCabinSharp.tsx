...
const MaterialCabinSharpSvg = props => (
  <svg
...
const MaterialCabinSharp = props => <Icon as={MaterialCabinSharpSvg} {...props} />

MaterialCabinSharp.defaultProps = { ...Icon.defaultProps }

MaterialCabinSharp.propTypes = { ...Icon.propTypes }
