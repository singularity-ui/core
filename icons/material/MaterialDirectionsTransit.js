...
const MaterialDirectionsTransitSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDirectionsTransit = (styled.default || styled)(MaterialDirectionsTransitSvg).attrs(p => ({
...
`;
MaterialDirectionsTransit.propTypes = {
