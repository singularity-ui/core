...
const MaterialReduceCapacitySvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReduceCapacity = (styled.default || styled)(MaterialReduceCapacitySvg).attrs(p => ({
...
`;
MaterialReduceCapacity.propTypes = {
