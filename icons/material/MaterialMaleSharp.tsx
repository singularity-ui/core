...
const MaterialMaleSharpSvg = props => (
  <svg
...
const MaterialMaleSharp = props => <Icon as={MaterialMaleSharpSvg} {...props} />

MaterialMaleSharp.defaultProps = { ...Icon.defaultProps }

MaterialMaleSharp.propTypes = { ...Icon.propTypes }

export default MaterialMaleSharp
