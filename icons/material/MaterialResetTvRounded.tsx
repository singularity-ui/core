...
const MaterialResetTvRoundedSvg = props => (
  <svg
...
const MaterialResetTvRounded = props => <Icon as={MaterialResetTvRoundedSvg} {...props} />

MaterialResetTvRounded.defaultProps = { ...Icon.defaultProps }

MaterialResetTvRounded.propTypes = { ...Icon.propTypes }
