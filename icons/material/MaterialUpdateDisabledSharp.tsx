...
const MaterialUpdateDisabledSharpSvg = props => (
  <svg
...
const MaterialUpdateDisabledSharp = props => <Icon as={MaterialUpdateDisabledSharpSvg} {...props} />

MaterialUpdateDisabledSharp.defaultProps = { ...Icon.defaultProps }

MaterialUpdateDisabledSharp.propTypes = { ...Icon.propTypes }

export default MaterialUpdateDisabledSharp
