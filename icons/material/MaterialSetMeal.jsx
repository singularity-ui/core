...
const MaterialSetMealSvg = props => (
  <svg
...
const MaterialSetMeal = props => <Icon as={MaterialSetMealSvg} {...props} />

MaterialSetMeal.defaultProps = { ...Icon.defaultProps }

MaterialSetMeal.propTypes = { ...Icon.propTypes }
