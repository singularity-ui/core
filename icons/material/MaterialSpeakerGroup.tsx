...
const MaterialSpeakerGroupSvg = props => (
...
const MaterialSpeakerGroup = props => <Icon as={MaterialSpeakerGroupSvg} {...props} />

MaterialSpeakerGroup.defaultProps = { ...Icon.defaultProps }

MaterialSpeakerGroup.propTypes = { ...Icon.propTypes }

export default MaterialSpeakerGroup
