...
const MaterialBedtimeOutlinedSvg = props => (
  <svg
...
const MaterialBedtimeOutlined = props => <Icon as={MaterialBedtimeOutlinedSvg} {...props} />

MaterialBedtimeOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBedtimeOutlined.propTypes = { ...Icon.propTypes }
