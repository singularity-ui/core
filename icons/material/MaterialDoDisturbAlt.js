...
const MaterialDoDisturbAltSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoDisturbAlt = (styled.default || styled)(MaterialDoDisturbAltSvg).attrs(p => ({
...
`;
MaterialDoDisturbAlt.propTypes = {
