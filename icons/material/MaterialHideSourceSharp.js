...
const MaterialHideSourceSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHideSourceSharp = (styled.default || styled)(MaterialHideSourceSharpSvg).attrs(p => ({
...
`;
MaterialHideSourceSharp.propTypes = {
