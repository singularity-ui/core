...
const MaterialWifiCallingRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWifiCallingRounded = (styled.default || styled)(MaterialWifiCallingRoundedSvg).attrs(p => ({
...
`;
MaterialWifiCallingRounded.propTypes = {
