...
const MaterialLockClockRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLockClockRounded = (styled.default || styled)(MaterialLockClockRoundedSvg).attrs(p => ({
...
`;
MaterialLockClockRounded.propTypes = {
