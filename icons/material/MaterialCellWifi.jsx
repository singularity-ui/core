...
const MaterialCellWifiSvg = props => (
  <svg
...
const MaterialCellWifi = props => <Icon as={MaterialCellWifiSvg} {...props} />

MaterialCellWifi.defaultProps = { ...Icon.defaultProps }

MaterialCellWifi.propTypes = { ...Icon.propTypes }

export default MaterialCellWifi
