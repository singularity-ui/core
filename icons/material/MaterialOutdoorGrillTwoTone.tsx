...
const MaterialOutdoorGrillTwoToneSvg = props => (
  <svg
...
const MaterialOutdoorGrillTwoTone = props => <Icon as={MaterialOutdoorGrillTwoToneSvg} {...props} />

MaterialOutdoorGrillTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialOutdoorGrillTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialOutdoorGrillTwoTone
