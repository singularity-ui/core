...
const MaterialMonochromePhotosSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMonochromePhotos = (styled.default || styled)(MaterialMonochromePhotosSvg).attrs(p => ({
...
`;
MaterialMonochromePhotos.propTypes = {
