...
const MaterialLeakAddSvg = props => (
...
const MaterialLeakAdd = props => <Icon as={MaterialLeakAddSvg} {...props} />

MaterialLeakAdd.defaultProps = { ...Icon.defaultProps }

MaterialLeakAdd.propTypes = { ...Icon.propTypes }

export default MaterialLeakAdd
