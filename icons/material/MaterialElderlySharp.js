...
const MaterialElderlySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElderlySharp = (styled.default || styled)(MaterialElderlySharpSvg).attrs(p => ({
...
`;
MaterialElderlySharp.propTypes = {
