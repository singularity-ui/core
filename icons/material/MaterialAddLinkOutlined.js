...
const MaterialAddLinkOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddLinkOutlined = (styled.default || styled)(MaterialAddLinkOutlinedSvg).attrs(p => ({
...
`;
MaterialAddLinkOutlined.propTypes = {
