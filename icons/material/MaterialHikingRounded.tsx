...
const MaterialHikingRoundedSvg = props => (
  <svg
...
const MaterialHikingRounded = props => <Icon as={MaterialHikingRoundedSvg} {...props} />

MaterialHikingRounded.defaultProps = { ...Icon.defaultProps }

MaterialHikingRounded.propTypes = { ...Icon.propTypes }
