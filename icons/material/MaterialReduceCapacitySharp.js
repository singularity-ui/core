...
const MaterialReduceCapacitySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReduceCapacitySharp = (styled.default || styled)(MaterialReduceCapacitySharpSvg).attrs(p => ({
...
`;
MaterialReduceCapacitySharp.propTypes = {
