...
const MaterialCleanHandsSvg = props => (
  <svg
...
const MaterialCleanHands = props => <Icon as={MaterialCleanHandsSvg} {...props} />

MaterialCleanHands.defaultProps = { ...Icon.defaultProps }

MaterialCleanHands.propTypes = { ...Icon.propTypes }
