...
const MaterialColorizeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialColorizeRounded = (styled.default || styled)(MaterialColorizeRoundedSvg).attrs(p => ({
...
`;
MaterialColorizeRounded.propTypes = {
