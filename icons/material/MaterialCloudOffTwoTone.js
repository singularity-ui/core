...
const MaterialCloudOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCloudOffTwoTone = (styled.default || styled)(MaterialCloudOffTwoToneSvg).attrs(p => ({
...
`;
MaterialCloudOffTwoTone.propTypes = {
