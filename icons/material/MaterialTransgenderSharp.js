...
const MaterialTransgenderSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTransgenderSharp = (styled.default || styled)(MaterialTransgenderSharpSvg).attrs(p => ({
...
`;
MaterialTransgenderSharp.propTypes = {
