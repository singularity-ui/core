...
const MaterialExploreOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialExploreOffRounded = (styled.default || styled)(MaterialExploreOffRoundedSvg).attrs(p => ({
...
`;
MaterialExploreOffRounded.propTypes = {
