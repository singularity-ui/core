...
const MaterialAssessmentRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAssessmentRounded = (styled.default || styled)(MaterialAssessmentRoundedSvg).attrs(p => ({
...
`;
MaterialAssessmentRounded.propTypes = {
