...
const MaterialHouseboatRoundedSvg = props => (
  <svg
...
const MaterialHouseboatRounded = props => <Icon as={MaterialHouseboatRoundedSvg} {...props} />

MaterialHouseboatRounded.defaultProps = { ...Icon.defaultProps }

MaterialHouseboatRounded.propTypes = { ...Icon.propTypes }
