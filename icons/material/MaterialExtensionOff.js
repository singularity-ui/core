...
const MaterialExtensionOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialExtensionOff = (styled.default || styled)(MaterialExtensionOffSvg).attrs(p => ({
...
`;
MaterialExtensionOff.propTypes = {
