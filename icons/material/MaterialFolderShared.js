...
const MaterialFolderSharedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFolderShared = (styled.default || styled)(MaterialFolderSharedSvg).attrs(p => ({
...
`;
MaterialFolderShared.propTypes = {
