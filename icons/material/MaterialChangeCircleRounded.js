...
const MaterialChangeCircleRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChangeCircleRounded = (styled.default || styled)(MaterialChangeCircleRoundedSvg).attrs(p => ({
...
`;
MaterialChangeCircleRounded.propTypes = {
