...
const MaterialAddAlarmSvg = props => (
...
const MaterialAddAlarm = props => <Icon as={MaterialAddAlarmSvg} {...props} />

MaterialAddAlarm.defaultProps = { ...Icon.defaultProps }

MaterialAddAlarm.propTypes = { ...Icon.propTypes }

export default MaterialAddAlarm
