...
const MaterialGrassTwoToneSvg = props => (
  <svg
...
const MaterialGrassTwoTone = props => <Icon as={MaterialGrassTwoToneSvg} {...props} />

MaterialGrassTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialGrassTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialGrassTwoTone
