...
const MaterialTollRoundedSvg = props => (
...
const MaterialTollRounded = props => <Icon as={MaterialTollRoundedSvg} {...props} />

MaterialTollRounded.defaultProps = { ...Icon.defaultProps }

MaterialTollRounded.propTypes = { ...Icon.propTypes }

export default MaterialTollRounded
