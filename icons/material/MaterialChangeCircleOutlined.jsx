...
const MaterialChangeCircleOutlinedSvg = props => (
  <svg
...
const MaterialChangeCircleOutlined = props => <Icon as={MaterialChangeCircleOutlinedSvg} {...props} />

MaterialChangeCircleOutlined.defaultProps = { ...Icon.defaultProps }

MaterialChangeCircleOutlined.propTypes = { ...Icon.propTypes }

export default MaterialChangeCircleOutlined
