...
const MaterialRemoveDoneSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRemoveDoneSharp = (styled.default || styled)(MaterialRemoveDoneSharpSvg).attrs(p => ({
...
`;
MaterialRemoveDoneSharp.propTypes = {
