...
const MaterialPanoramaPhotosphereSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPanoramaPhotosphere = (styled.default || styled)(MaterialPanoramaPhotosphereSvg).attrs(p => ({
...
`;
MaterialPanoramaPhotosphere.propTypes = {
