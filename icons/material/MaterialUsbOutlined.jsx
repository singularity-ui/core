...
const MaterialUsbOutlinedSvg = props => (
...
const MaterialUsbOutlined = props => <Icon as={MaterialUsbOutlinedSvg} {...props} />

MaterialUsbOutlined.defaultProps = { ...Icon.defaultProps }

MaterialUsbOutlined.propTypes = { ...Icon.propTypes }
