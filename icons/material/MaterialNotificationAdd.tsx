...
const MaterialNotificationAddSvg = props => (
  <svg
...
const MaterialNotificationAdd = props => <Icon as={MaterialNotificationAddSvg} {...props} />

MaterialNotificationAdd.defaultProps = { ...Icon.defaultProps }

MaterialNotificationAdd.propTypes = { ...Icon.propTypes }

export default MaterialNotificationAdd
