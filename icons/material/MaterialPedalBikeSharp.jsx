...
const MaterialPedalBikeSharpSvg = props => (
  <svg
...
const MaterialPedalBikeSharp = props => <Icon as={MaterialPedalBikeSharpSvg} {...props} />

MaterialPedalBikeSharp.defaultProps = { ...Icon.defaultProps }

MaterialPedalBikeSharp.propTypes = { ...Icon.propTypes }

export default MaterialPedalBikeSharp
