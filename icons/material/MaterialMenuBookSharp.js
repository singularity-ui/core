...
const MaterialMenuBookSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMenuBookSharp = (styled.default || styled)(MaterialMenuBookSharpSvg).attrs(p => ({
...
`;
MaterialMenuBookSharp.propTypes = {
