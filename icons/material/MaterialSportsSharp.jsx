...
const MaterialSportsSharpSvg = props => (
  <svg
...
const MaterialSportsSharp = props => <Icon as={MaterialSportsSharpSvg} {...props} />

MaterialSportsSharp.defaultProps = { ...Icon.defaultProps }

MaterialSportsSharp.propTypes = { ...Icon.propTypes }

export default MaterialSportsSharp
