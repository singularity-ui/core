...
const MaterialLivingRoundedSvg = props => (
  <svg
...
const MaterialLivingRounded = props => <Icon as={MaterialLivingRoundedSvg} {...props} />

MaterialLivingRounded.defaultProps = { ...Icon.defaultProps }

MaterialLivingRounded.propTypes = { ...Icon.propTypes }

export default MaterialLivingRounded
