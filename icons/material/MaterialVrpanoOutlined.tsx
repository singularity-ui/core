...
const MaterialVrpanoOutlinedSvg = props => (
  <svg
...
const MaterialVrpanoOutlined = props => <Icon as={MaterialVrpanoOutlinedSvg} {...props} />

MaterialVrpanoOutlined.defaultProps = { ...Icon.defaultProps }

MaterialVrpanoOutlined.propTypes = { ...Icon.propTypes }
