...
const MaterialCleanHandsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCleanHandsTwoTone = (styled.default || styled)(MaterialCleanHandsTwoToneSvg).attrs(p => ({
...
`;
MaterialCleanHandsTwoTone.propTypes = {
