...
const MaterialHistoryEduOutlinedSvg = props => (
  <svg
...
const MaterialHistoryEduOutlined = props => <Icon as={MaterialHistoryEduOutlinedSvg} {...props} />

MaterialHistoryEduOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHistoryEduOutlined.propTypes = { ...Icon.propTypes }
