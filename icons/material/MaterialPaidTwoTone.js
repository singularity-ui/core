...
const MaterialPaidTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPaidTwoTone = (styled.default || styled)(MaterialPaidTwoToneSvg).attrs(p => ({
...
`;
MaterialPaidTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialPaidTwoTone;