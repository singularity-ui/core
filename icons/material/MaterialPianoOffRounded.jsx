...
const MaterialPianoOffRoundedSvg = props => (
  <svg
...
const MaterialPianoOffRounded = props => <Icon as={MaterialPianoOffRoundedSvg} {...props} />

MaterialPianoOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialPianoOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialPianoOffRounded
