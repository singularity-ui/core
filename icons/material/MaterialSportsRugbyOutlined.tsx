...
const MaterialSportsRugbyOutlinedSvg = props => (
  <svg
...
const MaterialSportsRugbyOutlined = props => <Icon as={MaterialSportsRugbyOutlinedSvg} {...props} />

MaterialSportsRugbyOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSportsRugbyOutlined.propTypes = { ...Icon.propTypes }
