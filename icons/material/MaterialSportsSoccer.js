...
const MaterialSportsSoccerSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsSoccer = (styled.default || styled)(MaterialSportsSoccerSvg).attrs(p => ({
...
`;
MaterialSportsSoccer.propTypes = {
