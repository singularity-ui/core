...
const MaterialApi = props => <Icon as={MaterialApiSvg} {...props} />

MaterialApi.defaultProps = { ...Icon.defaultProps }

MaterialApi.propTypes = { ...Icon.propTypes }
