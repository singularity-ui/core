...
const MaterialExtensionOutlinedSvg = props => (
...
const MaterialExtensionOutlined = props => <Icon as={MaterialExtensionOutlinedSvg} {...props} />

MaterialExtensionOutlined.defaultProps = { ...Icon.defaultProps }

MaterialExtensionOutlined.propTypes = { ...Icon.propTypes }
