...
const MaterialHdrOnSelectSvg = props => (
  <svg
...
const MaterialHdrOnSelect = props => <Icon as={MaterialHdrOnSelectSvg} {...props} />

MaterialHdrOnSelect.defaultProps = { ...Icon.defaultProps }

MaterialHdrOnSelect.propTypes = { ...Icon.propTypes }

export default MaterialHdrOnSelect
