...
const MaterialPhonelinkLockSvg = props => (
...
const MaterialPhonelinkLock = props => <Icon as={MaterialPhonelinkLockSvg} {...props} />

MaterialPhonelinkLock.defaultProps = { ...Icon.defaultProps }

MaterialPhonelinkLock.propTypes = { ...Icon.propTypes }
