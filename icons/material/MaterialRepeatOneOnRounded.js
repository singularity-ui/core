...
const MaterialRepeatOneOnRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRepeatOneOnRounded = (styled.default || styled)(MaterialRepeatOneOnRoundedSvg).attrs(p => ({
...
`;
MaterialRepeatOneOnRounded.propTypes = {
