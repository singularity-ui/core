...
const MaterialFlakyTwoToneSvg = props => (
  <svg
...
const MaterialFlakyTwoTone = props => <Icon as={MaterialFlakyTwoToneSvg} {...props} />

MaterialFlakyTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialFlakyTwoTone.propTypes = { ...Icon.propTypes }
