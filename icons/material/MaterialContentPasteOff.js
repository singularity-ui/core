...
const MaterialContentPasteOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialContentPasteOff = (styled.default || styled)(MaterialContentPasteOffSvg).attrs(p => ({
...
`;
MaterialContentPasteOff.propTypes = {
