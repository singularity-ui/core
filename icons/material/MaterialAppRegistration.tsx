...
const MaterialAppRegistrationSvg = props => (
  <svg
...
const MaterialAppRegistration = props => <Icon as={MaterialAppRegistrationSvg} {...props} />

MaterialAppRegistration.defaultProps = { ...Icon.defaultProps }

MaterialAppRegistration.propTypes = { ...Icon.propTypes }
