...
const MaterialPhoneEnabledTwoToneSvg = props => (
  <svg
...
const MaterialPhoneEnabledTwoTone = props => <Icon as={MaterialPhoneEnabledTwoToneSvg} {...props} />

MaterialPhoneEnabledTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPhoneEnabledTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPhoneEnabledTwoTone
