...
const MaterialLocationOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocationOffRounded = (styled.default || styled)(MaterialLocationOffRoundedSvg).attrs(p => ({
...
`;
MaterialLocationOffRounded.propTypes = {
