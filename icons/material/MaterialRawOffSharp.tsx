...
const MaterialRawOffSharpSvg = props => (
  <svg
...
const MaterialRawOffSharp = props => <Icon as={MaterialRawOffSharpSvg} {...props} />

MaterialRawOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialRawOffSharp.propTypes = { ...Icon.propTypes }

export default MaterialRawOffSharp
