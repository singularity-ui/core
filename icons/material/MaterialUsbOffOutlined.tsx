...
const MaterialUsbOffOutlinedSvg = props => (
  <svg
...
const MaterialUsbOffOutlined = props => <Icon as={MaterialUsbOffOutlinedSvg} {...props} />

MaterialUsbOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialUsbOffOutlined.propTypes = { ...Icon.propTypes }
