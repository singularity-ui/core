...
const MaterialHeightRoundedSvg = props => (
  <svg
...
const MaterialHeightRounded = props => <Icon as={MaterialHeightRoundedSvg} {...props} />

MaterialHeightRounded.defaultProps = { ...Icon.defaultProps }

MaterialHeightRounded.propTypes = { ...Icon.propTypes }
