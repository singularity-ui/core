...
const MaterialAnchorOutlinedSvg = props => (
  <svg
...
const MaterialAnchorOutlined = props => <Icon as={MaterialAnchorOutlinedSvg} {...props} />

MaterialAnchorOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAnchorOutlined.propTypes = { ...Icon.propTypes }

export default MaterialAnchorOutlined
