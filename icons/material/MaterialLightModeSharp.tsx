...
const MaterialLightModeSharpSvg = props => (
  <svg
...
const MaterialLightModeSharp = props => <Icon as={MaterialLightModeSharpSvg} {...props} />

MaterialLightModeSharp.defaultProps = { ...Icon.defaultProps }

MaterialLightModeSharp.propTypes = { ...Icon.propTypes }
