...
const MaterialTableViewOutlinedSvg = props => (
  <svg
...
const MaterialTableViewOutlined = props => <Icon as={MaterialTableViewOutlinedSvg} {...props} />

MaterialTableViewOutlined.defaultProps = { ...Icon.defaultProps }

MaterialTableViewOutlined.propTypes = { ...Icon.propTypes }

export default MaterialTableViewOutlined
