...
const MaterialSportsMmaSvg = props => (
  <svg
...
const MaterialSportsMma = props => <Icon as={MaterialSportsMmaSvg} {...props} />

MaterialSportsMma.defaultProps = { ...Icon.defaultProps }

MaterialSportsMma.propTypes = { ...Icon.propTypes }

export default MaterialSportsMma
