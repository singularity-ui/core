...
const MaterialBakeryDiningSvg = props => (
  <svg
...
const MaterialBakeryDining = props => <Icon as={MaterialBakeryDiningSvg} {...props} />

MaterialBakeryDining.defaultProps = { ...Icon.defaultProps }

MaterialBakeryDining.propTypes = { ...Icon.propTypes }
