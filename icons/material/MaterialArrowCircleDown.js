...
const MaterialArrowCircleDownSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialArrowCircleDown = (styled.default || styled)(MaterialArrowCircleDownSvg).attrs(p => ({
...
`;
MaterialArrowCircleDown.propTypes = {
