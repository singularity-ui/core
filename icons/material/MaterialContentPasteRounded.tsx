...
const MaterialContentPasteRoundedSvg = props => (
...
const MaterialContentPasteRounded = props => <Icon as={MaterialContentPasteRoundedSvg} {...props} />

MaterialContentPasteRounded.defaultProps = { ...Icon.defaultProps }

MaterialContentPasteRounded.propTypes = { ...Icon.propTypes }

export default MaterialContentPasteRounded
