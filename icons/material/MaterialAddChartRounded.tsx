...
const MaterialAddchartRoundedSvg = props => (
  <svg
...
const MaterialAddchartRounded = props => <Icon as={MaterialAddchartRoundedSvg} {...props} />

MaterialAddchartRounded.defaultProps = { ...Icon.defaultProps }

MaterialAddchartRounded.propTypes = { ...Icon.propTypes }
