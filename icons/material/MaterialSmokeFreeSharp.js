...
const MaterialSmokeFreeSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSmokeFreeSharp = (styled.default || styled)(MaterialSmokeFreeSharpSvg).attrs(p => ({
...
`;
MaterialSmokeFreeSharp.propTypes = {
