...
const MaterialOfflineShareSvg = props => (
...
const MaterialOfflineShare = props => <Icon as={MaterialOfflineShareSvg} {...props} />

MaterialOfflineShare.defaultProps = { ...Icon.defaultProps }

MaterialOfflineShare.propTypes = { ...Icon.propTypes }
