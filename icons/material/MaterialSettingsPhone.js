...
const MaterialSettingsPhoneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSettingsPhone = (styled.default || styled)(MaterialSettingsPhoneSvg).attrs(p => ({
...
`;
MaterialSettingsPhone.propTypes = {
