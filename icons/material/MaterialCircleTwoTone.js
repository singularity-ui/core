...
const MaterialCircleTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCircleTwoTone = (styled.default || styled)(MaterialCircleTwoToneSvg).attrs(p => ({
...
`;
MaterialCircleTwoTone.propTypes = {
