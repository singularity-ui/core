...
const MaterialUmbrellaOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUmbrellaOutlined = (styled.default || styled)(MaterialUmbrellaOutlinedSvg).attrs(p => ({
...
`;
MaterialUmbrellaOutlined.propTypes = {
