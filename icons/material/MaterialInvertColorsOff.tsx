...
const MaterialInvertColorsOffSvg = props => (
  <svg
...
const MaterialInvertColorsOff = props => <Icon as={MaterialInvertColorsOffSvg} {...props} />

MaterialInvertColorsOff.defaultProps = { ...Icon.defaultProps }

MaterialInvertColorsOff.propTypes = { ...Icon.propTypes }
