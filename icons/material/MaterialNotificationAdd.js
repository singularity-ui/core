...
const MaterialNotificationAddSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNotificationAdd = (styled.default || styled)(MaterialNotificationAddSvg).attrs(p => ({
...
`;
MaterialNotificationAdd.propTypes = {
