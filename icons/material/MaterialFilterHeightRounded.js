...
const MaterialFilterHeightRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFilterHeightRounded = (styled.default || styled)(MaterialFilterHeightRoundedSvg).attrs(p => ({
...
`;
MaterialFilterHeightRounded.propTypes = {
