...
const MaterialKeyboardHideSvg = props => (
...
const MaterialKeyboardHide = props => <Icon as={MaterialKeyboardHideSvg} {...props} />

MaterialKeyboardHide.defaultProps = { ...Icon.defaultProps }

MaterialKeyboardHide.propTypes = { ...Icon.propTypes }

export default MaterialKeyboardHide
