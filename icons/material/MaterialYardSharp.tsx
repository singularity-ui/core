...
const MaterialYardSharpSvg = props => (
  <svg
...
const MaterialYardSharp = props => <Icon as={MaterialYardSharpSvg} {...props} />

MaterialYardSharp.defaultProps = { ...Icon.defaultProps }

MaterialYardSharp.propTypes = { ...Icon.propTypes }
