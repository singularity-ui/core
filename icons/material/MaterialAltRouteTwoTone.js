...
const MaterialAltRouteTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAltRouteTwoTone = (styled.default || styled)(MaterialAltRouteTwoToneSvg).attrs(p => ({
...
`;
MaterialAltRouteTwoTone.propTypes = {
