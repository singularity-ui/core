...
const MaterialReviewsRoundedSvg = props => (
  <svg
...
const MaterialReviewsRounded = props => <Icon as={MaterialReviewsRoundedSvg} {...props} />

MaterialReviewsRounded.defaultProps = { ...Icon.defaultProps }

MaterialReviewsRounded.propTypes = { ...Icon.propTypes }

export default MaterialReviewsRounded
