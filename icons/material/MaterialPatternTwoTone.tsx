...
const MaterialPatternTwoToneSvg = props => (
  <svg
...
const MaterialPatternTwoTone = props => <Icon as={MaterialPatternTwoToneSvg} {...props} />

MaterialPatternTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPatternTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPatternTwoTone
