...
const MaterialBlurOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBlurOffSharp = (styled.default || styled)(MaterialBlurOffSharpSvg).attrs(p => ({
...
`;
MaterialBlurOffSharp.propTypes = {
