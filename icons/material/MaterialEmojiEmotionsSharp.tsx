...
const MaterialEmojiEmotionsSharpSvg = props => (
  <svg
...
const MaterialEmojiEmotionsSharp = props => <Icon as={MaterialEmojiEmotionsSharpSvg} {...props} />

MaterialEmojiEmotionsSharp.defaultProps = { ...Icon.defaultProps }

MaterialEmojiEmotionsSharp.propTypes = { ...Icon.propTypes }

export default MaterialEmojiEmotionsSharp
