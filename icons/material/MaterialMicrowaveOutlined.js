...
const MaterialMicrowaveOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMicrowaveOutlined = (styled.default || styled)(MaterialMicrowaveOutlinedSvg).attrs(p => ({
...
`;
MaterialMicrowaveOutlined.propTypes = {
