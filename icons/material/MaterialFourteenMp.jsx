...
const MaterialFourteenMpSvg = props => (
...
const MaterialFourteenMp = props => <Icon as={MaterialFourteenMpSvg} {...props} />

MaterialFourteenMp.defaultProps = { ...Icon.defaultProps }

MaterialFourteenMp.propTypes = { ...Icon.propTypes }

export default MaterialFourteenMp
