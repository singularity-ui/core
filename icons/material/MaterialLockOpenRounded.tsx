...
const MaterialLockOpenRoundedSvg = props => (
...
const MaterialLockOpenRounded = props => <Icon as={MaterialLockOpenRoundedSvg} {...props} />

MaterialLockOpenRounded.defaultProps = { ...Icon.defaultProps }

MaterialLockOpenRounded.propTypes = { ...Icon.propTypes }
