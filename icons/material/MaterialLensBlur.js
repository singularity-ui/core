...
const MaterialLensBlurSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLensBlur = (styled.default || styled)(MaterialLensBlurSvg).attrs(p => ({
...
`;
MaterialLensBlur.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialLensBlur;