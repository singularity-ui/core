...
const MaterialToysOutlinedSvg = props => (
  <svg
...
const MaterialToysOutlined = props => <Icon as={MaterialToysOutlinedSvg} {...props} />

MaterialToysOutlined.defaultProps = { ...Icon.defaultProps }

MaterialToysOutlined.propTypes = { ...Icon.propTypes }

export default MaterialToysOutlined
