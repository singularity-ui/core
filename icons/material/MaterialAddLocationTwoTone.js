...
const MaterialAddLocationTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddLocationTwoTone = (styled.default || styled)(MaterialAddLocationTwoToneSvg).attrs(p => ({
...
`;
MaterialAddLocationTwoTone.propTypes = {
