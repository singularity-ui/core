...
const MaterialEscalatorTwoToneSvg = props => (
  <svg
...
const MaterialEscalatorTwoTone = props => <Icon as={MaterialEscalatorTwoToneSvg} {...props} />

MaterialEscalatorTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialEscalatorTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialEscalatorTwoTone
