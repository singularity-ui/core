...
const MaterialAddLinkSharpSvg = props => (
  <svg
...
const MaterialAddLinkSharp = props => <Icon as={MaterialAddLinkSharpSvg} {...props} />

MaterialAddLinkSharp.defaultProps = { ...Icon.defaultProps }

MaterialAddLinkSharp.propTypes = { ...Icon.propTypes }
