...
const MaterialChangeCircleSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChangeCircleSharp = (styled.default || styled)(MaterialChangeCircleSharpSvg).attrs(p => ({
...
`;
MaterialChangeCircleSharp.propTypes = {
