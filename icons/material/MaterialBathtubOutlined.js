...
const MaterialBathtubOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBathtubOutlined = (styled.default || styled)(MaterialBathtubOutlinedSvg).attrs(p => ({
...
`;
MaterialBathtubOutlined.propTypes = {
