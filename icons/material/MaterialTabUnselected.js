...
const MaterialTabUnselectedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTabUnselected = (styled.default || styled)(MaterialTabUnselectedSvg).attrs(p => ({
...
`;
MaterialTabUnselected.propTypes = {
