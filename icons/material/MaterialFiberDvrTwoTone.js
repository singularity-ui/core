...
const MaterialFiberDvrTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFiberDvrTwoTone = (styled.default || styled)(MaterialFiberDvrTwoToneSvg).attrs(p => ({
...
`;
MaterialFiberDvrTwoTone.propTypes = {
