...
const MaterialCabinOutlinedSvg = props => (
  <svg
...
const MaterialCabinOutlined = props => <Icon as={MaterialCabinOutlinedSvg} {...props} />

MaterialCabinOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCabinOutlined.propTypes = { ...Icon.propTypes }

export default MaterialCabinOutlined
