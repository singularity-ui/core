...
const MaterialFormatColorResetSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFormatColorReset = (styled.default || styled)(MaterialFormatColorResetSvg).attrs(p => ({
...
`;
MaterialFormatColorReset.propTypes = {
