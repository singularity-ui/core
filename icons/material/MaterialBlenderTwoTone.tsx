...
const MaterialBlenderTwoToneSvg = props => (
  <svg
...
const MaterialBlenderTwoTone = props => <Icon as={MaterialBlenderTwoToneSvg} {...props} />

MaterialBlenderTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBlenderTwoTone.propTypes = { ...Icon.propTypes }
