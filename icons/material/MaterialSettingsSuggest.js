...
const MaterialSettingsSuggestSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSettingsSuggest = (styled.default || styled)(MaterialSettingsSuggestSvg).attrs(p => ({
...
`;
MaterialSettingsSuggest.propTypes = {
