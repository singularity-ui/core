...
const MaterialImageSearchRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialImageSearchRounded = (styled.default || styled)(MaterialImageSearchRoundedSvg).attrs(p => ({
...
`;
MaterialImageSearchRounded.propTypes = {
