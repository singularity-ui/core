...
const MaterialKeyboardHideTwoToneSvg = props => (
...
const MaterialKeyboardHideTwoTone = props => <Icon as={MaterialKeyboardHideTwoToneSvg} {...props} />

MaterialKeyboardHideTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialKeyboardHideTwoTone.propTypes = { ...Icon.propTypes }
