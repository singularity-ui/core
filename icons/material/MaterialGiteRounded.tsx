...
const MaterialGiteRoundedSvg = props => (
  <svg
...
const MaterialGiteRounded = props => <Icon as={MaterialGiteRoundedSvg} {...props} />

MaterialGiteRounded.defaultProps = { ...Icon.defaultProps }

MaterialGiteRounded.propTypes = { ...Icon.propTypes }
