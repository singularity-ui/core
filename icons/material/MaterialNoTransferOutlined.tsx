...
const MaterialNoTransferOutlinedSvg = props => (
  <svg
...
const MaterialNoTransferOutlined = props => <Icon as={MaterialNoTransferOutlinedSvg} {...props} />

MaterialNoTransferOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNoTransferOutlined.propTypes = { ...Icon.propTypes }

export default MaterialNoTransferOutlined
