...
const MaterialTask = props => <Icon as={MaterialTaskSvg} {...props} />

MaterialTask.defaultProps = { ...Icon.defaultProps }

MaterialTask.propTypes = { ...Icon.propTypes }
