...
const MaterialBusinessCenterSvg = props => (
...
const MaterialBusinessCenter = props => <Icon as={MaterialBusinessCenterSvg} {...props} />

MaterialBusinessCenter.defaultProps = { ...Icon.defaultProps }

MaterialBusinessCenter.propTypes = { ...Icon.propTypes }
