...
const MaterialNoEncryptionSvg = props => (
...
const MaterialNoEncryption = props => <Icon as={MaterialNoEncryptionSvg} {...props} />

MaterialNoEncryption.defaultProps = { ...Icon.defaultProps }

MaterialNoEncryption.propTypes = { ...Icon.propTypes }
