...
const MaterialPeopleAltTwoToneSvg = props => (
  <svg
...
const MaterialPeopleAltTwoTone = props => <Icon as={MaterialPeopleAltTwoToneSvg} {...props} />

MaterialPeopleAltTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPeopleAltTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPeopleAltTwoTone
