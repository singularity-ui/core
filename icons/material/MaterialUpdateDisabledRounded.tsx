...
const MaterialUpdateDisabledRoundedSvg = props => (
  <svg
...
const MaterialUpdateDisabledRounded = props => <Icon as={MaterialUpdateDisabledRoundedSvg} {...props} />

MaterialUpdateDisabledRounded.defaultProps = { ...Icon.defaultProps }

MaterialUpdateDisabledRounded.propTypes = { ...Icon.propTypes }

export default MaterialUpdateDisabledRounded
