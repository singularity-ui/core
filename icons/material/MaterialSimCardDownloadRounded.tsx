...
const MaterialSimCardDownloadRoundedSvg = props => (
  <svg
...
const MaterialSimCardDownloadRounded = props => <Icon as={MaterialSimCardDownloadRoundedSvg} {...props} />

MaterialSimCardDownloadRounded.defaultProps = { ...Icon.defaultProps }

MaterialSimCardDownloadRounded.propTypes = { ...Icon.propTypes }
