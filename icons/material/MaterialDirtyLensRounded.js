...
const MaterialDirtyLensRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDirtyLensRounded = (styled.default || styled)(MaterialDirtyLensRoundedSvg).attrs(p => ({
...
`;
MaterialDirtyLensRounded.propTypes = {
