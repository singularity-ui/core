...
const MaterialSouthRoundedSvg = props => (
  <svg
...
const MaterialSouthRounded = props => <Icon as={MaterialSouthRoundedSvg} {...props} />

MaterialSouthRounded.defaultProps = { ...Icon.defaultProps }

MaterialSouthRounded.propTypes = { ...Icon.propTypes }
