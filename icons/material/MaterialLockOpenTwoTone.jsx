...
const MaterialLockOpenTwoToneSvg = props => (
...
const MaterialLockOpenTwoTone = props => <Icon as={MaterialLockOpenTwoToneSvg} {...props} />

MaterialLockOpenTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialLockOpenTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialLockOpenTwoTone
