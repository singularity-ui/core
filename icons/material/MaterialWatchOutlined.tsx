...
const MaterialWatchOutlinedSvg = props => (
...
const MaterialWatchOutlined = props => <Icon as={MaterialWatchOutlinedSvg} {...props} />

MaterialWatchOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWatchOutlined.propTypes = { ...Icon.propTypes }

export default MaterialWatchOutlined
