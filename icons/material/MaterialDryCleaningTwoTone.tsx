...
const MaterialDryCleaningTwoToneSvg = props => (
  <svg
...
const MaterialDryCleaningTwoTone = props => <Icon as={MaterialDryCleaningTwoToneSvg} {...props} />

MaterialDryCleaningTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDryCleaningTwoTone.propTypes = { ...Icon.propTypes }
