...
const MaterialGradientRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGradientRounded = (styled.default || styled)(MaterialGradientRoundedSvg).attrs(p => ({
...
`;
MaterialGradientRounded.propTypes = {
