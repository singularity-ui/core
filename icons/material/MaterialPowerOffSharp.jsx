...
const MaterialPowerOffSharpSvg = props => (
...
const MaterialPowerOffSharp = props => <Icon as={MaterialPowerOffSharpSvg} {...props} />

MaterialPowerOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialPowerOffSharp.propTypes = { ...Icon.propTypes }
