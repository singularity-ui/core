...
const MaterialSuperscriptSvg = props => (
  <svg
...
const MaterialSuperscript = props => <Icon as={MaterialSuperscriptSvg} {...props} />

MaterialSuperscript.defaultProps = { ...Icon.defaultProps }

MaterialSuperscript.propTypes = { ...Icon.propTypes }

export default MaterialSuperscript
