...
const MaterialSquareFootSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSquareFootSharp = (styled.default || styled)(MaterialSquareFootSharpSvg).attrs(p => ({
...
`;
MaterialSquareFootSharp.propTypes = {
