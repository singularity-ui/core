...
const MaterialArchitectureOutlinedSvg = props => (
  <svg
...
const MaterialArchitectureOutlined = props => <Icon as={MaterialArchitectureOutlinedSvg} {...props} />

MaterialArchitectureOutlined.defaultProps = { ...Icon.defaultProps }

MaterialArchitectureOutlined.propTypes = { ...Icon.propTypes }

export default MaterialArchitectureOutlined
