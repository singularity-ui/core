...
const MaterialToll = props => <Icon as={MaterialTollSvg} {...props} />

MaterialToll.defaultProps = { ...Icon.defaultProps }

MaterialToll.propTypes = { ...Icon.propTypes }

export default MaterialToll
