...
const MaterialHistoryTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHistoryTwoTone = (styled.default || styled)(MaterialHistoryTwoToneSvg).attrs(p => ({
...
`;
MaterialHistoryTwoTone.propTypes = {
