...
const MaterialQuizOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialQuizOutlined = (styled.default || styled)(MaterialQuizOutlinedSvg).attrs(p => ({
...
`;
MaterialQuizOutlined.propTypes = {
