...
const MaterialAppRegistrationSharpSvg = props => (
  <svg
...
const MaterialAppRegistrationSharp = props => <Icon as={MaterialAppRegistrationSharpSvg} {...props} />

MaterialAppRegistrationSharp.defaultProps = { ...Icon.defaultProps }

MaterialAppRegistrationSharp.propTypes = { ...Icon.propTypes }
