...
const MaterialNetworkCheckTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNetworkCheckTwoTone = (styled.default || styled)(MaterialNetworkCheckTwoToneSvg).attrs(p => ({
...
`;
MaterialNetworkCheckTwoTone.propTypes = {
