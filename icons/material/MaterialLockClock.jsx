...
const MaterialLockClockSvg = props => (
...
const MaterialLockClock = props => <Icon as={MaterialLockClockSvg} {...props} />

MaterialLockClock.defaultProps = { ...Icon.defaultProps }

MaterialLockClock.propTypes = { ...Icon.propTypes }
