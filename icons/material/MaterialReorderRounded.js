...
const MaterialReorderRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReorderRounded = (styled.default || styled)(MaterialReorderRoundedSvg).attrs(p => ({
...
`;
MaterialReorderRounded.propTypes = {
