...
const MaterialTextSnippetRoundedSvg = props => (
  <svg
...
const MaterialTextSnippetRounded = props => <Icon as={MaterialTextSnippetRoundedSvg} {...props} />

MaterialTextSnippetRounded.defaultProps = { ...Icon.defaultProps }

MaterialTextSnippetRounded.propTypes = { ...Icon.propTypes }
