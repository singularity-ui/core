...
const MaterialSensorsSvg = props => (
  <svg
...
const MaterialSensors = props => <Icon as={MaterialSensorsSvg} {...props} />

MaterialSensors.defaultProps = { ...Icon.defaultProps }

MaterialSensors.propTypes = { ...Icon.propTypes }

export default MaterialSensors
