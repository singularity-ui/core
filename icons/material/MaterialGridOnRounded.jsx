...
const MaterialGridOnRoundedSvg = props => (
...
const MaterialGridOnRounded = props => <Icon as={MaterialGridOnRoundedSvg} {...props} />

MaterialGridOnRounded.defaultProps = { ...Icon.defaultProps }

MaterialGridOnRounded.propTypes = { ...Icon.propTypes }
