...
const MaterialPhoneCallbackSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneCallback = (styled.default || styled)(MaterialPhoneCallbackSvg).attrs(p => ({
...
`;
MaterialPhoneCallback.propTypes = {
