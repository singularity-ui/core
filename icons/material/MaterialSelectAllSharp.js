...
const MaterialSelectAllSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSelectAllSharp = (styled.default || styled)(MaterialSelectAllSharpSvg).attrs(p => ({
...
`;
MaterialSelectAllSharp.propTypes = {
