...
const MaterialPieChartTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPieChartTwoTone = (styled.default || styled)(MaterialPieChartTwoToneSvg).attrs(p => ({
...
`;
MaterialPieChartTwoTone.propTypes = {
