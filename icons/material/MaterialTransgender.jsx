...
const MaterialTransgenderSvg = props => (
  <svg
...
const MaterialTransgender = props => <Icon as={MaterialTransgenderSvg} {...props} />

MaterialTransgender.defaultProps = { ...Icon.defaultProps }

MaterialTransgender.propTypes = { ...Icon.propTypes }

export default MaterialTransgender
