...
const MaterialAllOut = props => <Icon as={MaterialAllOutSvg} {...props} />

MaterialAllOut.defaultProps = { ...Icon.defaultProps }

MaterialAllOut.propTypes = { ...Icon.propTypes }

export default MaterialAllOut
