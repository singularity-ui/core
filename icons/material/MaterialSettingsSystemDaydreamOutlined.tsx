...
const MaterialSettingsSystemDaydreamOutlinedSvg = props => (
...
const MaterialSettingsSystemDaydreamOutlined = props => (
  <Icon as={MaterialSettingsSystemDaydreamOutlinedSvg} {...props} />
)

MaterialSettingsSystemDaydreamOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSettingsSystemDaydreamOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSettingsSystemDaydreamOutlined
