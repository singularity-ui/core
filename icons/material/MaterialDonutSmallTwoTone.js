...
const MaterialDonutSmallTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDonutSmallTwoTone = (styled.default || styled)(MaterialDonutSmallTwoToneSvg).attrs(p => ({
...
`;
MaterialDonutSmallTwoTone.propTypes = {
