...
const MaterialHeightKRoundedSvg = props => (
  <svg
...
const MaterialHeightKRounded = props => <Icon as={MaterialHeightKRoundedSvg} {...props} />

MaterialHeightKRounded.defaultProps = { ...Icon.defaultProps }

MaterialHeightKRounded.propTypes = { ...Icon.propTypes }
