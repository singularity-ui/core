...
const MaterialDirtyLensOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDirtyLensOutlined = (styled.default || styled)(MaterialDirtyLensOutlinedSvg).attrs(p => ({
...
`;
MaterialDirtyLensOutlined.propTypes = {
