...
const MaterialDirtyLensSharpSvg = props => (
  <svg
...
const MaterialDirtyLensSharp = props => <Icon as={MaterialDirtyLensSharpSvg} {...props} />

MaterialDirtyLensSharp.defaultProps = { ...Icon.defaultProps }

MaterialDirtyLensSharp.propTypes = { ...Icon.propTypes }
