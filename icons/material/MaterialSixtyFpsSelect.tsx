...
const MaterialSixtyFpsSelectSvg = props => (
  <svg
...
const MaterialSixtyFpsSelect = props => <Icon as={MaterialSixtyFpsSelectSvg} {...props} />

MaterialSixtyFpsSelect.defaultProps = { ...Icon.defaultProps }

MaterialSixtyFpsSelect.propTypes = { ...Icon.propTypes }

export default MaterialSixtyFpsSelect
