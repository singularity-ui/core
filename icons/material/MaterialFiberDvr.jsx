...
const MaterialFiberDvrSvg = props => (
  <svg
...
const MaterialFiberDvr = props => <Icon as={MaterialFiberDvrSvg} {...props} />

MaterialFiberDvr.defaultProps = { ...Icon.defaultProps }

MaterialFiberDvr.propTypes = { ...Icon.propTypes }
