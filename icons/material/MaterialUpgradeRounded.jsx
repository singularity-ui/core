...
const MaterialUpgradeRoundedSvg = props => (
  <svg
...
const MaterialUpgradeRounded = props => <Icon as={MaterialUpgradeRoundedSvg} {...props} />

MaterialUpgradeRounded.defaultProps = { ...Icon.defaultProps }

MaterialUpgradeRounded.propTypes = { ...Icon.propTypes }
