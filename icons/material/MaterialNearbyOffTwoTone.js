...
const MaterialNearbyOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNearbyOffTwoTone = (styled.default || styled)(MaterialNearbyOffTwoToneSvg).attrs(p => ({
...
`;
MaterialNearbyOffTwoTone.propTypes = {
