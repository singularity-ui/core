...
const MaterialKeyboardAltRoundedSvg = props => (
  <svg
...
const MaterialKeyboardAltRounded = props => <Icon as={MaterialKeyboardAltRoundedSvg} {...props} />

MaterialKeyboardAltRounded.defaultProps = { ...Icon.defaultProps }

MaterialKeyboardAltRounded.propTypes = { ...Icon.propTypes }

export default MaterialKeyboardAltRounded
