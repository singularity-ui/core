...
const MaterialTransgenderRoundedSvg = props => (
  <svg
...
const MaterialTransgenderRounded = props => <Icon as={MaterialTransgenderRoundedSvg} {...props} />

MaterialTransgenderRounded.defaultProps = { ...Icon.defaultProps }

MaterialTransgenderRounded.propTypes = { ...Icon.propTypes }
