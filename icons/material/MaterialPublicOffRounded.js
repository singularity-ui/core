...
const MaterialPublicOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPublicOffRounded = (styled.default || styled)(MaterialPublicOffRoundedSvg).attrs(p => ({
...
`;
MaterialPublicOffRounded.propTypes = {
