...
const MaterialThreePRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThreePRounded = (styled.default || styled)(MaterialThreePRoundedSvg).attrs(p => ({
...
`;
MaterialThreePRounded.propTypes = {
