...
const MaterialAccessibleForwardSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAccessibleForward = (styled.default || styled)(MaterialAccessibleForwardSvg).attrs(p => ({
...
`;
MaterialAccessibleForward.propTypes = {
