...
const MaterialFemaleTwoToneSvg = props => (
  <svg
...
const MaterialFemaleTwoTone = props => <Icon as={MaterialFemaleTwoToneSvg} {...props} />

MaterialFemaleTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialFemaleTwoTone.propTypes = { ...Icon.propTypes }
