...
const MaterialBatchPredictionRoundedSvg = props => (
  <svg
...
const MaterialBatchPredictionRounded = props => <Icon as={MaterialBatchPredictionRoundedSvg} {...props} />

MaterialBatchPredictionRounded.defaultProps = { ...Icon.defaultProps }

MaterialBatchPredictionRounded.propTypes = { ...Icon.propTypes }

export default MaterialBatchPredictionRounded
