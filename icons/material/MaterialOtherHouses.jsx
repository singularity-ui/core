...
const MaterialOtherHousesSvg = props => (
  <svg
...
const MaterialOtherHouses = props => <Icon as={MaterialOtherHousesSvg} {...props} />

MaterialOtherHouses.defaultProps = { ...Icon.defaultProps }

MaterialOtherHouses.propTypes = { ...Icon.propTypes }
