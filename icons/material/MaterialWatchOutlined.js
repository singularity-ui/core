...
const MaterialWatchOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWatchOutlined = (styled.default || styled)(MaterialWatchOutlinedSvg).attrs(p => ({
...
`;
MaterialWatchOutlined.propTypes = {
