...
const MaterialCameraFrontRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCameraFrontRounded = (styled.default || styled)(MaterialCameraFrontRoundedSvg).attrs(p => ({
...
`;
MaterialCameraFrontRounded.propTypes = {
