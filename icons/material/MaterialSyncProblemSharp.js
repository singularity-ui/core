...
const MaterialSyncProblemSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSyncProblemSharp = (styled.default || styled)(MaterialSyncProblemSharpSvg).attrs(p => ({
...
`;
MaterialSyncProblemSharp.propTypes = {
