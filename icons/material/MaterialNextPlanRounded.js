...
const MaterialNextPlanRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNextPlanRounded = (styled.default || styled)(MaterialNextPlanRoundedSvg).attrs(p => ({
...
`;
MaterialNextPlanRounded.propTypes = {
