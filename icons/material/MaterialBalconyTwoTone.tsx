...
const MaterialBalconyTwoToneSvg = props => (
  <svg
...
const MaterialBalconyTwoTone = props => <Icon as={MaterialBalconyTwoToneSvg} {...props} />

MaterialBalconyTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBalconyTwoTone.propTypes = { ...Icon.propTypes }
