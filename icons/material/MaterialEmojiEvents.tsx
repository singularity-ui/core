...
const MaterialEmojiEventsSvg = props => (
  <svg
...
const MaterialEmojiEvents = props => <Icon as={MaterialEmojiEventsSvg} {...props} />

MaterialEmojiEvents.defaultProps = { ...Icon.defaultProps }

MaterialEmojiEvents.propTypes = { ...Icon.propTypes }

export default MaterialEmojiEvents
