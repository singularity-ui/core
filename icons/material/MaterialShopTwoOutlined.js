...
const MaterialShopTwoOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialShopTwoOutlined = (styled.default || styled)(MaterialShopTwoOutlinedSvg).attrs(p => ({
...
`;
MaterialShopTwoOutlined.propTypes = {
