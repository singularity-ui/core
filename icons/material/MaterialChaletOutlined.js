...
const MaterialChaletOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChaletOutlined = (styled.default || styled)(MaterialChaletOutlinedSvg).attrs(p => ({
...
`;
MaterialChaletOutlined.propTypes = {
