...
const MaterialArchiveOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialArchiveOutlined = (styled.default || styled)(MaterialArchiveOutlinedSvg).attrs(p => ({
...
`;
MaterialArchiveOutlined.propTypes = {
