...
const MaterialCameraTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCameraTwoTone = (styled.default || styled)(MaterialCameraTwoToneSvg).attrs(p => ({
...
`;
MaterialCameraTwoTone.propTypes = {
