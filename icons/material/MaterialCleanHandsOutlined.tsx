...
const MaterialCleanHandsOutlinedSvg = props => (
  <svg
...
const MaterialCleanHandsOutlined = props => <Icon as={MaterialCleanHandsOutlinedSvg} {...props} />

MaterialCleanHandsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCleanHandsOutlined.propTypes = { ...Icon.propTypes }
