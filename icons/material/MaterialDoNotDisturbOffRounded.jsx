...
const MaterialDoNotDisturbOffRoundedSvg = props => (
  <svg
...
const MaterialDoNotDisturbOffRounded = props => <Icon as={MaterialDoNotDisturbOffRoundedSvg} {...props} />

MaterialDoNotDisturbOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialDoNotDisturbOffRounded.propTypes = { ...Icon.propTypes }
