...
const MaterialVerifiedSharpSvg = props => (
  <svg
...
const MaterialVerifiedSharp = props => <Icon as={MaterialVerifiedSharpSvg} {...props} />

MaterialVerifiedSharp.defaultProps = { ...Icon.defaultProps }

MaterialVerifiedSharp.propTypes = { ...Icon.propTypes }

export default MaterialVerifiedSharp
