...
const MaterialStarTwoToneSvg = props => (
  <svg
...
const MaterialStarTwoTone = props => <Icon as={MaterialStarTwoToneSvg} {...props} />

MaterialStarTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialStarTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialStarTwoTone
