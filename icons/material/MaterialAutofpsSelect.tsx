...
const MaterialAutofpsSelectSvg = props => (
  <svg
...
const MaterialAutofpsSelect = props => <Icon as={MaterialAutofpsSelectSvg} {...props} />

MaterialAutofpsSelect.defaultProps = { ...Icon.defaultProps }

MaterialAutofpsSelect.propTypes = { ...Icon.propTypes }

export default MaterialAutofpsSelect
