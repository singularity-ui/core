...
const MaterialForwardThirtySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardThirtySharp = (styled.default || styled)(MaterialForwardThirtySharpSvg).attrs(p => ({
...
`;
MaterialForwardThirtySharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialForwardThirtySharp;