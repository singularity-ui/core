...
const MaterialManageAccountsRoundedSvg = props => (
  <svg
...
const MaterialManageAccountsRounded = props => <Icon as={MaterialManageAccountsRoundedSvg} {...props} />

MaterialManageAccountsRounded.defaultProps = { ...Icon.defaultProps }

MaterialManageAccountsRounded.propTypes = { ...Icon.propTypes }

export default MaterialManageAccountsRounded
