...
const MaterialSportsTennisSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsTennisSharp = (styled.default || styled)(MaterialSportsTennisSharpSvg).attrs(p => ({
...
`;
MaterialSportsTennisSharp.propTypes = {
