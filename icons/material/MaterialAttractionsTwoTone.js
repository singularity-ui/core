...
const MaterialAttractionsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttractionsTwoTone = (styled.default || styled)(MaterialAttractionsTwoToneSvg).attrs(p => ({
...
`;
MaterialAttractionsTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialAttractionsTwoTone;