...
const MaterialNoMealsRoundedSvg = props => (
  <svg
...
const MaterialNoMealsRounded = props => <Icon as={MaterialNoMealsRoundedSvg} {...props} />

MaterialNoMealsRounded.defaultProps = { ...Icon.defaultProps }

MaterialNoMealsRounded.propTypes = { ...Icon.propTypes }
