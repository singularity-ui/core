...
const MaterialRequestQuoteSvg = props => (
  <svg
...
const MaterialRequestQuote = props => <Icon as={MaterialRequestQuoteSvg} {...props} />

MaterialRequestQuote.defaultProps = { ...Icon.defaultProps }

MaterialRequestQuote.propTypes = { ...Icon.propTypes }

export default MaterialRequestQuote
