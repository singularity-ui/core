...
const MaterialBorderColorTwoToneSvg = props => (
  <svg
...
const MaterialBorderColorTwoTone = props => <Icon as={MaterialBorderColorTwoToneSvg} {...props} />

MaterialBorderColorTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBorderColorTwoTone.propTypes = { ...Icon.propTypes }
