...
const MaterialExposureZeroSvg = props => (
...
const MaterialExposureZero = props => <Icon as={MaterialExposureZeroSvg} {...props} />

MaterialExposureZero.defaultProps = { ...Icon.defaultProps }

MaterialExposureZero.propTypes = { ...Icon.propTypes }

export default MaterialExposureZero
