...
const MaterialStorefrontRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStorefrontRounded = (styled.default || styled)(MaterialStorefrontRoundedSvg).attrs(p => ({
...
`;
MaterialStorefrontRounded.propTypes = {
