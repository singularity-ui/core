...
const MaterialPlumbingOutlinedSvg = props => (
  <svg
...
const MaterialPlumbingOutlined = props => <Icon as={MaterialPlumbingOutlinedSvg} {...props} />

MaterialPlumbingOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPlumbingOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPlumbingOutlined
