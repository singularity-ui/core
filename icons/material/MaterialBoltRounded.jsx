...
const MaterialBoltRoundedSvg = props => (
  <svg
...
const MaterialBoltRounded = props => <Icon as={MaterialBoltRoundedSvg} {...props} />

MaterialBoltRounded.defaultProps = { ...Icon.defaultProps }

MaterialBoltRounded.propTypes = { ...Icon.propTypes }
