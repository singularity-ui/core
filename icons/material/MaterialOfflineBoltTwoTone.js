...
const MaterialOfflineBoltTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOfflineBoltTwoTone = (styled.default || styled)(MaterialOfflineBoltTwoToneSvg).attrs(p => ({
...
`;
MaterialOfflineBoltTwoTone.propTypes = {
