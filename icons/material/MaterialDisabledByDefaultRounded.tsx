...
const MaterialDisabledByDefaultRoundedSvg = props => (
  <svg
...
const MaterialDisabledByDefaultRounded = props => <Icon as={MaterialDisabledByDefaultRoundedSvg} {...props} />

MaterialDisabledByDefaultRounded.defaultProps = { ...Icon.defaultProps }

MaterialDisabledByDefaultRounded.propTypes = { ...Icon.propTypes }

export default MaterialDisabledByDefaultRounded
