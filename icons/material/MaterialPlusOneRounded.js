...
const MaterialPlusOneRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPlusOneRounded = (styled.default || styled)(MaterialPlusOneRoundedSvg).attrs(p => ({
...
`;
MaterialPlusOneRounded.propTypes = {
