...
const MaterialSpaRoundedSvg = props => (
...
const MaterialSpaRounded = props => <Icon as={MaterialSpaRoundedSvg} {...props} />

MaterialSpaRounded.defaultProps = { ...Icon.defaultProps }

MaterialSpaRounded.propTypes = { ...Icon.propTypes }
