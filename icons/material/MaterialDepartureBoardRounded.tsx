...
const MaterialDepartureBoardRoundedSvg = props => (
...
const MaterialDepartureBoardRounded = props => <Icon as={MaterialDepartureBoardRoundedSvg} {...props} />

MaterialDepartureBoardRounded.defaultProps = { ...Icon.defaultProps }

MaterialDepartureBoardRounded.propTypes = { ...Icon.propTypes }

export default MaterialDepartureBoardRounded
