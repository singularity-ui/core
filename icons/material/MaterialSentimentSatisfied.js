...
const MaterialSentimentSatisfiedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSentimentSatisfied = (styled.default || styled)(MaterialSentimentSatisfiedSvg).attrs(p => ({
...
`;
MaterialSentimentSatisfied.propTypes = {
