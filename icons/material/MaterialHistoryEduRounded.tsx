...
const MaterialHistoryEduRoundedSvg = props => (
  <svg
...
const MaterialHistoryEduRounded = props => <Icon as={MaterialHistoryEduRoundedSvg} {...props} />

MaterialHistoryEduRounded.defaultProps = { ...Icon.defaultProps }

MaterialHistoryEduRounded.propTypes = { ...Icon.propTypes }

export default MaterialHistoryEduRounded
