...
const MaterialDoNotTouchOutlinedSvg = props => (
  <svg
...
const MaterialDoNotTouchOutlined = props => <Icon as={MaterialDoNotTouchOutlinedSvg} {...props} />

MaterialDoNotTouchOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDoNotTouchOutlined.propTypes = { ...Icon.propTypes }

export default MaterialDoNotTouchOutlined
