...
const MaterialTramOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTramOutlined = (styled.default || styled)(MaterialTramOutlinedSvg).attrs(p => ({
...
`;
MaterialTramOutlined.propTypes = {
