...
const MaterialSportsKabaddiTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsKabaddiTwoTone = (styled.default || styled)(MaterialSportsKabaddiTwoToneSvg).attrs(p => ({
...
`;
MaterialSportsKabaddiTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSportsKabaddiTwoTone;