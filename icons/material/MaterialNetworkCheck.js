...
const MaterialNetworkCheckSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNetworkCheck = (styled.default || styled)(MaterialNetworkCheckSvg).attrs(p => ({
...
`;
MaterialNetworkCheck.propTypes = {
