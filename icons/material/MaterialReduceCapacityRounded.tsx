...
const MaterialReduceCapacityRoundedSvg = props => (
  <svg
...
const MaterialReduceCapacityRounded = props => <Icon as={MaterialReduceCapacityRoundedSvg} {...props} />

MaterialReduceCapacityRounded.defaultProps = { ...Icon.defaultProps }

MaterialReduceCapacityRounded.propTypes = { ...Icon.propTypes }

export default MaterialReduceCapacityRounded
