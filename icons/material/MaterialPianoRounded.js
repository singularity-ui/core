...
const MaterialPianoRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPianoRounded = (styled.default || styled)(MaterialPianoRoundedSvg).attrs(p => ({
...
`;
MaterialPianoRounded.propTypes = {
