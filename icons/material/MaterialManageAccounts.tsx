...
const MaterialManageAccountsSvg = props => (
  <svg
...
const MaterialManageAccounts = props => <Icon as={MaterialManageAccountsSvg} {...props} />

MaterialManageAccounts.defaultProps = { ...Icon.defaultProps }

MaterialManageAccounts.propTypes = { ...Icon.propTypes }

export default MaterialManageAccounts
