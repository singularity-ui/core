...
const MaterialShuffleOnRoundedSvg = props => (
  <svg
...
const MaterialShuffleOnRounded = props => <Icon as={MaterialShuffleOnRoundedSvg} {...props} />

MaterialShuffleOnRounded.defaultProps = { ...Icon.defaultProps }

MaterialShuffleOnRounded.propTypes = { ...Icon.propTypes }
