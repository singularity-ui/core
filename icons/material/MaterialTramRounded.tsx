...
const MaterialTramRoundedSvg = props => (
...
const MaterialTramRounded = props => <Icon as={MaterialTramRoundedSvg} {...props} />

MaterialTramRounded.defaultProps = { ...Icon.defaultProps }

MaterialTramRounded.propTypes = { ...Icon.propTypes }

export default MaterialTramRounded
