...
const MaterialLightOutlinedSvg = props => (
  <svg
...
const MaterialLightOutlined = props => <Icon as={MaterialLightOutlinedSvg} {...props} />

MaterialLightOutlined.defaultProps = { ...Icon.defaultProps }

MaterialLightOutlined.propTypes = { ...Icon.propTypes }
