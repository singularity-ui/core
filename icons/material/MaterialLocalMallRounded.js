...
const MaterialLocalMallRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalMallRounded = (styled.default || styled)(MaterialLocalMallRoundedSvg).attrs(p => ({
...
`;
MaterialLocalMallRounded.propTypes = {
