...
const MaterialWaterOutlinedSvg = props => (
  <svg
...
const MaterialWaterOutlined = props => <Icon as={MaterialWaterOutlinedSvg} {...props} />

MaterialWaterOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWaterOutlined.propTypes = { ...Icon.propTypes }

export default MaterialWaterOutlined
