...
const MaterialCarRentalOutlinedSvg = props => (
  <svg
...
const MaterialCarRentalOutlined = props => <Icon as={MaterialCarRentalOutlinedSvg} {...props} />

MaterialCarRentalOutlined.defaultProps = { ...Icon.defaultProps }

MaterialCarRentalOutlined.propTypes = { ...Icon.propTypes }

export default MaterialCarRentalOutlined
