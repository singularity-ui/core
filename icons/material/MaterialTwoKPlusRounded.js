...
const MaterialTwoKPlusRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTwoKPlusRounded = (styled.default || styled)(MaterialTwoKPlusRoundedSvg).attrs(p => ({
...
`;
MaterialTwoKPlusRounded.propTypes = {
