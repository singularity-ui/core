...
const MaterialRestorePageRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRestorePageRounded = (styled.default || styled)(MaterialRestorePageRoundedSvg).attrs(p => ({
...
`;
MaterialRestorePageRounded.propTypes = {
