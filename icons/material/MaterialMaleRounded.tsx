...
const MaterialMaleRoundedSvg = props => (
  <svg
...
const MaterialMaleRounded = props => <Icon as={MaterialMaleRoundedSvg} {...props} />

MaterialMaleRounded.defaultProps = { ...Icon.defaultProps }

MaterialMaleRounded.propTypes = { ...Icon.propTypes }
