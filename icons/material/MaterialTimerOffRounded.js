...
const MaterialTimerOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerOffRounded = (styled.default || styled)(MaterialTimerOffRoundedSvg).attrs(p => ({
...
`;
MaterialTimerOffRounded.propTypes = {
