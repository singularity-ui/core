...
const MaterialPlagiarismSvg = props => (
  <svg
...
const MaterialPlagiarism = props => <Icon as={MaterialPlagiarismSvg} {...props} />

MaterialPlagiarism.defaultProps = { ...Icon.defaultProps }

MaterialPlagiarism.propTypes = { ...Icon.propTypes }

export default MaterialPlagiarism
