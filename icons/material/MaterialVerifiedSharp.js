...
const MaterialVerifiedSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVerifiedSharp = (styled.default || styled)(MaterialVerifiedSharpSvg).attrs(p => ({
...
`;
MaterialVerifiedSharp.propTypes = {
