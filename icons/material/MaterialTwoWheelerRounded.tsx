...
const MaterialTwoWheelerRoundedSvg = props => (
  <svg
...
const MaterialTwoWheelerRounded = props => <Icon as={MaterialTwoWheelerRoundedSvg} {...props} />

MaterialTwoWheelerRounded.defaultProps = { ...Icon.defaultProps }

MaterialTwoWheelerRounded.propTypes = { ...Icon.propTypes }
