...
const MaterialDnsRoundedSvg = props => (
...
const MaterialDnsRounded = props => <Icon as={MaterialDnsRoundedSvg} {...props} />

MaterialDnsRounded.defaultProps = { ...Icon.defaultProps }

MaterialDnsRounded.propTypes = { ...Icon.propTypes }

export default MaterialDnsRounded
