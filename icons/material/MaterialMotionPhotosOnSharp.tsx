...
const MaterialMotionPhotosOnSharpSvg = props => (
  <svg
...
const MaterialMotionPhotosOnSharp = props => <Icon as={MaterialMotionPhotosOnSharpSvg} {...props} />

MaterialMotionPhotosOnSharp.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosOnSharp.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosOnSharp
