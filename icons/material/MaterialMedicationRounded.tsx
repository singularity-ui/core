...
const MaterialMedicationRoundedSvg = props => (
  <svg
...
const MaterialMedicationRounded = props => <Icon as={MaterialMedicationRoundedSvg} {...props} />

MaterialMedicationRounded.defaultProps = { ...Icon.defaultProps }

MaterialMedicationRounded.propTypes = { ...Icon.propTypes }
