...
const MaterialEventRoundedSvg = props => (
...
const MaterialEventRounded = props => <Icon as={MaterialEventRoundedSvg} {...props} />

MaterialEventRounded.defaultProps = { ...Icon.defaultProps }

MaterialEventRounded.propTypes = { ...Icon.propTypes }
