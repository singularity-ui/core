...
const MaterialSmokingRoomsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSmokingRooms = (styled.default || styled)(MaterialSmokingRoomsSvg).attrs(p => ({
...
`;
MaterialSmokingRooms.propTypes = {
