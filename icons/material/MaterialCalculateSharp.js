...
const MaterialCalculateSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCalculateSharp = (styled.default || styled)(MaterialCalculateSharpSvg).attrs(p => ({
...
`;
MaterialCalculateSharp.propTypes = {
