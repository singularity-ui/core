...
const MaterialEuroTwoToneSvg = props => (
  <svg
...
const MaterialEuroTwoTone = props => <Icon as={MaterialEuroTwoToneSvg} {...props} />

MaterialEuroTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialEuroTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialEuroTwoTone
