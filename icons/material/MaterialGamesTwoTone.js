...
const MaterialGamesTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGamesTwoTone = (styled.default || styled)(MaterialGamesTwoToneSvg).attrs(p => ({
...
`;
MaterialGamesTwoTone.propTypes = {
