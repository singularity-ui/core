...
const MaterialLocalConvenienceStoreRoundedSvg = props => (
  <svg
...
const MaterialLocalConvenienceStoreRounded = props => <Icon as={MaterialLocalConvenienceStoreRoundedSvg} {...props} />

MaterialLocalConvenienceStoreRounded.defaultProps = { ...Icon.defaultProps }

MaterialLocalConvenienceStoreRounded.propTypes = { ...Icon.propTypes }

export default MaterialLocalConvenienceStoreRounded
