...
const MaterialNextPlanSharpSvg = props => (
  <svg
...
const MaterialNextPlanSharp = props => <Icon as={MaterialNextPlanSharpSvg} {...props} />

MaterialNextPlanSharp.defaultProps = { ...Icon.defaultProps }

MaterialNextPlanSharp.propTypes = { ...Icon.propTypes }

export default MaterialNextPlanSharp
