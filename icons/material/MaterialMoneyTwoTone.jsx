...
const MaterialMoneyTwoToneSvg = props => (
...
const MaterialMoneyTwoTone = props => <Icon as={MaterialMoneyTwoToneSvg} {...props} />

MaterialMoneyTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMoneyTwoTone.propTypes = { ...Icon.propTypes }
