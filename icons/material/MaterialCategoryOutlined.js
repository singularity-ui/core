...
const MaterialCategoryOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCategoryOutlined = (styled.default || styled)(MaterialCategoryOutlinedSvg).attrs(p => ({
...
`;
MaterialCategoryOutlined.propTypes = {
