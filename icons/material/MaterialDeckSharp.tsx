...
const MaterialDeckSharpSvg = props => (
  <svg
...
const MaterialDeckSharp = props => <Icon as={MaterialDeckSharpSvg} {...props} />

MaterialDeckSharp.defaultProps = { ...Icon.defaultProps }

MaterialDeckSharp.propTypes = { ...Icon.propTypes }

export default MaterialDeckSharp
