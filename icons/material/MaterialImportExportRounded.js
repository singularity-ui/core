...
const MaterialImportExportRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialImportExportRounded = (styled.default || styled)(MaterialImportExportRoundedSvg).attrs(p => ({
...
`;
MaterialImportExportRounded.propTypes = {
