...
const MaterialChildCareTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChildCareTwoTone = (styled.default || styled)(MaterialChildCareTwoToneSvg).attrs(p => ({
...
`;
MaterialChildCareTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialChildCareTwoTone;