...
const MaterialMopedTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMopedTwoTone = (styled.default || styled)(MaterialMopedTwoToneSvg).attrs(p => ({
...
`;
MaterialMopedTwoTone.propTypes = {
