...
const MaterialHearingDisabledSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHearingDisabled = (styled.default || styled)(MaterialHearingDisabledSvg).attrs(p => ({
...
`;
MaterialHearingDisabled.propTypes = {
