...
const MaterialBookOnlineOutlinedSvg = props => (
  <svg
...
const MaterialBookOnlineOutlined = props => <Icon as={MaterialBookOnlineOutlinedSvg} {...props} />

MaterialBookOnlineOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBookOnlineOutlined.propTypes = { ...Icon.propTypes }

export default MaterialBookOnlineOutlined
