...
const MaterialAddAlertSvg = props => (
...
const MaterialAddAlert = props => <Icon as={MaterialAddAlertSvg} {...props} />

MaterialAddAlert.defaultProps = { ...Icon.defaultProps }

MaterialAddAlert.propTypes = { ...Icon.propTypes }

export default MaterialAddAlert
