...
const MaterialBorderBottomSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBorderBottom = (styled.default || styled)(MaterialBorderBottomSvg).attrs(p => ({
...
`;
MaterialBorderBottom.propTypes = {
