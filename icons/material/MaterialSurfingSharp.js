...
const MaterialSurfingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSurfingSharp = (styled.default || styled)(MaterialSurfingSharpSvg).attrs(p => ({
...
`;
MaterialSurfingSharp.propTypes = {
