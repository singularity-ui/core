...
const MaterialAccountBoxTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAccountBoxTwoTone = (styled.default || styled)(MaterialAccountBoxTwoToneSvg).attrs(p => ({
...
`;
MaterialAccountBoxTwoTone.propTypes = {
