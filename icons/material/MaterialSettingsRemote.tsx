...
const MaterialSettingsRemoteSvg = props => (
...
const MaterialSettingsRemote = props => <Icon as={MaterialSettingsRemoteSvg} {...props} />

MaterialSettingsRemote.defaultProps = { ...Icon.defaultProps }

MaterialSettingsRemote.propTypes = { ...Icon.propTypes }

export default MaterialSettingsRemote
