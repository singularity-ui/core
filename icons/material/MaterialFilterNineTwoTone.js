...
const MaterialFilterNineTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFilterNineTwoTone = (styled.default || styled)(MaterialFilterNineTwoToneSvg).attrs(p => ({
...
`;
MaterialFilterNineTwoTone.propTypes = {
