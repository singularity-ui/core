...
const MaterialWhereToVoteOutlinedSvg = props => (
...
const MaterialWhereToVoteOutlined = props => <Icon as={MaterialWhereToVoteOutlinedSvg} {...props} />

MaterialWhereToVoteOutlined.defaultProps = { ...Icon.defaultProps }

MaterialWhereToVoteOutlined.propTypes = { ...Icon.propTypes }
