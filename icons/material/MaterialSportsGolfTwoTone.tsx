...
const MaterialSportsGolfTwoToneSvg = props => (
  <svg
...
const MaterialSportsGolfTwoTone = props => <Icon as={MaterialSportsGolfTwoToneSvg} {...props} />

MaterialSportsGolfTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSportsGolfTwoTone.propTypes = { ...Icon.propTypes }
