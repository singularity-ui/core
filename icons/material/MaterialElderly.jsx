...
const MaterialElderlySvg = props => (
  <svg
...
const MaterialElderly = props => <Icon as={MaterialElderlySvg} {...props} />

MaterialElderly.defaultProps = { ...Icon.defaultProps }

MaterialElderly.propTypes = { ...Icon.propTypes }
