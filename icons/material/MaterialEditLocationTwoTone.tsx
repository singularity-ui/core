...
const MaterialEditLocationTwoToneSvg = props => (
  <svg
...
const MaterialEditLocationTwoTone = props => <Icon as={MaterialEditLocationTwoToneSvg} {...props} />

MaterialEditLocationTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialEditLocationTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialEditLocationTwoTone
