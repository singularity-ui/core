...
const MaterialHealingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHealingTwoTone = (styled.default || styled)(MaterialHealingTwoToneSvg).attrs(p => ({
...
`;
MaterialHealingTwoTone.propTypes = {
