...
const MaterialHeadphonesBatterySvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHeadphonesBattery = (styled.default || styled)(MaterialHeadphonesBatterySvg).attrs(p => ({
...
`;
MaterialHeadphonesBattery.propTypes = {
