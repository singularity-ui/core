...
const MaterialDynamicFeedSvg = props => (
  <svg
...
const MaterialDynamicFeed = props => <Icon as={MaterialDynamicFeedSvg} {...props} />

MaterialDynamicFeed.defaultProps = { ...Icon.defaultProps }

MaterialDynamicFeed.propTypes = { ...Icon.propTypes }
