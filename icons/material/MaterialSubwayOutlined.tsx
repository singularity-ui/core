...
const MaterialSubwayOutlinedSvg = props => (
...
const MaterialSubwayOutlined = props => <Icon as={MaterialSubwayOutlinedSvg} {...props} />

MaterialSubwayOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSubwayOutlined.propTypes = { ...Icon.propTypes }
