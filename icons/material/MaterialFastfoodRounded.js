...
const MaterialFastfoodRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFastfoodRounded = (styled.default || styled)(MaterialFastfoodRoundedSvg).attrs(p => ({
...
`;
MaterialFastfoodRounded.propTypes = {
