...
const MaterialLiveHelpTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLiveHelpTwoTone = (styled.default || styled)(MaterialLiveHelpTwoToneSvg).attrs(p => ({
...
`;
MaterialLiveHelpTwoTone.propTypes = {
