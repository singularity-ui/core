...
const MaterialSetMealRoundedSvg = props => (
  <svg
...
const MaterialSetMealRounded = props => <Icon as={MaterialSetMealRoundedSvg} {...props} />

MaterialSetMealRounded.defaultProps = { ...Icon.defaultProps }

MaterialSetMealRounded.propTypes = { ...Icon.propTypes }
