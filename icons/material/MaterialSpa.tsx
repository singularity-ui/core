...
const MaterialSpa = props => <Icon as={MaterialSpaSvg} {...props} />

MaterialSpa.defaultProps = { ...Icon.defaultProps }

MaterialSpa.propTypes = { ...Icon.propTypes }
