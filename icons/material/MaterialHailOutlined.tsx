...
const MaterialHailOutlinedSvg = props => (
  <svg
...
const MaterialHailOutlined = props => <Icon as={MaterialHailOutlinedSvg} {...props} />

MaterialHailOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHailOutlined.propTypes = { ...Icon.propTypes }
