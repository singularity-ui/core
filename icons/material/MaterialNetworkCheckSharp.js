...
const MaterialNetworkCheckSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNetworkCheckSharp = (styled.default || styled)(MaterialNetworkCheckSharpSvg).attrs(p => ({
...
`;
MaterialNetworkCheckSharp.propTypes = {
