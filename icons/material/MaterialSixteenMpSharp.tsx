...
const MaterialSixteenMpSharpSvg = props => (
  <svg
...
const MaterialSixteenMpSharp = props => <Icon as={MaterialSixteenMpSharpSvg} {...props} />

MaterialSixteenMpSharp.defaultProps = { ...Icon.defaultProps }

MaterialSixteenMpSharp.propTypes = { ...Icon.propTypes }
