...
const MaterialFingerprintOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFingerprintOutlined = (styled.default || styled)(MaterialFingerprintOutlinedSvg).attrs(p => ({
...
`;
MaterialFingerprintOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFingerprintOutlined;