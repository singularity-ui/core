...
const MaterialLooksThreeTwoToneSvg = props => (
...
const MaterialLooksThreeTwoTone = props => <Icon as={MaterialLooksThreeTwoToneSvg} {...props} />

MaterialLooksThreeTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialLooksThreeTwoTone.propTypes = { ...Icon.propTypes }
