...
const MaterialSnowshoeingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSnowshoeingSharp = (styled.default || styled)(MaterialSnowshoeingSharpSvg).attrs(p => ({
...
`;
MaterialSnowshoeingSharp.propTypes = {
