...
const MaterialRepeatRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRepeatRounded = (styled.default || styled)(MaterialRepeatRoundedSvg).attrs(p => ({
...
`;
MaterialRepeatRounded.propTypes = {
