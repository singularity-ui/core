...
const MaterialCabinRoundedSvg = props => (
  <svg
...
const MaterialCabinRounded = props => <Icon as={MaterialCabinRoundedSvg} {...props} />

MaterialCabinRounded.defaultProps = { ...Icon.defaultProps }

MaterialCabinRounded.propTypes = { ...Icon.propTypes }
