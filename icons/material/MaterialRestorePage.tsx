...
const MaterialRestorePageSvg = props => (
...
const MaterialRestorePage = props => <Icon as={MaterialRestorePageSvg} {...props} />

MaterialRestorePage.defaultProps = { ...Icon.defaultProps }

MaterialRestorePage.propTypes = { ...Icon.propTypes }

export default MaterialRestorePage
