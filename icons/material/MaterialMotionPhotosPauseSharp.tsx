...
const MaterialMotionPhotosPauseSharpSvg = props => (
  <svg
...
const MaterialMotionPhotosPauseSharp = props => <Icon as={MaterialMotionPhotosPauseSharpSvg} {...props} />

MaterialMotionPhotosPauseSharp.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosPauseSharp.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosPauseSharp
