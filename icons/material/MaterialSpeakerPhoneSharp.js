...
const MaterialSpeakerPhoneSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSpeakerPhoneSharp = (styled.default || styled)(MaterialSpeakerPhoneSharpSvg).attrs(p => ({
...
`;
MaterialSpeakerPhoneSharp.propTypes = {
