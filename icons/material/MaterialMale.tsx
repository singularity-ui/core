...
const MaterialMale = props => <Icon as={MaterialMaleSvg} {...props} />

MaterialMale.defaultProps = { ...Icon.defaultProps }

MaterialMale.propTypes = { ...Icon.propTypes }

export default MaterialMale
