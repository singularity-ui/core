...
const MaterialElectricBikeSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElectricBikeSharp = (styled.default || styled)(MaterialElectricBikeSharpSvg).attrs(p => ({
...
`;
MaterialElectricBikeSharp.propTypes = {
