...
const MaterialExposureSvg = props => (
...
const MaterialExposure = props => <Icon as={MaterialExposureSvg} {...props} />

MaterialExposure.defaultProps = { ...Icon.defaultProps }

MaterialExposure.propTypes = { ...Icon.propTypes }

export default MaterialExposure
