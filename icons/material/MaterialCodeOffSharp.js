...
const MaterialCodeOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCodeOffSharp = (styled.default || styled)(MaterialCodeOffSharpSvg).attrs(p => ({
...
`;
MaterialCodeOffSharp.propTypes = {
