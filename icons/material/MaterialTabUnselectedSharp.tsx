...
const MaterialTabUnselectedSharpSvg = props => (
...
const MaterialTabUnselectedSharp = props => <Icon as={MaterialTabUnselectedSharpSvg} {...props} />

MaterialTabUnselectedSharp.defaultProps = { ...Icon.defaultProps }

MaterialTabUnselectedSharp.propTypes = { ...Icon.propTypes }
