...
const MaterialPersonSearchRoundedSvg = props => (
  <svg
...
const MaterialPersonSearchRounded = props => <Icon as={MaterialPersonSearchRoundedSvg} {...props} />

MaterialPersonSearchRounded.defaultProps = { ...Icon.defaultProps }

MaterialPersonSearchRounded.propTypes = { ...Icon.propTypes }

export default MaterialPersonSearchRounded
