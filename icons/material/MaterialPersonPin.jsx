...
const MaterialPersonPinSvg = props => (
...
const MaterialPersonPin = props => <Icon as={MaterialPersonPinSvg} {...props} />

MaterialPersonPin.defaultProps = { ...Icon.defaultProps }

MaterialPersonPin.propTypes = { ...Icon.propTypes }

export default MaterialPersonPin
