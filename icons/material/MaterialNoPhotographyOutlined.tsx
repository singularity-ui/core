...
const MaterialNoPhotographyOutlinedSvg = props => (
  <svg
...
const MaterialNoPhotographyOutlined = props => <Icon as={MaterialNoPhotographyOutlinedSvg} {...props} />

MaterialNoPhotographyOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNoPhotographyOutlined.propTypes = { ...Icon.propTypes }
