...
const MaterialReplayThirtySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayThirtySharp = (styled.default || styled)(MaterialReplayThirtySharpSvg).attrs(p => ({
...
`;
MaterialReplayThirtySharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialReplayThirtySharp;