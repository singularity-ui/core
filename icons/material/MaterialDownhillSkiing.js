...
const MaterialDownhillSkiingSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDownhillSkiing = (styled.default || styled)(MaterialDownhillSkiingSvg).attrs(p => ({
...
`;
MaterialDownhillSkiing.propTypes = {
