...
const MaterialTimerTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerTwoTone = (styled.default || styled)(MaterialTimerTwoToneSvg).attrs(p => ({
...
`;
MaterialTimerTwoTone.propTypes = {
