...
const MaterialChalet = props => <Icon as={MaterialChaletSvg} {...props} />

MaterialChalet.defaultProps = { ...Icon.defaultProps }

MaterialChalet.propTypes = { ...Icon.propTypes }

export default MaterialChalet
