...
const MaterialOfflinePinRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOfflinePinRounded = (styled.default || styled)(MaterialOfflinePinRoundedSvg).attrs(p => ({
...
`;
MaterialOfflinePinRounded.propTypes = {
