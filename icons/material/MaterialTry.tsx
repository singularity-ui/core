...
const MaterialTry = props => <Icon as={MaterialTrySvg} {...props} />

MaterialTry.defaultProps = { ...Icon.defaultProps }

MaterialTry.propTypes = { ...Icon.propTypes }

export default MaterialTry
