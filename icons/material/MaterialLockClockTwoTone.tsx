...
const MaterialLockClockTwoToneSvg = props => (
  <svg
...
const MaterialLockClockTwoTone = props => <Icon as={MaterialLockClockTwoToneSvg} {...props} />

MaterialLockClockTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialLockClockTwoTone.propTypes = { ...Icon.propTypes }
