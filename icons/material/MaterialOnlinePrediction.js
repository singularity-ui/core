...
const MaterialOnlinePredictionSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOnlinePrediction = (styled.default || styled)(MaterialOnlinePredictionSvg).attrs(p => ({
...
`;
MaterialOnlinePrediction.propTypes = {
