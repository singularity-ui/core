...
const MaterialSportsBaseballSharpSvg = props => (
  <svg
...
const MaterialSportsBaseballSharp = props => <Icon as={MaterialSportsBaseballSharpSvg} {...props} />

MaterialSportsBaseballSharp.defaultProps = { ...Icon.defaultProps }

MaterialSportsBaseballSharp.propTypes = { ...Icon.propTypes }

export default MaterialSportsBaseballSharp
