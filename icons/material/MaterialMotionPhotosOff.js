...
const MaterialMotionPhotosOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMotionPhotosOff = (styled.default || styled)(MaterialMotionPhotosOffSvg).attrs(p => ({
...
`;
MaterialMotionPhotosOff.propTypes = {
