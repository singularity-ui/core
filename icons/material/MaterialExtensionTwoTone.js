...
const MaterialExtensionTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialExtensionTwoTone = (styled.default || styled)(MaterialExtensionTwoToneSvg).attrs(p => ({
...
`;
MaterialExtensionTwoTone.propTypes = {
