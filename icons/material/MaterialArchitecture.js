...
const MaterialArchitectureSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialArchitecture = (styled.default || styled)(MaterialArchitectureSvg).attrs(p => ({
...
`;
MaterialArchitecture.propTypes = {
