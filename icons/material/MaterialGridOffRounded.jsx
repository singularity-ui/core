...
const MaterialGridOffRoundedSvg = props => (
...
const MaterialGridOffRounded = props => <Icon as={MaterialGridOffRoundedSvg} {...props} />

MaterialGridOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialGridOffRounded.propTypes = { ...Icon.propTypes }
