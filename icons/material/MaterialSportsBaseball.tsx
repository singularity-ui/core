...
const MaterialSportsBaseballSvg = props => (
  <svg
...
const MaterialSportsBaseball = props => <Icon as={MaterialSportsBaseballSvg} {...props} />

MaterialSportsBaseball.defaultProps = { ...Icon.defaultProps }

MaterialSportsBaseball.propTypes = { ...Icon.propTypes }

export default MaterialSportsBaseball
