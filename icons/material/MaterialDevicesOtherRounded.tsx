...
const MaterialDevicesOtherRoundedSvg = props => (
...
const MaterialDevicesOtherRounded = props => <Icon as={MaterialDevicesOtherRoundedSvg} {...props} />

MaterialDevicesOtherRounded.defaultProps = { ...Icon.defaultProps }

MaterialDevicesOtherRounded.propTypes = { ...Icon.propTypes }

export default MaterialDevicesOtherRounded
