...
const MaterialOpacitySharpSvg = props => (
...
const MaterialOpacitySharp = props => <Icon as={MaterialOpacitySharpSvg} {...props} />

MaterialOpacitySharp.defaultProps = { ...Icon.defaultProps }

MaterialOpacitySharp.propTypes = { ...Icon.propTypes }

export default MaterialOpacitySharp
