...
const MaterialElevatorRoundedSvg = props => (
  <svg
...
const MaterialElevatorRounded = props => <Icon as={MaterialElevatorRoundedSvg} {...props} />

MaterialElevatorRounded.defaultProps = { ...Icon.defaultProps }

MaterialElevatorRounded.propTypes = { ...Icon.propTypes }

export default MaterialElevatorRounded
