...
const MaterialGradeRoundedSvg = props => (
...
const MaterialGradeRounded = props => <Icon as={MaterialGradeRoundedSvg} {...props} />

MaterialGradeRounded.defaultProps = { ...Icon.defaultProps }

MaterialGradeRounded.propTypes = { ...Icon.propTypes }
