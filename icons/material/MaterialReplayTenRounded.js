...
const MaterialReplayTenRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayTenRounded = (styled.default || styled)(MaterialReplayTenRoundedSvg).attrs(p => ({
...
`;
MaterialReplayTenRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialReplayTenRounded;