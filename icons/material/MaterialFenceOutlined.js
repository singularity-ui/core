...
const MaterialFenceOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFenceOutlined = (styled.default || styled)(MaterialFenceOutlinedSvg).attrs(p => ({
...
`;
MaterialFenceOutlined.propTypes = {
