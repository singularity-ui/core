...
const MaterialTipsAndUpdatesTwoToneSvg = props => (
  <svg
...
const MaterialTipsAndUpdatesTwoTone = props => <Icon as={MaterialTipsAndUpdatesTwoToneSvg} {...props} />

MaterialTipsAndUpdatesTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialTipsAndUpdatesTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialTipsAndUpdatesTwoTone
