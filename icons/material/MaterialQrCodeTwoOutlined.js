...
const MaterialQrCodeTwoOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialQrCodeTwoOutlined = (styled.default || styled)(MaterialQrCodeTwoOutlinedSvg).attrs(p => ({
...
`;
MaterialQrCodeTwoOutlined.propTypes = {
