...
const MaterialFollowTheSignsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFollowTheSigns = (styled.default || styled)(MaterialFollowTheSignsSvg).attrs(p => ({
...
`;
MaterialFollowTheSigns.propTypes = {
