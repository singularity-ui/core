...
const MaterialNetworkLockedRoundedSvg = props => (
  <svg
...
const MaterialNetworkLockedRounded = props => <Icon as={MaterialNetworkLockedRoundedSvg} {...props} />

MaterialNetworkLockedRounded.defaultProps = { ...Icon.defaultProps }

MaterialNetworkLockedRounded.propTypes = { ...Icon.propTypes }
