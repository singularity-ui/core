...
const MaterialRunCircleTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRunCircleTwoTone = (styled.default || styled)(MaterialRunCircleTwoToneSvg).attrs(p => ({
...
`;
MaterialRunCircleTwoTone.propTypes = {
