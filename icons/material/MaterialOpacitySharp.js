...
const MaterialOpacitySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOpacitySharp = (styled.default || styled)(MaterialOpacitySharpSvg).attrs(p => ({
...
`;
MaterialOpacitySharp.propTypes = {
