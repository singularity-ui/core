...
const MaterialInventoryOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialInventoryOutlined = (styled.default || styled)(MaterialInventoryOutlinedSvg).attrs(p => ({
...
`;
MaterialInventoryOutlined.propTypes = {
