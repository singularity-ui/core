...
const MaterialContactlessSharpSvg = props => (
  <svg
...
const MaterialContactlessSharp = props => <Icon as={MaterialContactlessSharpSvg} {...props} />

MaterialContactlessSharp.defaultProps = { ...Icon.defaultProps }

MaterialContactlessSharp.propTypes = { ...Icon.propTypes }
