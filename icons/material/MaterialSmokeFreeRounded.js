...
const MaterialSmokeFreeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSmokeFreeRounded = (styled.default || styled)(MaterialSmokeFreeRoundedSvg).attrs(p => ({
...
`;
MaterialSmokeFreeRounded.propTypes = {
