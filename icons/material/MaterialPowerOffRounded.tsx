...
const MaterialPowerOffRoundedSvg = props => (
...
const MaterialPowerOffRounded = props => <Icon as={MaterialPowerOffRoundedSvg} {...props} />

MaterialPowerOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialPowerOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialPowerOffRounded
