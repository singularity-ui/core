...
const MaterialDesignServicesSvg = props => (
  <svg
...
const MaterialDesignServices = props => <Icon as={MaterialDesignServicesSvg} {...props} />

MaterialDesignServices.defaultProps = { ...Icon.defaultProps }

MaterialDesignServices.propTypes = { ...Icon.propTypes }

export default MaterialDesignServices
