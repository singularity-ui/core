...
const MaterialCoronavirusOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCoronavirusOutlined = (styled.default || styled)(MaterialCoronavirusOutlinedSvg).attrs(p => ({
...
`;
MaterialCoronavirusOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialCoronavirusOutlined;