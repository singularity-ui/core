...
const MaterialTheaterComedySvg = props => (
  <svg
...
const MaterialTheaterComedy = props => <Icon as={MaterialTheaterComedySvg} {...props} />

MaterialTheaterComedy.defaultProps = { ...Icon.defaultProps }

MaterialTheaterComedy.propTypes = { ...Icon.propTypes }
