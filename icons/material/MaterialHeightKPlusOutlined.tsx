...
const MaterialHeightKPlusOutlinedSvg = props => (
  <svg
...
const MaterialHeightKPlusOutlined = props => <Icon as={MaterialHeightKPlusOutlinedSvg} {...props} />

MaterialHeightKPlusOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHeightKPlusOutlined.propTypes = { ...Icon.propTypes }

export default MaterialHeightKPlusOutlined
