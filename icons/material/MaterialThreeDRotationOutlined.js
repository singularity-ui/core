...
const MaterialThreeDRotationOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThreeDRotationOutlined = (styled.default || styled)(MaterialThreeDRotationOutlinedSvg).attrs(p => ({
...
`;
MaterialThreeDRotationOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialThreeDRotationOutlined;