...
const MaterialRamenDiningOutlinedSvg = props => (
  <svg
...
const MaterialRamenDiningOutlined = props => <Icon as={MaterialRamenDiningOutlinedSvg} {...props} />

MaterialRamenDiningOutlined.defaultProps = { ...Icon.defaultProps }

MaterialRamenDiningOutlined.propTypes = { ...Icon.propTypes }
