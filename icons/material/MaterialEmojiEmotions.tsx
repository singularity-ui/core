...
const MaterialEmojiEmotionsSvg = props => (
  <svg
...
const MaterialEmojiEmotions = props => <Icon as={MaterialEmojiEmotionsSvg} {...props} />

MaterialEmojiEmotions.defaultProps = { ...Icon.defaultProps }

MaterialEmojiEmotions.propTypes = { ...Icon.propTypes }

export default MaterialEmojiEmotions
