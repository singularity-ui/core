...
const MaterialVideoCallRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVideoCallRounded = (styled.default || styled)(MaterialVideoCallRoundedSvg).attrs(p => ({
...
`;
MaterialVideoCallRounded.propTypes = {
