...
const MaterialDirectionsTransitFilledRoundedSvg = props => (
  <svg
...
const MaterialDirectionsTransitFilledRounded = props => (
  <Icon as={MaterialDirectionsTransitFilledRoundedSvg} {...props} />
)

MaterialDirectionsTransitFilledRounded.defaultProps = { ...Icon.defaultProps }

MaterialDirectionsTransitFilledRounded.propTypes = { ...Icon.propTypes }
