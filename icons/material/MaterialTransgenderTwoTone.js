...
const MaterialTransgenderTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTransgenderTwoTone = (styled.default || styled)(MaterialTransgenderTwoToneSvg).attrs(p => ({
...
`;
MaterialTransgenderTwoTone.propTypes = {
