...
const MaterialCrib = props => <Icon as={MaterialCribSvg} {...props} />

MaterialCrib.defaultProps = { ...Icon.defaultProps }

MaterialCrib.propTypes = { ...Icon.propTypes }
