...
const MaterialPersonSearchSvg = props => (
  <svg
...
const MaterialPersonSearch = props => <Icon as={MaterialPersonSearchSvg} {...props} />

MaterialPersonSearch.defaultProps = { ...Icon.defaultProps }

MaterialPersonSearch.propTypes = { ...Icon.propTypes }

export default MaterialPersonSearch
