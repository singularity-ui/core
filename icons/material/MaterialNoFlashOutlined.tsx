...
const MaterialNoFlashOutlinedSvg = props => (
  <svg
...
const MaterialNoFlashOutlined = props => <Icon as={MaterialNoFlashOutlinedSvg} {...props} />

MaterialNoFlashOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNoFlashOutlined.propTypes = { ...Icon.propTypes }
