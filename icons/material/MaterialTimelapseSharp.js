...
const MaterialTimelapseSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimelapseSharp = (styled.default || styled)(MaterialTimelapseSharpSvg).attrs(p => ({
...
`;
MaterialTimelapseSharp.propTypes = {
