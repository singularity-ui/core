...
const MaterialRoundedCornerSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRoundedCornerSharp = (styled.default || styled)(MaterialRoundedCornerSharpSvg).attrs(p => ({
...
`;
MaterialRoundedCornerSharp.propTypes = {
