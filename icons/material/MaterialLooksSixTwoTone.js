...
const MaterialLooksSixTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLooksSixTwoTone = (styled.default || styled)(MaterialLooksSixTwoToneSvg).attrs(p => ({
...
`;
MaterialLooksSixTwoTone.propTypes = {
