...
const MaterialSpeedOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSpeedOutlined = (styled.default || styled)(MaterialSpeedOutlinedSvg).attrs(p => ({
...
`;
MaterialSpeedOutlined.propTypes = {
