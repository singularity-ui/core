...
const MaterialDoNotStepOutlinedSvg = props => (
  <svg
...
const MaterialDoNotStepOutlined = props => <Icon as={MaterialDoNotStepOutlinedSvg} {...props} />

MaterialDoNotStepOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDoNotStepOutlined.propTypes = { ...Icon.propTypes }
