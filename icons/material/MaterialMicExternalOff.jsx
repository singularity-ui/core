...
const MaterialMicExternalOffSvg = props => (
...
const MaterialMicExternalOff = props => <Icon as={MaterialMicExternalOffSvg} {...props} />

MaterialMicExternalOff.defaultProps = { ...Icon.defaultProps }

MaterialMicExternalOff.propTypes = { ...Icon.propTypes }
