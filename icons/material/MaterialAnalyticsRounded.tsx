...
const MaterialAnalyticsRoundedSvg = props => (
  <svg
...
const MaterialAnalyticsRounded = props => <Icon as={MaterialAnalyticsRoundedSvg} {...props} />

MaterialAnalyticsRounded.defaultProps = { ...Icon.defaultProps }

MaterialAnalyticsRounded.propTypes = { ...Icon.propTypes }
