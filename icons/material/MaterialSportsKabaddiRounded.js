...
const MaterialSportsKabaddiRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsKabaddiRounded = (styled.default || styled)(MaterialSportsKabaddiRoundedSvg).attrs(p => ({
...
`;
MaterialSportsKabaddiRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSportsKabaddiRounded;