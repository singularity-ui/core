...
const MaterialRadarRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRadarRounded = (styled.default || styled)(MaterialRadarRoundedSvg).attrs(p => ({
...
`;
MaterialRadarRounded.propTypes = {
