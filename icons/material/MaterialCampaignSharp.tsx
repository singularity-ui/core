...
const MaterialCampaignSharpSvg = props => (
  <svg
...
const MaterialCampaignSharp = props => <Icon as={MaterialCampaignSharpSvg} {...props} />

MaterialCampaignSharp.defaultProps = { ...Icon.defaultProps }

MaterialCampaignSharp.propTypes = { ...Icon.propTypes }

export default MaterialCampaignSharp
