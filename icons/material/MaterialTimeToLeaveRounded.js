...
const MaterialTimeToLeaveRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimeToLeaveRounded = (styled.default || styled)(MaterialTimeToLeaveRoundedSvg).attrs(p => ({
...
`;
MaterialTimeToLeaveRounded.propTypes = {
