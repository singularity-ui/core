...
const MaterialOutdoorGrillSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialOutdoorGrill = (styled.default || styled)(MaterialOutdoorGrillSvg).attrs(p => ({
...
`;
MaterialOutdoorGrill.propTypes = {
