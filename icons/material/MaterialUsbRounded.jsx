...
const MaterialUsbRoundedSvg = props => (
...
const MaterialUsbRounded = props => <Icon as={MaterialUsbRoundedSvg} {...props} />

MaterialUsbRounded.defaultProps = { ...Icon.defaultProps }

MaterialUsbRounded.propTypes = { ...Icon.propTypes }

export default MaterialUsbRounded
