...
const MaterialBorderVerticalSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBorderVertical = (styled.default || styled)(MaterialBorderVerticalSvg).attrs(p => ({
...
`;
MaterialBorderVertical.propTypes = {
