...
const MaterialSportsBarRoundedSvg = props => (
  <svg
...
const MaterialSportsBarRounded = props => <Icon as={MaterialSportsBarRoundedSvg} {...props} />

MaterialSportsBarRounded.defaultProps = { ...Icon.defaultProps }

MaterialSportsBarRounded.propTypes = { ...Icon.propTypes }
