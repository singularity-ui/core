...
const MaterialWheelchairPickupSvg = props => (
  <svg
...
const MaterialWheelchairPickup = props => <Icon as={MaterialWheelchairPickupSvg} {...props} />

MaterialWheelchairPickup.defaultProps = { ...Icon.defaultProps }

MaterialWheelchairPickup.propTypes = { ...Icon.propTypes }

export default MaterialWheelchairPickup
