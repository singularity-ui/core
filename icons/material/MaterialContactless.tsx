...
const MaterialContactlessSvg = props => (
  <svg
...
const MaterialContactless = props => <Icon as={MaterialContactlessSvg} {...props} />

MaterialContactless.defaultProps = { ...Icon.defaultProps }

MaterialContactless.propTypes = { ...Icon.propTypes }

export default MaterialContactless
