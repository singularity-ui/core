...
const MaterialQueueRoundedSvg = props => (
...
const MaterialQueueRounded = props => <Icon as={MaterialQueueRoundedSvg} {...props} />

MaterialQueueRounded.defaultProps = { ...Icon.defaultProps }

MaterialQueueRounded.propTypes = { ...Icon.propTypes }
