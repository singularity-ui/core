...
const MaterialHdrOnRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHdrOnRounded = (styled.default || styled)(MaterialHdrOnRoundedSvg).attrs(p => ({
...
`;
MaterialHdrOnRounded.propTypes = {
