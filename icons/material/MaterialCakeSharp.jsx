...
const MaterialCakeSharpSvg = props => (
...
const MaterialCakeSharp = props => <Icon as={MaterialCakeSharpSvg} {...props} />

MaterialCakeSharp.defaultProps = { ...Icon.defaultProps }

MaterialCakeSharp.propTypes = { ...Icon.propTypes }

export default MaterialCakeSharp
