...
const MaterialLocalActivitySvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalActivity = (styled.default || styled)(MaterialLocalActivitySvg).attrs(p => ({
...
`;
MaterialLocalActivity.propTypes = {
