...
const MaterialSearchOffRoundedSvg = props => (
  <svg
...
const MaterialSearchOffRounded = props => <Icon as={MaterialSearchOffRoundedSvg} {...props} />

MaterialSearchOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialSearchOffRounded.propTypes = { ...Icon.propTypes }
