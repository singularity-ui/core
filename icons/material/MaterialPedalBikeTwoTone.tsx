...
const MaterialPedalBikeTwoToneSvg = props => (
  <svg
...
const MaterialPedalBikeTwoTone = props => <Icon as={MaterialPedalBikeTwoToneSvg} {...props} />

MaterialPedalBikeTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPedalBikeTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPedalBikeTwoTone
