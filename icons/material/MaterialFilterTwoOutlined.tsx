...
const MaterialFilterTwoOutlinedSvg = props => (
...
const MaterialFilterTwoOutlined = props => <Icon as={MaterialFilterTwoOutlinedSvg} {...props} />

MaterialFilterTwoOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFilterTwoOutlined.propTypes = { ...Icon.propTypes }
