...
const MaterialMediationRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMediationRounded = (styled.default || styled)(MaterialMediationRoundedSvg).attrs(p => ({
...
`;
MaterialMediationRounded.propTypes = {
