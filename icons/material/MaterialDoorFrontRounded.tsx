...
const MaterialDoorFrontRoundedSvg = props => (
  <svg
...
const MaterialDoorFrontRounded = props => <Icon as={MaterialDoorFrontRoundedSvg} {...props} />

MaterialDoorFrontRounded.defaultProps = { ...Icon.defaultProps }

MaterialDoorFrontRounded.propTypes = { ...Icon.propTypes }
