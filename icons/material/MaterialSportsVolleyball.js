...
const MaterialSportsVolleyballSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsVolleyball = (styled.default || styled)(MaterialSportsVolleyballSvg).attrs(p => ({
...
`;
MaterialSportsVolleyball.propTypes = {
