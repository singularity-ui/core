...
const MaterialContactsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialContactsRounded = (styled.default || styled)(MaterialContactsRoundedSvg).attrs(p => ({
...
`;
MaterialContactsRounded.propTypes = {
