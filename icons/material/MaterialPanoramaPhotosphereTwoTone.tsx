...
const MaterialPanoramaPhotosphereTwoToneSvg = props => (
  <svg
...
const MaterialPanoramaPhotosphereTwoTone = props => <Icon as={MaterialPanoramaPhotosphereTwoToneSvg} {...props} />

MaterialPanoramaPhotosphereTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPanoramaPhotosphereTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPanoramaPhotosphereTwoTone
