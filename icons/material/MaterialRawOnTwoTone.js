...
const MaterialRawOnTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRawOnTwoTone = (styled.default || styled)(MaterialRawOnTwoToneSvg).attrs(p => ({
...
`;
MaterialRawOnTwoTone.propTypes = {
