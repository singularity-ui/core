...
const MaterialAttachMoneyTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttachMoneyTwoTone = (styled.default || styled)(MaterialAttachMoneyTwoToneSvg).attrs(p => ({
...
`;
MaterialAttachMoneyTwoTone.propTypes = {
