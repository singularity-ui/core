...
const MaterialRvHookupRoundedSvg = props => (
...
const MaterialRvHookupRounded = props => <Icon as={MaterialRvHookupRoundedSvg} {...props} />

MaterialRvHookupRounded.defaultProps = { ...Icon.defaultProps }

MaterialRvHookupRounded.propTypes = { ...Icon.propTypes }
