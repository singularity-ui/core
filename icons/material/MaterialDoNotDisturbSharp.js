...
const MaterialDoNotDisturbSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoNotDisturbSharp = (styled.default || styled)(MaterialDoNotDisturbSharpSvg).attrs(p => ({
...
`;
MaterialDoNotDisturbSharp.propTypes = {
