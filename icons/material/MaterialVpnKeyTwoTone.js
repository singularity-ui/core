...
const MaterialVpnKeyTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVpnKeyTwoTone = (styled.default || styled)(MaterialVpnKeyTwoToneSvg).attrs(p => ({
...
`;
MaterialVpnKeyTwoTone.propTypes = {
