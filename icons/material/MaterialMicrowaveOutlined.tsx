...
const MaterialMicrowaveOutlinedSvg = props => (
  <svg
...
const MaterialMicrowaveOutlined = props => <Icon as={MaterialMicrowaveOutlinedSvg} {...props} />

MaterialMicrowaveOutlined.defaultProps = { ...Icon.defaultProps }

MaterialMicrowaveOutlined.propTypes = { ...Icon.propTypes }

export default MaterialMicrowaveOutlined
