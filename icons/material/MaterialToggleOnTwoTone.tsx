...
const MaterialToggleOnTwoToneSvg = props => (
...
const MaterialToggleOnTwoTone = props => <Icon as={MaterialToggleOnTwoToneSvg} {...props} />

MaterialToggleOnTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialToggleOnTwoTone.propTypes = { ...Icon.propTypes }
