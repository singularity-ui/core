...
const MaterialReceiptTwoToneSvg = props => (
...
const MaterialReceiptTwoTone = props => <Icon as={MaterialReceiptTwoToneSvg} {...props} />

MaterialReceiptTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialReceiptTwoTone.propTypes = { ...Icon.propTypes }
