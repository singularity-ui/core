...
const MaterialLinearScaleRoundedSvg = props => (
  <svg
...
const MaterialLinearScaleRounded = props => <Icon as={MaterialLinearScaleRoundedSvg} {...props} />

MaterialLinearScaleRounded.defaultProps = { ...Icon.defaultProps }

MaterialLinearScaleRounded.propTypes = { ...Icon.propTypes }
