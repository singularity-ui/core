...
const MaterialSportsBarTwoToneSvg = props => (
  <svg
...
const MaterialSportsBarTwoTone = props => <Icon as={MaterialSportsBarTwoToneSvg} {...props} />

MaterialSportsBarTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSportsBarTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSportsBarTwoTone
