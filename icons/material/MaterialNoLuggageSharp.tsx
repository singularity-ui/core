...
const MaterialNoLuggageSharpSvg = props => (
  <svg
...
const MaterialNoLuggageSharp = props => <Icon as={MaterialNoLuggageSharpSvg} {...props} />

MaterialNoLuggageSharp.defaultProps = { ...Icon.defaultProps }

MaterialNoLuggageSharp.propTypes = { ...Icon.propTypes }
