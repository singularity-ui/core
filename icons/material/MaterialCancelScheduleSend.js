...
const MaterialCancelScheduleSendSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCancelScheduleSend = (styled.default || styled)(MaterialCancelScheduleSendSvg).attrs(p => ({
...
`;
MaterialCancelScheduleSend.propTypes = {
