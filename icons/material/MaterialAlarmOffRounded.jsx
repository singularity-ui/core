...
const MaterialAlarmOffRoundedSvg = props => (
...
const MaterialAlarmOffRounded = props => <Icon as={MaterialAlarmOffRoundedSvg} {...props} />

MaterialAlarmOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialAlarmOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialAlarmOffRounded
