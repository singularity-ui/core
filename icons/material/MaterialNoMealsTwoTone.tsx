...
const MaterialNoMealsTwoToneSvg = props => (
  <svg
...
const MaterialNoMealsTwoTone = props => <Icon as={MaterialNoMealsTwoToneSvg} {...props} />

MaterialNoMealsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialNoMealsTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialNoMealsTwoTone
