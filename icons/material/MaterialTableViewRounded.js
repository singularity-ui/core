...
const MaterialTableViewRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTableViewRounded = (styled.default || styled)(MaterialTableViewRoundedSvg).attrs(p => ({
...
`;
MaterialTableViewRounded.propTypes = {
