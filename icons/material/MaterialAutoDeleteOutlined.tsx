...
const MaterialAutoDeleteOutlinedSvg = props => (
  <svg
...
const MaterialAutoDeleteOutlined = props => <Icon as={MaterialAutoDeleteOutlinedSvg} {...props} />

MaterialAutoDeleteOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAutoDeleteOutlined.propTypes = { ...Icon.propTypes }
