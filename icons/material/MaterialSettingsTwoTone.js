...
const MaterialSettingsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSettingsTwoTone = (styled.default || styled)(MaterialSettingsTwoToneSvg).attrs(p => ({
...
`;
MaterialSettingsTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSettingsTwoTone;