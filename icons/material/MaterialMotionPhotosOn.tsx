...
const MaterialMotionPhotosOnSvg = props => (
  <svg
...
const MaterialMotionPhotosOn = props => <Icon as={MaterialMotionPhotosOnSvg} {...props} />

MaterialMotionPhotosOn.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosOn.propTypes = { ...Icon.propTypes }

export default MaterialMotionPhotosOn
