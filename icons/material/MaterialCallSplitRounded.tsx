...
const MaterialCallSplitRoundedSvg = props => (
...
const MaterialCallSplitRounded = props => <Icon as={MaterialCallSplitRoundedSvg} {...props} />

MaterialCallSplitRounded.defaultProps = { ...Icon.defaultProps }

MaterialCallSplitRounded.propTypes = { ...Icon.propTypes }

export default MaterialCallSplitRounded
