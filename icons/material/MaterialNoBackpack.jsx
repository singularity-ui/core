...
const MaterialNoBackpackSvg = props => (
  <svg
...
const MaterialNoBackpack = props => <Icon as={MaterialNoBackpackSvg} {...props} />

MaterialNoBackpack.defaultProps = { ...Icon.defaultProps }

MaterialNoBackpack.propTypes = { ...Icon.propTypes }
