...
const MaterialMenuOpenRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMenuOpenRounded = (styled.default || styled)(MaterialMenuOpenRoundedSvg).attrs(p => ({
...
`;
MaterialMenuOpenRounded.propTypes = {
