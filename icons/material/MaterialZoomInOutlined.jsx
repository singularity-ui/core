...
const MaterialZoomInOutlinedSvg = props => (
...
const MaterialZoomInOutlined = props => <Icon as={MaterialZoomInOutlinedSvg} {...props} />

MaterialZoomInOutlined.defaultProps = { ...Icon.defaultProps }

MaterialZoomInOutlined.propTypes = { ...Icon.propTypes }

export default MaterialZoomInOutlined
