...
const MaterialPartyModeSvg = props => (
...
const MaterialPartyMode = props => <Icon as={MaterialPartyModeSvg} {...props} />

MaterialPartyMode.defaultProps = { ...Icon.defaultProps }

MaterialPartyMode.propTypes = { ...Icon.propTypes }

export default MaterialPartyMode
