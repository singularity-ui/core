...
const MaterialHeadsetOffSvg = props => (
...
const MaterialHeadsetOff = props => <Icon as={MaterialHeadsetOffSvg} {...props} />

MaterialHeadsetOff.defaultProps = { ...Icon.defaultProps }

MaterialHeadsetOff.propTypes = { ...Icon.propTypes }

export default MaterialHeadsetOff
