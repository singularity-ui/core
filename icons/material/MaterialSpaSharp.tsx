...
const MaterialSpaSharpSvg = props => (
...
const MaterialSpaSharp = props => <Icon as={MaterialSpaSharpSvg} {...props} />

MaterialSpaSharp.defaultProps = { ...Icon.defaultProps }

MaterialSpaSharp.propTypes = { ...Icon.propTypes }

export default MaterialSpaSharp
