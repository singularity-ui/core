...
const MaterialBorderLeftSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBorderLeftSharp = (styled.default || styled)(MaterialBorderLeftSharpSvg).attrs(p => ({
...
`;
MaterialBorderLeftSharp.propTypes = {
