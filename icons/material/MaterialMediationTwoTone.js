...
const MaterialMediationTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMediationTwoTone = (styled.default || styled)(MaterialMediationTwoToneSvg).attrs(p => ({
...
`;
MaterialMediationTwoTone.propTypes = {
