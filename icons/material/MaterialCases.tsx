...
const MaterialCases = props => <Icon as={MaterialCasesSvg} {...props} />

MaterialCases.defaultProps = { ...Icon.defaultProps }

MaterialCases.propTypes = { ...Icon.propTypes }
