...
const MaterialFlightRoundedSvg = props => (
...
const MaterialFlightRounded = props => <Icon as={MaterialFlightRoundedSvg} {...props} />

MaterialFlightRounded.defaultProps = { ...Icon.defaultProps }

MaterialFlightRounded.propTypes = { ...Icon.propTypes }
