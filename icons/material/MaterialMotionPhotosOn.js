...
const MaterialMotionPhotosOnSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMotionPhotosOn = (styled.default || styled)(MaterialMotionPhotosOnSvg).attrs(p => ({
...
`;
MaterialMotionPhotosOn.propTypes = {
