...
const MaterialPinRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPinRounded = (styled.default || styled)(MaterialPinRoundedSvg).attrs(p => ({
...
`;
MaterialPinRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialPinRounded;