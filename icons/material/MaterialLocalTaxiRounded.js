...
const MaterialLocalTaxiRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalTaxiRounded = (styled.default || styled)(MaterialLocalTaxiRoundedSvg).attrs(p => ({
...
`;
MaterialLocalTaxiRounded.propTypes = {
