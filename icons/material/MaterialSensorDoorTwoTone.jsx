...
const MaterialSensorDoorTwoToneSvg = props => (
  <svg
...
const MaterialSensorDoorTwoTone = props => <Icon as={MaterialSensorDoorTwoToneSvg} {...props} />

MaterialSensorDoorTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSensorDoorTwoTone.propTypes = { ...Icon.propTypes }
