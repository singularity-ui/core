...
const MaterialDoNotDisturbOffSvg = props => (
...
const MaterialDoNotDisturbOff = props => <Icon as={MaterialDoNotDisturbOffSvg} {...props} />

MaterialDoNotDisturbOff.defaultProps = { ...Icon.defaultProps }

MaterialDoNotDisturbOff.propTypes = { ...Icon.propTypes }

export default MaterialDoNotDisturbOff
