...
const MaterialSurfingRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSurfingRounded = (styled.default || styled)(MaterialSurfingRoundedSvg).attrs(p => ({
...
`;
MaterialSurfingRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSurfingRounded;