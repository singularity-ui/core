...
const MaterialPlaylistPlayRoundedSvg = props => (
...
const MaterialPlaylistPlayRounded = props => <Icon as={MaterialPlaylistPlayRoundedSvg} {...props} />

MaterialPlaylistPlayRounded.defaultProps = { ...Icon.defaultProps }

MaterialPlaylistPlayRounded.propTypes = { ...Icon.propTypes }
