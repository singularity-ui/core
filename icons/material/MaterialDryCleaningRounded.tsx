...
const MaterialDryCleaningRoundedSvg = props => (
  <svg
...
const MaterialDryCleaningRounded = props => <Icon as={MaterialDryCleaningRoundedSvg} {...props} />

MaterialDryCleaningRounded.defaultProps = { ...Icon.defaultProps }

MaterialDryCleaningRounded.propTypes = { ...Icon.propTypes }
