...
const MaterialTableViewSvg = props => (
  <svg
...
const MaterialTableView = props => <Icon as={MaterialTableViewSvg} {...props} />

MaterialTableView.defaultProps = { ...Icon.defaultProps }

MaterialTableView.propTypes = { ...Icon.propTypes }
