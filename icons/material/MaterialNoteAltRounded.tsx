...
const MaterialNoteAltRoundedSvg = props => (
  <svg
...
const MaterialNoteAltRounded = props => <Icon as={MaterialNoteAltRoundedSvg} {...props} />

MaterialNoteAltRounded.defaultProps = { ...Icon.defaultProps }

MaterialNoteAltRounded.propTypes = { ...Icon.propTypes }
