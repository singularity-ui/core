...
const MaterialSailingSvg = props => (
  <svg
...
const MaterialSailing = props => <Icon as={MaterialSailingSvg} {...props} />

MaterialSailing.defaultProps = { ...Icon.defaultProps }

MaterialSailing.propTypes = { ...Icon.propTypes }
