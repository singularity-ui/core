...
const MaterialPersonSearchSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPersonSearch = (styled.default || styled)(MaterialPersonSearchSvg).attrs(p => ({
...
`;
MaterialPersonSearch.propTypes = {
