...
const MaterialPestControlTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPestControlTwoTone = (styled.default || styled)(MaterialPestControlTwoToneSvg).attrs(p => ({
...
`;
MaterialPestControlTwoTone.propTypes = {
