...
const MaterialPersonOffRoundedSvg = props => (
  <svg
...
const MaterialPersonOffRounded = props => <Icon as={MaterialPersonOffRoundedSvg} {...props} />

MaterialPersonOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialPersonOffRounded.propTypes = { ...Icon.propTypes }
