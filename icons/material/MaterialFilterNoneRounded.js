...
const MaterialFilterNoneRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFilterNoneRounded = (styled.default || styled)(MaterialFilterNoneRoundedSvg).attrs(p => ({
...
`;
MaterialFilterNoneRounded.propTypes = {
