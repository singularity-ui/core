...
const MaterialLocalPlayRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalPlayRounded = (styled.default || styled)(MaterialLocalPlayRoundedSvg).attrs(p => ({
...
`;
MaterialLocalPlayRounded.propTypes = {
