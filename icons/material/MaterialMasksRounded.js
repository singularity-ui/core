...
const MaterialMasksRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMasksRounded = (styled.default || styled)(MaterialMasksRoundedSvg).attrs(p => ({
...
`;
MaterialMasksRounded.propTypes = {
