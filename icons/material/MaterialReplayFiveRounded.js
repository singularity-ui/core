...
const MaterialReplayFiveRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayFiveRounded = (styled.default || styled)(MaterialReplayFiveRoundedSvg).attrs(p => ({
...
`;
MaterialReplayFiveRounded.propTypes = {
