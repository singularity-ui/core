...
const MaterialRunCircleRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRunCircleRounded = (styled.default || styled)(MaterialRunCircleRoundedSvg).attrs(p => ({
...
`;
MaterialRunCircleRounded.propTypes = {
