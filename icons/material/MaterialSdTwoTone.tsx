...
const MaterialSdTwoToneSvg = props => (
  <svg
...
const MaterialSdTwoTone = props => <Icon as={MaterialSdTwoToneSvg} {...props} />

MaterialSdTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSdTwoTone.propTypes = { ...Icon.propTypes }
