...
const MaterialBorderRightSvg = props => (
...
const MaterialBorderRight = props => <Icon as={MaterialBorderRightSvg} {...props} />

MaterialBorderRight.defaultProps = { ...Icon.defaultProps }

MaterialBorderRight.propTypes = { ...Icon.propTypes }

export default MaterialBorderRight
