...
const MaterialSportsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsRounded = (styled.default || styled)(MaterialSportsRoundedSvg).attrs(p => ({
...
`;
MaterialSportsRounded.propTypes = {
