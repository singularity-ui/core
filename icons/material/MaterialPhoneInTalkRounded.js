...
const MaterialPhoneInTalkRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPhoneInTalkRounded = (styled.default || styled)(MaterialPhoneInTalkRoundedSvg).attrs(p => ({
...
`;
MaterialPhoneInTalkRounded.propTypes = {
