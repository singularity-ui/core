...
const MaterialReportOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReportOffSharp = (styled.default || styled)(MaterialReportOffSharpSvg).attrs(p => ({
...
`;
MaterialReportOffSharp.propTypes = {
