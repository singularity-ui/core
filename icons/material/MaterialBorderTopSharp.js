...
const MaterialBorderTopSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBorderTopSharp = (styled.default || styled)(MaterialBorderTopSharpSvg).attrs(p => ({
...
`;
MaterialBorderTopSharp.propTypes = {
