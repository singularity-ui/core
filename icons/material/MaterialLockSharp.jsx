...
const MaterialLockSharpSvg = props => (
...
const MaterialLockSharp = props => <Icon as={MaterialLockSharpSvg} {...props} />

MaterialLockSharp.defaultProps = { ...Icon.defaultProps }

MaterialLockSharp.propTypes = { ...Icon.propTypes }
