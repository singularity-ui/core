...
const MaterialSentimentVeryDissatisfiedRoundedSvg = props => (
...
const MaterialSentimentVeryDissatisfiedRounded = props => (
  <Icon as={MaterialSentimentVeryDissatisfiedRoundedSvg} {...props} />
)

MaterialSentimentVeryDissatisfiedRounded.defaultProps = { ...Icon.defaultProps }

MaterialSentimentVeryDissatisfiedRounded.propTypes = { ...Icon.propTypes }

export default MaterialSentimentVeryDissatisfiedRounded
