...
const MaterialDirectionsCarFilledRoundedSvg = props => (
  <svg
...
const MaterialDirectionsCarFilledRounded = props => <Icon as={MaterialDirectionsCarFilledRoundedSvg} {...props} />

MaterialDirectionsCarFilledRounded.defaultProps = { ...Icon.defaultProps }

MaterialDirectionsCarFilledRounded.propTypes = { ...Icon.propTypes }

export default MaterialDirectionsCarFilledRounded
