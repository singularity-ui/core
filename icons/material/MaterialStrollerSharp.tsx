...
const MaterialStrollerSharpSvg = props => (
  <svg
...
const MaterialStrollerSharp = props => <Icon as={MaterialStrollerSharpSvg} {...props} />

MaterialStrollerSharp.defaultProps = { ...Icon.defaultProps }

MaterialStrollerSharp.propTypes = { ...Icon.propTypes }
