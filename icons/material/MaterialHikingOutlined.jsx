...
const MaterialHikingOutlinedSvg = props => (
  <svg
...
const MaterialHikingOutlined = props => <Icon as={MaterialHikingOutlinedSvg} {...props} />

MaterialHikingOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHikingOutlined.propTypes = { ...Icon.propTypes }
