...
const MaterialInsertEmoticonRoundedSvg = props => (
  <svg
...
const MaterialInsertEmoticonRounded = props => <Icon as={MaterialInsertEmoticonRoundedSvg} {...props} />

MaterialInsertEmoticonRounded.defaultProps = { ...Icon.defaultProps }

MaterialInsertEmoticonRounded.propTypes = { ...Icon.propTypes }

export default MaterialInsertEmoticonRounded
