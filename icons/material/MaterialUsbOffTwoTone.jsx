...
const MaterialUsbOffTwoToneSvg = props => (
  <svg
...
const MaterialUsbOffTwoTone = props => <Icon as={MaterialUsbOffTwoToneSvg} {...props} />

MaterialUsbOffTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialUsbOffTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialUsbOffTwoTone
