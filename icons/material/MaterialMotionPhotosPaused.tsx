...
const MaterialMotionPhotosPausedSvg = props => (
  <svg
...
const MaterialMotionPhotosPaused = props => <Icon as={MaterialMotionPhotosPausedSvg} {...props} />

MaterialMotionPhotosPaused.defaultProps = { ...Icon.defaultProps }

MaterialMotionPhotosPaused.propTypes = { ...Icon.propTypes }
