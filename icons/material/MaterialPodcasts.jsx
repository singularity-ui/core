...
const MaterialPodcastsSvg = props => (
  <svg
...
const MaterialPodcasts = props => <Icon as={MaterialPodcastsSvg} {...props} />

MaterialPodcasts.defaultProps = { ...Icon.defaultProps }

MaterialPodcasts.propTypes = { ...Icon.propTypes }

export default MaterialPodcasts
