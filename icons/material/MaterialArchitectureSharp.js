...
const MaterialArchitectureSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialArchitectureSharp = (styled.default || styled)(MaterialArchitectureSharpSvg).attrs(p => ({
...
`;
MaterialArchitectureSharp.propTypes = {
