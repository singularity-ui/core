...
const MaterialAutoStoriesRoundedSvg = props => (
  <svg
...
const MaterialAutoStoriesRounded = props => <Icon as={MaterialAutoStoriesRoundedSvg} {...props} />

MaterialAutoStoriesRounded.defaultProps = { ...Icon.defaultProps }

MaterialAutoStoriesRounded.propTypes = { ...Icon.propTypes }
