...
const MaterialCableTwoToneSvg = props => (
  <svg
...
const MaterialCableTwoTone = props => <Icon as={MaterialCableTwoToneSvg} {...props} />

MaterialCableTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCableTwoTone.propTypes = { ...Icon.propTypes }
