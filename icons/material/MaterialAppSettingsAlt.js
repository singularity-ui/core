...
const MaterialAppSettingsAltSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAppSettingsAlt = (styled.default || styled)(MaterialAppSettingsAltSvg).attrs(p => ({
...
`;
MaterialAppSettingsAlt.propTypes = {
