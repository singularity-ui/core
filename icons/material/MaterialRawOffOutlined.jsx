...
const MaterialRawOffOutlinedSvg = props => (
  <svg
...
const MaterialRawOffOutlined = props => <Icon as={MaterialRawOffOutlinedSvg} {...props} />

MaterialRawOffOutlined.defaultProps = { ...Icon.defaultProps }

MaterialRawOffOutlined.propTypes = { ...Icon.propTypes }

export default MaterialRawOffOutlined
