...
const MaterialReduceCapacitySvg = props => (
  <svg
...
const MaterialReduceCapacity = props => <Icon as={MaterialReduceCapacitySvg} {...props} />

MaterialReduceCapacity.defaultProps = { ...Icon.defaultProps }

MaterialReduceCapacity.propTypes = { ...Icon.propTypes }

export default MaterialReduceCapacity
