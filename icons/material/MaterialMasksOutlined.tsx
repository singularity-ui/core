...
const MaterialMasksOutlinedSvg = props => (
  <svg
...
const MaterialMasksOutlined = props => <Icon as={MaterialMasksOutlinedSvg} {...props} />

MaterialMasksOutlined.defaultProps = { ...Icon.defaultProps }

MaterialMasksOutlined.propTypes = { ...Icon.propTypes }

export default MaterialMasksOutlined
