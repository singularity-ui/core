...
const MaterialQrCodeTwoSvg = props => (
  <svg
...
const MaterialQrCodeTwo = props => <Icon as={MaterialQrCodeTwoSvg} {...props} />

MaterialQrCodeTwo.defaultProps = { ...Icon.defaultProps }

MaterialQrCodeTwo.propTypes = { ...Icon.propTypes }

export default MaterialQrCodeTwo
