...
const MaterialCommuteRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCommuteRounded = (styled.default || styled)(MaterialCommuteRoundedSvg).attrs(p => ({
...
`;
MaterialCommuteRounded.propTypes = {
