...
const MaterialFmdBadOutlinedSvg = props => (
  <svg
...
const MaterialFmdBadOutlined = props => <Icon as={MaterialFmdBadOutlinedSvg} {...props} />

MaterialFmdBadOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFmdBadOutlined.propTypes = { ...Icon.propTypes }
