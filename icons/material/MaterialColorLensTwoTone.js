...
const MaterialColorLensTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialColorLensTwoTone = (styled.default || styled)(MaterialColorLensTwoToneSvg).attrs(p => ({
...
`;
MaterialColorLensTwoTone.propTypes = {
