...
const MaterialAnchorTwoToneSvg = props => (
  <svg
...
const MaterialAnchorTwoTone = props => <Icon as={MaterialAnchorTwoToneSvg} {...props} />

MaterialAnchorTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialAnchorTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialAnchorTwoTone
