...
const MaterialKeyboardHideSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKeyboardHide = (styled.default || styled)(MaterialKeyboardHideSvg).attrs(p => ({
...
`;
MaterialKeyboardHide.propTypes = {
