...
const MaterialWcTwoToneSvg = props => (
...
const MaterialWcTwoTone = props => <Icon as={MaterialWcTwoToneSvg} {...props} />

MaterialWcTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialWcTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialWcTwoTone
