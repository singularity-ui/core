...
const MaterialSportsHockeySvg = props => (
  <svg
...
const MaterialSportsHockey = props => <Icon as={MaterialSportsHockeySvg} {...props} />

MaterialSportsHockey.defaultProps = { ...Icon.defaultProps }

MaterialSportsHockey.propTypes = { ...Icon.propTypes }
