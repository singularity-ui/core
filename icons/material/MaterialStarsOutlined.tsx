...
const MaterialStarsOutlinedSvg = props => (
...
const MaterialStarsOutlined = props => <Icon as={MaterialStarsOutlinedSvg} {...props} />

MaterialStarsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialStarsOutlined.propTypes = { ...Icon.propTypes }

export default MaterialStarsOutlined
