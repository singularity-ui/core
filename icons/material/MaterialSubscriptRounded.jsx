...
const MaterialSubscriptRoundedSvg = props => (
  <svg
...
const MaterialSubscriptRounded = props => <Icon as={MaterialSubscriptRoundedSvg} {...props} />

MaterialSubscriptRounded.defaultProps = { ...Icon.defaultProps }

MaterialSubscriptRounded.propTypes = { ...Icon.propTypes }
