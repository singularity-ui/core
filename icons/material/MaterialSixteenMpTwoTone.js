...
const MaterialSixteenMpTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixteenMpTwoTone = (styled.default || styled)(MaterialSixteenMpTwoToneSvg).attrs(p => ({
...
`;
MaterialSixteenMpTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSixteenMpTwoTone;