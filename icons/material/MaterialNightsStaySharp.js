...
const MaterialNightsStaySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNightsStaySharp = (styled.default || styled)(MaterialNightsStaySharpSvg).attrs(p => ({
...
`;
MaterialNightsStaySharp.propTypes = {
