...
const MaterialRiceBowlSvg = props => (
  <svg
...
const MaterialRiceBowl = props => <Icon as={MaterialRiceBowlSvg} {...props} />

MaterialRiceBowl.defaultProps = { ...Icon.defaultProps }

MaterialRiceBowl.propTypes = { ...Icon.propTypes }
