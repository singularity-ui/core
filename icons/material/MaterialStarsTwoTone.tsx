...
const MaterialStarsTwoToneSvg = props => (
...
const MaterialStarsTwoTone = props => <Icon as={MaterialStarsTwoToneSvg} {...props} />

MaterialStarsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialStarsTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialStarsTwoTone
