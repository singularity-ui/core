...
const MaterialSportsHandballSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsHandball = (styled.default || styled)(MaterialSportsHandballSvg).attrs(p => ({
...
`;
MaterialSportsHandball.propTypes = {
