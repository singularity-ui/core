...
const MaterialCameraAltTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCameraAltTwoTone = (styled.default || styled)(MaterialCameraAltTwoToneSvg).attrs(p => ({
...
`;
MaterialCameraAltTwoTone.propTypes = {
