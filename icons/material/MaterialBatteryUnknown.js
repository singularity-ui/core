...
const MaterialBatteryUnknownSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBatteryUnknown = (styled.default || styled)(MaterialBatteryUnknownSvg).attrs(p => ({
...
`;
MaterialBatteryUnknown.propTypes = {
