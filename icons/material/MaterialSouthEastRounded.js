...
const MaterialSouthEastRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSouthEastRounded = (styled.default || styled)(MaterialSouthEastRoundedSvg).attrs(p => ({
...
`;
MaterialSouthEastRounded.propTypes = {
