...
const MaterialAutoGraphRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAutoGraphRounded = (styled.default || styled)(MaterialAutoGraphRoundedSvg).attrs(p => ({
...
`;
MaterialAutoGraphRounded.propTypes = {
