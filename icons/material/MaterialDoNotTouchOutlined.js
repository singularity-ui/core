...
const MaterialDoNotTouchOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoNotTouchOutlined = (styled.default || styled)(MaterialDoNotTouchOutlinedSvg).attrs(p => ({
...
`;
MaterialDoNotTouchOutlined.propTypes = {
