...
const MaterialTaskAltOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTaskAltOutlined = (styled.default || styled)(MaterialTaskAltOutlinedSvg).attrs(p => ({
...
`;
MaterialTaskAltOutlined.propTypes = {
