...
const MaterialCellWifiSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCellWifiSharp = (styled.default || styled)(MaterialCellWifiSharpSvg).attrs(p => ({
...
`;
MaterialCellWifiSharp.propTypes = {
