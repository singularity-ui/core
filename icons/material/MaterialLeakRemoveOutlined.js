...
const MaterialLeakRemoveOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLeakRemoveOutlined = (styled.default || styled)(MaterialLeakRemoveOutlinedSvg).attrs(p => ({
...
`;
MaterialLeakRemoveOutlined.propTypes = {
