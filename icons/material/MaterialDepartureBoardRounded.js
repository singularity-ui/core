...
const MaterialDepartureBoardRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDepartureBoardRounded = (styled.default || styled)(MaterialDepartureBoardRoundedSvg).attrs(p => ({
...
`;
MaterialDepartureBoardRounded.propTypes = {
