...
const MaterialFlakySharpSvg = props => (
  <svg
...
const MaterialFlakySharp = props => <Icon as={MaterialFlakySharpSvg} {...props} />

MaterialFlakySharp.defaultProps = { ...Icon.defaultProps }

MaterialFlakySharp.propTypes = { ...Icon.propTypes }

export default MaterialFlakySharp
