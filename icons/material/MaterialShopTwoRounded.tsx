...
const MaterialShopTwoRoundedSvg = props => (
...
const MaterialShopTwoRounded = props => <Icon as={MaterialShopTwoRoundedSvg} {...props} />

MaterialShopTwoRounded.defaultProps = { ...Icon.defaultProps }

MaterialShopTwoRounded.propTypes = { ...Icon.propTypes }
