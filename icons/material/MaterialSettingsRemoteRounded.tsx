...
const MaterialSettingsRemoteRoundedSvg = props => (
  <svg
...
const MaterialSettingsRemoteRounded = props => <Icon as={MaterialSettingsRemoteRoundedSvg} {...props} />

MaterialSettingsRemoteRounded.defaultProps = { ...Icon.defaultProps }

MaterialSettingsRemoteRounded.propTypes = { ...Icon.propTypes }
