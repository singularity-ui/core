...
const MaterialModeEditOutlineTwoToneSvg = props => (
  <svg
...
const MaterialModeEditOutlineTwoTone = props => <Icon as={MaterialModeEditOutlineTwoToneSvg} {...props} />

MaterialModeEditOutlineTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialModeEditOutlineTwoTone.propTypes = { ...Icon.propTypes }
