...
const MaterialDoorbellSvg = props => (
  <svg
...
const MaterialDoorbell = props => <Icon as={MaterialDoorbellSvg} {...props} />

MaterialDoorbell.defaultProps = { ...Icon.defaultProps }

MaterialDoorbell.propTypes = { ...Icon.propTypes }

export default MaterialDoorbell
