...
const MaterialLinkOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLinkOffTwoTone = (styled.default || styled)(MaterialLinkOffTwoToneSvg).attrs(p => ({
...
`;
MaterialLinkOffTwoTone.propTypes = {
