...
const MaterialSettingsPhoneSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSettingsPhoneSharp = (styled.default || styled)(MaterialSettingsPhoneSharpSvg).attrs(p => ({
...
`;
MaterialSettingsPhoneSharp.propTypes = {
