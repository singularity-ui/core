...
const MaterialPodcastsSharpSvg = props => (
  <svg
...
const MaterialPodcastsSharp = props => <Icon as={MaterialPodcastsSharpSvg} {...props} />

MaterialPodcastsSharp.defaultProps = { ...Icon.defaultProps }

MaterialPodcastsSharp.propTypes = { ...Icon.propTypes }

export default MaterialPodcastsSharp
