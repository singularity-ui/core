...
const MaterialPriceChangeRoundedSvg = props => (
  <svg
...
const MaterialPriceChangeRounded = props => <Icon as={MaterialPriceChangeRoundedSvg} {...props} />

MaterialPriceChangeRounded.defaultProps = { ...Icon.defaultProps }

MaterialPriceChangeRounded.propTypes = { ...Icon.propTypes }
