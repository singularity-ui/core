...
const MaterialBathtubTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBathtubTwoTone = (styled.default || styled)(MaterialBathtubTwoToneSvg).attrs(p => ({
...
`;
MaterialBathtubTwoTone.propTypes = {
