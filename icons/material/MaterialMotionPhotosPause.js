...
const MaterialMotionPhotosPauseSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMotionPhotosPause = (styled.default || styled)(MaterialMotionPhotosPauseSvg).attrs(p => ({
...
`;
MaterialMotionPhotosPause.propTypes = {
