...
const MaterialEmojiNatureSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEmojiNature = (styled.default || styled)(MaterialEmojiNatureSvg).attrs(p => ({
...
`;
MaterialEmojiNature.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialEmojiNature;