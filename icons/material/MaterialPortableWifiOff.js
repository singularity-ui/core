...
const MaterialPortableWifiOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPortableWifiOff = (styled.default || styled)(MaterialPortableWifiOffSvg).attrs(p => ({
...
`;
MaterialPortableWifiOff.propTypes = {
