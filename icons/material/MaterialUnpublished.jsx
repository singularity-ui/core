...
const MaterialUnpublishedSvg = props => (
  <svg
...
const MaterialUnpublished = props => <Icon as={MaterialUnpublishedSvg} {...props} />

MaterialUnpublished.defaultProps = { ...Icon.defaultProps }

MaterialUnpublished.propTypes = { ...Icon.propTypes }

export default MaterialUnpublished
