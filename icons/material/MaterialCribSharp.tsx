...
const MaterialCribSharpSvg = props => (
  <svg
...
const MaterialCribSharp = props => <Icon as={MaterialCribSharpSvg} {...props} />

MaterialCribSharp.defaultProps = { ...Icon.defaultProps }

MaterialCribSharp.propTypes = { ...Icon.propTypes }
