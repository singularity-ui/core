...
const MaterialThreeDRotationTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialThreeDRotationTwoTone = (styled.default || styled)(MaterialThreeDRotationTwoToneSvg).attrs(p => ({
...
`;
MaterialThreeDRotationTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialThreeDRotationTwoTone;