...
const MaterialFilterNineSvg = props => (
...
const MaterialFilterNine = props => <Icon as={MaterialFilterNineSvg} {...props} />

MaterialFilterNine.defaultProps = { ...Icon.defaultProps }

MaterialFilterNine.propTypes = { ...Icon.propTypes }

export default MaterialFilterNine
