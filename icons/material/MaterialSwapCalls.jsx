...
const MaterialSwapCallsSvg = props => (
...
const MaterialSwapCalls = props => <Icon as={MaterialSwapCallsSvg} {...props} />

MaterialSwapCalls.defaultProps = { ...Icon.defaultProps }

MaterialSwapCalls.propTypes = { ...Icon.propTypes }
