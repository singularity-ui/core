...
const MaterialDesignServicesOutlinedSvg = props => (
  <svg
...
const MaterialDesignServicesOutlined = props => <Icon as={MaterialDesignServicesOutlinedSvg} {...props} />

MaterialDesignServicesOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDesignServicesOutlined.propTypes = { ...Icon.propTypes }
