...
const MaterialPinDropTwoToneSvg = props => (
  <svg
...
const MaterialPinDropTwoTone = props => <Icon as={MaterialPinDropTwoToneSvg} {...props} />

MaterialPinDropTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPinDropTwoTone.propTypes = { ...Icon.propTypes }
