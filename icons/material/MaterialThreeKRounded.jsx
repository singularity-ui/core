...
const MaterialThreeKRoundedSvg = props => (
  <svg
...
const MaterialThreeKRounded = props => <Icon as={MaterialThreeKRoundedSvg} {...props} />

MaterialThreeKRounded.defaultProps = { ...Icon.defaultProps }

MaterialThreeKRounded.propTypes = { ...Icon.propTypes }
