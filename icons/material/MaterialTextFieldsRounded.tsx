...
const MaterialTextFieldsRoundedSvg = props => (
...
const MaterialTextFieldsRounded = props => <Icon as={MaterialTextFieldsRoundedSvg} {...props} />

MaterialTextFieldsRounded.defaultProps = { ...Icon.defaultProps }

MaterialTextFieldsRounded.propTypes = { ...Icon.propTypes }
