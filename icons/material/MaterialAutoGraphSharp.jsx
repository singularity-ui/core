...
const MaterialAutoGraphSharpSvg = props => (
  <svg
...
const MaterialAutoGraphSharp = props => <Icon as={MaterialAutoGraphSharpSvg} {...props} />

MaterialAutoGraphSharp.defaultProps = { ...Icon.defaultProps }

MaterialAutoGraphSharp.propTypes = { ...Icon.propTypes }

export default MaterialAutoGraphSharp
