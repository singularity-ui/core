...
const MaterialEventBusySvg = props => (
...
const MaterialEventBusy = props => <Icon as={MaterialEventBusySvg} {...props} />

MaterialEventBusy.defaultProps = { ...Icon.defaultProps }

MaterialEventBusy.propTypes = { ...Icon.propTypes }

export default MaterialEventBusy
