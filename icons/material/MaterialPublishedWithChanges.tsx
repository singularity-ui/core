...
const MaterialPublishedWithChangesSvg = props => (
  <svg
...
const MaterialPublishedWithChanges = props => <Icon as={MaterialPublishedWithChangesSvg} {...props} />

MaterialPublishedWithChanges.defaultProps = { ...Icon.defaultProps }

MaterialPublishedWithChanges.propTypes = { ...Icon.propTypes }

export default MaterialPublishedWithChanges
