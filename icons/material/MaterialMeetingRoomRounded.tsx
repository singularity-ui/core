...
const MaterialMeetingRoomRoundedSvg = props => (
  <svg
...
const MaterialMeetingRoomRounded = props => <Icon as={MaterialMeetingRoomRoundedSvg} {...props} />

MaterialMeetingRoomRounded.defaultProps = { ...Icon.defaultProps }

MaterialMeetingRoomRounded.propTypes = { ...Icon.propTypes }
