...
const MaterialDirectionsBoatFilledSharpSvg = props => (
  <svg
...
const MaterialDirectionsBoatFilledSharp = props => <Icon as={MaterialDirectionsBoatFilledSharpSvg} {...props} />

MaterialDirectionsBoatFilledSharp.defaultProps = { ...Icon.defaultProps }

MaterialDirectionsBoatFilledSharp.propTypes = { ...Icon.propTypes }

export default MaterialDirectionsBoatFilledSharp
