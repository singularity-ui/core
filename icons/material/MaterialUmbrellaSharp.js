...
const MaterialUmbrellaSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUmbrellaSharp = (styled.default || styled)(MaterialUmbrellaSharpSvg).attrs(p => ({
...
`;
MaterialUmbrellaSharp.propTypes = {
