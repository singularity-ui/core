...
const MaterialFlipToBackSvg = props => (
...
const MaterialFlipToBack = props => <Icon as={MaterialFlipToBackSvg} {...props} />

MaterialFlipToBack.defaultProps = { ...Icon.defaultProps }

MaterialFlipToBack.propTypes = { ...Icon.propTypes }

export default MaterialFlipToBack
