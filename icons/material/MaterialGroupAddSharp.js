...
const MaterialGroupAddSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGroupAddSharp = (styled.default || styled)(MaterialGroupAddSharpSvg).attrs(p => ({
...
`;
MaterialGroupAddSharp.propTypes = {
