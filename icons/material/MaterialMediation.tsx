...
const MaterialMediationSvg = props => (
...
const MaterialMediation = props => <Icon as={MaterialMediationSvg} {...props} />

MaterialMediation.defaultProps = { ...Icon.defaultProps }

MaterialMediation.propTypes = { ...Icon.propTypes }

export default MaterialMediation
