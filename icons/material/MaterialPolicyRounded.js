...
const MaterialPolicyRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPolicyRounded = (styled.default || styled)(MaterialPolicyRoundedSvg).attrs(p => ({
...
`;
MaterialPolicyRounded.propTypes = {
