...
const MaterialDoorbellOutlinedSvg = props => (
  <svg
...
const MaterialDoorbellOutlined = props => <Icon as={MaterialDoorbellOutlinedSvg} {...props} />

MaterialDoorbellOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDoorbellOutlined.propTypes = { ...Icon.propTypes }
