...
const MaterialHandymanOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHandymanOutlined = (styled.default || styled)(MaterialHandymanOutlinedSvg).attrs(p => ({
...
`;
MaterialHandymanOutlined.propTypes = {
