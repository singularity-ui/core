...
const MaterialLightbulbSharpSvg = props => (
  <svg
...
const MaterialLightbulbSharp = props => <Icon as={MaterialLightbulbSharpSvg} {...props} />

MaterialLightbulbSharp.defaultProps = { ...Icon.defaultProps }

MaterialLightbulbSharp.propTypes = { ...Icon.propTypes }
