...
const MaterialNoBackpackOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoBackpackOutlined = (styled.default || styled)(MaterialNoBackpackOutlinedSvg).attrs(p => ({
...
`;
MaterialNoBackpackOutlined.propTypes = {
