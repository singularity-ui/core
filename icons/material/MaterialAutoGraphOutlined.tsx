...
const MaterialAutoGraphOutlinedSvg = props => (
  <svg
...
const MaterialAutoGraphOutlined = props => <Icon as={MaterialAutoGraphOutlinedSvg} {...props} />

MaterialAutoGraphOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAutoGraphOutlined.propTypes = { ...Icon.propTypes }

export default MaterialAutoGraphOutlined
