...
const MaterialRuleOutlinedSvg = props => (
  <svg
...
const MaterialRuleOutlined = props => <Icon as={MaterialRuleOutlinedSvg} {...props} />

MaterialRuleOutlined.defaultProps = { ...Icon.defaultProps }

MaterialRuleOutlined.propTypes = { ...Icon.propTypes }
