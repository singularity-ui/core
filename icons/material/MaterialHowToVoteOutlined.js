...
const MaterialHowToVoteOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHowToVoteOutlined = (styled.default || styled)(MaterialHowToVoteOutlinedSvg).attrs(p => ({
...
`;
MaterialHowToVoteOutlined.propTypes = {
