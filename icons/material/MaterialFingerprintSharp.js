...
const MaterialFingerprintSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFingerprintSharp = (styled.default || styled)(MaterialFingerprintSharpSvg).attrs(p => ({
...
`;
MaterialFingerprintSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFingerprintSharp;