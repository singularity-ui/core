...
const MaterialDoNotDisturbAltSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoNotDisturbAlt = (styled.default || styled)(MaterialDoNotDisturbAltSvg).attrs(p => ({
...
`;
MaterialDoNotDisturbAlt.propTypes = {
