...
const MaterialTryRoundedSvg = props => (
  <svg
...
const MaterialTryRounded = props => <Icon as={MaterialTryRoundedSvg} {...props} />

MaterialTryRounded.defaultProps = { ...Icon.defaultProps }

MaterialTryRounded.propTypes = { ...Icon.propTypes }
