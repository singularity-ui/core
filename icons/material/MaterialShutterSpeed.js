...
const MaterialShutterSpeedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialShutterSpeed = (styled.default || styled)(MaterialShutterSpeedSvg).attrs(p => ({
...
`;
MaterialShutterSpeed.propTypes = {
