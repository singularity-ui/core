...
const MaterialImportContactsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialImportContacts = (styled.default || styled)(MaterialImportContactsSvg).attrs(p => ({
...
`;
MaterialImportContacts.propTypes = {
