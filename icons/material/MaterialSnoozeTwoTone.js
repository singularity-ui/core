...
const MaterialSnoozeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSnoozeTwoTone = (styled.default || styled)(MaterialSnoozeTwoToneSvg).attrs(p => ({
...
`;
MaterialSnoozeTwoTone.propTypes = {
