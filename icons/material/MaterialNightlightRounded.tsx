...
const MaterialNightlightRoundedSvg = props => (
  <svg
...
const MaterialNightlightRounded = props => <Icon as={MaterialNightlightRoundedSvg} {...props} />

MaterialNightlightRounded.defaultProps = { ...Icon.defaultProps }

MaterialNightlightRounded.propTypes = { ...Icon.propTypes }
