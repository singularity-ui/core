...
const MaterialSevenKPlusRoundedSvg = props => (
  <svg
...
const MaterialSevenKPlusRounded = props => <Icon as={MaterialSevenKPlusRoundedSvg} {...props} />

MaterialSevenKPlusRounded.defaultProps = { ...Icon.defaultProps }

MaterialSevenKPlusRounded.propTypes = { ...Icon.propTypes }

export default MaterialSevenKPlusRounded
