...
const MaterialTaskAltRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTaskAltRounded = (styled.default || styled)(MaterialTaskAltRoundedSvg).attrs(p => ({
...
`;
MaterialTaskAltRounded.propTypes = {
