...
const MaterialQuizSharpSvg = props => (
  <svg
...
const MaterialQuizSharp = props => <Icon as={MaterialQuizSharpSvg} {...props} />

MaterialQuizSharp.defaultProps = { ...Icon.defaultProps }

MaterialQuizSharp.propTypes = { ...Icon.propTypes }
