...
const MaterialOutletTwoToneSvg = props => (
  <svg
...
const MaterialOutletTwoTone = props => <Icon as={MaterialOutletTwoToneSvg} {...props} />

MaterialOutletTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialOutletTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialOutletTwoTone
