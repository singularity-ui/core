...
const MaterialSixtyFpsTwoToneSvg = props => (
  <svg
...
const MaterialSixtyFpsTwoTone = props => <Icon as={MaterialSixtyFpsTwoToneSvg} {...props} />

MaterialSixtyFpsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSixtyFpsTwoTone.propTypes = { ...Icon.propTypes }
