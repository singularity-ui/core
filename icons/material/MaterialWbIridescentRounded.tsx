...
const MaterialWbIridescentRoundedSvg = props => (
...
const MaterialWbIridescentRounded = props => <Icon as={MaterialWbIridescentRoundedSvg} {...props} />

MaterialWbIridescentRounded.defaultProps = { ...Icon.defaultProps }

MaterialWbIridescentRounded.propTypes = { ...Icon.propTypes }
