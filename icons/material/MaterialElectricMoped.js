...
const MaterialElectricMopedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialElectricMoped = (styled.default || styled)(MaterialElectricMopedSvg).attrs(p => ({
...
`;
MaterialElectricMoped.propTypes = {
