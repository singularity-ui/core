...
const MaterialHowToVoteSvg = props => (
...
const MaterialHowToVote = props => <Icon as={MaterialHowToVoteSvg} {...props} />

MaterialHowToVote.defaultProps = { ...Icon.defaultProps }

MaterialHowToVote.propTypes = { ...Icon.propTypes }

export default MaterialHowToVote
