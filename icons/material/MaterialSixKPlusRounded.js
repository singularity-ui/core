...
const MaterialSixKPlusRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSixKPlusRounded = (styled.default || styled)(MaterialSixKPlusRoundedSvg).attrs(p => ({
...
`;
MaterialSixKPlusRounded.propTypes = {
