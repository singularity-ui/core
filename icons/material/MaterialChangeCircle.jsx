...
const MaterialChangeCircleSvg = props => (
  <svg
...
const MaterialChangeCircle = props => <Icon as={MaterialChangeCircleSvg} {...props} />

MaterialChangeCircle.defaultProps = { ...Icon.defaultProps }

MaterialChangeCircle.propTypes = { ...Icon.propTypes }

export default MaterialChangeCircle
