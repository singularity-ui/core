...
const MaterialReportTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReportTwoTone = (styled.default || styled)(MaterialReportTwoToneSvg).attrs(p => ({
...
`;
MaterialReportTwoTone.propTypes = {
