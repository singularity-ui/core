...
const MaterialMapsUgcRoundedSvg = props => (
  <svg
...
const MaterialMapsUgcRounded = props => <Icon as={MaterialMapsUgcRoundedSvg} {...props} />

MaterialMapsUgcRounded.defaultProps = { ...Icon.defaultProps }

MaterialMapsUgcRounded.propTypes = { ...Icon.propTypes }

export default MaterialMapsUgcRounded
