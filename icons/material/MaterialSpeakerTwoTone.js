...
const MaterialSpeakerTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSpeakerTwoTone = (styled.default || styled)(MaterialSpeakerTwoToneSvg).attrs(p => ({
...
`;
MaterialSpeakerTwoTone.propTypes = {
