...
const MaterialRingVolumeTwoToneSvg = props => (
...
const MaterialRingVolumeTwoTone = props => <Icon as={MaterialRingVolumeTwoToneSvg} {...props} />

MaterialRingVolumeTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRingVolumeTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialRingVolumeTwoTone
