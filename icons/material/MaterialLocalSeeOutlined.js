...
const MaterialLocalSeeOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalSeeOutlined = (styled.default || styled)(MaterialLocalSeeOutlinedSvg).attrs(p => ({
...
`;
MaterialLocalSeeOutlined.propTypes = {
