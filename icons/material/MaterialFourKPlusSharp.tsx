...
const MaterialFourKPlusSharpSvg = props => (
  <svg
...
const MaterialFourKPlusSharp = props => <Icon as={MaterialFourKPlusSharpSvg} {...props} />

MaterialFourKPlusSharp.defaultProps = { ...Icon.defaultProps }

MaterialFourKPlusSharp.propTypes = { ...Icon.propTypes }
