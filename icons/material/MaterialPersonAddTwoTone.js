...
const MaterialPersonAddTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPersonAddTwoTone = (styled.default || styled)(MaterialPersonAddTwoToneSvg).attrs(p => ({
...
`;
MaterialPersonAddTwoTone.propTypes = {
