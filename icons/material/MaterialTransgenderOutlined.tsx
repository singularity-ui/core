...
const MaterialTransgenderOutlinedSvg = props => (
  <svg
...
const MaterialTransgenderOutlined = props => <Icon as={MaterialTransgenderOutlinedSvg} {...props} />

MaterialTransgenderOutlined.defaultProps = { ...Icon.defaultProps }

MaterialTransgenderOutlined.propTypes = { ...Icon.propTypes }

export default MaterialTransgenderOutlined
