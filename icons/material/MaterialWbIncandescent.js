...
const MaterialWbIncandescentSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWbIncandescent = (styled.default || styled)(MaterialWbIncandescentSvg).attrs(p => ({
...
`;
MaterialWbIncandescent.propTypes = {
