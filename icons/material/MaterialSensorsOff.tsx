...
const MaterialSensorsOffSvg = props => (
  <svg
...
const MaterialSensorsOff = props => <Icon as={MaterialSensorsOffSvg} {...props} />

MaterialSensorsOff.defaultProps = { ...Icon.defaultProps }

MaterialSensorsOff.propTypes = { ...Icon.propTypes }

export default MaterialSensorsOff
