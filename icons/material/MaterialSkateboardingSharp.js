...
const MaterialSkateboardingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSkateboardingSharp = (styled.default || styled)(MaterialSkateboardingSharpSvg).attrs(p => ({
...
`;
MaterialSkateboardingSharp.propTypes = {
