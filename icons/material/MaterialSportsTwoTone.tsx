...
const MaterialSportsTwoToneSvg = props => (
  <svg
...
const MaterialSportsTwoTone = props => <Icon as={MaterialSportsTwoToneSvg} {...props} />

MaterialSportsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSportsTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSportsTwoTone
