...
const MaterialIceSkatingSvg = props => (
  <svg
...
const MaterialIceSkating = props => <Icon as={MaterialIceSkatingSvg} {...props} />

MaterialIceSkating.defaultProps = { ...Icon.defaultProps }

MaterialIceSkating.propTypes = { ...Icon.propTypes }
