...
const MaterialPlaceTwoToneSvg = props => (
  <svg
...
const MaterialPlaceTwoTone = props => <Icon as={MaterialPlaceTwoToneSvg} {...props} />

MaterialPlaceTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPlaceTwoTone.propTypes = { ...Icon.propTypes }
