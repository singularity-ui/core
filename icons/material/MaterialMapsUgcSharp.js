...
const MaterialMapsUgcSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMapsUgcSharp = (styled.default || styled)(MaterialMapsUgcSharpSvg).attrs(p => ({
...
`;
MaterialMapsUgcSharp.propTypes = {
