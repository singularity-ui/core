...
const MaterialSettingsSuggestOutlinedSvg = props => (
  <svg
...
const MaterialSettingsSuggestOutlined = props => <Icon as={MaterialSettingsSuggestOutlinedSvg} {...props} />

MaterialSettingsSuggestOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSettingsSuggestOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSettingsSuggestOutlined
