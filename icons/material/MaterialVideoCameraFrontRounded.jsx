...
const MaterialVideoCameraFrontRoundedSvg = props => (
  <svg
...
const MaterialVideoCameraFrontRounded = props => <Icon as={MaterialVideoCameraFrontRoundedSvg} {...props} />

MaterialVideoCameraFrontRounded.defaultProps = { ...Icon.defaultProps }

MaterialVideoCameraFrontRounded.propTypes = { ...Icon.propTypes }
