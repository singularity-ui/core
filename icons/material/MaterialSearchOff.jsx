...
const MaterialSearchOffSvg = props => (
  <svg
...
const MaterialSearchOff = props => <Icon as={MaterialSearchOffSvg} {...props} />

MaterialSearchOff.defaultProps = { ...Icon.defaultProps }

MaterialSearchOff.propTypes = { ...Icon.propTypes }

export default MaterialSearchOff
