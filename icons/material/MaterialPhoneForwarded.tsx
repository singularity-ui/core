...
const MaterialPhoneForwardedSvg = props => (
...
const MaterialPhoneForwarded = props => <Icon as={MaterialPhoneForwardedSvg} {...props} />

MaterialPhoneForwarded.defaultProps = { ...Icon.defaultProps }

MaterialPhoneForwarded.propTypes = { ...Icon.propTypes }

export default MaterialPhoneForwarded
