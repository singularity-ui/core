...
const MaterialRecommendTwoToneSvg = props => (
  <svg
...
const MaterialRecommendTwoTone = props => <Icon as={MaterialRecommendTwoToneSvg} {...props} />

MaterialRecommendTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRecommendTwoTone.propTypes = { ...Icon.propTypes }
