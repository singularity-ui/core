...
const MaterialPanoramaWideAngleSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPanoramaWideAngle = (styled.default || styled)(MaterialPanoramaWideAngleSvg).attrs(p => ({
...
`;
MaterialPanoramaWideAngle.propTypes = {
