...
const MaterialCottageRoundedSvg = props => (
  <svg
...
const MaterialCottageRounded = props => <Icon as={MaterialCottageRoundedSvg} {...props} />

MaterialCottageRounded.defaultProps = { ...Icon.defaultProps }

MaterialCottageRounded.propTypes = { ...Icon.propTypes }
