...
const MaterialSimCardTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSimCardTwoTone = (styled.default || styled)(MaterialSimCardTwoToneSvg).attrs(p => ({
...
`;
MaterialSimCardTwoTone.propTypes = {
