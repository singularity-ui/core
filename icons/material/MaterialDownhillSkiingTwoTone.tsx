...
const MaterialDownhillSkiingTwoToneSvg = props => (
  <svg
...
const MaterialDownhillSkiingTwoTone = props => <Icon as={MaterialDownhillSkiingTwoToneSvg} {...props} />

MaterialDownhillSkiingTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDownhillSkiingTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialDownhillSkiingTwoTone
