...
const MaterialHiking = props => <Icon as={MaterialHikingSvg} {...props} />

MaterialHiking.defaultProps = { ...Icon.defaultProps }

MaterialHiking.propTypes = { ...Icon.propTypes }

export default MaterialHiking
