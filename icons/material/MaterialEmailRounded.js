...
const MaterialEmailRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEmailRounded = (styled.default || styled)(MaterialEmailRoundedSvg).attrs(p => ({
...
`;
MaterialEmailRounded.propTypes = {
