...
const MaterialSendToMobileOutlinedSvg = props => (
  <svg
...
const MaterialSendToMobileOutlined = props => <Icon as={MaterialSendToMobileOutlinedSvg} {...props} />

MaterialSendToMobileOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSendToMobileOutlined.propTypes = { ...Icon.propTypes }
