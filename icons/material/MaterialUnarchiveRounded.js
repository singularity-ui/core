...
const MaterialUnarchiveRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUnarchiveRounded = (styled.default || styled)(MaterialUnarchiveRoundedSvg).attrs(p => ({
...
`;
MaterialUnarchiveRounded.propTypes = {
