...
const MaterialRotateLeftTwoToneSvg = props => (
...
const MaterialRotateLeftTwoTone = props => <Icon as={MaterialRotateLeftTwoToneSvg} {...props} />

MaterialRotateLeftTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRotateLeftTwoTone.propTypes = { ...Icon.propTypes }
