...
const MaterialSurroundSoundSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSurroundSound = (styled.default || styled)(MaterialSurroundSoundSvg).attrs(p => ({
...
`;
MaterialSurroundSound.propTypes = {
