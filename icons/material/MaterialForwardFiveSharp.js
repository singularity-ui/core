...
const MaterialForwardFiveSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardFiveSharp = (styled.default || styled)(MaterialForwardFiveSharpSvg).attrs(p => ({
...
`;
MaterialForwardFiveSharp.propTypes = {
