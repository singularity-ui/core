...
const MaterialAutoFixHighTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAutoFixHighTwoTone = (styled.default || styled)(MaterialAutoFixHighTwoToneSvg).attrs(p => ({
...
`;
MaterialAutoFixHighTwoTone.propTypes = {
