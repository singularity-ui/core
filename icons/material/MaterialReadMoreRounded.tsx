...
const MaterialReadMoreRoundedSvg = props => (
  <svg
...
const MaterialReadMoreRounded = props => <Icon as={MaterialReadMoreRoundedSvg} {...props} />

MaterialReadMoreRounded.defaultProps = { ...Icon.defaultProps }

MaterialReadMoreRounded.propTypes = { ...Icon.propTypes }
