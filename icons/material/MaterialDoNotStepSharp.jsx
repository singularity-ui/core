...
const MaterialDoNotStepSharpSvg = props => (
  <svg
...
const MaterialDoNotStepSharp = props => <Icon as={MaterialDoNotStepSharpSvg} {...props} />

MaterialDoNotStepSharp.defaultProps = { ...Icon.defaultProps }

MaterialDoNotStepSharp.propTypes = { ...Icon.propTypes }
