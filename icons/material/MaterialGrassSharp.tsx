...
const MaterialGrassSharpSvg = props => (
  <svg
...
const MaterialGrassSharp = props => <Icon as={MaterialGrassSharpSvg} {...props} />

MaterialGrassSharp.defaultProps = { ...Icon.defaultProps }

MaterialGrassSharp.propTypes = { ...Icon.propTypes }

export default MaterialGrassSharp
