...
const MaterialCampaignTwoToneSvg = props => (
  <svg
...
const MaterialCampaignTwoTone = props => <Icon as={MaterialCampaignTwoToneSvg} {...props} />

MaterialCampaignTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCampaignTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialCampaignTwoTone
