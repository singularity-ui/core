...
const MaterialGroupsRoundedSvg = props => (
  <svg
...
const MaterialGroupsRounded = props => <Icon as={MaterialGroupsRoundedSvg} {...props} />

MaterialGroupsRounded.defaultProps = { ...Icon.defaultProps }

MaterialGroupsRounded.propTypes = { ...Icon.propTypes }

export default MaterialGroupsRounded
