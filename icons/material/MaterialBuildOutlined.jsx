...
const MaterialBuildOutlinedSvg = props => (
...
const MaterialBuildOutlined = props => <Icon as={MaterialBuildOutlinedSvg} {...props} />

MaterialBuildOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBuildOutlined.propTypes = { ...Icon.propTypes }
