...
const MaterialFactCheckSvg = props => (
  <svg
...
const MaterialFactCheck = props => <Icon as={MaterialFactCheckSvg} {...props} />

MaterialFactCheck.defaultProps = { ...Icon.defaultProps }

MaterialFactCheck.propTypes = { ...Icon.propTypes }
