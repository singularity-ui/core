...
const MaterialSipTwoToneSvg = props => (
  <svg
...
const MaterialSipTwoTone = props => <Icon as={MaterialSipTwoToneSvg} {...props} />

MaterialSipTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSipTwoTone.propTypes = { ...Icon.propTypes }
