...
const MaterialDialpadSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDialpadSharp = (styled.default || styled)(MaterialDialpadSharpSvg).attrs(p => ({
...
`;
MaterialDialpadSharp.propTypes = {
