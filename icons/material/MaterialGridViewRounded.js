...
const MaterialGridViewRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGridViewRounded = (styled.default || styled)(MaterialGridViewRoundedSvg).attrs(p => ({
...
`;
MaterialGridViewRounded.propTypes = {
