...
const MaterialPublicOffSvg = props => (
  <svg
...
const MaterialPublicOff = props => <Icon as={MaterialPublicOffSvg} {...props} />

MaterialPublicOff.defaultProps = { ...Icon.defaultProps }

MaterialPublicOff.propTypes = { ...Icon.propTypes }

export default MaterialPublicOff
