...
const MaterialIceSkatingRoundedSvg = props => (
  <svg
...
const MaterialIceSkatingRounded = props => <Icon as={MaterialIceSkatingRoundedSvg} {...props} />

MaterialIceSkatingRounded.defaultProps = { ...Icon.defaultProps }

MaterialIceSkatingRounded.propTypes = { ...Icon.propTypes }
