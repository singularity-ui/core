...
const MaterialNoFoodOutlinedSvg = props => (
  <svg
...
const MaterialNoFoodOutlined = props => <Icon as={MaterialNoFoodOutlinedSvg} {...props} />

MaterialNoFoodOutlined.defaultProps = { ...Icon.defaultProps }

MaterialNoFoodOutlined.propTypes = { ...Icon.propTypes }
