...
const MaterialAdb = props => <Icon as={MaterialAdbSvg} {...props} />

MaterialAdb.defaultProps = { ...Icon.defaultProps }

MaterialAdb.propTypes = { ...Icon.propTypes }

export default MaterialAdb
