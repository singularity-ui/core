...
const MaterialSkateboardingSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSkateboarding = (styled.default || styled)(MaterialSkateboardingSvg).attrs(p => ({
...
`;
MaterialSkateboarding.propTypes = {
