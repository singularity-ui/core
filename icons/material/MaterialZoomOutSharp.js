...
const MaterialZoomOutSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialZoomOutSharp = (styled.default || styled)(MaterialZoomOutSharpSvg).attrs(p => ({
...
`;
MaterialZoomOutSharp.propTypes = {
