...
const MaterialEighteenMpSvg = props => (
...
const MaterialEighteenMp = props => <Icon as={MaterialEighteenMpSvg} {...props} />

MaterialEighteenMp.defaultProps = { ...Icon.defaultProps }

MaterialEighteenMp.propTypes = { ...Icon.propTypes }

export default MaterialEighteenMp
