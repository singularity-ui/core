...
const MaterialSettingsPhoneTwoToneSvg = props => (
...
const MaterialSettingsPhoneTwoTone = props => <Icon as={MaterialSettingsPhoneTwoToneSvg} {...props} />

MaterialSettingsPhoneTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSettingsPhoneTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSettingsPhoneTwoTone
