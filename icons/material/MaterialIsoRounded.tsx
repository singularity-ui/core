...
const MaterialIsoRoundedSvg = props => (
...
const MaterialIsoRounded = props => <Icon as={MaterialIsoRoundedSvg} {...props} />

MaterialIsoRounded.defaultProps = { ...Icon.defaultProps }

MaterialIsoRounded.propTypes = { ...Icon.propTypes }
