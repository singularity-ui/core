...
const MaterialSnowshoeingSharpSvg = props => (
  <svg
...
const MaterialSnowshoeingSharp = props => <Icon as={MaterialSnowshoeingSharpSvg} {...props} />

MaterialSnowshoeingSharp.defaultProps = { ...Icon.defaultProps }

MaterialSnowshoeingSharp.propTypes = { ...Icon.propTypes }

export default MaterialSnowshoeingSharp
