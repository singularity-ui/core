...
const MaterialTwentyOneMpSharpSvg = props => (
  <svg
...
const MaterialTwentyOneMpSharp = props => <Icon as={MaterialTwentyOneMpSharpSvg} {...props} />

MaterialTwentyOneMpSharp.defaultProps = { ...Icon.defaultProps }

MaterialTwentyOneMpSharp.propTypes = { ...Icon.propTypes }
