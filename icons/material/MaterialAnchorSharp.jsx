...
const MaterialAnchorSharpSvg = props => (
  <svg
...
const MaterialAnchorSharp = props => <Icon as={MaterialAnchorSharpSvg} {...props} />

MaterialAnchorSharp.defaultProps = { ...Icon.defaultProps }

MaterialAnchorSharp.propTypes = { ...Icon.propTypes }
