...
const MaterialMoreRoundedSvg = props => (
...
const MaterialMoreRounded = props => <Icon as={MaterialMoreRoundedSvg} {...props} />

MaterialMoreRounded.defaultProps = { ...Icon.defaultProps }

MaterialMoreRounded.propTypes = { ...Icon.propTypes }

export default MaterialMoreRounded
