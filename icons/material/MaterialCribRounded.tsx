...
const MaterialCribRoundedSvg = props => (
  <svg
...
const MaterialCribRounded = props => <Icon as={MaterialCribRoundedSvg} {...props} />

MaterialCribRounded.defaultProps = { ...Icon.defaultProps }

MaterialCribRounded.propTypes = { ...Icon.propTypes }
