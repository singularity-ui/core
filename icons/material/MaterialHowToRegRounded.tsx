...
const MaterialHowToRegRoundedSvg = props => (
...
const MaterialHowToRegRounded = props => <Icon as={MaterialHowToRegRoundedSvg} {...props} />

MaterialHowToRegRounded.defaultProps = { ...Icon.defaultProps }

MaterialHowToRegRounded.propTypes = { ...Icon.propTypes }
