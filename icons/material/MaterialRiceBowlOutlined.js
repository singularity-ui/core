...
const MaterialRiceBowlOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRiceBowlOutlined = (styled.default || styled)(MaterialRiceBowlOutlinedSvg).attrs(p => ({
...
`;
MaterialRiceBowlOutlined.propTypes = {
