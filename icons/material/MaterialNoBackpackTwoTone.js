...
const MaterialNoBackpackTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoBackpackTwoTone = (styled.default || styled)(MaterialNoBackpackTwoToneSvg).attrs(p => ({
...
`;
MaterialNoBackpackTwoTone.propTypes = {
