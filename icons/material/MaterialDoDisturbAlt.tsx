...
const MaterialDoDisturbAltSvg = props => (
  <svg
...
const MaterialDoDisturbAlt = props => <Icon as={MaterialDoDisturbAltSvg} {...props} />

MaterialDoDisturbAlt.defaultProps = { ...Icon.defaultProps }

MaterialDoDisturbAlt.propTypes = { ...Icon.propTypes }

export default MaterialDoDisturbAlt
