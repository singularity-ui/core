...
const MaterialFaceTwoToneSvg = props => (
...
const MaterialFaceTwoTone = props => <Icon as={MaterialFaceTwoToneSvg} {...props} />

MaterialFaceTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialFaceTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialFaceTwoTone
