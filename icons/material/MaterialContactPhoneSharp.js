...
const MaterialContactPhoneSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialContactPhoneSharp = (styled.default || styled)(MaterialContactPhoneSharpSvg).attrs(p => ({
...
`;
MaterialContactPhoneSharp.propTypes = {
