...
const MaterialRawOffTwoToneSvg = props => (
  <svg
...
const MaterialRawOffTwoTone = props => <Icon as={MaterialRawOffTwoToneSvg} {...props} />

MaterialRawOffTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialRawOffTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialRawOffTwoTone
