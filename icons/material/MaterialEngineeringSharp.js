...
const MaterialEngineeringSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEngineeringSharp = (styled.default || styled)(MaterialEngineeringSharpSvg).attrs(p => ({
...
`;
MaterialEngineeringSharp.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialEngineeringSharp;