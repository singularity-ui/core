...
const MaterialAccessAlarmsSvg = props => (
...
const MaterialAccessAlarms = props => <Icon as={MaterialAccessAlarmsSvg} {...props} />

MaterialAccessAlarms.defaultProps = { ...Icon.defaultProps }

MaterialAccessAlarms.propTypes = { ...Icon.propTypes }

export default MaterialAccessAlarms
