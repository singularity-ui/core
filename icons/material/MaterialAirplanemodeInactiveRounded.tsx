...
const MaterialAirplanemodeInactiveRoundedSvg = props => (
  <svg
...
const MaterialAirplanemodeInactiveRounded = props => <Icon as={MaterialAirplanemodeInactiveRoundedSvg} {...props} />

MaterialAirplanemodeInactiveRounded.defaultProps = { ...Icon.defaultProps }

MaterialAirplanemodeInactiveRounded.propTypes = { ...Icon.propTypes }

export default MaterialAirplanemodeInactiveRounded
