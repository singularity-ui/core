...
const MaterialMore = props => <Icon as={MaterialMoreSvg} {...props} />

MaterialMore.defaultProps = { ...Icon.defaultProps }

MaterialMore.propTypes = { ...Icon.propTypes }

export default MaterialMore
