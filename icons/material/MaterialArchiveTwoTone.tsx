...
const MaterialArchiveTwoToneSvg = props => (
...
const MaterialArchiveTwoTone = props => <Icon as={MaterialArchiveTwoToneSvg} {...props} />

MaterialArchiveTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialArchiveTwoTone.propTypes = { ...Icon.propTypes }
