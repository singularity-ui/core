...
const MaterialVideogameAssetOffSvg = props => (
  <svg
...
const MaterialVideogameAssetOff = props => <Icon as={MaterialVideogameAssetOffSvg} {...props} />

MaterialVideogameAssetOff.defaultProps = { ...Icon.defaultProps }

MaterialVideogameAssetOff.propTypes = { ...Icon.propTypes }
