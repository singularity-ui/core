...
const MaterialDataSaverOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDataSaverOffSharp = (styled.default || styled)(MaterialDataSaverOffSharpSvg).attrs(p => ({
...
`;
MaterialDataSaverOffSharp.propTypes = {
