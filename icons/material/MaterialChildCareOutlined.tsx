...
const MaterialChildCareOutlinedSvg = props => (
...
const MaterialChildCareOutlined = props => <Icon as={MaterialChildCareOutlinedSvg} {...props} />

MaterialChildCareOutlined.defaultProps = { ...Icon.defaultProps }

MaterialChildCareOutlined.propTypes = { ...Icon.propTypes }

export default MaterialChildCareOutlined
