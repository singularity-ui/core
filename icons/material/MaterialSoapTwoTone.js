...
const MaterialSoapTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSoapTwoTone = (styled.default || styled)(MaterialSoapTwoToneSvg).attrs(p => ({
...
`;
MaterialSoapTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialSoapTwoTone;