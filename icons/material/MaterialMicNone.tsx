...
const MaterialMicNoneSvg = props => (
...
const MaterialMicNone = props => <Icon as={MaterialMicNoneSvg} {...props} />

MaterialMicNone.defaultProps = { ...Icon.defaultProps }

MaterialMicNone.propTypes = { ...Icon.propTypes }

export default MaterialMicNone
