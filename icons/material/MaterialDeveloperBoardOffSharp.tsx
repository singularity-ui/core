...
const MaterialDeveloperBoardOffSharpSvg = props => (
  <svg
...
const MaterialDeveloperBoardOffSharp = props => <Icon as={MaterialDeveloperBoardOffSharpSvg} {...props} />

MaterialDeveloperBoardOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialDeveloperBoardOffSharp.propTypes = { ...Icon.propTypes }
