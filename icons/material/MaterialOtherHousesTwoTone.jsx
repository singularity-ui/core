...
const MaterialOtherHousesTwoToneSvg = props => (
  <svg
...
const MaterialOtherHousesTwoTone = props => <Icon as={MaterialOtherHousesTwoToneSvg} {...props} />

MaterialOtherHousesTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialOtherHousesTwoTone.propTypes = { ...Icon.propTypes }
