...
const MaterialSnowboardingSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSnowboarding = (styled.default || styled)(MaterialSnowboardingSvg).attrs(p => ({
...
`;
MaterialSnowboarding.propTypes = {
