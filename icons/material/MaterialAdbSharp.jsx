...
const MaterialAdbSharpSvg = props => (
...
const MaterialAdbSharp = props => <Icon as={MaterialAdbSharpSvg} {...props} />

MaterialAdbSharp.defaultProps = { ...Icon.defaultProps }

MaterialAdbSharp.propTypes = { ...Icon.propTypes }

export default MaterialAdbSharp
