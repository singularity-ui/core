...
const MaterialUpcomingOutlinedSvg = props => (
  <svg
...
const MaterialUpcomingOutlined = props => <Icon as={MaterialUpcomingOutlinedSvg} {...props} />

MaterialUpcomingOutlined.defaultProps = { ...Icon.defaultProps }

MaterialUpcomingOutlined.propTypes = { ...Icon.propTypes }
