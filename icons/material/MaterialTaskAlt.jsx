...
const MaterialTaskAltSvg = props => (
  <svg
...
const MaterialTaskAlt = props => <Icon as={MaterialTaskAltSvg} {...props} />

MaterialTaskAlt.defaultProps = { ...Icon.defaultProps }

MaterialTaskAlt.propTypes = { ...Icon.propTypes }

export default MaterialTaskAlt
