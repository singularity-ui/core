...
const MaterialArchitectureSvg = props => (
  <svg
...
const MaterialArchitecture = props => <Icon as={MaterialArchitectureSvg} {...props} />

MaterialArchitecture.defaultProps = { ...Icon.defaultProps }

MaterialArchitecture.propTypes = { ...Icon.propTypes }

export default MaterialArchitecture
