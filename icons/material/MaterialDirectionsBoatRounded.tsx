...
const MaterialDirectionsBoatRoundedSvg = props => (
  <svg
...
const MaterialDirectionsBoatRounded = props => <Icon as={MaterialDirectionsBoatRoundedSvg} {...props} />

MaterialDirectionsBoatRounded.defaultProps = { ...Icon.defaultProps }

MaterialDirectionsBoatRounded.propTypes = { ...Icon.propTypes }

export default MaterialDirectionsBoatRounded
