...
const MaterialPedalBikeOutlinedSvg = props => (
  <svg
...
const MaterialPedalBikeOutlined = props => <Icon as={MaterialPedalBikeOutlinedSvg} {...props} />

MaterialPedalBikeOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPedalBikeOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPedalBikeOutlined
