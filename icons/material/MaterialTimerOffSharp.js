...
const MaterialTimerOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerOffSharp = (styled.default || styled)(MaterialTimerOffSharpSvg).attrs(p => ({
...
`;
MaterialTimerOffSharp.propTypes = {
