...
const MaterialTopicTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTopicTwoTone = (styled.default || styled)(MaterialTopicTwoToneSvg).attrs(p => ({
...
`;
MaterialTopicTwoTone.propTypes = {
