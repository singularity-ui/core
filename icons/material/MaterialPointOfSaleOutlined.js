...
const MaterialPointOfSaleOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPointOfSaleOutlined = (styled.default || styled)(MaterialPointOfSaleOutlinedSvg).attrs(p => ({
...
`;
MaterialPointOfSaleOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialPointOfSaleOutlined;