...
const MaterialSocialDistanceSvg = props => (
  <svg
...
const MaterialSocialDistance = props => <Icon as={MaterialSocialDistanceSvg} {...props} />

MaterialSocialDistance.defaultProps = { ...Icon.defaultProps }

MaterialSocialDistance.propTypes = { ...Icon.propTypes }

export default MaterialSocialDistance
