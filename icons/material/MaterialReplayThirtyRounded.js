...
const MaterialReplayThirtyRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayThirtyRounded = (styled.default || styled)(MaterialReplayThirtyRoundedSvg).attrs(p => ({
...
`;
MaterialReplayThirtyRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialReplayThirtyRounded;