...
const MaterialChairSharpSvg = props => (
  <svg
...
const MaterialChairSharp = props => <Icon as={MaterialChairSharpSvg} {...props} />

MaterialChairSharp.defaultProps = { ...Icon.defaultProps }

MaterialChairSharp.propTypes = { ...Icon.propTypes }
