...
const MaterialEmojiNatureOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEmojiNatureOutlined = (styled.default || styled)(MaterialEmojiNatureOutlinedSvg).attrs(p => ({
...
`;
MaterialEmojiNatureOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialEmojiNatureOutlined;