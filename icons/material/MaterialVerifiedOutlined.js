...
const MaterialVerifiedOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVerifiedOutlined = (styled.default || styled)(MaterialVerifiedOutlinedSvg).attrs(p => ({
...
`;
MaterialVerifiedOutlined.propTypes = {
