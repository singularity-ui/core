...
const MaterialUsbOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialUsbOffTwoTone = (styled.default || styled)(MaterialUsbOffTwoToneSvg).attrs(p => ({
...
`;
MaterialUsbOffTwoTone.propTypes = {
