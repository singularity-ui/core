...
const MaterialMoving = props => <Icon as={MaterialMovingSvg} {...props} />

MaterialMoving.defaultProps = { ...Icon.defaultProps }

MaterialMoving.propTypes = { ...Icon.propTypes }

export default MaterialMoving
