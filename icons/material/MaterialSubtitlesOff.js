...
const MaterialSubtitlesOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSubtitlesOff = (styled.default || styled)(MaterialSubtitlesOffSvg).attrs(p => ({
...
`;
MaterialSubtitlesOff.propTypes = {
