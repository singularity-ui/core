...
const MaterialAirportShuttleSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAirportShuttle = (styled.default || styled)(MaterialAirportShuttleSvg).attrs(p => ({
...
`;
MaterialAirportShuttle.propTypes = {
