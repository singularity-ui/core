...
const MaterialLocationOffRoundedSvg = props => (
...
const MaterialLocationOffRounded = props => <Icon as={MaterialLocationOffRoundedSvg} {...props} />

MaterialLocationOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialLocationOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialLocationOffRounded
