...
const MaterialRepeatRoundedSvg = props => (
...
const MaterialRepeatRounded = props => <Icon as={MaterialRepeatRoundedSvg} {...props} />

MaterialRepeatRounded.defaultProps = { ...Icon.defaultProps }

MaterialRepeatRounded.propTypes = { ...Icon.propTypes }

export default MaterialRepeatRounded
