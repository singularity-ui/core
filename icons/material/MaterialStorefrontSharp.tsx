...
const MaterialStorefrontSharpSvg = props => (
  <svg
...
const MaterialStorefrontSharp = props => <Icon as={MaterialStorefrontSharpSvg} {...props} />

MaterialStorefrontSharp.defaultProps = { ...Icon.defaultProps }

MaterialStorefrontSharp.propTypes = { ...Icon.propTypes }

export default MaterialStorefrontSharp
