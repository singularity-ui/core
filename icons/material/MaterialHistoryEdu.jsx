...
const MaterialHistoryEduSvg = props => (
  <svg
...
const MaterialHistoryEdu = props => <Icon as={MaterialHistoryEduSvg} {...props} />

MaterialHistoryEdu.defaultProps = { ...Icon.defaultProps }

MaterialHistoryEdu.propTypes = { ...Icon.propTypes }

export default MaterialHistoryEdu
