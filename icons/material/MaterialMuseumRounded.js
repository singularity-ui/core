...
const MaterialMuseumRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMuseumRounded = (styled.default || styled)(MaterialMuseumRoundedSvg).attrs(p => ({
...
`;
MaterialMuseumRounded.propTypes = {
