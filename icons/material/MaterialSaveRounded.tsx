...
const MaterialSaveRoundedSvg = props => (
...
const MaterialSaveRounded = props => <Icon as={MaterialSaveRoundedSvg} {...props} />

MaterialSaveRounded.defaultProps = { ...Icon.defaultProps }

MaterialSaveRounded.propTypes = { ...Icon.propTypes }
