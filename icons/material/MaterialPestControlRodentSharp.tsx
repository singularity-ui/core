...
const MaterialPestControlRodentSharpSvg = props => (
  <svg
...
const MaterialPestControlRodentSharp = props => <Icon as={MaterialPestControlRodentSharpSvg} {...props} />

MaterialPestControlRodentSharp.defaultProps = { ...Icon.defaultProps }

MaterialPestControlRodentSharp.propTypes = { ...Icon.propTypes }

export default MaterialPestControlRodentSharp
