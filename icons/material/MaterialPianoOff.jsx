...
const MaterialPianoOffSvg = props => (
  <svg
...
const MaterialPianoOff = props => <Icon as={MaterialPianoOffSvg} {...props} />

MaterialPianoOff.defaultProps = { ...Icon.defaultProps }

MaterialPianoOff.propTypes = { ...Icon.propTypes }
