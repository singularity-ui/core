...
const MaterialChairRoundedSvg = props => (
  <svg
...
const MaterialChairRounded = props => <Icon as={MaterialChairRoundedSvg} {...props} />

MaterialChairRounded.defaultProps = { ...Icon.defaultProps }

MaterialChairRounded.propTypes = { ...Icon.propTypes }

export default MaterialChairRounded
