...
const MaterialFontDownloadOffRoundedSvg = props => (
  <svg
...
const MaterialFontDownloadOffRounded = props => <Icon as={MaterialFontDownloadOffRoundedSvg} {...props} />

MaterialFontDownloadOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialFontDownloadOffRounded.propTypes = { ...Icon.propTypes }
