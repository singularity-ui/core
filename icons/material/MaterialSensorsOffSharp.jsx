...
const MaterialSensorsOffSharpSvg = props => (
  <svg
...
const MaterialSensorsOffSharp = props => <Icon as={MaterialSensorsOffSharpSvg} {...props} />

MaterialSensorsOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialSensorsOffSharp.propTypes = { ...Icon.propTypes }

export default MaterialSensorsOffSharp
