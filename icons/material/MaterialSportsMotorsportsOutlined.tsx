...
const MaterialSportsMotorsportsOutlinedSvg = props => (
  <svg
...
const MaterialSportsMotorsportsOutlined = props => <Icon as={MaterialSportsMotorsportsOutlinedSvg} {...props} />

MaterialSportsMotorsportsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSportsMotorsportsOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSportsMotorsportsOutlined
