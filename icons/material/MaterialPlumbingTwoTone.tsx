...
const MaterialPlumbingTwoToneSvg = props => (
  <svg
...
const MaterialPlumbingTwoTone = props => <Icon as={MaterialPlumbingTwoToneSvg} {...props} />

MaterialPlumbingTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPlumbingTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialPlumbingTwoTone
