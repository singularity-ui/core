...
const MaterialCompressRoundedSvg = props => (
  <svg
...
const MaterialCompressRounded = props => <Icon as={MaterialCompressRoundedSvg} {...props} />

MaterialCompressRounded.defaultProps = { ...Icon.defaultProps }

MaterialCompressRounded.propTypes = { ...Icon.propTypes }
