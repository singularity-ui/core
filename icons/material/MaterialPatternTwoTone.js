...
const MaterialPatternTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPatternTwoTone = (styled.default || styled)(MaterialPatternTwoToneSvg).attrs(p => ({
...
`;
MaterialPatternTwoTone.propTypes = {
