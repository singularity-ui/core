...
const MaterialRadarSharpSvg = props => (
  <svg
...
const MaterialRadarSharp = props => <Icon as={MaterialRadarSharpSvg} {...props} />

MaterialRadarSharp.defaultProps = { ...Icon.defaultProps }

MaterialRadarSharp.propTypes = { ...Icon.propTypes }

export default MaterialRadarSharp
