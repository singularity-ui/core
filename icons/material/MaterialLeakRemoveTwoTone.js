...
const MaterialLeakRemoveTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLeakRemoveTwoTone = (styled.default || styled)(MaterialLeakRemoveTwoToneSvg).attrs(p => ({
...
`;
MaterialLeakRemoveTwoTone.propTypes = {
