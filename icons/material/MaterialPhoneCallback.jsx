...
const MaterialPhoneCallbackSvg = props => (
...
const MaterialPhoneCallback = props => <Icon as={MaterialPhoneCallbackSvg} {...props} />

MaterialPhoneCallback.defaultProps = { ...Icon.defaultProps }

MaterialPhoneCallback.propTypes = { ...Icon.propTypes }

export default MaterialPhoneCallback
