...
const MaterialPestControlOutlinedSvg = props => (
  <svg
...
const MaterialPestControlOutlined = props => <Icon as={MaterialPestControlOutlinedSvg} {...props} />

MaterialPestControlOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPestControlOutlined.propTypes = { ...Icon.propTypes }
