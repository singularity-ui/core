...
const MaterialShuffleRoundedSvg = props => (
...
const MaterialShuffleRounded = props => <Icon as={MaterialShuffleRoundedSvg} {...props} />

MaterialShuffleRounded.defaultProps = { ...Icon.defaultProps }

MaterialShuffleRounded.propTypes = { ...Icon.propTypes }
