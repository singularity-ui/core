...
const MaterialHideImageRoundedSvg = props => (
  <svg
...
const MaterialHideImageRounded = props => <Icon as={MaterialHideImageRoundedSvg} {...props} />

MaterialHideImageRounded.defaultProps = { ...Icon.defaultProps }

MaterialHideImageRounded.propTypes = { ...Icon.propTypes }
