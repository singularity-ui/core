...
const MaterialAddLinkRoundedSvg = props => (
  <svg
...
const MaterialAddLinkRounded = props => <Icon as={MaterialAddLinkRoundedSvg} {...props} />

MaterialAddLinkRounded.defaultProps = { ...Icon.defaultProps }

MaterialAddLinkRounded.propTypes = { ...Icon.propTypes }
