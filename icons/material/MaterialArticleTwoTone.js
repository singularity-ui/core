...
const MaterialArticleTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialArticleTwoTone = (styled.default || styled)(MaterialArticleTwoToneSvg).attrs(p => ({
...
`;
MaterialArticleTwoTone.propTypes = {
