...
const MaterialBlurOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBlurOffRounded = (styled.default || styled)(MaterialBlurOffRoundedSvg).attrs(p => ({
...
`;
MaterialBlurOffRounded.propTypes = {
