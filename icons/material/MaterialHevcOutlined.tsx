...
const MaterialHevcOutlinedSvg = props => (
  <svg
...
const MaterialHevcOutlined = props => <Icon as={MaterialHevcOutlinedSvg} {...props} />

MaterialHevcOutlined.defaultProps = { ...Icon.defaultProps }

MaterialHevcOutlined.propTypes = { ...Icon.propTypes }

export default MaterialHevcOutlined
