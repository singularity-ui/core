...
const MaterialCampaignSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCampaignSharp = (styled.default || styled)(MaterialCampaignSharpSvg).attrs(p => ({
...
`;
MaterialCampaignSharp.propTypes = {
