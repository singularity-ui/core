...
const MaterialIcecreamRoundedSvg = props => (
  <svg
...
const MaterialIcecreamRounded = props => <Icon as={MaterialIcecreamRoundedSvg} {...props} />

MaterialIcecreamRounded.defaultProps = { ...Icon.defaultProps }

MaterialIcecreamRounded.propTypes = { ...Icon.propTypes }
