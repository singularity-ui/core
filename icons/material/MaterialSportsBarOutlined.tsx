...
const MaterialSportsBarOutlinedSvg = props => (
  <svg
...
const MaterialSportsBarOutlined = props => <Icon as={MaterialSportsBarOutlinedSvg} {...props} />

MaterialSportsBarOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSportsBarOutlined.propTypes = { ...Icon.propTypes }
