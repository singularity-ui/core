...
const MaterialWifiOffRoundedSvg = props => (
...
const MaterialWifiOffRounded = props => <Icon as={MaterialWifiOffRoundedSvg} {...props} />

MaterialWifiOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialWifiOffRounded.propTypes = { ...Icon.propTypes }
