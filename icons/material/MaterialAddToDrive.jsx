...
const MaterialAddToDriveSvg = props => (
  <svg
...
const MaterialAddToDrive = props => <Icon as={MaterialAddToDriveSvg} {...props} />

MaterialAddToDrive.defaultProps = { ...Icon.defaultProps }

MaterialAddToDrive.propTypes = { ...Icon.propTypes }

export default MaterialAddToDrive
