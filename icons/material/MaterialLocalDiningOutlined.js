...
const MaterialLocalDiningOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLocalDiningOutlined = (styled.default || styled)(MaterialLocalDiningOutlinedSvg).attrs(p => ({
...
`;
MaterialLocalDiningOutlined.propTypes = {
