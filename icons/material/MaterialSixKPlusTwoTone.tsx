...
const MaterialSixKPlusTwoToneSvg = props => (
  <svg
...
const MaterialSixKPlusTwoTone = props => <Icon as={MaterialSixKPlusTwoToneSvg} {...props} />

MaterialSixKPlusTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialSixKPlusTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialSixKPlusTwoTone
