...
const MaterialPatternRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPatternRounded = (styled.default || styled)(MaterialPatternRoundedSvg).attrs(p => ({
...
`;
MaterialPatternRounded.propTypes = {
