...
const MaterialDraftsTwoToneSvg = props => (
...
const MaterialDraftsTwoTone = props => <Icon as={MaterialDraftsTwoToneSvg} {...props} />

MaterialDraftsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDraftsTwoTone.propTypes = { ...Icon.propTypes }
