...
const MaterialDriveFileRenameOutlineOutlinedSvg = props => (
  <svg
...
const MaterialDriveFileRenameOutlineOutlined = props => (
  <Icon as={MaterialDriveFileRenameOutlineOutlinedSvg} {...props} />
)

MaterialDriveFileRenameOutlineOutlined.defaultProps = { ...Icon.defaultProps }

MaterialDriveFileRenameOutlineOutlined.propTypes = { ...Icon.propTypes }
