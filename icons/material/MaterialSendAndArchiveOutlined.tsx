...
const MaterialSendAndArchiveOutlinedSvg = props => (
  <svg
...
const MaterialSendAndArchiveOutlined = props => <Icon as={MaterialSendAndArchiveOutlinedSvg} {...props} />

MaterialSendAndArchiveOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSendAndArchiveOutlined.propTypes = { ...Icon.propTypes }

export default MaterialSendAndArchiveOutlined
