...
const MaterialSearchOffSharpSvg = props => (
  <svg
...
const MaterialSearchOffSharp = props => <Icon as={MaterialSearchOffSharpSvg} {...props} />

MaterialSearchOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialSearchOffSharp.propTypes = { ...Icon.propTypes }

export default MaterialSearchOffSharp
