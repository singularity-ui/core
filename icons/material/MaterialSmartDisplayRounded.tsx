...
const MaterialSmartDisplayRoundedSvg = props => (
  <svg
...
const MaterialSmartDisplayRounded = props => <Icon as={MaterialSmartDisplayRoundedSvg} {...props} />

MaterialSmartDisplayRounded.defaultProps = { ...Icon.defaultProps }

MaterialSmartDisplayRounded.propTypes = { ...Icon.propTypes }
