...
const MaterialVideoSettingsSvg = props => (
  <svg
...
const MaterialVideoSettings = props => <Icon as={MaterialVideoSettingsSvg} {...props} />

MaterialVideoSettings.defaultProps = { ...Icon.defaultProps }

MaterialVideoSettings.propTypes = { ...Icon.propTypes }

export default MaterialVideoSettings
