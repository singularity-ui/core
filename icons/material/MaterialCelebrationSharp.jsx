...
const MaterialCelebrationSharpSvg = props => (
  <svg
...
const MaterialCelebrationSharp = props => <Icon as={MaterialCelebrationSharpSvg} {...props} />

MaterialCelebrationSharp.defaultProps = { ...Icon.defaultProps }

MaterialCelebrationSharp.propTypes = { ...Icon.propTypes }
