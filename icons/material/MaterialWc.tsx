...
const MaterialWc = props => <Icon as={MaterialWcSvg} {...props} />

MaterialWc.defaultProps = { ...Icon.defaultProps }

MaterialWc.propTypes = { ...Icon.propTypes }

export default MaterialWc
