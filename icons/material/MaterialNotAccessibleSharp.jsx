...
const MaterialNotAccessibleSharpSvg = props => (
  <svg
...
const MaterialNotAccessibleSharp = props => <Icon as={MaterialNotAccessibleSharpSvg} {...props} />

MaterialNotAccessibleSharp.defaultProps = { ...Icon.defaultProps }

MaterialNotAccessibleSharp.propTypes = { ...Icon.propTypes }

export default MaterialNotAccessibleSharp
