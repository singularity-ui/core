...
const MaterialAutoFixHighTwoToneSvg = props => (
  <svg
...
const MaterialAutoFixHighTwoTone = props => <Icon as={MaterialAutoFixHighTwoToneSvg} {...props} />

MaterialAutoFixHighTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialAutoFixHighTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialAutoFixHighTwoTone
