...
const MaterialVerifiedOutlinedSvg = props => (
  <svg
...
const MaterialVerifiedOutlined = props => <Icon as={MaterialVerifiedOutlinedSvg} {...props} />

MaterialVerifiedOutlined.defaultProps = { ...Icon.defaultProps }

MaterialVerifiedOutlined.propTypes = { ...Icon.propTypes }

export default MaterialVerifiedOutlined
