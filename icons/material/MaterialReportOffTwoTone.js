...
const MaterialReportOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReportOffTwoTone = (styled.default || styled)(MaterialReportOffTwoToneSvg).attrs(p => ({
...
`;
MaterialReportOffTwoTone.propTypes = {
