...
const MaterialRestartAltSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRestartAltSharp = (styled.default || styled)(MaterialRestartAltSharpSvg).attrs(p => ({
...
`;
MaterialRestartAltSharp.propTypes = {
