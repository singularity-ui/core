...
const MaterialAttachEmailSvg = props => (
  <svg
...
const MaterialAttachEmail = props => <Icon as={MaterialAttachEmailSvg} {...props} />

MaterialAttachEmail.defaultProps = { ...Icon.defaultProps }

MaterialAttachEmail.propTypes = { ...Icon.propTypes }

export default MaterialAttachEmail
