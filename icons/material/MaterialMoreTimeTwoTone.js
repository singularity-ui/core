...
const MaterialMoreTimeTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMoreTimeTwoTone = (styled.default || styled)(MaterialMoreTimeTwoToneSvg).attrs(p => ({
...
`;
MaterialMoreTimeTwoTone.propTypes = {
