...
const MaterialTransgenderSharpSvg = props => (
  <svg
...
const MaterialTransgenderSharp = props => <Icon as={MaterialTransgenderSharpSvg} {...props} />

MaterialTransgenderSharp.defaultProps = { ...Icon.defaultProps }

MaterialTransgenderSharp.propTypes = { ...Icon.propTypes }

export default MaterialTransgenderSharp
