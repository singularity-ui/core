...
const MaterialBiotechOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBiotechOutlined = (styled.default || styled)(MaterialBiotechOutlinedSvg).attrs(p => ({
...
`;
MaterialBiotechOutlined.propTypes = {
