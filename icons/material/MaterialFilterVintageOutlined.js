...
const MaterialFilterVintageOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFilterVintageOutlined = (styled.default || styled)(MaterialFilterVintageOutlinedSvg).attrs(p => ({
...
`;
MaterialFilterVintageOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFilterVintageOutlined;