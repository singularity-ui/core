...
const MaterialAirSharpSvg = props => (
  <svg
...
const MaterialAirSharp = props => <Icon as={MaterialAirSharpSvg} {...props} />

MaterialAirSharp.defaultProps = { ...Icon.defaultProps }

MaterialAirSharp.propTypes = { ...Icon.propTypes }

export default MaterialAirSharp
