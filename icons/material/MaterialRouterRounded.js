...
const MaterialRouterRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRouterRounded = (styled.default || styled)(MaterialRouterRoundedSvg).attrs(p => ({
...
`;
MaterialRouterRounded.propTypes = {
