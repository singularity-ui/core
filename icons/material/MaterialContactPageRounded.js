...
const MaterialContactPageRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialContactPageRounded = (styled.default || styled)(MaterialContactPageRoundedSvg).attrs(p => ({
...
`;
MaterialContactPageRounded.propTypes = {
