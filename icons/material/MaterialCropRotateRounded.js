...
const MaterialCropRotateRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCropRotateRounded = (styled.default || styled)(MaterialCropRotateRoundedSvg).attrs(p => ({
...
`;
MaterialCropRotateRounded.propTypes = {
