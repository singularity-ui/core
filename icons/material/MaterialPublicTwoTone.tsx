...
const MaterialPublicTwoToneSvg = props => (
...
const MaterialPublicTwoTone = props => <Icon as={MaterialPublicTwoToneSvg} {...props} />

MaterialPublicTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialPublicTwoTone.propTypes = { ...Icon.propTypes }
