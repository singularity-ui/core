...
const MaterialGTranslateTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGTranslateTwoTone = (styled.default || styled)(MaterialGTranslateTwoToneSvg).attrs(p => ({
...
`;
MaterialGTranslateTwoTone.propTypes = {
