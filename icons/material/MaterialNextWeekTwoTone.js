...
const MaterialNextWeekTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNextWeekTwoTone = (styled.default || styled)(MaterialNextWeekTwoToneSvg).attrs(p => ({
...
`;
MaterialNextWeekTwoTone.propTypes = {
