...
const MaterialSixKPlusOutlinedSvg = props => (
  <svg
...
const MaterialSixKPlusOutlined = props => <Icon as={MaterialSixKPlusOutlinedSvg} {...props} />

MaterialSixKPlusOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSixKPlusOutlined.propTypes = { ...Icon.propTypes }
