...
const MaterialParaglidingSvg = props => (
  <svg
...
const MaterialParagliding = props => <Icon as={MaterialParaglidingSvg} {...props} />

MaterialParagliding.defaultProps = { ...Icon.defaultProps }

MaterialParagliding.propTypes = { ...Icon.propTypes }
