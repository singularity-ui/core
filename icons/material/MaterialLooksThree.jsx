...
const MaterialLooksThreeSvg = props => (
...
const MaterialLooksThree = props => <Icon as={MaterialLooksThreeSvg} {...props} />

MaterialLooksThree.defaultProps = { ...Icon.defaultProps }

MaterialLooksThree.propTypes = { ...Icon.propTypes }

export default MaterialLooksThree
