...
const MaterialAccessibleRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAccessibleRounded = (styled.default || styled)(MaterialAccessibleRoundedSvg).attrs(p => ({
...
`;
MaterialAccessibleRounded.propTypes = {
