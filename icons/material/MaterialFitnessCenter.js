...
const MaterialFitnessCenterSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFitnessCenter = (styled.default || styled)(MaterialFitnessCenterSvg).attrs(p => ({
...
`;
MaterialFitnessCenter.propTypes = {
