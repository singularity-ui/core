...
const MaterialRadarRoundedSvg = props => (
  <svg
...
const MaterialRadarRounded = props => <Icon as={MaterialRadarRoundedSvg} {...props} />

MaterialRadarRounded.defaultProps = { ...Icon.defaultProps }

MaterialRadarRounded.propTypes = { ...Icon.propTypes }

export default MaterialRadarRounded
