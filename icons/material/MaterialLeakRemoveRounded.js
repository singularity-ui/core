...
const MaterialLeakRemoveRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLeakRemoveRounded = (styled.default || styled)(MaterialLeakRemoveRoundedSvg).attrs(p => ({
...
`;
MaterialLeakRemoveRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialLeakRemoveRounded;