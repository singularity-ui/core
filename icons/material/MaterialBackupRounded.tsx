...
const MaterialBackupRoundedSvg = props => (
  <svg
...
const MaterialBackupRounded = props => <Icon as={MaterialBackupRoundedSvg} {...props} />

MaterialBackupRounded.defaultProps = { ...Icon.defaultProps }

MaterialBackupRounded.propTypes = { ...Icon.propTypes }
