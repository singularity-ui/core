...
const MaterialRiceBowlSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRiceBowlSharp = (styled.default || styled)(MaterialRiceBowlSharpSvg).attrs(p => ({
...
`;
MaterialRiceBowlSharp.propTypes = {
