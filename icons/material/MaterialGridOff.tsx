...
const MaterialGridOffSvg = props => (
...
const MaterialGridOff = props => <Icon as={MaterialGridOffSvg} {...props} />

MaterialGridOff.defaultProps = { ...Icon.defaultProps }

MaterialGridOff.propTypes = { ...Icon.propTypes }

export default MaterialGridOff
