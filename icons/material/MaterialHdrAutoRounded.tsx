...
const MaterialHdrAutoRoundedSvg = props => (
  <svg
...
const MaterialHdrAutoRounded = props => <Icon as={MaterialHdrAutoRoundedSvg} {...props} />

MaterialHdrAutoRounded.defaultProps = { ...Icon.defaultProps }

MaterialHdrAutoRounded.propTypes = { ...Icon.propTypes }
