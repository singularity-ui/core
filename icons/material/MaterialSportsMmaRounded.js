...
const MaterialSportsMmaRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSportsMmaRounded = (styled.default || styled)(MaterialSportsMmaRoundedSvg).attrs(p => ({
...
`;
MaterialSportsMmaRounded.propTypes = {
