...
const MaterialSailingTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSailingTwoTone = (styled.default || styled)(MaterialSailingTwoToneSvg).attrs(p => ({
...
`;
MaterialSailingTwoTone.propTypes = {
