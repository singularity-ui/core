...
const MaterialRiceBowlTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRiceBowlTwoTone = (styled.default || styled)(MaterialRiceBowlTwoToneSvg).attrs(p => ({
...
`;
MaterialRiceBowlTwoTone.propTypes = {
