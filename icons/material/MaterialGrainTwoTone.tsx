...
const MaterialGrainTwoToneSvg = props => (
...
const MaterialGrainTwoTone = props => <Icon as={MaterialGrainTwoToneSvg} {...props} />

MaterialGrainTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialGrainTwoTone.propTypes = { ...Icon.propTypes }
