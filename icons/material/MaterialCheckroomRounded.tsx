...
const MaterialCheckroomRoundedSvg = props => (
  <svg
...
const MaterialCheckroomRounded = props => <Icon as={MaterialCheckroomRoundedSvg} {...props} />

MaterialCheckroomRounded.defaultProps = { ...Icon.defaultProps }

MaterialCheckroomRounded.propTypes = { ...Icon.propTypes }
