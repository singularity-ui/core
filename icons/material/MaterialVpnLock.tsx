...
const MaterialVpnLockSvg = props => (
...
const MaterialVpnLock = props => <Icon as={MaterialVpnLockSvg} {...props} />

MaterialVpnLock.defaultProps = { ...Icon.defaultProps }

MaterialVpnLock.propTypes = { ...Icon.propTypes }

export default MaterialVpnLock
