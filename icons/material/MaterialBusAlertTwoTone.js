...
const MaterialBusAlertTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBusAlertTwoTone = (styled.default || styled)(MaterialBusAlertTwoToneSvg).attrs(p => ({
...
`;
MaterialBusAlertTwoTone.propTypes = {
