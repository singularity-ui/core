...
const MaterialDevicesOtherRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDevicesOtherRounded = (styled.default || styled)(MaterialDevicesOtherRoundedSvg).attrs(p => ({
...
`;
MaterialDevicesOtherRounded.propTypes = {
