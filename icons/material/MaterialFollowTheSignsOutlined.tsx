...
const MaterialFollowTheSignsOutlinedSvg = props => (
  <svg
...
const MaterialFollowTheSignsOutlined = props => <Icon as={MaterialFollowTheSignsOutlinedSvg} {...props} />

MaterialFollowTheSignsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialFollowTheSignsOutlined.propTypes = { ...Icon.propTypes }

export default MaterialFollowTheSignsOutlined
