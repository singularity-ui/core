...
const MaterialBentoRoundedSvg = props => (
  <svg
...
const MaterialBentoRounded = props => <Icon as={MaterialBentoRoundedSvg} {...props} />

MaterialBentoRounded.defaultProps = { ...Icon.defaultProps }

MaterialBentoRounded.propTypes = { ...Icon.propTypes }
