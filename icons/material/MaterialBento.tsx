...
const MaterialBento = props => <Icon as={MaterialBentoSvg} {...props} />

MaterialBento.defaultProps = { ...Icon.defaultProps }

MaterialBento.propTypes = { ...Icon.propTypes }

export default MaterialBento
