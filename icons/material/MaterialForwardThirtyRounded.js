...
const MaterialForwardThirtyRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardThirtyRounded = (styled.default || styled)(MaterialForwardThirtyRoundedSvg).attrs(p => ({
...
`;
MaterialForwardThirtyRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialForwardThirtyRounded;