...
const MaterialCatchingPokemonSvg = props => (
  <svg
...
const MaterialCatchingPokemon = props => <Icon as={MaterialCatchingPokemonSvg} {...props} />

MaterialCatchingPokemon.defaultProps = { ...Icon.defaultProps }

MaterialCatchingPokemon.propTypes = { ...Icon.propTypes }
