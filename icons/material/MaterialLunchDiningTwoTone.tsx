...
const MaterialLunchDiningTwoToneSvg = props => (
  <svg
...
const MaterialLunchDiningTwoTone = props => <Icon as={MaterialLunchDiningTwoToneSvg} {...props} />

MaterialLunchDiningTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialLunchDiningTwoTone.propTypes = { ...Icon.propTypes }
