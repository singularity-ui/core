...
const MaterialPersonOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPersonOffTwoTone = (styled.default || styled)(MaterialPersonOffTwoToneSvg).attrs(p => ({
...
`;
MaterialPersonOffTwoTone.propTypes = {
