...
const MaterialLocalAtmSvg = props => (
...
const MaterialLocalAtm = props => <Icon as={MaterialLocalAtmSvg} {...props} />

MaterialLocalAtm.defaultProps = { ...Icon.defaultProps }

MaterialLocalAtm.propTypes = { ...Icon.propTypes }

export default MaterialLocalAtm
