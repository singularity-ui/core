...
const MaterialFlipCameraIosSvg = props => (
  <svg
...
const MaterialFlipCameraIos = props => <Icon as={MaterialFlipCameraIosSvg} {...props} />

MaterialFlipCameraIos.defaultProps = { ...Icon.defaultProps }

MaterialFlipCameraIos.propTypes = { ...Icon.propTypes }
