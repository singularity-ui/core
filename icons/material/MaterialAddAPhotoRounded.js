...
const MaterialAddAPhotoRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAddAPhotoRounded = (styled.default || styled)(MaterialAddAPhotoRoundedSvg).attrs(p => ({
...
`;
MaterialAddAPhotoRounded.propTypes = {
