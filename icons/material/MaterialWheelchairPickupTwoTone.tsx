...
const MaterialWheelchairPickupTwoToneSvg = props => (
  <svg
...
const MaterialWheelchairPickupTwoTone = props => <Icon as={MaterialWheelchairPickupTwoToneSvg} {...props} />

MaterialWheelchairPickupTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialWheelchairPickupTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialWheelchairPickupTwoTone
