...
const MaterialVideoCameraFrontSharpSvg = props => (
  <svg
...
const MaterialVideoCameraFrontSharp = props => <Icon as={MaterialVideoCameraFrontSharpSvg} {...props} />

MaterialVideoCameraFrontSharp.defaultProps = { ...Icon.defaultProps }

MaterialVideoCameraFrontSharp.propTypes = { ...Icon.propTypes }
