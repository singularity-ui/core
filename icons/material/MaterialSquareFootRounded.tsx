...
const MaterialSquareFootRoundedSvg = props => (
  <svg
...
const MaterialSquareFootRounded = props => <Icon as={MaterialSquareFootRoundedSvg} {...props} />

MaterialSquareFootRounded.defaultProps = { ...Icon.defaultProps }

MaterialSquareFootRounded.propTypes = { ...Icon.propTypes }
