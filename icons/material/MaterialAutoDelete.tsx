...
const MaterialAutoDeleteSvg = props => (
  <svg
...
const MaterialAutoDelete = props => <Icon as={MaterialAutoDeleteSvg} {...props} />

MaterialAutoDelete.defaultProps = { ...Icon.defaultProps }

MaterialAutoDelete.propTypes = { ...Icon.propTypes }

export default MaterialAutoDelete
