...
const MaterialWysiwygSvg = props => (
  <svg
...
const MaterialWysiwyg = props => <Icon as={MaterialWysiwygSvg} {...props} />

MaterialWysiwyg.defaultProps = { ...Icon.defaultProps }

MaterialWysiwyg.propTypes = { ...Icon.propTypes }
