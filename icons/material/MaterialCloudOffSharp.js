...
const MaterialCloudOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCloudOffSharp = (styled.default || styled)(MaterialCloudOffSharpSvg).attrs(p => ({
...
`;
MaterialCloudOffSharp.propTypes = {
