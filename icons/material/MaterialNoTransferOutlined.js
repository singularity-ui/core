...
const MaterialNoTransferOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoTransferOutlined = (styled.default || styled)(MaterialNoTransferOutlinedSvg).attrs(p => ({
...
`;
MaterialNoTransferOutlined.propTypes = {
