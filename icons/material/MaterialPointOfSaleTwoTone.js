...
const MaterialPointOfSaleTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPointOfSaleTwoTone = (styled.default || styled)(MaterialPointOfSaleTwoToneSvg).attrs(p => ({
...
`;
MaterialPointOfSaleTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialPointOfSaleTwoTone;