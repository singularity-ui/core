...
const MaterialConnectWithoutContactSvg = props => (
  <svg
...
const MaterialConnectWithoutContact = props => <Icon as={MaterialConnectWithoutContactSvg} {...props} />

MaterialConnectWithoutContact.defaultProps = { ...Icon.defaultProps }

MaterialConnectWithoutContact.propTypes = { ...Icon.propTypes }

export default MaterialConnectWithoutContact
