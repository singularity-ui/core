...
const MaterialAtmOutlinedSvg = props => (
...
const MaterialAtmOutlined = props => <Icon as={MaterialAtmOutlinedSvg} {...props} />

MaterialAtmOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAtmOutlined.propTypes = { ...Icon.propTypes }
