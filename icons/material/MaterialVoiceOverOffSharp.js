...
const MaterialVoiceOverOffSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVoiceOverOffSharp = (styled.default || styled)(MaterialVoiceOverOffSharpSvg).attrs(p => ({
...
`;
MaterialVoiceOverOffSharp.propTypes = {
