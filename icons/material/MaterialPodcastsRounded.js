...
const MaterialPodcastsRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
`;
MaterialPodcastsRounded.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialPodcastsRounded;