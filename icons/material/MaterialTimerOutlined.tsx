...
const MaterialTimerOutlinedSvg = props => (
...
const MaterialTimerOutlined = props => <Icon as={MaterialTimerOutlinedSvg} {...props} />

MaterialTimerOutlined.defaultProps = { ...Icon.defaultProps }

MaterialTimerOutlined.propTypes = { ...Icon.propTypes }

export default MaterialTimerOutlined
