...
const MaterialWysiwygRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWysiwygRounded = (styled.default || styled)(MaterialWysiwygRoundedSvg).attrs(p => ({
...
`;
MaterialWysiwygRounded.propTypes = {
