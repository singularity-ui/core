...
const MaterialPaletteOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPaletteOutlined = (styled.default || styled)(MaterialPaletteOutlinedSvg).attrs(p => ({
...
`;
MaterialPaletteOutlined.propTypes = {
