...
const MaterialBookOnlineTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
  ...
  d: "M17,4H7V3h10V4z M17,21H7v-1h10V21z",
  opacity: ".3"
}), /*#__PURE__*/React.createElement("path", {
...
const MaterialBookOnlineTwoTone = (styled.default || styled)(MaterialBookOnlineTwoToneSvg).attrs(p => ({
...
`;
MaterialBookOnlineTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialBookOnlineTwoTone;