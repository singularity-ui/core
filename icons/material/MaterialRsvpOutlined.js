...
const MaterialRsvpOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRsvpOutlined = (styled.default || styled)(MaterialRsvpOutlinedSvg).attrs(p => ({
...
`;
MaterialRsvpOutlined.propTypes = {
