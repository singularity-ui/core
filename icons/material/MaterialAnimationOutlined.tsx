...
const MaterialAnimationOutlinedSvg = props => (
  <svg
...
const MaterialAnimationOutlined = props => <Icon as={MaterialAnimationOutlinedSvg} {...props} />

MaterialAnimationOutlined.defaultProps = { ...Icon.defaultProps }

MaterialAnimationOutlined.propTypes = { ...Icon.propTypes }
