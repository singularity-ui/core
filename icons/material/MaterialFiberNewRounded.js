...
const MaterialFiberNewRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFiberNewRounded = (styled.default || styled)(MaterialFiberNewRoundedSvg).attrs(p => ({
...
`;
MaterialFiberNewRounded.propTypes = {
