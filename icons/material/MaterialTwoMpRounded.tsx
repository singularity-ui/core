...
const MaterialTwoMpRoundedSvg = props => (
  <svg
...
const MaterialTwoMpRounded = props => <Icon as={MaterialTwoMpRoundedSvg} {...props} />

MaterialTwoMpRounded.defaultProps = { ...Icon.defaultProps }

MaterialTwoMpRounded.propTypes = { ...Icon.propTypes }

export default MaterialTwoMpRounded
