...
const MaterialAlarmOnTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAlarmOnTwoTone = (styled.default || styled)(MaterialAlarmOnTwoToneSvg).attrs(p => ({
...
`;
MaterialAlarmOnTwoTone.propTypes = {
