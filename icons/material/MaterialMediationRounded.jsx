...
const MaterialMediationRoundedSvg = props => (
  <svg
...
const MaterialMediationRounded = props => <Icon as={MaterialMediationRoundedSvg} {...props} />

MaterialMediationRounded.defaultProps = { ...Icon.defaultProps }

MaterialMediationRounded.propTypes = { ...Icon.propTypes }

export default MaterialMediationRounded
