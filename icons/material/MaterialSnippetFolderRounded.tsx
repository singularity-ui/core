...
const MaterialSnippetFolderRoundedSvg = props => (
  <svg
...
const MaterialSnippetFolderRounded = props => <Icon as={MaterialSnippetFolderRoundedSvg} {...props} />

MaterialSnippetFolderRounded.defaultProps = { ...Icon.defaultProps }

MaterialSnippetFolderRounded.propTypes = { ...Icon.propTypes }
