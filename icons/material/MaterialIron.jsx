...
const MaterialIron = props => <Icon as={MaterialIronSvg} {...props} />

MaterialIron.defaultProps = { ...Icon.defaultProps }

MaterialIron.propTypes = { ...Icon.propTypes }

export default MaterialIron
