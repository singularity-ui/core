...
const MaterialAddTaskRoundedSvg = props => (
  <svg
...
const MaterialAddTaskRounded = props => <Icon as={MaterialAddTaskRoundedSvg} {...props} />

MaterialAddTaskRounded.defaultProps = { ...Icon.defaultProps }

MaterialAddTaskRounded.propTypes = { ...Icon.propTypes }

export default MaterialAddTaskRounded
