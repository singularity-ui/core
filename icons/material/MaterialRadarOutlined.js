...
const MaterialRadarOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRadarOutlined = (styled.default || styled)(MaterialRadarOutlinedSvg).attrs(p => ({
...
`;
MaterialRadarOutlined.propTypes = {
