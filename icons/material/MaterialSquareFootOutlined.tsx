...
const MaterialSquareFootOutlinedSvg = props => (
  <svg
...
const MaterialSquareFootOutlined = props => <Icon as={MaterialSquareFootOutlinedSvg} {...props} />

MaterialSquareFootOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSquareFootOutlined.propTypes = { ...Icon.propTypes }
