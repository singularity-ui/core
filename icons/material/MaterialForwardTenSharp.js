...
const MaterialForwardTenSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardTenSharp = (styled.default || styled)(MaterialForwardTenSharpSvg).attrs(p => ({
...
`;
MaterialForwardTenSharp.propTypes = {
