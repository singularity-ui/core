...
const MaterialLocalActivitySvg = props => (
...
const MaterialLocalActivity = props => <Icon as={MaterialLocalActivitySvg} {...props} />

MaterialLocalActivity.defaultProps = { ...Icon.defaultProps }

MaterialLocalActivity.propTypes = { ...Icon.propTypes }

export default MaterialLocalActivity
