...
const MaterialCloudQueueOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCloudQueueOutlined = (styled.default || styled)(MaterialCloudQueueOutlinedSvg).attrs(p => ({
...
`;
MaterialCloudQueueOutlined.propTypes = {
