...
const MaterialStairsTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStairsTwoTone = (styled.default || styled)(MaterialStairsTwoToneSvg).attrs(p => ({
...
`;
MaterialStairsTwoTone.propTypes = {
