...
const MaterialCountertopsSvg = props => (
  <svg
...
const MaterialCountertops = props => <Icon as={MaterialCountertopsSvg} {...props} />

MaterialCountertops.defaultProps = { ...Icon.defaultProps }

MaterialCountertops.propTypes = { ...Icon.propTypes }
