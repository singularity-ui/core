...
const MaterialSquareFootSvg = props => (
  <svg
...
const MaterialSquareFoot = props => <Icon as={MaterialSquareFootSvg} {...props} />

MaterialSquareFoot.defaultProps = { ...Icon.defaultProps }

MaterialSquareFoot.propTypes = { ...Icon.propTypes }

export default MaterialSquareFoot
