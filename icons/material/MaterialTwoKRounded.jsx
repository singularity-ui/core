...
const MaterialTwoKRoundedSvg = props => (
  <svg
...
const MaterialTwoKRounded = props => <Icon as={MaterialTwoKRoundedSvg} {...props} />

MaterialTwoKRounded.defaultProps = { ...Icon.defaultProps }

MaterialTwoKRounded.propTypes = { ...Icon.propTypes }

export default MaterialTwoKRounded
