...
const MaterialBatchPredictionOutlinedSvg = props => (
  <svg
...
const MaterialBatchPredictionOutlined = props => <Icon as={MaterialBatchPredictionOutlinedSvg} {...props} />

MaterialBatchPredictionOutlined.defaultProps = { ...Icon.defaultProps }

MaterialBatchPredictionOutlined.propTypes = { ...Icon.propTypes }

export default MaterialBatchPredictionOutlined
