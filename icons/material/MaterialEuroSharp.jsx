...
const MaterialEuroSharpSvg = props => (
  <svg
...
const MaterialEuroSharp = props => <Icon as={MaterialEuroSharpSvg} {...props} />

MaterialEuroSharp.defaultProps = { ...Icon.defaultProps }

MaterialEuroSharp.propTypes = { ...Icon.propTypes }

export default MaterialEuroSharp
