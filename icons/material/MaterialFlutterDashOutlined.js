...
const MaterialFlutterDashOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlutterDashOutlined = (styled.default || styled)(MaterialFlutterDashOutlinedSvg).attrs(p => ({
...
`;
MaterialFlutterDashOutlined.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialFlutterDashOutlined;