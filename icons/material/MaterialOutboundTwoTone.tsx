...
const MaterialOutboundTwoToneSvg = props => (
  <svg
...
const MaterialOutboundTwoTone = props => <Icon as={MaterialOutboundTwoToneSvg} {...props} />

MaterialOutboundTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialOutboundTwoTone.propTypes = { ...Icon.propTypes }
