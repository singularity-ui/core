...
const MaterialStrikethroughSTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialStrikethroughSTwoTone = (styled.default || styled)(MaterialStrikethroughSTwoToneSvg).attrs(p => ({
...
`;
MaterialStrikethroughSTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialStrikethroughSTwoTone;