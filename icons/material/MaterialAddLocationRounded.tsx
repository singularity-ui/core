...
const MaterialAddLocationRoundedSvg = props => (
  <svg
...
const MaterialAddLocationRounded = props => <Icon as={MaterialAddLocationRoundedSvg} {...props} />

MaterialAddLocationRounded.defaultProps = { ...Icon.defaultProps }

MaterialAddLocationRounded.propTypes = { ...Icon.propTypes }
