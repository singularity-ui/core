...
const MaterialHardwareRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHardwareRounded = (styled.default || styled)(MaterialHardwareRoundedSvg).attrs(p => ({
...
`;
MaterialHardwareRounded.propTypes = {
