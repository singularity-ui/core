...
const MaterialDownloadingSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDownloadingSharp = (styled.default || styled)(MaterialDownloadingSharpSvg).attrs(p => ({
...
`;
MaterialDownloadingSharp.propTypes = {
