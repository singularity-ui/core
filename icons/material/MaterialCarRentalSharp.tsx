...
const MaterialCarRentalSharpSvg = props => (
  <svg
...
const MaterialCarRentalSharp = props => <Icon as={MaterialCarRentalSharpSvg} {...props} />

MaterialCarRentalSharp.defaultProps = { ...Icon.defaultProps }

MaterialCarRentalSharp.propTypes = { ...Icon.propTypes }

export default MaterialCarRentalSharp
