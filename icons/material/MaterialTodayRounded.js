...
const MaterialTodayRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTodayRounded = (styled.default || styled)(MaterialTodayRoundedSvg).attrs(p => ({
...
`;
MaterialTodayRounded.propTypes = {
