...
const MaterialChairTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialChairTwoTone = (styled.default || styled)(MaterialChairTwoToneSvg).attrs(p => ({
...
`;
MaterialChairTwoTone.propTypes = {
