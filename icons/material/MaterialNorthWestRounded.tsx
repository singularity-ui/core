...
const MaterialNorthWestRoundedSvg = props => (
  <svg
...
const MaterialNorthWestRounded = props => <Icon as={MaterialNorthWestRoundedSvg} {...props} />

MaterialNorthWestRounded.defaultProps = { ...Icon.defaultProps }

MaterialNorthWestRounded.propTypes = { ...Icon.propTypes }
