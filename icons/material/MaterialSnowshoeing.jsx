...
const MaterialSnowshoeingSvg = props => (
  <svg
...
const MaterialSnowshoeing = props => <Icon as={MaterialSnowshoeingSvg} {...props} />

MaterialSnowshoeing.defaultProps = { ...Icon.defaultProps }

MaterialSnowshoeing.propTypes = { ...Icon.propTypes }

export default MaterialSnowshoeing
