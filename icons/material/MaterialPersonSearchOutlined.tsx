...
const MaterialPersonSearchOutlinedSvg = props => (
  <svg
...
const MaterialPersonSearchOutlined = props => <Icon as={MaterialPersonSearchOutlinedSvg} {...props} />

MaterialPersonSearchOutlined.defaultProps = { ...Icon.defaultProps }

MaterialPersonSearchOutlined.propTypes = { ...Icon.propTypes }

export default MaterialPersonSearchOutlined
