...
const MaterialLiquorOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLiquorOutlined = (styled.default || styled)(MaterialLiquorOutlinedSvg).attrs(p => ({
...
`;
MaterialLiquorOutlined.propTypes = {
