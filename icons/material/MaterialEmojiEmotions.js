...
const MaterialEmojiEmotionsSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEmojiEmotions = (styled.default || styled)(MaterialEmojiEmotionsSvg).attrs(p => ({
...
`;
MaterialEmojiEmotions.propTypes = {
