...
const MaterialAutoFixNormalSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAutoFixNormal = (styled.default || styled)(MaterialAutoFixNormalSvg).attrs(p => ({
...
`;
MaterialAutoFixNormal.propTypes = {
