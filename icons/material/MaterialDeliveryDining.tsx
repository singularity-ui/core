...
const MaterialDeliveryDiningSvg = props => (
  <svg
...
const MaterialDeliveryDining = props => <Icon as={MaterialDeliveryDiningSvg} {...props} />

MaterialDeliveryDining.defaultProps = { ...Icon.defaultProps }

MaterialDeliveryDining.propTypes = { ...Icon.propTypes }

export default MaterialDeliveryDining
