...
const MaterialRotateLeftRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRotateLeftRounded = (styled.default || styled)(MaterialRotateLeftRoundedSvg).attrs(p => ({
...
`;
MaterialRotateLeftRounded.propTypes = {
