...
const MaterialPatternSvg = props => (
  <svg
...
const MaterialPattern = props => <Icon as={MaterialPatternSvg} {...props} />

MaterialPattern.defaultProps = { ...Icon.defaultProps }

MaterialPattern.propTypes = { ...Icon.propTypes }
