...
const MaterialElderlyOutlinedSvg = props => (
  <svg
...
const MaterialElderlyOutlined = props => <Icon as={MaterialElderlyOutlinedSvg} {...props} />

MaterialElderlyOutlined.defaultProps = { ...Icon.defaultProps }

MaterialElderlyOutlined.propTypes = { ...Icon.propTypes }

export default MaterialElderlyOutlined
