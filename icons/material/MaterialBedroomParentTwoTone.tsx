...
const MaterialBedroomParentTwoToneSvg = props => (
  <svg
...
const MaterialBedroomParentTwoTone = props => <Icon as={MaterialBedroomParentTwoToneSvg} {...props} />

MaterialBedroomParentTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialBedroomParentTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialBedroomParentTwoTone
