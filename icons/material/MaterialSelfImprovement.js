...
const MaterialSelfImprovementSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSelfImprovement = (styled.default || styled)(MaterialSelfImprovementSvg).attrs(p => ({
...
`;
MaterialSelfImprovement.propTypes = {
