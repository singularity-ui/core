...
const MaterialTramTwoToneSvg = props => (
...
const MaterialTramTwoTone = props => <Icon as={MaterialTramTwoToneSvg} {...props} />

MaterialTramTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialTramTwoTone.propTypes = { ...Icon.propTypes }
