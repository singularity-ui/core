...
const MaterialTrainOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTrainOutlined = (styled.default || styled)(MaterialTrainOutlinedSvg).attrs(p => ({
...
`;
MaterialTrainOutlined.propTypes = {
