...
const MaterialUsbOffSharpSvg = props => (
  <svg
...
const MaterialUsbOffSharp = props => <Icon as={MaterialUsbOffSharpSvg} {...props} />

MaterialUsbOffSharp.defaultProps = { ...Icon.defaultProps }

MaterialUsbOffSharp.propTypes = { ...Icon.propTypes }

export default MaterialUsbOffSharp
