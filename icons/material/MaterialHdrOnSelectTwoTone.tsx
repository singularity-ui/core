...
const MaterialHdrOnSelectTwoToneSvg = props => (
  <svg
...
const MaterialHdrOnSelectTwoTone = props => <Icon as={MaterialHdrOnSelectTwoToneSvg} {...props} />

MaterialHdrOnSelectTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHdrOnSelectTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialHdrOnSelectTwoTone
