...
const MaterialSavingsRoundedSvg = props => (
  <svg
...
const MaterialSavingsRounded = props => <Icon as={MaterialSavingsRoundedSvg} {...props} />

MaterialSavingsRounded.defaultProps = { ...Icon.defaultProps }

MaterialSavingsRounded.propTypes = { ...Icon.propTypes }
