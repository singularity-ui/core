...
const MaterialAccessTimeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAccessTimeRounded = (styled.default || styled)(MaterialAccessTimeRoundedSvg).attrs(p => ({
...
`;
MaterialAccessTimeRounded.propTypes = {
