...
const MaterialSportsOutlinedSvg = props => (
  <svg
...
const MaterialSportsOutlined = props => <Icon as={MaterialSportsOutlinedSvg} {...props} />

MaterialSportsOutlined.defaultProps = { ...Icon.defaultProps }

MaterialSportsOutlined.propTypes = { ...Icon.propTypes }
