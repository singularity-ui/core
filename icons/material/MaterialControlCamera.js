...
const MaterialControlCameraSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialControlCamera = (styled.default || styled)(MaterialControlCameraSvg).attrs(p => ({
...
`;
MaterialControlCamera.propTypes = {
