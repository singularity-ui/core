...
const MaterialScreenLockPortraitSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialScreenLockPortrait = (styled.default || styled)(MaterialScreenLockPortraitSvg).attrs(p => ({
...
`;
MaterialScreenLockPortrait.propTypes = {
