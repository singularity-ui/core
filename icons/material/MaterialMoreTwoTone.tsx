...
const MaterialMoreTwoToneSvg = props => (
...
const MaterialMoreTwoTone = props => <Icon as={MaterialMoreTwoToneSvg} {...props} />

MaterialMoreTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialMoreTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialMoreTwoTone
