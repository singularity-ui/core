...
const MaterialFlipToBackTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlipToBackTwoTone = (styled.default || styled)(MaterialFlipToBackTwoToneSvg).attrs(p => ({
...
`;
MaterialFlipToBackTwoTone.propTypes = {
