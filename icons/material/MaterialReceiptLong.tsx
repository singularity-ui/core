...
const MaterialReceiptLongSvg = props => (
  <svg
...
const MaterialReceiptLong = props => <Icon as={MaterialReceiptLongSvg} {...props} />

MaterialReceiptLong.defaultProps = { ...Icon.defaultProps }

MaterialReceiptLong.propTypes = { ...Icon.propTypes }
