...
const MaterialViewInArSvg = props => (
...
const MaterialViewInAr = props => <Icon as={MaterialViewInArSvg} {...props} />

MaterialViewInAr.defaultProps = { ...Icon.defaultProps }

MaterialViewInAr.propTypes = { ...Icon.propTypes }
