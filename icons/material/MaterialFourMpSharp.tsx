...
const MaterialFourMpSharpSvg = props => (
  <svg
...
const MaterialFourMpSharp = props => <Icon as={MaterialFourMpSharpSvg} {...props} />

MaterialFourMpSharp.defaultProps = { ...Icon.defaultProps }

MaterialFourMpSharp.propTypes = { ...Icon.propTypes }
