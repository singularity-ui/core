...
const MaterialHouseboatTwoToneSvg = props => (
  <svg
...
const MaterialHouseboatTwoTone = props => <Icon as={MaterialHouseboatTwoToneSvg} {...props} />

MaterialHouseboatTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHouseboatTwoTone.propTypes = { ...Icon.propTypes }
