...
const MaterialSpeakerPhoneSvg = props => (
...
const MaterialSpeakerPhone = props => <Icon as={MaterialSpeakerPhoneSvg} {...props} />

MaterialSpeakerPhone.defaultProps = { ...Icon.defaultProps }

MaterialSpeakerPhone.propTypes = { ...Icon.propTypes }

export default MaterialSpeakerPhone
