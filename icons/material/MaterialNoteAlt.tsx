...
const MaterialNoteAltSvg = props => (
  <svg
...
const MaterialNoteAlt = props => <Icon as={MaterialNoteAltSvg} {...props} />

MaterialNoteAlt.defaultProps = { ...Icon.defaultProps }

MaterialNoteAlt.propTypes = { ...Icon.propTypes }

export default MaterialNoteAlt
