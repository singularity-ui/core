...
const MaterialRingVolumeOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRingVolumeOutlined = (styled.default || styled)(MaterialRingVolumeOutlinedSvg).attrs(p => ({
...
`;
MaterialRingVolumeOutlined.propTypes = {
