...
const MaterialPersonSearchSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPersonSearchSharp = (styled.default || styled)(MaterialPersonSearchSharpSvg).attrs(p => ({
...
`;
MaterialPersonSearchSharp.propTypes = {
