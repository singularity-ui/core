...
const MaterialAddToDriveRoundedSvg = props => (
  <svg
...
const MaterialAddToDriveRounded = props => <Icon as={MaterialAddToDriveRoundedSvg} {...props} />

MaterialAddToDriveRounded.defaultProps = { ...Icon.defaultProps }

MaterialAddToDriveRounded.propTypes = { ...Icon.propTypes }

export default MaterialAddToDriveRounded
