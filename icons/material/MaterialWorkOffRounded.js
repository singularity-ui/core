...
const MaterialWorkOffRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWorkOffRounded = (styled.default || styled)(MaterialWorkOffRoundedSvg).attrs(p => ({
...
`;
MaterialWorkOffRounded.propTypes = {
