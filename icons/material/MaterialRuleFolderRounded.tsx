...
const MaterialRuleFolderRoundedSvg = props => (
  <svg
...
const MaterialRuleFolderRounded = props => <Icon as={MaterialRuleFolderRoundedSvg} {...props} />

MaterialRuleFolderRounded.defaultProps = { ...Icon.defaultProps }

MaterialRuleFolderRounded.propTypes = { ...Icon.propTypes }
