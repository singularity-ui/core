...
const MaterialLinkedCameraSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLinkedCamera = (styled.default || styled)(MaterialLinkedCameraSvg).attrs(p => ({
...
`;
MaterialLinkedCamera.propTypes = {
