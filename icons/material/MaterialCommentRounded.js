...
const MaterialCommentRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCommentRounded = (styled.default || styled)(MaterialCommentRoundedSvg).attrs(p => ({
...
`;
MaterialCommentRounded.propTypes = {
