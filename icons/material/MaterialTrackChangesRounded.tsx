...
const MaterialTrackChangesRoundedSvg = props => (
...
const MaterialTrackChangesRounded = props => <Icon as={MaterialTrackChangesRoundedSvg} {...props} />

MaterialTrackChangesRounded.defaultProps = { ...Icon.defaultProps }

MaterialTrackChangesRounded.propTypes = { ...Icon.propTypes }

export default MaterialTrackChangesRounded
