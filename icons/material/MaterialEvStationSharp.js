...
const MaterialEvStationSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEvStationSharp = (styled.default || styled)(MaterialEvStationSharpSvg).attrs(p => ({
...
`;
MaterialEvStationSharp.propTypes = {
