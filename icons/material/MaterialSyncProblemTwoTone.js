...
const MaterialSyncProblemTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSyncProblemTwoTone = (styled.default || styled)(MaterialSyncProblemTwoToneSvg).attrs(p => ({
...
`;
MaterialSyncProblemTwoTone.propTypes = {
