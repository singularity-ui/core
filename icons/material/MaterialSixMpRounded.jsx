...
const MaterialSixMpRoundedSvg = props => (
  <svg
...
const MaterialSixMpRounded = props => <Icon as={MaterialSixMpRoundedSvg} {...props} />

MaterialSixMpRounded.defaultProps = { ...Icon.defaultProps }

MaterialSixMpRounded.propTypes = { ...Icon.propTypes }

export default MaterialSixMpRounded
