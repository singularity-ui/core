...
const MaterialFlipToBackRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFlipToBackRounded = (styled.default || styled)(MaterialFlipToBackRoundedSvg).attrs(p => ({
...
`;
MaterialFlipToBackRounded.propTypes = {
