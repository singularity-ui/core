...
const MaterialTimerThreeSelectSvg = props => (
  <svg
...
const MaterialTimerThreeSelect = props => <Icon as={MaterialTimerThreeSelectSvg} {...props} />

MaterialTimerThreeSelect.defaultProps = { ...Icon.defaultProps }

MaterialTimerThreeSelect.propTypes = { ...Icon.propTypes }

export default MaterialTimerThreeSelect
