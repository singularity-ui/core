...
const MaterialImportContactsSvg = props => (
  <svg
...
const MaterialImportContacts = props => <Icon as={MaterialImportContactsSvg} {...props} />

MaterialImportContacts.defaultProps = { ...Icon.defaultProps }

MaterialImportContacts.propTypes = { ...Icon.propTypes }

export default MaterialImportContacts
