...
const MaterialRouterOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRouterOutlined = (styled.default || styled)(MaterialRouterOutlinedSvg).attrs(p => ({
...
`;
MaterialRouterOutlined.propTypes = {
