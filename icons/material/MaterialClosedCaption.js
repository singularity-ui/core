...
const MaterialClosedCaptionSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialClosedCaption = (styled.default || styled)(MaterialClosedCaptionSvg).attrs(p => ({
...
`;
MaterialClosedCaption.propTypes = {
