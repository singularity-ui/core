...
const MaterialSports = props => <Icon as={MaterialSportsSvg} {...props} />

MaterialSports.defaultProps = { ...Icon.defaultProps }

MaterialSports.propTypes = { ...Icon.propTypes }

export default MaterialSports
