...
const MaterialGamesTwoToneSvg = props => (
...
const MaterialGamesTwoTone = props => <Icon as={MaterialGamesTwoToneSvg} {...props} />

MaterialGamesTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialGamesTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialGamesTwoTone
