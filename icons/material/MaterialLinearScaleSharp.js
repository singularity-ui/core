...
const MaterialLinearScaleSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLinearScaleSharp = (styled.default || styled)(MaterialLinearScaleSharpSvg).attrs(p => ({
...
`;
MaterialLinearScaleSharp.propTypes = {
