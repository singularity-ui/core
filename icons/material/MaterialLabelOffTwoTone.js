...
const MaterialLabelOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLabelOffTwoTone = (styled.default || styled)(MaterialLabelOffTwoToneSvg).attrs(p => ({
...
`;
MaterialLabelOffTwoTone.propTypes = {
