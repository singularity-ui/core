...
const MaterialRuleFolderOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRuleFolderOutlined = (styled.default || styled)(MaterialRuleFolderOutlinedSvg).attrs(p => ({
...
`;
MaterialRuleFolderOutlined.propTypes = {
