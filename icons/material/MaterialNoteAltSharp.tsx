...
const MaterialNoteAltSharpSvg = props => (
  <svg
...
const MaterialNoteAltSharp = props => <Icon as={MaterialNoteAltSharpSvg} {...props} />

MaterialNoteAltSharp.defaultProps = { ...Icon.defaultProps }

MaterialNoteAltSharp.propTypes = { ...Icon.propTypes }
