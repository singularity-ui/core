...
const MaterialDoDisturbOffSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDoDisturbOff = (styled.default || styled)(MaterialDoDisturbOffSvg).attrs(p => ({
...
`;
MaterialDoDisturbOff.propTypes = {
