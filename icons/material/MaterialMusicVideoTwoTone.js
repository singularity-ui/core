...
const MaterialMusicVideoTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialMusicVideoTwoTone = (styled.default || styled)(MaterialMusicVideoTwoToneSvg).attrs(p => ({
...
`;
MaterialMusicVideoTwoTone.propTypes = {
