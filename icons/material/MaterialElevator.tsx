...
const MaterialElevatorSvg = props => (
  <svg
...
const MaterialElevator = props => <Icon as={MaterialElevatorSvg} {...props} />

MaterialElevator.defaultProps = { ...Icon.defaultProps }

MaterialElevator.propTypes = { ...Icon.propTypes }

export default MaterialElevator
