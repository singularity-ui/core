...
const MaterialDriveEtaSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialDriveEtaSharp = (styled.default || styled)(MaterialDriveEtaSharpSvg).attrs(p => ({
...
`;
MaterialDriveEtaSharp.propTypes = {
