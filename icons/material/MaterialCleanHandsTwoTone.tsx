...
const MaterialCleanHandsTwoToneSvg = props => (
  <svg
...
const MaterialCleanHandsTwoTone = props => <Icon as={MaterialCleanHandsTwoToneSvg} {...props} />

MaterialCleanHandsTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCleanHandsTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialCleanHandsTwoTone
