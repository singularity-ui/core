...
const MaterialChildCareSvg = props => (
...
const MaterialChildCare = props => <Icon as={MaterialChildCareSvg} {...props} />

MaterialChildCare.defaultProps = { ...Icon.defaultProps }

MaterialChildCare.propTypes = { ...Icon.propTypes }
