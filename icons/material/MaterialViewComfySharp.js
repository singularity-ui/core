...
const MaterialViewComfySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialViewComfySharp = (styled.default || styled)(MaterialViewComfySharpSvg).attrs(p => ({
...
`;
MaterialViewComfySharp.propTypes = {
