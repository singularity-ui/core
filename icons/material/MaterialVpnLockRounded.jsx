...
const MaterialVpnLockRoundedSvg = props => (
  <svg
...
const MaterialVpnLockRounded = props => <Icon as={MaterialVpnLockRoundedSvg} {...props} />

MaterialVpnLockRounded.defaultProps = { ...Icon.defaultProps }

MaterialVpnLockRounded.propTypes = { ...Icon.propTypes }
