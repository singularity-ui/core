...
const MaterialSendToMobileRoundedSvg = props => (
  <svg
...
const MaterialSendToMobileRounded = props => <Icon as={MaterialSendToMobileRoundedSvg} {...props} />

MaterialSendToMobileRounded.defaultProps = { ...Icon.defaultProps }

MaterialSendToMobileRounded.propTypes = { ...Icon.propTypes }
