...
const MaterialAttributionTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAttributionTwoTone = (styled.default || styled)(MaterialAttributionTwoToneSvg).attrs(p => ({
...
`;
MaterialAttributionTwoTone.propTypes = {
