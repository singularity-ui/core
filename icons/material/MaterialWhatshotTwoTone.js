...
const MaterialWhatshotTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWhatshotTwoTone = (styled.default || styled)(MaterialWhatshotTwoToneSvg).attrs(p => ({
...
`;
MaterialWhatshotTwoTone.propTypes = {
