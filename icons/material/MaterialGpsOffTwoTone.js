...
const MaterialGpsOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGpsOffTwoTone = (styled.default || styled)(MaterialGpsOffTwoToneSvg).attrs(p => ({
...
`;
MaterialGpsOffTwoTone.propTypes = {
