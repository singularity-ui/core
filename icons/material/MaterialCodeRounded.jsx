...
const MaterialCodeRoundedSvg = props => (
...
const MaterialCodeRounded = props => <Icon as={MaterialCodeRoundedSvg} {...props} />

MaterialCodeRounded.defaultProps = { ...Icon.defaultProps }

MaterialCodeRounded.propTypes = { ...Icon.propTypes }
