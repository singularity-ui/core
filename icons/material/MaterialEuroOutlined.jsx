...
const MaterialEuroOutlinedSvg = props => (
  <svg
...
const MaterialEuroOutlined = props => <Icon as={MaterialEuroOutlinedSvg} {...props} />

MaterialEuroOutlined.defaultProps = { ...Icon.defaultProps }

MaterialEuroOutlined.propTypes = { ...Icon.propTypes }

export default MaterialEuroOutlined
