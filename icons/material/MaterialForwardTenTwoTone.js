...
const MaterialForwardTenTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialForwardTenTwoTone = (styled.default || styled)(MaterialForwardTenTwoToneSvg).attrs(p => ({
...
`;
MaterialForwardTenTwoTone.propTypes = {
