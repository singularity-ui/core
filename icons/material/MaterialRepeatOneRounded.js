...
const MaterialRepeatOneRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRepeatOneRounded = (styled.default || styled)(MaterialRepeatOneRoundedSvg).attrs(p => ({
...
`;
MaterialRepeatOneRounded.propTypes = {
