...
const MaterialLocalCarWashSvg = props => (
...
const MaterialLocalCarWash = props => <Icon as={MaterialLocalCarWashSvg} {...props} />

MaterialLocalCarWash.defaultProps = { ...Icon.defaultProps }

MaterialLocalCarWash.propTypes = { ...Icon.propTypes }
