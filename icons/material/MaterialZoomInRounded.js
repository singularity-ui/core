...
const MaterialZoomInRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialZoomInRounded = (styled.default || styled)(MaterialZoomInRoundedSvg).attrs(p => ({
...
`;
MaterialZoomInRounded.propTypes = {
