...
const MaterialFindReplaceRoundedSvg = props => (
...
const MaterialFindReplaceRounded = props => <Icon as={MaterialFindReplaceRoundedSvg} {...props} />

MaterialFindReplaceRounded.defaultProps = { ...Icon.defaultProps }

MaterialFindReplaceRounded.propTypes = { ...Icon.propTypes }
