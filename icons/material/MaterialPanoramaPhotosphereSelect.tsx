...
const MaterialPanoramaPhotosphereSelectSvg = props => (
...
const MaterialPanoramaPhotosphereSelect = props => <Icon as={MaterialPanoramaPhotosphereSelectSvg} {...props} />

MaterialPanoramaPhotosphereSelect.defaultProps = { ...Icon.defaultProps }

MaterialPanoramaPhotosphereSelect.propTypes = { ...Icon.propTypes }
