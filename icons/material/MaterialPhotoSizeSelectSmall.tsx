...
const MaterialPhotoSizeSelectSmallSvg = props => (
...
const MaterialPhotoSizeSelectSmall = props => <Icon as={MaterialPhotoSizeSelectSmallSvg} {...props} />

MaterialPhotoSizeSelectSmall.defaultProps = { ...Icon.defaultProps }

MaterialPhotoSizeSelectSmall.propTypes = { ...Icon.propTypes }
