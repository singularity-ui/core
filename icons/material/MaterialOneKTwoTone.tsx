...
const MaterialOneKTwoToneSvg = props => (
  <svg
...
const MaterialOneKTwoTone = props => <Icon as={MaterialOneKTwoToneSvg} {...props} />

MaterialOneKTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialOneKTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialOneKTwoTone
