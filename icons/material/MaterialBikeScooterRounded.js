...
const MaterialBikeScooterRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBikeScooterRounded = (styled.default || styled)(MaterialBikeScooterRoundedSvg).attrs(p => ({
...
`;
MaterialBikeScooterRounded.propTypes = {
