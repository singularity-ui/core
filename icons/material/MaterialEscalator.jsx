...
const MaterialEscalatorSvg = props => (
  <svg
...
const MaterialEscalator = props => <Icon as={MaterialEscalatorSvg} {...props} />

MaterialEscalator.defaultProps = { ...Icon.defaultProps }

MaterialEscalator.propTypes = { ...Icon.propTypes }
