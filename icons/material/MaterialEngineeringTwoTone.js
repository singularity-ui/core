...
const MaterialEngineeringTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
  ...
  d: "M9,11c1.1,0,2-0.9,2-2H7C7,10.1,7.9,11,9,11z",
  opacity: ".3"
...
const MaterialEngineeringTwoTone = (styled.default || styled)(MaterialEngineeringTwoToneSvg).attrs(p => ({
...
`;
MaterialEngineeringTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialEngineeringTwoTone;