...
const MaterialLoupeRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialLoupeRounded = (styled.default || styled)(MaterialLoupeRoundedSvg).attrs(p => ({
...
`;
MaterialLoupeRounded.propTypes = {
