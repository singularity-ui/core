...
const MaterialTimeToLeaveRoundedSvg = props => (
...
const MaterialTimeToLeaveRounded = props => <Icon as={MaterialTimeToLeaveRoundedSvg} {...props} />

MaterialTimeToLeaveRounded.defaultProps = { ...Icon.defaultProps }

MaterialTimeToLeaveRounded.propTypes = { ...Icon.propTypes }

export default MaterialTimeToLeaveRounded
