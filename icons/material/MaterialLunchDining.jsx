...
const MaterialLunchDiningSvg = props => (
  <svg
...
const MaterialLunchDining = props => <Icon as={MaterialLunchDiningSvg} {...props} />

MaterialLunchDining.defaultProps = { ...Icon.defaultProps }

MaterialLunchDining.propTypes = { ...Icon.propTypes }
