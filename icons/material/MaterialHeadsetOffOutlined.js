...
const MaterialHeadsetOffOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHeadsetOffOutlined = (styled.default || styled)(MaterialHeadsetOffOutlinedSvg).attrs(p => ({
...
`;
MaterialHeadsetOffOutlined.propTypes = {
