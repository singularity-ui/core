...
const MaterialOpenInNewOffTwoToneSvg = props => (
  <svg
...
const MaterialOpenInNewOffTwoTone = props => <Icon as={MaterialOpenInNewOffTwoToneSvg} {...props} />

MaterialOpenInNewOffTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialOpenInNewOffTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialOpenInNewOffTwoTone
