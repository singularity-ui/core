...
const MaterialHandymanTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialHandymanTwoTone = (styled.default || styled)(MaterialHandymanTwoToneSvg).attrs(p => ({
...
`;
MaterialHandymanTwoTone.propTypes = {
