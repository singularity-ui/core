...
const MaterialNordicWalkingSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNordicWalking = (styled.default || styled)(MaterialNordicWalkingSvg).attrs(p => ({
...
`;
MaterialNordicWalking.propTypes = {
