...
const MaterialClosedCaptionOffSvg = props => (
...
const MaterialClosedCaptionOff = props => <Icon as={MaterialClosedCaptionOffSvg} {...props} />

MaterialClosedCaptionOff.defaultProps = { ...Icon.defaultProps }

MaterialClosedCaptionOff.propTypes = { ...Icon.propTypes }

export default MaterialClosedCaptionOff
