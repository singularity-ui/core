...
const MaterialDepartureBoardTwoToneSvg = props => (
...
const MaterialDepartureBoardTwoTone = props => <Icon as={MaterialDepartureBoardTwoToneSvg} {...props} />

MaterialDepartureBoardTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDepartureBoardTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialDepartureBoardTwoTone
