...
const MaterialAutorenewRoundedSvg = props => (
...
const MaterialAutorenewRounded = props => <Icon as={MaterialAutorenewRoundedSvg} {...props} />

MaterialAutorenewRounded.defaultProps = { ...Icon.defaultProps }

MaterialAutorenewRounded.propTypes = { ...Icon.propTypes }
