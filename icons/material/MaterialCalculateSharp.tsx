...
const MaterialCalculateSharpSvg = props => (
  <svg
...
const MaterialCalculateSharp = props => <Icon as={MaterialCalculateSharpSvg} {...props} />

MaterialCalculateSharp.defaultProps = { ...Icon.defaultProps }

MaterialCalculateSharp.propTypes = { ...Icon.propTypes }

export default MaterialCalculateSharp
