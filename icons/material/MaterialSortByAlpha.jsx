...
const MaterialSortByAlphaSvg = props => (
...
const MaterialSortByAlpha = props => <Icon as={MaterialSortByAlphaSvg} {...props} />

MaterialSortByAlpha.defaultProps = { ...Icon.defaultProps }

MaterialSortByAlpha.propTypes = { ...Icon.propTypes }

export default MaterialSortByAlpha
