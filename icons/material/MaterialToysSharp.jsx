...
const MaterialToysSharpSvg = props => (
  <svg
...
const MaterialToysSharp = props => <Icon as={MaterialToysSharpSvg} {...props} />

MaterialToysSharp.defaultProps = { ...Icon.defaultProps }

MaterialToysSharp.propTypes = { ...Icon.propTypes }
