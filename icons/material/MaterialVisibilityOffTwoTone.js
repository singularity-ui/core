...
const MaterialVisibilityOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialVisibilityOffTwoTone = (styled.default || styled)(MaterialVisibilityOffTwoToneSvg).attrs(p => ({
...
`;
MaterialVisibilityOffTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialVisibilityOffTwoTone;