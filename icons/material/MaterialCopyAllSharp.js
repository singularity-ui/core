...
const MaterialCopyAllSharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCopyAllSharp = (styled.default || styled)(MaterialCopyAllSharpSvg).attrs(p => ({
...
`;
MaterialCopyAllSharp.propTypes = {
