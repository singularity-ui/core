...
const MaterialHikingTwoToneSvg = props => (
  <svg
...
const MaterialHikingTwoTone = props => <Icon as={MaterialHikingTwoToneSvg} {...props} />

MaterialHikingTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHikingTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialHikingTwoTone
