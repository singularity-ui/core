...
const MaterialBluetoothAudioSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBluetoothAudio = (styled.default || styled)(MaterialBluetoothAudioSvg).attrs(p => ({
...
`;
MaterialBluetoothAudio.propTypes = {
