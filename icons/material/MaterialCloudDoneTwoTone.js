...
const MaterialCloudDoneTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialCloudDoneTwoTone = (styled.default || styled)(MaterialCloudDoneTwoToneSvg).attrs(p => ({
...
`;
MaterialCloudDoneTwoTone.propTypes = {
