...
const MaterialAtm = props => <Icon as={MaterialAtmSvg} {...props} />

MaterialAtm.defaultProps = { ...Icon.defaultProps }

MaterialAtm.propTypes = { ...Icon.propTypes }

export default MaterialAtm
