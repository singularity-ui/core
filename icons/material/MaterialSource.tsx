...
const MaterialSource = props => <Icon as={MaterialSourceSvg} {...props} />

MaterialSource.defaultProps = { ...Icon.defaultProps }

MaterialSource.propTypes = { ...Icon.propTypes }
