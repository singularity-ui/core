...
const MaterialDiscFullTwoToneSvg = props => (
...
const MaterialDiscFullTwoTone = props => <Icon as={MaterialDiscFullTwoToneSvg} {...props} />

MaterialDiscFullTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDiscFullTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialDiscFullTwoTone
