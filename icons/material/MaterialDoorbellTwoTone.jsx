...
const MaterialDoorbellTwoToneSvg = props => (
  <svg
...
const MaterialDoorbellTwoTone = props => <Icon as={MaterialDoorbellTwoToneSvg} {...props} />

MaterialDoorbellTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialDoorbellTwoTone.propTypes = { ...Icon.propTypes }
