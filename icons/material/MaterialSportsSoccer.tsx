...
const MaterialSportsSoccerSvg = props => (
  <svg
...
const MaterialSportsSoccer = props => <Icon as={MaterialSportsSoccerSvg} {...props} />

MaterialSportsSoccer.defaultProps = { ...Icon.defaultProps }

MaterialSportsSoccer.propTypes = { ...Icon.propTypes }

export default MaterialSportsSoccer
