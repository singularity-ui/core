...
const MaterialSixtyFpsSvg = props => (
  <svg
...
const MaterialSixtyFps = props => <Icon as={MaterialSixtyFpsSvg} {...props} />

MaterialSixtyFps.defaultProps = { ...Icon.defaultProps }

MaterialSixtyFps.propTypes = { ...Icon.propTypes }

export default MaterialSixtyFps
