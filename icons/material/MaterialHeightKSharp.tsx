...
const MaterialHeightKSharpSvg = props => (
  <svg
...
const MaterialHeightKSharp = props => <Icon as={MaterialHeightKSharpSvg} {...props} />

MaterialHeightKSharp.defaultProps = { ...Icon.defaultProps }

MaterialHeightKSharp.propTypes = { ...Icon.propTypes }
