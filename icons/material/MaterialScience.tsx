...
const MaterialScienceSvg = props => (
  <svg
...
const MaterialScience = props => <Icon as={MaterialScienceSvg} {...props} />

MaterialScience.defaultProps = { ...Icon.defaultProps }

MaterialScience.propTypes = { ...Icon.propTypes }
