...
const MaterialReplayThirtyTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayThirtyTwoTone = (styled.default || styled)(MaterialReplayThirtyTwoToneSvg).attrs(p => ({
...
`;
MaterialReplayThirtyTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialReplayThirtyTwoTone;