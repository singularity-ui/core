...
const MaterialSummarizeOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialSummarizeOutlined = (styled.default || styled)(MaterialSummarizeOutlinedSvg).attrs(p => ({
...
`;
MaterialSummarizeOutlined.propTypes = {
