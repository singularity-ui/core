...
const MaterialBorderAllRoundedSvg = props => (
...
const MaterialBorderAllRounded = props => <Icon as={MaterialBorderAllRoundedSvg} {...props} />

MaterialBorderAllRounded.defaultProps = { ...Icon.defaultProps }

MaterialBorderAllRounded.propTypes = { ...Icon.propTypes }
