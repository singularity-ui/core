...
const MaterialExposurePlusTwoSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialExposurePlusTwo = (styled.default || styled)(MaterialExposurePlusTwoSvg).attrs(p => ({
...
`;
MaterialExposurePlusTwo.propTypes = {
