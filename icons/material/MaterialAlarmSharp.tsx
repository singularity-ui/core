...
const MaterialAlarmSharpSvg = props => (
...
const MaterialAlarmSharp = props => <Icon as={MaterialAlarmSharpSvg} {...props} />

MaterialAlarmSharp.defaultProps = { ...Icon.defaultProps }

MaterialAlarmSharp.propTypes = { ...Icon.propTypes }

export default MaterialAlarmSharp
