...
const MaterialSyncDisabledSvg = props => (
...
const MaterialSyncDisabled = props => <Icon as={MaterialSyncDisabledSvg} {...props} />

MaterialSyncDisabled.defaultProps = { ...Icon.defaultProps }

MaterialSyncDisabled.propTypes = { ...Icon.propTypes }

export default MaterialSyncDisabled
