...
const MaterialDeveloperModeSvg = props => (
...
const MaterialDeveloperMode = props => <Icon as={MaterialDeveloperModeSvg} {...props} />

MaterialDeveloperMode.defaultProps = { ...Icon.defaultProps }

MaterialDeveloperMode.propTypes = { ...Icon.propTypes }

export default MaterialDeveloperMode
