...
const MaterialNoFoodRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialNoFoodRounded = (styled.default || styled)(MaterialNoFoodRoundedSvg).attrs(p => ({
...
`;
MaterialNoFoodRounded.propTypes = {
