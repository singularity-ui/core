...
const MaterialAllInboxTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAllInboxTwoTone = (styled.default || styled)(MaterialAllInboxTwoToneSvg).attrs(p => ({
...
`;
MaterialAllInboxTwoTone.propTypes = {
