...
const MaterialEarbudsBatterySvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialEarbudsBattery = (styled.default || styled)(MaterialEarbudsBatterySvg).attrs(p => ({
...
`;
MaterialEarbudsBattery.propTypes = {
