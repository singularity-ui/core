...
const MaterialSubscriptSvg = props => (
  <svg
...
const MaterialSubscript = props => <Icon as={MaterialSubscriptSvg} {...props} />

MaterialSubscript.defaultProps = { ...Icon.defaultProps }

MaterialSubscript.propTypes = { ...Icon.propTypes }

export default MaterialSubscript
