...
const MaterialRestartAltOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialRestartAltOutlined = (styled.default || styled)(MaterialRestartAltOutlinedSvg).attrs(p => ({
...
`;
MaterialRestartAltOutlined.propTypes = {
