...
const MaterialRvHookupSvg = props => (
...
const MaterialRvHookup = props => <Icon as={MaterialRvHookupSvg} {...props} />

MaterialRvHookup.defaultProps = { ...Icon.defaultProps }

MaterialRvHookup.propTypes = { ...Icon.propTypes }

export default MaterialRvHookup
