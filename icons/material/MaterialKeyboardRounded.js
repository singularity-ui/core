...
const MaterialKeyboardRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialKeyboardRounded = (styled.default || styled)(MaterialKeyboardRoundedSvg).attrs(p => ({
...
`;
MaterialKeyboardRounded.propTypes = {
