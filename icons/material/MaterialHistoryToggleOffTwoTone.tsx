...
const MaterialHistoryToggleOffTwoToneSvg = props => (
  <svg
...
const MaterialHistoryToggleOffTwoTone = props => <Icon as={MaterialHistoryToggleOffTwoToneSvg} {...props} />

MaterialHistoryToggleOffTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialHistoryToggleOffTwoTone.propTypes = { ...Icon.propTypes }

export default MaterialHistoryToggleOffTwoTone
