...
const MaterialGradeTwoToneSvg = props => (
...
const MaterialGradeTwoTone = props => <Icon as={MaterialGradeTwoToneSvg} {...props} />

MaterialGradeTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialGradeTwoTone.propTypes = { ...Icon.propTypes }
