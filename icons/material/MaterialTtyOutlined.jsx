...
const MaterialTtyOutlinedSvg = props => (
  <svg
...
const MaterialTtyOutlined = props => <Icon as={MaterialTtyOutlinedSvg} {...props} />

MaterialTtyOutlined.defaultProps = { ...Icon.defaultProps }

MaterialTtyOutlined.propTypes = { ...Icon.propTypes }

export default MaterialTtyOutlined
