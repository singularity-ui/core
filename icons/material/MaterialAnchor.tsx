...
const MaterialAnchor = props => <Icon as={MaterialAnchorSvg} {...props} />

MaterialAnchor.defaultProps = { ...Icon.defaultProps }

MaterialAnchor.propTypes = { ...Icon.propTypes }

export default MaterialAnchor
