...
const MaterialInventorySharpSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialInventorySharp = (styled.default || styled)(MaterialInventorySharpSvg).attrs(p => ({
...
`;
MaterialInventorySharp.propTypes = {
