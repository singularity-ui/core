...
const MaterialLightbulbRoundedSvg = props => (
  <svg
...
const MaterialLightbulbRounded = props => <Icon as={MaterialLightbulbRoundedSvg} {...props} />

MaterialLightbulbRounded.defaultProps = { ...Icon.defaultProps }

MaterialLightbulbRounded.propTypes = { ...Icon.propTypes }

export default MaterialLightbulbRounded
