...
const MaterialBalconySharpSvg = props => (
  <svg
...
const MaterialBalconySharp = props => <Icon as={MaterialBalconySharpSvg} {...props} />

MaterialBalconySharp.defaultProps = { ...Icon.defaultProps }

MaterialBalconySharp.propTypes = { ...Icon.propTypes }
