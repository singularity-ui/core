...
const MaterialTimelapseOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimelapseOutlined = (styled.default || styled)(MaterialTimelapseOutlinedSvg).attrs(p => ({
...
`;
MaterialTimelapseOutlined.propTypes = {
