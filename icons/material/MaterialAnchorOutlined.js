...
const MaterialAnchorOutlinedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialAnchorOutlined = (styled.default || styled)(MaterialAnchorOutlinedSvg).attrs(p => ({
...
`;
MaterialAnchorOutlined.propTypes = {
