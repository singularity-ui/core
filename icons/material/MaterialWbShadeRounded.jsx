...
const MaterialWbShadeRoundedSvg = props => (
  <svg
...
const MaterialWbShadeRounded = props => <Icon as={MaterialWbShadeRoundedSvg} {...props} />

MaterialWbShadeRounded.defaultProps = { ...Icon.defaultProps }

MaterialWbShadeRounded.propTypes = { ...Icon.propTypes }
