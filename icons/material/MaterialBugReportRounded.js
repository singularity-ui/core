...
const MaterialBugReportRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialBugReportRounded = (styled.default || styled)(MaterialBugReportRoundedSvg).attrs(p => ({
...
`;
MaterialBugReportRounded.propTypes = {
