...
const MaterialPrintTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialPrintTwoTone = (styled.default || styled)(MaterialPrintTwoToneSvg).attrs(p => ({
...
`;
MaterialPrintTwoTone.propTypes = {
