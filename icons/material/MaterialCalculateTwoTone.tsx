...
const MaterialCalculateTwoToneSvg = props => (
  <svg
...
const MaterialCalculateTwoTone = props => <Icon as={MaterialCalculateTwoToneSvg} {...props} />

MaterialCalculateTwoTone.defaultProps = { ...Icon.defaultProps }

MaterialCalculateTwoTone.propTypes = { ...Icon.propTypes }
