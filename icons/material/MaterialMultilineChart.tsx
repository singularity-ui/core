...
const MaterialMultilineChartSvg = props => (
...
const MaterialMultilineChart = props => <Icon as={MaterialMultilineChartSvg} {...props} />

MaterialMultilineChart.defaultProps = { ...Icon.defaultProps }

MaterialMultilineChart.propTypes = { ...Icon.propTypes }

export default MaterialMultilineChart
