...
const MaterialGridOffTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialGridOffTwoTone = (styled.default || styled)(MaterialGridOffTwoToneSvg).attrs(p => ({
...
`;
MaterialGridOffTwoTone.propTypes = {
