...
const MaterialWebAssetOffRoundedSvg = props => (
  <svg
...
const MaterialWebAssetOffRounded = props => <Icon as={MaterialWebAssetOffRoundedSvg} {...props} />

MaterialWebAssetOffRounded.defaultProps = { ...Icon.defaultProps }

MaterialWebAssetOffRounded.propTypes = { ...Icon.propTypes }

export default MaterialWebAssetOffRounded
