...
const MaterialGppBad = props => <Icon as={MaterialGppBadSvg} {...props} />

MaterialGppBad.defaultProps = { ...Icon.defaultProps }

MaterialGppBad.propTypes = { ...Icon.propTypes }

export default MaterialGppBad
