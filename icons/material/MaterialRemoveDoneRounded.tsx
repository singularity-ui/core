...
const MaterialRemoveDoneRoundedSvg = props => (
  <svg
...
const MaterialRemoveDoneRounded = props => <Icon as={MaterialRemoveDoneRoundedSvg} {...props} />

MaterialRemoveDoneRounded.defaultProps = { ...Icon.defaultProps }

MaterialRemoveDoneRounded.propTypes = { ...Icon.propTypes }
