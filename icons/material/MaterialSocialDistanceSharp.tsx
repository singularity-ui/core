...
const MaterialSocialDistanceSharpSvg = props => (
  <svg
...
const MaterialSocialDistanceSharp = props => <Icon as={MaterialSocialDistanceSharpSvg} {...props} />

MaterialSocialDistanceSharp.defaultProps = { ...Icon.defaultProps }

MaterialSocialDistanceSharp.propTypes = { ...Icon.propTypes }

export default MaterialSocialDistanceSharp
