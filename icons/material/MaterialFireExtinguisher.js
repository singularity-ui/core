...
const MaterialFireExtinguisherSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialFireExtinguisher = (styled.default || styled)(MaterialFireExtinguisherSvg).attrs(p => ({
...
`;
MaterialFireExtinguisher.propTypes = {
