...
const MaterialAddReactionSharpSvg = props => (
  <svg
...
const MaterialAddReactionSharp = props => <Icon as={MaterialAddReactionSharpSvg} {...props} />

MaterialAddReactionSharp.defaultProps = { ...Icon.defaultProps }

MaterialAddReactionSharp.propTypes = { ...Icon.propTypes }

export default MaterialAddReactionSharp
