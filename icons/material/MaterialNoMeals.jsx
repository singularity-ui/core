...
const MaterialNoMealsSvg = props => (
  <svg
...
const MaterialNoMeals = props => <Icon as={MaterialNoMealsSvg} {...props} />

MaterialNoMeals.defaultProps = { ...Icon.defaultProps }

MaterialNoMeals.propTypes = { ...Icon.propTypes }
