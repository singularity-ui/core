...
const MaterialReplyAllRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplyAllRounded = (styled.default || styled)(MaterialReplyAllRoundedSvg).attrs(p => ({
...
`;
MaterialReplyAllRounded.propTypes = {
