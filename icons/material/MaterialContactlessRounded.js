...
const MaterialContactlessRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialContactlessRounded = (styled.default || styled)(MaterialContactlessRoundedSvg).attrs(p => ({
...
`;
MaterialContactlessRounded.propTypes = {
