...
const MaterialWifiProtectedSetupSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialWifiProtectedSetup = (styled.default || styled)(MaterialWifiProtectedSetupSvg).attrs(p => ({
...
`;
MaterialWifiProtectedSetup.propTypes = {
