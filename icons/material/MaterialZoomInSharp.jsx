...
const MaterialZoomInSharpSvg = props => (
...
const MaterialZoomInSharp = props => <Icon as={MaterialZoomInSharpSvg} {...props} />

MaterialZoomInSharp.defaultProps = { ...Icon.defaultProps }

MaterialZoomInSharp.propTypes = { ...Icon.propTypes }

export default MaterialZoomInSharp
