...
const MaterialReplayRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialReplayRounded = (styled.default || styled)(MaterialReplayRoundedSvg).attrs(p => ({
...
`;
MaterialReplayRounded.propTypes = {
