...
const MaterialScheduleRoundedSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialScheduleRounded = (styled.default || styled)(MaterialScheduleRoundedSvg).attrs(p => ({
...
`;
MaterialScheduleRounded.propTypes = {
