...
const MaterialLocalPoliceSvg = props => (
  <svg
...
const MaterialLocalPolice = props => <Icon as={MaterialLocalPoliceSvg} {...props} />

MaterialLocalPolice.defaultProps = { ...Icon.defaultProps }

MaterialLocalPolice.propTypes = { ...Icon.propTypes }
