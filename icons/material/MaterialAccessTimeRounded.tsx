...
const MaterialAccessTimeRoundedSvg = props => (
...
const MaterialAccessTimeRounded = props => <Icon as={MaterialAccessTimeRoundedSvg} {...props} />

MaterialAccessTimeRounded.defaultProps = { ...Icon.defaultProps }

MaterialAccessTimeRounded.propTypes = { ...Icon.propTypes }

export default MaterialAccessTimeRounded
