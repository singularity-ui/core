...
const MaterialMoney = props => <Icon as={MaterialMoneySvg} {...props} />

MaterialMoney.defaultProps = { ...Icon.defaultProps }

MaterialMoney.propTypes = { ...Icon.propTypes }

export default MaterialMoney
