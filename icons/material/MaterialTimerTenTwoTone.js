...
const MaterialTimerTenTwoToneSvg = props => /*#__PURE__*/React.createElement("svg", {
...
const MaterialTimerTenTwoTone = (styled.default || styled)(MaterialTimerTenTwoToneSvg).attrs(p => ({
...
`;
MaterialTimerTenTwoTone.propTypes = {
  accent: PropTypes.oneOf(ACCENTS),
  size: PropTypes.oneOf(SIZES)
};
export default MaterialTimerTenTwoTone;